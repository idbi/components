import{css as e}from"styled-components";import{Size as l}from"../components/Typography/id-utils.js";import{theme as g}from"./id-index.js";const d=({color:t="SECONDARY/900",design:r,hover:c,theme:n=g})=>{const o=t.split("/"),a=o[0];let i=+o[1];if(c&&i>=300)switch(r){case"solid":i-=100;break;case"outline":i=100;break;case"flat":i=100;break;default:i>=400?i-=100:i+=100;break}if(c&&i<300)switch(r){case"solid":i+=100;break;case"outline":i=100;break;case"flat":i=100;break;default:i-=100;break}return a==="PRIMARY"||a==="NEUTRAL"||a==="SECONDARY"||a==="TERTIARY"||a==="QUATERNARY"||a==="STATE"||a==="ALERT"||a==="SUCCESS"?i===0||i===50||i===100||i===200||i===300||i===400||i===500||i===600||i===700||i===800||i===900?n.color[a][i]:n.color[a][900]:n.color.PRIMARY[900]},$=({shape:t})=>{switch(t){case"rounded":return e`
