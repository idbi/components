import l, { css as f, keyframes as P } from "styled-components";
import { jsxs as d, jsx as t, Fragment as z } from "react/jsx-runtime";
import Y, { useEffect as T, forwardRef as ae, useState as L, useRef as D, useCallback as _, useMemo as Ft, useLayoutEffect as Bt, createContext as Ht, useContext as Pt } from "react";
import * as le from "@radix-ui/react-collapsible";
import { useFloating as lt, autoUpdate as dt, offset as Ut, arrow as Zt } from "@floating-ui/react-dom";
...
const Vt = {
  ...
  switch (e) {
    case "solid":
      return f`
        background-color: ${() => B({ color: n })};
        color: ${r ? B({ color: r }) : "#fff"};
      `;
    case "outline":
      return f`
        background-color: white;
        border: 1px solid ${() => B({ color: n })};
        color: ${() => B({ color: n })};
      `;
    case "flat":
      return f`
...
`, qt = l(Kt)`
  ...
  ${({ size: e }) => oe({ size: e })};
  ${({ shape: e }) => Gt({ shape: e })};
  ${({ design: e, color: n, fontColor: r }) => Xt({ design: e, color: n, fontColor: r })};
  ${({ fullWidth: e }) => st({ fullWidth: e })};
  ${({ isLoading: e }) => pt({ isLoading: e })};
  ${({ disabled: e }) => de({ disabled: e })};
  ${({ m: e, mb: n, mt: r, mr: o, ml: i, my: a, mx: s, p: c, pb: A, pt: h, pr: u, pl: g, py: m, px: x }) => ht({ m: e, mb: n, mt: r, mr: o, ml: i, my: a, mx: s, p: c, pb: A, pt: h, pr: u, pl: g, py: m, px: x })};

  &:hover:not(:disabled) {
    background-color: ${({ color: e, design: n }) => n === "link" ? "transparent" : B({ color: e, design: n, hover: !0 })};
  }
  ...
  T(() => {
    const i = (a) => {
      a.key === "Backspace" && setTimeout(() => {
        const s = o(), c = document.activeElement;
        c.value = "";
        const A = s.indexOf(c);
        A > 0 && s[A - 1].focus();
      }, 0);
    ...
    const i = (a) => {
      if (a.key !== "Backspace") {
        ...
        setTimeout(() => {
          if (s.length === 1) {
            const c = o(), A = document.activeElement;
            A.value = s;
            const h = c.indexOf(A);
            h < c.length - 1 && c[h + 1].focus();
          }
        }, 0);
      }
    };
    ...
    if (r) {
      const i = o(), a = i.map((A) => A.value), s = r.split(""), c = s.length === a.length ? s : a;
      i.forEach((A, h) => {
        const u = c[h];
        u && (A.value = u);
      });
...
`, en = {
  ...
  ${({ m: e, mb: n, mt: r, mr: o, ml: i, my: a, mx: s, p: c, pb: A, pt: h, pr: u, pl: g, py: m, px: x }) => ht({ m: e, mb: n, mt: r, mr: o, ml: i, my: a, mx: s, p: c, pb: A, pt: h, pr: u, pl: g, py: m, px: x })};
`, nn = (e) => {
  const n = e === "h1" || e === "h2" || e === "h3" || e === "h4" || e === "h5" || e === "h6", r = n ? "bold" : "medium", o = n ? ve[e] : ve.text, i = "PRIMARY/900";
  return f`
    font-weight: ${({ weight: a = r }) => Vt[a] || "500"};
    font-size: ${({ size: a = o }) => ct[a] || a};
    color: ${({ color: a = i }) => {
    const s = a == null ? void 0 : a.split("/")[0], c = Number(a == null ? void 0 : a.split("/")[1]);
    return p.color[s][c];
  }};
  `;
}, rn = l.div`
...
`, I = (e) => e.rightIcon || e.leftIcon ? /* @__PURE__ */ d(on, {
...
`, un = ae(({
  ...
  const g = D(null), [m, x] = L(i), [b, v] = L(""), [y, w] = L(!1);
  V(g, () => {
    w(!1);
  });
  const C = _(() => {
    ...
    A(i.find((E) => E.label === M)), w(!1), v(""), x(i);
  }, [C]), R = _((M) => {
    v(M.target.value);
...
`, Dn = ({
  ...
  return /* @__PURE__ */ d(ie, {
    ...
    children: [e, " ", /* @__PURE__ */ t("div", {
      ...
      children: /* @__PURE__ */ t(ut, {
        children: n.map((s, c) => /* @__PURE__ */ d(ie, {
          alert: s.alert,
  ...
  children: [n && /* @__PURE__ */ t(En, {
    children: n
  }), e.map((r, o) => "options" in r ? /* @__PURE__ */ t(Dn, {
    ...r
  }, `option-${o}`) : /* @__PURE__ */ d(ie, {
...
`, Pn = (e) => e === "small" ? "45px" : e === "big" ? "55px" : `${e}px`, Un = l.input`
  width: 100%;
  height: ${({ containerSize: e }) => Pn(e)};
  padding: 8px 15px;
...
`, On = ({
  ...
  T(() => {
    ...
    (n == null ? void 0 : n.length) === 1 && s && (v(), r != null && r.onSelect && r.onSelect(n[0]));
  }, [n]);
  const y = () => /* @__PURE__ */ t(Qn, {
    onClick: () => {
      c != null && c.onCreate && (c == null || c.onCreate(g), v());
    },
    children: (c == null ? void 0 : c.text) || "Crear"
  });
  return /* @__PURE__ */ d(Zn, {
    style: i,
    ref: m,
    active: Boolean(!x && n && g.length >= 1),
    children: [c.show && c.location === "top" && y(), !A && n && n.length > 0 ? n.map((C, k) => {
      var R;
      return /* @__PURE__ */ t(we, {
        onClick: () => {
          r != null && r.onSelect && r.onSelect(C), r != null && r.hideOnSelect && v();
        },
        children: o ? o(C) : `${C.name} ${C.quantity} ${(R = C.kardex_unit) == null ? void 0 : R.symbol}`
      }, `${k}search`);
    }) : /* @__PURE__ */ t(we, {
      style: {
        color: "#cbbcbb"
  ...
  const g = D(null), m = D(null), [x, b] = L(n || ""), v = () => {
    b(""), e("");
  }, y = (w) => {
...
var ft = {
  ...
  style: void 0,
  attr: void 0
}, Ce = Y.createContext && Y.createContext(ft), Z = globalThis && globalThis.__assign || function() {
...
}, Gn = globalThis && globalThis.__rest || function(e, n) {
  var r = {};
  for (var o in e)
...
function gt(e) {
  return e && e.map(function(n, r) {
    return Y.createElement(n.tag, Z({
      key: r
    }, n.attr), gt(n.child));
  });
}
...
function Jn(e) {
  var n = function(r) {
    var o = e.attr, i = e.size, a = e.title, s = Gn(e, ["attr", "size", "title"]), c = i || r.size || "1em", A;
    return r.className && (A = r.className), e.className && (A = (A ? A + " " : "") + e.className), Y.createElement("svg", Z({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, r.attr, o, s, {
      ...
      width: c,
      xmlns: "http://www.w3.org/2000/svg"
    }), a && Y.createElement("title", null, a), e.children);
  };
  return Ce !== void 0 ? Y.createElement(Ce.Consumer, null, function(r) {
    return n(r);
  }) : n(ft);
}
function Kn(e) {
...
`, lr = ({
  ...
  return /* @__PURE__ */ d("li", {
    ...
    children: [/* @__PURE__ */ d("div", {
      ...
      children: [e.text, " ", r.length > 0 && /* @__PURE__ */ t(ue, {
        size: 12,
        style: {
          display: "block",
          marginLeft: "auto",
      ...
      children: r.map((a, s) => /* @__PURE__ */ t("li", {
        onClick: () => {
          a.onClick(), n();
        },
        children: a.text
  ...
  const [A, h] = L(!1), [u, g] = L(!1), m = D(null);
  return V(m, () => {
    h(!1), g(!1);
  }), /* @__PURE__ */ d(er, {
    zIndex: s,
    ...
    children: [/* @__PURE__ */ d(tr, {
      children: [/* @__PURE__ */ d(Me, {
        ...
        children: [/* @__PURE__ */ t(rr, {
          children: n.map((x, b) => /* @__PURE__ */ t("li", {
            onClick: () => (x == null ? void 0 : x.onClick) && (x == null ? void 0 : x.onClick()),
            children: x.text
          }, `${b}navbarlinksfordesktop`))
        }), (o == null ? void 0 : o.show) && /* @__PURE__ */ t(Vn, {
          ...o,
          onSearch: (x) => o.onSearch(x)
        }), (a == null ? void 0 : a.show) && /* @__PURE__ */ t(qn, {
          size: 16,
          onClick: () => {
            a != null && a.onClick && a.onClick(), h(!1), g(!u);
          }
        }), (r == null ? void 0 : r.show) && /* @__PURE__ */ d(Me, {
          children: [((r == null ? void 0 : r.name) || (r == null ? void 0 : r.note)) && /* @__PURE__ */ d(or, {
            children: [(r == null ? void 0 : r.name) && /* @__PURE__ */ t(I, {
              children: r == null ? void 0 : r.name
            }), (r == null ? void 0 : r.note) && /* @__PURE__ */ t(I, {
              color: "NEUTRAL/500",
              size: "xs",
              as: "span",
            ...
            containerProps: {
              onClick: () => {
                r != null && r.onClick && (h(!1), g(!1), r.onClick());
              },
      ...
      children: /* @__PURE__ */ t("ul", {
        children: e.map((x, b) => /* @__PURE__ */ t(lr, {
          option: x.option,
...
`, ul = ({
  ...
  ${({ isActive: e, rounded: n, activeColor: r, tabWidth: o, tabFullWidth: i, tabHeight: a }) => e && f`
      color: ${r};
      ::before {
        content: "";
        background-color: ${r};
...
`, fr = ({
  ...
  const [c, A] = L(!1), h = D(null), {
    ...
    placement: o || "top",
    strategy: a,
    middleware: [Ut(i != null ? i : 10), ...s, Zt({
      element: h
    })]
  }), {
    x: k,
...
}, gr = (...e) => e.reduce((n, r) => n + (r || "").charAt(0), "").toUpperCase(), xr = ({
  name: e,
  lastname: n,
  img: r,
  size: o,
...
`, Le = {
  ...
  statusName: e,
  removeBackground: r,
  children: n || ((i) => Le[i] || Le.default)(e)
}), Cr = l.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
...
`, Re = (e, n, r) => e >= n && e <= r ? e : e < n ? n : r, yr = ({
  ...
  const a = Re(e, 0, 1), s = Re(n, 0, 1), c = 256 * a;
  return /* @__PURE__ */ t(Cr, {
    style: {
      backgroundColor: `rgba(${c}, ${c}, ${c}, ${s})`,
      ...o
    },
    ...i,
    children: r
...
`, Te = (e) => /* @__PURE__ */ d("svg", {
  ...
  statusName: e,
  radius: i,
  children: [o || zr[e], (n === "default" || r === "default" || n.length > 1 || r.length > 1) && /* @__PURE__ */ d("div", {
    children: [n === "default" ? /* @__PURE__ */ t(Ee, {
      children: Ne[e].title
    }) : /* @__PURE__ */ t(Ee, {
      children: n
...
`, Cl = ({
  ...
  children: [(n || o) && /* @__PURE__ */ d(Hr, {
    ...
    children: e.map((h) => /* @__PURE__ */ d(Yr, {
      remark: Boolean(h.remark),
      children: [i ? /* @__PURE__ */ d(ze, {
        children: [/* @__PURE__ */ d("div", {
...
`, yl = ({
  ...
  children: [(e || r) && /* @__PURE__ */ d(Xr, {
    hasContent: !!o,
    children: [/* @__PURE__ */ d(Jr, {
      children: [n, " ", e]
    }), r]
  }), o, i.map((a) => a && /* @__PURE__ */ t(Gr, {
    children: a
  }))]
}), Kr = (e) => /* @__PURE__ */ d(F, {
  viewBox: "0 0 13 11",
...
`, kl = ({
  ...
  children: [(() => {
    ...
    children: [e && /* @__PURE__ */ t(lo, {
      ...
      children: [n, " ", o && o.onClick && /* @__PURE__ */ t(so, {
        onClick: (s) => {
...
`, Ue = ({
  ...
  const a = D(null), [s, c] = L(i || ""), A = (u) => {
    const g = u.target.value;
    let m = /^[0-9]\d*(\.(\d*))?$/;
    o && (m = /^[0-9]*$/), !(g !== "" && !m.test(g)) && c(g);
  };
  T(() => {
    a.current.focus();
  }, []);
...
`, wt = ({
  ...
  const [v, y] = L(!1), w = Number(e || 0), C = e === null || w <= o, k = (M) => {
    M.stopPropagation();
...
`, Rl = ({
  ...
  return /* @__PURE__ */ d(To, {
    children: [/* @__PURE__ */ d(Do, {
      onClick: c || (() => {
      }),
      canClick: !!c,
      children: [(e == null ? void 0 : e.src) && /* @__PURE__ */ t(No, {
        ...e
      }), /* @__PURE__ */ d(Io, {
        children: [/* @__PURE__ */ d(zo, {
          detailsActive: y,
          children: [n, /* @__PURE__ */ t(ue, {
            size: 16,
            onClick: (k) => {
              k.stopPropagation(), w((R) => !R);
            }
          })]
        }), g && /* @__PURE__ */ t(So, {
          children: g.label
        }), /* @__PURE__ */ d(jo, {
          children: [g && /* @__PURE__ */ d(Fo, {
            children: ["-", r, g.discountedAmount.toFixed(2)]
          }), /* @__PURE__ */ d(Ze, {
...
`, Qo = ({
  ...
  children: [e && /* @__PURE__ */ t(Zo, {
    ...
    children: n.map((i) => /* @__PURE__ */ t(Wo, {
      selected: i.value === r,
      onClick: () => o(i.value, i),
      disabled: !!i.disabled,
      children: i.content
...
}), Oo = Array.from(Array(5), (e, n) => ({ content: `${n}`, value: `${n}` })), Vo = l.div`
  position: absolute;
  top: calc(100% + 5px);
  left: 0;
`, Go = ({
...
`, El = ({
  ...
  return /* @__PURE__ */ d(Xo, {
    children: [m && /* @__PURE__ */ d(Jo, {
      ...
      children: [(e == null ? void 0 : e.src) && /* @__PURE__ */ d(qo, {
        ...
        children: [/* @__PURE__ */ d(Ye, {
          ...
          children: [/* @__PURE__ */ d("div", {
            children: [/* @__PURE__ */ d(ni, {
              ...
              children: [r, " ", A.prevTotal.toFixed(2)]
            })]
          }), /* @__PURE__ */ t(wt, {
            value: i,
            onSetQuantity: s,
...
`, We = ({
  ...
  const c = o || "u.";
  return /* @__PURE__ */ d(oi, {
    disabled: a,
    bottom: s,
    children: [/* @__PURE__ */ t("span", {
      children: n !== null && /* @__PURE__ */ d(z, {
        children: [e, n.toFixed(2), " x ", c]
      })
    }), /* @__PURE__ */ d(ii, {
      disabled: a,
...
`, Tl = ({
  ...
  return /* @__PURE__ */ d(li, {
    ...
    children: [/* @__PURE__ */ d(di, {
      children: [(n == null ? void 0 : n.src) && /* @__PURE__ */ d(ci, {
        children: [/* @__PURE__ */ t("div", {
          children: /* @__PURE__ */ t("img", {
            ...n
          })
        }), g, u && !g && !!Qe(u) && /* @__PURE__ */ t(si, {
          status: u,
          children: Qe(u)
        })]
      }), /* @__PURE__ */ d(pi, {
...
`, Ii = ({
  ...
  children: [/* @__PURE__ */ d(Ei, {
    children: [(e || n) && /* @__PURE__ */ d(Ti, {
      children: [e && /* @__PURE__ */ t(Di, {
        children: e
      }), n && /* @__PURE__ */ t(Ni, {
        children: n
      })]
    }), r.length > 0 && /* @__PURE__ */ t(Oe, {
      children: r.map((i, a) => /* @__PURE__ */ t(j, {
        design: "solid",
        shape: "circular",
        size: "xs",
        fullWidth: !0,
...
`, Il = ({
  ...
  const [a, s] = L((i == null ? void 0 : i.checked) || !1);
  return T(() => {
    s(Boolean(i == null ? void 0 : i.checked));
  }, [i == null ? void 0 : i.checked]), /* @__PURE__ */ d(ji, {
    disabled: o,
    children: [/* @__PURE__ */ t("input", {
      ...i,
      type: "checkbox",
      ...
      disabled: o,
      onChange: (c) => {
        s(!a), r(c.target.value, !a);
      },
      checked: a
    }), /* @__PURE__ */ t("span", {
      children: a ? /* @__PURE__ */ t(zi, {
        color: o ? "gray" : "#4318FF"
      }) : /* @__PURE__ */ t(Si, {
        color: o ? "gray" : "#4318FF"
      })
...
`, Sl = ({
  ...
  return /* @__PURE__ */ d(Hi, {
    fullWidth: a,
    children: [((s = i == null ? void 0 : i.available) != null ? s : !0) && /* @__PURE__ */ t(Ve, {
      onClick: () => n(e - 1),
      ...
      children: [e, " ", r]
    }), ((c = o == null ? void 0 : o.available) != null ? c : !0) && /* @__PURE__ */ t(Ve, {
      onClick: () => n(e + 1),
...
const jl = ({
  ...
  model: a,
  fullWidth: i,
  children: e.map((c) => /* @__PURE__ */ t(Zi, {
    onClick: () => o(c.value),
    active: c.value === n,
    disabled: r,
    model: a,
...
`, Gi = l.div`
  ...
  ${({ toggled: e, styleOn: n, styleOff: r }) => e ? f`
...
`, Xi = l.div`
  ...
  ${({ toggled: e, styleOn: n, styleOff: r, width: o }) => e ? f`
...
function Q(e) {
  return function(n, r) {
    ...
    if (o === "formatting" && e.formattingValues) {
      ...
      var c = e.defaultWidth, A = r != null && r.width ? String(r.width) : e.defaultWidth;
      i = e.values[A] || e.values[c];
    }
...
function O(e) {
  return function(n) {
    ...
    if (!a)
      return null;
    var s = a[0], c = o && e.parsePatterns[o] || e.parsePatterns[e.defaultParseWidth], A = Array.isArray(c) ? i0(c, function(g) {
      return g.test(s);
    }) : o0(c, function(g) {
      return g.test(s);
    }), h;
    h = e.valueCallback ? e.valueCallback(A) : A, h = r.valueCallback ? r.valueCallback(h) : h;
...
var f0 = {
  ...
  return r.getUTCHours() !== 1 ? g0[n] : f0[n];
};
const m0 = x0;
var b0 = {
  narrow: ["AC", "DC"],
...
`, Pl = ({
  ...
  const A = D(null), [h, u] = L({
    ...
    var k, R;
    if ((x == null ? void 0 : x.length) > 0 && ((k = x[0]) == null ? void 0 : k.startDate) && ((R = x[0]) == null ? void 0 : R.endDate)) {
      const {
        startDate: N,
        endDate: M
      } = x[0], E = C === "from" ? N : M;
    ...
    if (C)
      ...
      const [E, S] = (k = h == null ? void 0 : h.from) == null ? void 0 : k.split(":"), [J, jt] = (R = h == null ? void 0 : h.to) == null ? void 0 : R.split(":");
      let W, $;
      if ((N = x[0]) != null && N.startDate && (W = new Date(x[0].startDate), W.setHours(Number(E || 0), Number(S || 0), 0)), (M = x[0]) != null && M.endDate && ($ = new Date(x[0].endDate), $.setHours(Number(J || 23), Number(jt || 59), 59)), W && W) {
        const be = {
          ...x[0],
          startDate: W,
          endDate: $
  ...
  return T(() => {
    const C = (k) => {
      var R;
      g && A.current && !((R = A.current) != null && R.contains(k.target)) && m(!1);
    };
    ...
    ref: A,
    children: [/* @__PURE__ */ d(G0, {
      onClick: () => m(!0),
      children: [r && /* @__PURE__ */ t(W0, {}), v("from") ? /* @__PURE__ */ t("p", {
      ...
      children: [/* @__PURE__ */ t(Qt, {
        onChange: (C) => {
          ...
          !Array.isArray(k) || (k == null ? void 0 : k.length) < 1 || b([{
            ...x[0],
            startDate: (R = k[0]) == null ? void 0 : R.startDate,
            endDate: (N = k[0]) == null ? void 0 : N.endDate
          }]);
        },
...
`, Ke = /* @__PURE__ */ t("div", {
  ...
  return /* @__PURE__ */ t(X, {
    ...
    closeIcon: !0,
    children: /* @__PURE__ */ d(J0, {
      children: [/* @__PURE__ */ d(q0, {
        children: [/* @__PURE__ */ d(K0, {
          children: [g && /* @__PURE__ */ t(q, {
            ...
            as: "h2",
            size: "md",
            children: (g == null ? void 0 : g.text) || a
          })]
        }), i.length > 0 && /* @__PURE__ */ t(I, {
          color: "NEUTRAL/400",
          size: "sm",
          weight: "regular",
          children: (g == null ? void 0 : g.description) || i
        })]
      }), /* @__PURE__ */ d($0, {
        direction: c,
        children: [!g && e.map((m, x) => "onClick" in m ? /* @__PURE__ */ d(te, {
          alert: m.alert,
        ...
        }, `option-${x}`)), g == null ? void 0 : g.options.map((m, x) => /* @__PURE__ */ d(te, {
          alert: m.alert,
          disabled: m.disabled || m.loading,
          onClick: () => {
...
`, na = ({
  ...
  maxWidth: "600px",
  ...a,
  children: [/* @__PURE__ */ t(_0, {
    children: e
  }), /* @__PURE__ */ t(ea, {
    children: n.map((c) => /* @__PURE__ */ d(ta, {
      minHeight: s,
      selected: c.value === r,
      disabled: c.disabled,
      onClick: () => {
        c.disabled || o(c.value, c);
      },
      children: [c.content, " ", c.icon]
    }, c.value))
  })]
}), ra = (e) => /* @__PURE__ */ t(F, {
  viewBox: "0 0 10 8",
...
`, Yl = ({
  ...
  options: e.map(({
    ...
    icon: a.value === r.selected ? n || /* @__PURE__ */ t(ra, {}) : void 0,
    ...a
  })),
  ...r
}), ia = l.div`
...
`, Wl = ({
  ...
  children: [/* @__PURE__ */ t(ia, {
    ...
    children: n.map((a, s) => /* @__PURE__ */ d(la, {
      disabled: a.disabled,
      onClick: () => {
  ...
  const c = D(null), A = () => c.current.click(), h = () => {
    const x = c.current.files[0];
    m(x);
  }, u = (x) => {
    x.stopPropagation(), x.preventDefault();
    const b = x.dataTransfer.files[0];
    m(b);
  }, g = (x) => i ? new RegExp(`${i.join("|")}$`, "i").exec(x.toLowerCase()) : !0, m = (x) => {
    var v;
    if (!x)
      return;
    if (!g(x.name)) {
    ...
    const b = da(x, n);
    if (!b.success) {
      r((v = b.error) == null ? void 0 : v.message);
      return;
    }
    e(x);
  };
...
`, Ql = ({
  ...
  const [i, a] = L(null), [s, c] = L(e || null), A = ge();
  return T(() => {
    let h = "";
    return i && (h = window.URL.createObjectURL(i), c(h)), () => {
    ...
    children: s ? /* @__PURE__ */ d(pa, {
      children: [/* @__PURE__ */ d(ha, {
        ...
        variant: "secondary",
        onClick: (h) => {
          h.stopPropagation(), a(null), c(null);
        },
...
`, Ol = ({
  ...
  const [o, i] = L(n || []), [a, s] = L(null), c = ge(), A = (u) => {
    ...
    const g = o[u];
    typeof g != "string" && window.URL.revokeObjectURL(g.url), i((m) => m.filter((x, b) => b !== u));
  };
  return T(() => {
    c || e(o);
  }, [o]), /* @__PURE__ */ d(ua, {
    children: [o.map((u, g) => /* @__PURE__ */ d(fa, {
      onMouseEnter: () => s(g),
      onMouseLeave: () => s(null),
    ...
    }, `imgs-${g}`)), !(r && o.length >= r) && /* @__PURE__ */ t(Mt, {
      onError: alert,
      onSelectFile: A,
      acceptedFiles: "image/x-png,image/jpeg",
      validFileExtensions: ["jpg", "jpeg", "png"],
...
`, ka = ({
  ...
  }, s = () => Number(o) <= 1 ? "1px solid #BFBFBF" : "1px solid #4318FF", c = () => Number(o) <= 1 ? "#BFBFBF" : "#4318FF", A = () => Number(o) === n ? "#BFBFBF" : "#4318FF";
  ...
  T(() => {
    if (!e.current || o.current)
      return;
    const i = e.current, a = (c) => {
      c.preventDefault();
      const h = c.pageX - i.offsetLeft - n.current;
    ...
    return i.addEventListener("mousedown", (c) => {
      n.current = c.pageX - i.offsetLeft, r.current = i.scrollLeft, window.addEventListener("mousemove", a), window.addEventListener("mouseup", s);
    }), o.current = !0, () => {
      window.removeEventListener("mousemove", a), window.removeEventListener("mouseup", s);
    };
  }, [e]);
...
`, Gl = ({
  ...
  return La(b), Bt(() => {
    ...
    children: [/* @__PURE__ */ t(Ra, {
      style: i,
      onScroll: (y) => {
        !A || (x.current && clearTimeout(x.current), x.current = setTimeout(() => {
          var w;
          A(((w = y.target) == null ? void 0 : w.scrollLeft) || 0);
        }, 50));
      },
      ref: b,
      children: /* @__PURE__ */ d(Ea, {
        noHover: o,
        style: a,
        children: [/* @__PURE__ */ t("thead", {
          ...
          children: e ? Array.from(Array(2).keys()).map((y) => /* @__PURE__ */ t("tr", {
            children: g.map((w) => /* @__PURE__ */ t("td", {
...
`, Xl = ({
  ...
  return /* @__PURE__ */ d(Da, {
    ...
    children: [r != null && r.hide ? /* @__PURE__ */ t("div", {}) : /* @__PURE__ */ t(Ae, {
      onClick: r.onClick,
      style: {
      ...
      children: (o = n == null ? void 0 : n.options) == null ? void 0 : o.map((i, a) => /* @__PURE__ */ t(Ia, {
        onClick: i.onClick,
        type: "button",
        mode: i.mode,
        disabled: i.disabled,
...
`, Kl = ({
  ...
  children: [e && /* @__PURE__ */ t("div", {
    children: e
  }), n == null ? void 0 : n.map((o) => /* @__PURE__ */ t(j, {
    ...o
  }, crypto.randomUUID()))]
}), It = (e, n = 2) => new Intl.NumberFormat("en-US", {
...
`, ql = ({
  ...
  const u = (g) => It(g, A ? 0 : 2);
  return /* @__PURE__ */ t(Fa, {
    main: a,
    autoWidth: c,
    style: h,
    children: s ? /* @__PURE__ */ d(z, {
...
`, St = ({
  ...
  const {
    ...
    h(w), m.current || (m.current = new i.api.Geocoder()), m.current.geocode({
      ...
      if (k !== "OK" || !C[0])
        return;
      const R = C[0], N = R.address_components.find((S) => S.types.includes("locality")), M = (N == null ? void 0 : N.long_name) || "", E = R.formatted_address;
      R.geometry && c(R.geometry), u((S) => {
        const J = g != null && g.current ? S.address : E;
        return {
          ...w,
          locality: M,
          address: J
  ...
  return /* @__PURE__ */ d(Ot, {
    ...
    onClick: (v) => {
      x((v == null ? void 0 : v.lat) || 0, (v == null ? void 0 : v.lng) || 0);
    },
    children: [n && b && /* @__PURE__ */ t(St, {
      text: "Location",
...
`, Ja = ({
  ...
  return T(() => {
    if (!r.loaded)
      return;
    const A = new r.api.places.Autocomplete(c.current);
    return A.addListener("place_changed", () => {
      ...
      if (!((x = h.geometry) != null && x.location)) {
        const {
          name: b
        } = h;
      ...
      }), i(h.geometry), a(g), c.current.value = "", o.current = !0;
    }), A.bindTo("bounds", r.instance), () => {
      c.current && r.api.event.clearInstanceListeners(c.current);
    };
  }, [r]), /* @__PURE__ */ t(Ct, {
    startEl: /* @__PURE__ */ t(Ga, {
      size: 13
    }),
    endEl: /* @__PURE__ */ t(Xa, {
      onClick: () => {
...
export {
  Wl as ActionOptionsModal,
  xl as Badge,
  Ct as BaseInput,
  Yl as BulletOptionsModal,
  sr as BulletPoint,
  j as Button,
  Qo as ButtonsSelect,
  jl as ButtonsSwitch,
  ...
  al as CodeInput,
  cl as Collapsible,
  Dl as ConfirmationCard,
  Nl as ConfirmationCardV2,
  Ii as ConfirmationCardV3,
  Zl as ConfirmationModalV3,
  wl as CurrentStatusCard,
  un as CustomSelect,
  ...
  _l as Map,
  Xl as ModalHeader,
  Ul as MultipleOptionsModal,
  Al as Navbar,
  hl as NoData,
  na as OptionsModal,
  wr as OrderStatusBadge,
  ml as OrderTypeBanner,
  ka as Pagination,
  Tl as ProductDetailsCard,
  ll as ProfileImage,
  Sl as QuantityInputV2,
  zl as Radio,
  Vn as Search,
  yl as SectionCard,
  Jl as SectionHeader,
