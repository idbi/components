import l, { css as h, keyframes as j } from "styled-components";
import { jsxs as d, jsx as t, Fragment as D } from "react/jsx-runtime";
import { useEffect as y, forwardRef as K, useState as M, useRef as E, useCallback as O, useMemo as ht, useLayoutEffect as ft } from "react";
import * as q from "@radix-ui/react-collapsible";
import { useFloating as We, autoUpdate as Ge, offset as gt, arrow as ut } from "@floating-ui/react-dom";
import { AiOutlineMenu as xt } from "../node_modules/react-icons/ai/index.esm.js";
import F from "react-loading-skeleton";
import mt from "react-select";
import { FiChevronsLeft as bt, FiChevronLeft as wt, FiChevronRight as vt, FiChevronsRight as Ct, FiActivity as Lt } from "../node_modules/react-icons/fi/index.esm.js";
import { MdKeyboardBackspace as Mt } from "../node_modules/react-icons/md/index.esm.js";
const kt = {
  bold: 700,
  medium: 500,
  regular: 400,
...
`, Nt = l(Tt)`
  ...
  ${({ size: e }) => J({ size: e })};
  ${({ shape: e }) => yt({ shape: e })};
  ${({ design: e, color: o, fontColor: n }) => Rt({ design: e, color: o, fontColor: n })};
  ${({ fullWidth: e }) => Ve({ fullWidth: e })};
  ${({ isLoading: e }) => Je({ isLoading: e })};
  ${({ disabled: e }) => $({ disabled: e })};
  ${({ m: e, mb: o, mt: n, mr: r, ml: i, my: a, mx: c, p, pb: g, pt: A, pr: f, pl: u, py: m, px: x }) => Xe({ m: e, mb: o, mt: n, mr: r, ml: i, my: a, mx: c, p, pb: g, pt: A, pr: f, pl: u, py: m, px: x })};
  ...
  y(() => {
    ...
    const i = (a) => {
      if (a.key !== "Backspace") {
        ...
        setTimeout(() => {
          if (c.length === 1) {
            const p = r(), g = document.activeElement;
            g.value = c;
            const A = p.indexOf(g);
    ...
    if (n) {
      const i = r(), a = i.map((g) => g.value), c = n.split(""), p = c.length === a.length ? c : a;
      i.forEach((g, A) => {
        const f = p[A];
        f && (g.value = f);
      });
...
`, St = (e) => {
  ...
  return h`
    font-weight: ${({ weight: a = n }) => kt[a] || "500"};
    font-size: ${({ size: a = r }) => Oe[a] || a};
    color: ${({ color: a = i }) => {
...
`, N = (e) => e.rightIcon || e.leftIcon ? /* @__PURE__ */ d(Bt, {
  children: [e.leftIcon, /* @__PURE__ */ t(B, {
    as: e.as || "p",
    ...e
  }), e.rightIcon]
}) : /* @__PURE__ */ t(B, {
...
`, Ot = K(({
  ...
  const u = E(null), [m, x] = M(i), [b, L] = M(""), [v, w] = M(!1);
  Z(u, () => {
    w(!1);
  });
  const k = O(() => {
    const C = i.filter((R) => R.label.toLowerCase().includes(b.toLowerCase()));
    x(C);
  }, [i, r]), T = O((C) => {
    g(i.find((R) => R.label === C)), w(!1), L(""), x(i);
  }, [k]), I = O((C) => {
    L(C.target.value);
    const R = i.filter((Q) => Q.label.toLowerCase().includes(C.target.value.toLowerCase()));
    x(R);
  }, []), H = () => {
    const C = u.current;
    if (C) {
  ...
  return /* @__PURE__ */ d(Wt, {
    ...
    children: [e && /* @__PURE__ */ t(N, {
      ...
      children: [o && /* @__PURE__ */ t("div", {
        ...
        className: "options",
        children: m.map((C) => /* @__PURE__ */ t(N, {
          as: "li",
          color: "NEUTRAL/700",
          className: C.value === r.value ? "selected" : "",
          tabIndex: 0,
          onClick: () => T(C.label),
          onKeyUpCapture: (R) => {
...
`, oo = l(q.Content)`
  overflow: hidden;
  &[data-state="open"] {
    animation: ${eo} 300ms ease-out;
  }
  &[data-state="closed"] {
    animation: ${to} 300ms ease-out;
  }
`, F0 = ({
  open: e,
  setOpen: o,
...
`, S0 = ({
  ...
  children: [/* @__PURE__ */ d("button", {
    type: "button",
    onClick: e,
    children: [/* @__PURE__ */ t(G, {}), /* @__PURE__ */ t(N, {
      color: "NEUTRAL/900",
      children: o
    })]
  }), r || /* @__PURE__ */ t("img", {
...
`, ro = l.div`
  ...
  border-radius: 50%;
  animation: ${io} 1s infinite linear;
`, te = (e) => /* @__PURE__ */ t(ro, {
  width: e.width,
  height: e.height,
...
`, co = ({
  ...
  return /* @__PURE__ */ d(X, {
    ...
    children: [e, " ", /* @__PURE__ */ t("div", {
      ...
      children: /* @__PURE__ */ t(qe, {
        children: o.map((c, p) => /* @__PURE__ */ d(X, {
          alert: c.alert,
  ...
  children: [o && /* @__PURE__ */ t(lo, {
    children: o
  }), e.map((n, r) => "options" in n ? /* @__PURE__ */ t(co, {
    ...n
  }, `option-${r}`) : /* @__PURE__ */ d(X, {
...
`, j0 = ({
  ...
  return y(() => {
    if (!(!A.reference.current || !A.floating.current))
      return Ge(A.reference.current, A.floating.current, g);
  }, [f, g]), Z(A.reference, () => {
    u(!1);
  }), /* @__PURE__ */ d("div", {
    ref: a,
...
`, mo = (e) => e === "small" ? "45px" : e === "big" ? "55px" : `${e}px`, bo = l.input`
  width: 100%;
  height: ${({ containerSize: e }) => mo(e)};
  padding: 8px 15px;
...
`, Mo = ({
  ...
  y(() => {
    b(!1);
  }, [(w = A == null ? void 0 : A.current) == null ? void 0 : w.value]), y(() => {
    (o == null ? void 0 : o.length) === 1 && c && (L(), n != null && n.onSelect && n.onSelect(o[0]));
  }, [o]);
  const v = () => /* @__PURE__ */ t(Lo, {
    onClick: () => {
  ...
  return /* @__PURE__ */ d(wo, {
    ...
    children: [p.show && p.location === "top" && v(), !g && o && o.length > 0 ? o.map((k, T) => {
      var I;
      return /* @__PURE__ */ t(de, {
        onClick: () => {
          n != null && n.onSelect && n.onSelect(k), n != null && n.hideOnSelect && L();
        },
        children: r ? r(k) : `${k.name} ${k.quantity} ${(I = k.kardex_unit) == null ? void 0 : I.symbol}`
      }, `${T}search`);
    }) : /* @__PURE__ */ t(de, {
      style: {
        color: "#cbbcbb"
  ...
  return /* @__PURE__ */ d(uo, {
    children: [/* @__PURE__ */ d(xo, {
      ...
      children: [a && /* @__PURE__ */ t("div", {
        ...
        onChange: (w) => {
          var k;
          return v(((k = w == null ? void 0 : w.target) == null ? void 0 : k.value) || "");
        },
        placeholder: n,
        addSearchIcon: a,
        addCleanOption: c,
...
`, jo = ({
  ...
  return /* @__PURE__ */ d("li", {
    ...
    children: [/* @__PURE__ */ d("div", {
      ...
      children: [e.text, " ", n.length > 0 && /* @__PURE__ */ t(ie, {
        size: 12,
        style: {
          display: "block",
          marginLeft: "auto",
  ...
  return Z(m, () => {
    ...
    children: [/* @__PURE__ */ d(No, {
      children: [/* @__PURE__ */ d(se, {
        children: [e.length > 0 && /* @__PURE__ */ t(xt, {
          size: 20,
          color: "#151E5A",
          onClick: () => {
            u(!1), A(!g);
        ...
        }), i != null && i.onClick ? /* @__PURE__ */ t(ce, {
          size: 28,
          onClick: () => {
            A(!1), u(!1), i == null || i.onClick();
          }
        }) : /* @__PURE__ */ t(ce, {
          size: 28
        })]
        ...
        }), (r == null ? void 0 : r.show) && /* @__PURE__ */ t(ko, {
          ...r,
          onSearch: (x) => r.onSearch(x)
        }), (a == null ? void 0 : a.show) && /* @__PURE__ */ t(yo, {
          size: 16,
          onClick: () => {
            a != null && a.onClick && a.onClick(), A(!1), u(!f);
          }
        }), (n == null ? void 0 : n.show) && /* @__PURE__ */ d(se, {
          children: [((n == null ? void 0 : n.name) || (n == null ? void 0 : n.note)) && /* @__PURE__ */ d(zo, {
      ...
      children: /* @__PURE__ */ t("ul", {
        children: e.map((x, b) => /* @__PURE__ */ t(jo, {
          option: x.option,
...
`, Wo = ({
  ...
  const [p, g] = M(!1), A = E(null), {
    ...
    placement: r || "top",
    strategy: a,
    middleware: [gt(i != null ? i : 10), ...c, ut({
      element: A
    })]
  }), {
    x: T,
  ...
  y(() => {
    if (!(!v.reference.current || !v.floating.current))
      return Ge(v.reference.current, v.floating.current, L);
  }, [p, L]);
  const R = {
    top: "bottom",
    right: "left",
...
}, Go = (...e) => e.reduce((o, n) => o + (n || "").charAt(0), "").toUpperCase(), Oo = ({
  name: e,
  lastname: o,
  img: n,
  size: r,
...
`, Ae = {
  ...
  statusName: e,
  removeBackground: n,
  children: o || ((i) => Ae[i] || Ae.default)(e)
}), $o = l.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
...
`, he = (e, o, n) => e >= o && e <= n ? e : e < o ? o : n, _o = ({
  ...
  const a = he(e, 0, 1), c = he(o, 0, 1), p = 256 * a;
  return /* @__PURE__ */ t($o, {
    style: {
...
`, ge = (e) => /* @__PURE__ */ d("svg", {
  ...
  pending: /* @__PURE__ */ t(an, {}),
  rejected: /* @__PURE__ */ t(ge, {}),
  accepted: /* @__PURE__ */ t(ue, {
    color: "#4318FF"
  }),
  canceled: /* @__PURE__ */ t(ge, {}),
  preparing: /* @__PURE__ */ t(cn, {
    color: "#F79E1B"
  }),
  readyforpickup: /* @__PURE__ */ t(dn, {
    color: "#FF82AF"
  }),
  delivered: /* @__PURE__ */ t(ue, {
    color: "#2DC96F"
  })
}, xe = {
  default: {
  ...
  statusName: e,
  radius: i,
  children: [r || sn[e], (o === "default" || n === "default" || o.length > 1 || n.length > 1) && /* @__PURE__ */ d("div", {
    children: [o === "default" ? /* @__PURE__ */ t(fe, {
      children: xe[e].title
    }) : /* @__PURE__ */ t(fe, {
      children: o
...
`, V0 = ({
  ...
  children: [(o || r) && /* @__PURE__ */ d(gn, {
    ...
    children: e.map((A) => /* @__PURE__ */ d(bn, {
      remark: Boolean(A.remark),
      children: [i ? /* @__PURE__ */ d(be, {
        children: [/* @__PURE__ */ d("div", {
          children: [/* @__PURE__ */ t("span", {
            children: A.description
          }), A.notes && /* @__PURE__ */ t(we, {
...
`, K0 = ({
  ...
  children: [(() => {
    ...
    children: [e && /* @__PURE__ */ t(Un, {
      children: e
    }), o && /* @__PURE__ */ d(Hn, {
      children: [o, " ", r && r.onClick && /* @__PURE__ */ t(Zn, {
        onClick: (c) => {
...
`, On = "data:image/svg+xml;base64,", q0 = ({
  ...
  children: [(r == null ? void 0 : r.component) && /* @__PURE__ */ t(Yn, {
    padding: r == null ? void 0 : r.padding,
    children: r == null ? void 0 : r.component
  }), i && /* @__PURE__ */ t(Gn, {
    src: i != null && i.url ? i == null ? void 0 : i.url : On,
...
`, ye = ({
  ...
  const a = E(null), [c, p] = M(i || ""), g = (f) => {
    const u = f.target.value;
    let m = /^[0-9]\d*(\.(\d*))?$/;
    r && (m = /^[0-9]*$/), !(u !== "" && !m.test(u)) && p(u);
  };
  y(() => {
    a.current.focus();
  }, []);
...
`, ot = ({
  ...
  const [L, v] = M(!1), w = Number(e || 0), k = e === null || w <= r, T = (C) => {
    C.stopPropagation();
    const R = w % 1 !== 0 ? Math.ceil(w) : w + 1;
    o(R);
  }, I = (C) => {
    if (C.stopPropagation(), k) {
      n && n();
      return;
    }
...
`, $0 = ({
  ...
  const [v, w] = M(!0), k = m || "u.";
  return /* @__PURE__ */ d(ri, {
    children: [/* @__PURE__ */ d(li, {
      onClick: p || (() => {
      }),
      canClick: !!p,
      children: [(e == null ? void 0 : e.src) && /* @__PURE__ */ t(ai, {
        ...e
      }), /* @__PURE__ */ d(di, {
        children: [/* @__PURE__ */ d(ci, {
          detailsActive: v,
          children: [o, /* @__PURE__ */ t(ie, {
            size: 16,
            onClick: (T) => {
              T.stopPropagation(), w((I) => !I);
            }
          })]
        }), u && /* @__PURE__ */ t(si, {
          children: u.label
        }), /* @__PURE__ */ d(pi, {
          children: [u && /* @__PURE__ */ d(Ai, {
...
`, wi = ({
  ...
  children: [e && /* @__PURE__ */ t(xi, {
    children: e
  }), /* @__PURE__ */ t(mi, {
    children: o.map((i) => /* @__PURE__ */ t(bi, {
      selected: i.value === n,
      onClick: () => r(i.value, i),
      disabled: !!i.disabled,
      children: i.content
...
}), vi = Array.from(Array(5), (e, o) => ({ content: `${o}`, value: `${o}` })), Ci = l.div`
  position: absolute;
  top: calc(100% + 5px);
  left: 0;
`, Li = ({
...
`, _0 = ({
  ...
  return /* @__PURE__ */ d(Mi, {
    children: [m && /* @__PURE__ */ d(ki, {
      ...
      children: [(e == null ? void 0 : e.src) && /* @__PURE__ */ d(Ri, {
...
`, e1 = ({
  ...
  return /* @__PURE__ */ d(Ui, {
    ...
    children: [/* @__PURE__ */ d(Hi, {
      children: [(o == null ? void 0 : o.src) && /* @__PURE__ */ d(Zi, {
        children: [/* @__PURE__ */ t("div", {
          children: /* @__PURE__ */ t("img", {
            ...o
          })
...
`, cr = ({
  ...
  children: [/* @__PURE__ */ d(rr, {
    children: [(e || o) && /* @__PURE__ */ d(lr, {
      children: [e && /* @__PURE__ */ t(ar, {
        children: e
      }), o && /* @__PURE__ */ t(dr, {
        children: o
      })]
    }), n.length > 0 && /* @__PURE__ */ t(Ne, {
      children: n.map((i, a) => /* @__PURE__ */ t(S, {
        design: "solid",
        shape: "circular",
        size: "xs",
        fullWidth: !0,
...
`, n1 = ({
  ...
  const [a, c] = M((i == null ? void 0 : i.checked) || !1);
  return y(() => {
    c(Boolean(i == null ? void 0 : i.checked));
  }, [i == null ? void 0 : i.checked]), /* @__PURE__ */ d(Ar, {
    disabled: r,
    children: [/* @__PURE__ */ t("input", {
      ...i,
      type: "checkbox",
...
const r1 = ({
  ...
  model: a,
  fullWidth: i,
  children: e.map((c) => /* @__PURE__ */ t(gr, {
    onClick: () => r(c.value),
    active: c.value === o,
    disabled: n,
    model: a,
    ...
    children: /* @__PURE__ */ d(Dr, {
      children: [/* @__PURE__ */ d(Fr, {
        children: [/* @__PURE__ */ d(zr, {
          ...
          size: "sm",
          weight: "regular",
          children: (u == null ? void 0 : u.description) || i
        })]
      }), /* @__PURE__ */ d(Sr, {
        direction: p,
        children: [!u && e.map((m, x) => "onClick" in m ? /* @__PURE__ */ d(V, {
          ...
          optionsInCenter: c,
          children: [m.text, " ", m.loading ? ze : m.icon]
        }, `suboption-${x}`))]
      })]
    })
  });
...
`, Hr = ({
  ...
  children: [/* @__PURE__ */ t(jr, {
    ...
    children: o.map((p) => /* @__PURE__ */ d(Ur, {
      minHeight: c,
      selected: p.value === n,
      disabled: p.disabled,
      onClick: () => {
...
`, A1 = ({
  ...
  options: e.map(({
    ...
    icon: a.value === n.selected ? o || /* @__PURE__ */ t(Zr, {}) : void 0,
    ...a
  })),
  ...n
}), Yr = l.div`
...
`, h1 = ({
  ...
  children: [/* @__PURE__ */ t(Yr, {
    ...
    children: o.map((a, c) => /* @__PURE__ */ d(Wr, {
      disabled: a.disabled,
      onClick: () => {
  ...
  const p = E(null), g = () => p.current.click(), A = () => {
    ...
    m(b);
  }, u = (x) => i ? new RegExp(`${i.join("|")}$`, "i").exec(x.toLowerCase()) : !0, m = (x) => {
    var L;
    if (!x)
      return;
    if (!u(x.name)) {
...
`, f1 = ({
  ...
  const [i, a] = M(null), [c, p] = M(e || null), g = rt();
  return y(() => {
    let A = "";
    ...
    children: c ? /* @__PURE__ */ d(Jr, {
      children: [/* @__PURE__ */ d(Xr, {
        children: [/* @__PURE__ */ t("img", {
          src: c
        }), /* @__PURE__ */ d(Kr, {
          children: [/* @__PURE__ */ t("span", {
            children: (i == null ? void 0 : i.name) || Fe(c)[0]
          }), /* @__PURE__ */ t("span", {
            children: (i == null ? void 0 : i.type) || Fe(c)[1]
          })]
        })]
      }), /* @__PURE__ */ t(ne, {
        variant: "secondary",
...
`, g1 = ({
  ...
  const [r, i] = M(o || []), [a, c] = M(null), p = rt(), g = (f) => {
    ...
    const u = r[f];
    typeof u != "string" && window.URL.revokeObjectURL(u.url), i((m) => m.filter((x, b) => b !== f));
  };
  return y(() => {
    p || e(r);
  }, [r]), /* @__PURE__ */ d(qr, {
    children: [r.map((f, u) => /* @__PURE__ */ d($r, {
      onMouseEnter: () => c(u),
      onMouseLeave: () => c(null),
    ...
    }, `imgs-${u}`)), !(n && r.length >= n) && /* @__PURE__ */ t(it, {
      onError: alert,
      onSelectFile: g,
      acceptedFiles: "image/x-png,image/jpeg",
      validFileExtensions: ["jpg", "jpeg", "png"],
...
`, ct = (e) => {
  ...
  padding-bottom: 8px;
  padding: 15px 10px 8px;
  ${({ location: e }) => ct(e || "left")}
  ${({ separator: e }) => st(Boolean(e))}
  ${({ itemFlex: e }) => pt(Boolean(e))}
  ${({ gridColumn: e }) => le(e)}
`, i0 = l.div`
  ${dt}
  font-weight: 400;
...
`, d0 = ({
  ...
  }, c = () => Number(r) <= 1 ? "1px solid #BFBFBF" : "1px solid #4318FF", p = () => Number(r) <= 1 ? "#BFBFBF" : "#4318FF", g = () => Number(r) === o ? "#BFBFBF" : "#4318FF";
...
`, m1 = ({
  ...
  return /* @__PURE__ */ d(h0, {
    ...
    children: [n != null && n.hide ? /* @__PURE__ */ t("div", {}) : /* @__PURE__ */ t(ne, {
      onClick: n.onClick,
      style: {
      ...
      children: (r = o == null ? void 0 : o.options) == null ? void 0 : r.map((i, a) => /* @__PURE__ */ t(g0, {
        onClick: i.onClick,
        type: "button",
        mode: i.mode,
        disabled: i.disabled,
...
`, w1 = ({
  ...
  children: [e && /* @__PURE__ */ t("div", {
    children: e
  }), o == null ? void 0 : o.map((r) => /* @__PURE__ */ t(S, {
    ...r
  }, crypto.randomUUID()))]
}), At = (e, o = 2) => new Intl.NumberFormat("en-US", {
...
`, v1 = ({
  ...
  const f = (u) => At(u, g ? 0 : 2);
  return /* @__PURE__ */ t(b0, {
    main: a,
    autoWidth: p,
    style: A,
    children: c ? /* @__PURE__ */ d(D, {
      children: [/* @__PURE__ */ t(Be, {
        ...
        children: [/* @__PURE__ */ d(W, {
          ...
          children: [/* @__PURE__ */ t(Se, {}), " ", /* @__PURE__ */ t("span", {
            children: /* @__PURE__ */ t(F, {
              width: "50px",
              height: "15px"
            })
      ...
      children: [/* @__PURE__ */ t(Be, {
        ...
        children: r && r > 0 || i && i > 0 ? /* @__PURE__ */ d(D, {
          children: [/* @__PURE__ */ t("span", {
            children: "Propina: "
...
`, C1 = ({
  ...
  var m;
  const g = (x) => At(x, c ? 0 : 2), A = () => {
    if (!n || !r)
      return 0;
    const x = Math.round(n * 100 / r);
    return Number.isNaN(x - 100) ? 0 : Number.isFinite(x - 100) ? x : 100;
  }, f = {
    isUp: !n || !r ? !1 : n >= r,
    value: `${(m = g(A())) != null ? m : "0"}%`
  }, u = `${o != null ? o : ""} ${g(n || 0)}`;
  return i ? /* @__PURE__ */ d(Ze, {
    autoWidth: Boolean(a),
    style: p,
    children: [e && /* @__PURE__ */ t(Pe, {
      children: /* @__PURE__ */ t(F, {
        width: "70px",
        height: "17px"
      })
    ...
    children: [e && /* @__PURE__ */ d(Pe, {
      ...
      children: [/* @__PURE__ */ t("strong", {
        ...
        children: /* @__PURE__ */ d("strong", {
          children: [/* @__PURE__ */ t(Mt, {}), f.value]
        })
      })]
    })]
  });
...
export {
  ...
  I0 as CodeInput,
  F0 as Collapsible,
  t1 as ConfirmationCard,
  o1 as ConfirmationCardV2,
  cr as ConfirmationCardV3,
  p1 as ConfirmationModalV3,
  O0 as CurrentStatusCard,
  Ot as CustomSelect,
  j0 as DropdownMenu,
  ot as EditQuantityInput,
  u1 as GridTable,
  N0 as Heading,
  H0 as HorizontalDivision,
  q0 as IDCard,
  U as IconV2,
  v1 as KpiCard,
  C1 as KpiCardV2,
  z0 as Loader,
  m1 as ModalHeader,
  s1 as MultipleOptionsModal,
  U0 as Navbar,
  B0 as NoData,
  Hr as OptionsModal,
  qo as OrderStatusBadge,
  Q0 as OrderTypeBanner,
  d0 as Pagination,
  e1 as ProductDetailsCard,
  D0 as ProfileImage,
  i1 as Radio,
  ko as Search,
  J0 as SectionCard,
  ...
  d1 as ToggleSwitch,
  V0 as TotalsCard,
  _o as TransparentBadge,
  it as UploadFileContainer,
  f1 as UploadImage,
  g1 as UploadMultipleImages,
  Oo as UserIconTooltip,
  re as UserProfileIcon,
  P0 as UsersList
};
