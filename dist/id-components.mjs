import a, { css as s, keyframes as L } from "styled-components";
import { jsxs as c, jsx as t, Fragment as j } from "react/jsx-runtime";
import { useEffect as y, forwardRef as O, useState as C, useRef as S, useCallback as Q, useMemo as He } from "react";
import Oe from "react-loading-skeleton";
import We from "react-select";
import * as W from "@radix-ui/react-collapsible";
import { useFloating as Ge, autoUpdate as Ve } from "@floating-ui/react-dom";
const Je = {
  bold: 700,
  medium: 500,
  regular: 400,
...
`, _e = a($e)`
  ...
  ${({ size: e }) => Z({ size: e })};
  ${({ shape: e }) => Xe({ shape: e })};
  ${({ design: e, color: o, fontColor: n }) => Ke({ design: e, color: o, fontColor: n })};
...
`, Mt = O(({
  ...
  const f = S(null), [x, m] = C(r), [w, k] = C(""), [M, v] = C(!1);
  ye(f, () => {
    v(!1);
  });
  const I = Q(() => {
  ...
  return /* @__PURE__ */ c(H, {
    ...
    children: [e, " ", /* @__PURE__ */ t("div", {
      ...
      children: /* @__PURE__ */ t(Te, {
        children: o.map((A, h) => /* @__PURE__ */ c(H, {
          alert: A.alert,
...
`, ee = {
  ...
  statusName: e,
  removeBackground: n,
  children: o || ((r) => ee[r] || ee.default)(e)
}), Kt = a.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
...
`, ne = (e) => /* @__PURE__ */ A("svg", {
  ...
  pending: /* @__PURE__ */ t(ro, {}),
  rejected: /* @__PURE__ */ t(ne, {}),
  accepted: /* @__PURE__ */ t(re, {
    color: "#4318FF"
  }),
  canceled: /* @__PURE__ */ t(ne, {}),
  preparing: /* @__PURE__ */ t(ao, {
    color: "#F79E1B"
  }),
  readyforpickup: /* @__PURE__ */ t(io, {
    color: "#FF82AF"
  }),
  delivered: /* @__PURE__ */ t(re, {
    color: "#2DC96F"
  })
}, ie = {
  default: {
...
`, Zn = ({
  ...
  children: [/* @__PURE__ */ c(Un, {
    children: [(e || o) && /* @__PURE__ */ c(Pn, {
      children: [e && /* @__PURE__ */ t(Qn, {
        children: e
      }), o && /* @__PURE__ */ t(Yn, {
        children: o
      })]
  ...
  return /* @__PURE__ */ t(K, {
    ...
    children: /* @__PURE__ */ A($n, {
      children: [/* @__PURE__ */ A(er, {
        ...
        direction: h,
        children: [!f && e.map((x, m) => "onClick" in x ? /* @__PURE__ */ c(Y, {
          alert: x.alert,
...
=======
        }, `option-${m}`)), f == null ? void 0 : f.options.map((x, m) => /* @__PURE__ */ c(Y, {
          onClick: () => {
          },
          optionsInCenter: c,
...
=======
  const h = S(null), g = () => h.current.click(), p = () => {
>>>>>>> main
...
=======
  const [r, l] = C(null), [A, h] = C(e || null), g = Se();
>>>>>>> main
  return y(() => {
    let p = "";
...
=======
  const [i, r] = C(o || []), [l, A] = C(null), h = Se(), g = (u) => {
...
`, Qe = (e) => {
  ...
  padding-bottom: 8px;
  padding: 15px 10px 8px;
  ${({ location: e }) => Qe(e || "left")}
  ${({ separator: e }) => Ye(Boolean(e))}
  ${({ itemFlex: e }) => Ze(Boolean(e))}
  ${({ gridColumn: e }) => q(e)}
`, ur = a.div`
  ${Pe}
  font-weight: 400;
...
>>>>>>> main
      ...
      children: (i = o == null ? void 0 : o.options) == null ? void 0 : i.map((r, l) => /* @__PURE__ */ t(Cr, {
        onClick: r.onClick,
        type: "button",
        mode: r.mode,
        disabled: r.disabled,
...
>>>>>>> main
  ...
  ii as ConfirmationModalV3,
  Or as CurrentStatusCard,
  Mt as CustomSelect,
  Ur as DropdownMenu,
  tn as EditQuantityInput,
  di as GridTable,
  Lr as Heading,
  Xr as IDCard,
  B as IconV2,
  ...
  Pr as NoData,
  Xt as OrderStatusBadge,
  Yr as OrderTypeBanner,
  qr as ProductDetailsCard,
  jr as ProfileImage,
  ti as Radio,
  Gr as SectionCard,
  zr as SelectField,
  ...
  Jr as ToastCard,
  Wr as TotalsCard,
  qt as TransparentBadge,
  je as UploadFileContainer,
  ai as UploadImage,
  li as UploadMultipleImages,
  Vt as UserProfileIcon
};
