import l, { css as p, keyframes as T } from "styled-components";
import { jsxs as c, jsx as t, Fragment as z } from "react/jsx-runtime";
import { useEffect as M, forwardRef as W, useState as w, useRef as j, useCallback as G, useMemo as Ie } from "react";
import Te from "react-loading-skeleton";
import Fe from "react-select";
import * as Q from "@radix-ui/react-collapsible";
import { useFloating as Be, autoUpdate as Se } from "@floating-ui/react-dom";
const ze = {
  bold: 700,
  medium: 500,
  regular: 400,
  ...
  switch (e) {
    case "solid":
      return p`
        background-color: ${() => I({ color: n })};
        color: ${o ? I({ color: o }) : "#fff"};
      `;
    case "outline":
      return p`
        background-color: white;
        border: 1px solid ${() => I({ color: n })};
        color: ${() => I({ color: n })};
      `;
    case "flat":
      return p`
  ...
  return r === "PRIMARY" || r === "NEUTRAL" || r === "SECONDARY" || r === "TERTIARY" || r === "QUATERNARY" || r === "STATE" || r === "ALERT" || r === "SUCCESS" ? a === 0 || a === 50 || a === 100 || a === 200 || a === 300 || a === 400 || a === 500 || a === 600 || a === 700 || a === 800 || a === 900 ? A.color[r][a] : A.color[r][900] : A.color.PRIMARY[900];
}, me = ({ fullWidth: e }) => e ? p`
      width: 100%;
    ` : p`
    width: auto;
...
`, Pe = l(Ge)`
  ...
  ${({ size: e }) => Y({ size: e })};
  ${({ shape: e }) => je({ shape: e })};
  ${({ design: e, color: n, fontColor: o }) => Ue({ design: e, color: n, fontColor: o })};
  ${({ fullWidth: e }) => me({ fullWidth: e })};
  ${({ isLoading: e }) => De({ isLoading: e })};
  ${({ disabled: e }) => Ne({ disabled: e })};
  ${({ m: e, mb: n, mt: o, mr: i, ml: r, my: a, mx: d, p: h, pb: u, pt: s, pr: g, pl: f, py: x, px: m }) => be({ m: e, mb: n, mt: o, mr: i, ml: r, my: a, mx: d, p: h, pb: u, pt: s, pr: g, pl: f, py: x, px: m })};

  &:hover:not(:disabled) {
    background-color: ${({ color: e, design: n }) => n === "link" ? "transparent" : I({ color: e, design: n, hover: !0 })};
  }
  ...
  M(() => {
    const r = (a) => {
      a.key === "Backspace" && setTimeout(() => {
        const d = i(), h = document.activeElement;
        h.value = "";
        const u = d.indexOf(h);
        u > 0 && d[u - 1].focus();
      }, 0);
    ...
    const r = (a) => {
      if (a.key !== "Backspace") {
        const d = a.key.toLowerCase();
        setTimeout(() => {
          if (d.length === 1) {
            const h = i(), u = document.activeElement;
            u.value = d;
            const s = h.indexOf(u);
            s < h.length - 1 && h[s + 1].focus();
          }
        }, 0);
      }
    };
    ...
    if (o) {
      const r = i(), a = r.map((u) => u.value), d = o.split(""), h = d.length === a.length ? d : a;
      r.forEach((u, s) => {
        const g = h[s];
        g && (u.value = g);
      });
...
`, We = {
  ...
  ${({ m: e, mb: n, mt: o, mr: i, ml: r, my: a, mx: d, p: h, pb: u, pt: s, pr: g, pl: f, py: x, px: m }) => be({ m: e, mb: n, mt: o, mr: i, ml: r, my: a, mx: d, p: h, pb: u, pt: s, pr: g, pl: f, py: x, px: m })};
`, Oe = (e) => {
  const n = e === "h1" || e === "h2" || e === "h3" || e === "h4" || e === "h5" || e === "h6", o = n ? "bold" : "medium", i = n ? K[e] : K.text, r = "PRIMARY/900";
  return p`
    font-weight: ${({ weight: a = o }) => ze[a] || "500"};
    font-size: ${({ size: a = i }) => xe[a] || a};
    color: ${({ color: a = r }) => {
    const d = a == null ? void 0 : a.split("/")[0], h = Number(a == null ? void 0 : a.split("/")[1]);
    return A.color[d][h];
  }};
  `;
}, Ve = l.div`
...
`, L = (e) => e.rightIcon || e.leftIcon ? /* @__PURE__ */ c(Xe, {
  ...
  > input {
    ...
    height: 45px;
    border: 1px solid
      ${({ errorMessage: e, success: n }) => e ? A.color.ALERT[900] : n ? A.color.SUCCESS[900] : A.color.NEUTRAL[300]};
    border-radius: 8px;
    background: #fff;
  ...
  ${(e) => e.variant == "V1" && p`
      ${(n) => n.active && p`
          &::before {
            ...
            left: 50%;
            transform: translate(-50%, -50%);
            background: ${(o) => o.color || A.color.PRIMARY[900]};
            width: ${(o) => o.size * 2}px;
...
`, et = l.svg`
  ...
  ${(e) => e.variant === "V2" && p`
      ...
      ${(n) => n.active && p`
          fill: ${(o) => o.color || A.color.PRIMARY[900]};
        `}
    `}
`, ve = (e) => {
  const {
  ...
  border-radius: 8px;
  border: 1px solid
    ${({ error: e, success: n, isFocused: o }) => e ? A.color.ALERT[900] : n && o ? A.color.SUCCESS[900] : o ? A.color.QUATERNARY[900] : A.color.NEUTRAL[300]};
  background: #fff;
  min-height: 45px;
  ::placeholder {
    color: ${() => A.color.NEUTRAL[500]};
...
`, st = W(({
  ...
  const f = j(null), [x, m] = w(r), [v, E] = w(""), [k, C] = w(!1);
  Ce(f, () => {
    C(!1);
  });
  const y = G(() => {
    const b = r.filter((R) => R.label.toLowerCase().includes(v.toLowerCase()));
    m(b);
  }, [r, i]), B = G((b) => {
    u(r.find((R) => R.label === b)), C(!1), E(""), m(r);
  }, [y]), U = G((b) => {
    E(b.target.value);
    const R = r.filter((q) => q.label.toLowerCase().includes(b.target.value.toLowerCase()));
    m(R);
  }, []), N = () => {
    const b = f.current;
    if (b) {
  ...
  return /* @__PURE__ */ c(ct, {
    ...
    children: [e && /* @__PURE__ */ t(L, {
      ...
      children: [/* @__PURE__ */ t(L, {
        ...
        color: "NEUTRAL/700",
        mr: "0.5rem",
        children: g ? g(i) : s ? s(i) : i.label
      }), /* @__PURE__ */ t(we, {
        size: 20
      })]
    }), k && /* @__PURE__ */ c(At, {
      maxOptionsHeight: o ? N() : 285,
      fullWidthOptions: h,
      children: [n && /* @__PURE__ */ t("div", {
        className: "search-box",
        children: /* @__PURE__ */ t(V, {
          leftAddon: /* @__PURE__ */ t(dt, {}),
          type: "text",
          placeholder: a,
          value: v,
          onChange: U,
        ...
        children: x.map((b) => /* @__PURE__ */ t(L, {
          ...
          onClick: () => B(b.label),
          onKeyUpCapture: (R) => {
            R.key === "Enter" && B(b.label);
          },
          children: s ? s(b) : b.label
        }, `${b.label}-${b.value}`))
      })]
    })]
  });
});
st.displayName = "CustomSelect";
const pt = l.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  ...
  return /* @__PURE__ */ c(pt, {
    ...
    children: [/* @__PURE__ */ t(L, {
      ...
      children: [/* @__PURE__ */ t("input", {
        ...
        onChange: (a) => {
          var h;
          const d = (h = a.target.files) == null ? void 0 : h[0];
          if (d) {
...
`, Ct = l(Q.Content)`
  overflow: hidden;
  &[data-state="open"] {
    animation: ${bt} 300ms ease-out;
  }
  &[data-state="closed"] {
    animation: ${vt} 300ms ease-out;
  }
`, qo = ({
  open: e,
  setOpen: n,
...
`, Ko = ({
  ...
  children: [/* @__PURE__ */ c("button", {
    type: "button",
    onClick: e,
    children: [/* @__PURE__ */ t(H, {}), /* @__PURE__ */ t(L, {
      color: "NEUTRAL/900",
      children: n
    })]
  }), i || /* @__PURE__ */ t("img", {
...
`, Rt = l.div`
  ...
  border-radius: 50%;
  animation: ${kt} 1s infinite linear;
`, X = (e) => /* @__PURE__ */ t(Rt, {
  width: e.width,
  height: e.height,
...
`, Mt = ({
  ...
  const [o, i] = w(!1), r = j(null), a = (d) => {
    if (r.current && clearTimeout(r.current), d) {
      i(!0);
      return;
    }
  ...
  return /* @__PURE__ */ c(Z, {
    ...
    children: [e, " ", /* @__PURE__ */ t("div", {
      ...
      children: /* @__PURE__ */ t(ke, {
        children: n.map((d, h) => /* @__PURE__ */ c(Z, {
          alert: d.alert,
          onClick: (u) => d.disabled || d.loading ? u.stopPropagation() : d.onClick(),
  ...
  children: [n && /* @__PURE__ */ t(Et, {
    children: n
  }), e.map((o, i) => "options" in o ? /* @__PURE__ */ t(Mt, {
    ...o
  }, `option-${i}`) : /* @__PURE__ */ c(Z, {
    disabled: o.disabled || o.loading,
    alert: o.alert,
    onClick: o.disabled || o.loading ? (r) => r.stopPropagation() : o.onClick,
    loading: o.loading,
    children: [o.text, " ", o.loading ? /* @__PURE__ */ t("div", {
      style: {
        width: "24px"
      },
      children: /* @__PURE__ */ t(X, {
...
`, $o = ({
  ...
  return M(() => {
    if (!(!s.reference.current || !s.floating.current))
      return Se(s.reference.current, s.floating.current, u);
  }, [g, u]), Ce(s.reference, () => {
    f(!1);
  }), /* @__PURE__ */ c("div", {
    ref: a,
...
`, D = ({
  ...
  background-color: ${({ hasImg: e, theme: n }) => e ? n.color.QUATERNARY[300] : "transparent"};
  border-radius: 50%;
...
`, Bt = ({
  ...
  const i = o.slice(0, 2).toUpperCase();
  return /* @__PURE__ */ t(Ft, {
    hasImg: !(e != null && e.src),
    style: {
      width: `${n}px`,
      height: `${n}px`,
      fontSize: `${n / (o.length === 1 ? 2 : 2.25)}px`
    },
  ...
  if (e === "draft")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.DRAFT[0]};
        color: ${A.color.STATUS.DRAFT[1]};
      `;
  if (e === "pending")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.PENDING[0]};
        color: ${A.color.STATUS.PENDING[1]};
      `;
  if (e === "rejected")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.REJECTED[0]};
        color: ${A.color.STATUS.REJECTED[1]};
      `;
  if (e === "accepted")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.ACCEPTED[0]};
        color: ${A.color.STATUS.ACCEPTED[1]};
      `;
  if (e === "canceled")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.CANCELED[0]};
        color: ${A.color.STATUS.CANCELED[1]};
      `;
  if (e === "preparing")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.PREPARING[0]};
        color: ${A.color.STATUS.PREPARING[1]};
      `;
  if (e === "readyforpickup")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.READYFORPICKUP[0]};
        color: ${A.color.STATUS.READYFORPICKUP[1]};
      `;
  if (e === "delivered")
    return p`
        background: ${n ? "transparent" : A.color.STATUS.DELIVERED[0]};
...
`, _ = (e, n, o) => e >= n && e <= o ? e : e < n ? n : o, Ut = ({
  ...
  const a = _(e, 0, 1), d = _(n, 0, 1), h = 256 * a;
  return /* @__PURE__ */ t(jt, {
    style: {
      backgroundColor: `rgba(${h}, ${h}, ${h}, ${d})`,
      ...i
    },
    ...r,
    children: o
...
`, te = (e) => /* @__PURE__ */ c("svg", {
  ...
  pending: /* @__PURE__ */ t(Yt, {}),
  rejected: /* @__PURE__ */ t(te, {}),
  accepted: /* @__PURE__ */ t(ne, {
    color: "#4318FF"
  }),
  canceled: /* @__PURE__ */ t(te, {}),
  preparing: /* @__PURE__ */ t(Wt, {
    color: "#F79E1B"
  }),
  readyforpickup: /* @__PURE__ */ t(Zt, {
    color: "#FF82AF"
  }),
  delivered: /* @__PURE__ */ t(ne, {
    color: "#2DC96F"
  })
}, oe = {
  default: {
  ...
  statusName: e,
  radius: r,
  children: [i || Qt[e], (n === "default" || o === "default" || n.length > 1 || o.length > 1) && /* @__PURE__ */ c("div", {
    children: [n === "default" ? /* @__PURE__ */ t(ee, {
      children: oe[e].title
    }) : /* @__PURE__ */ t(ee, {
      children: n
    }), o === "default" ? /* @__PURE__ */ t("p", {
      children: oe[e].description
    }) : /* @__PURE__ */ t("p", {
      children: o
    })]
  }), a]
...
`, tr = ({
  ...
  children: [n && /* @__PURE__ */ t("header", {
    ...
    children: o.map((d) => /* @__PURE__ */ t("li", {
      children: i(d)
    }, d.value))
  }), r && r]
}), Vt = l.div`
...
`, nr = ({
  ...
  }, crypto.randomUUID())), o && /* @__PURE__ */ c("div", {
    children: [n && /* @__PURE__ */ t("span", {
      children: n
    }), /* @__PURE__ */ t(re, {
      children: o
...
`, or = ({
  ...
  children: [(n || i) && /* @__PURE__ */ c(qt, {
    ...
    children: e.map((s) => /* @__PURE__ */ c(en, {
      remark: Boolean(s.remark),
      children: [r ? /* @__PURE__ */ c(ie, {
        children: [/* @__PURE__ */ c("div", {
          children: [/* @__PURE__ */ t("span", {
            children: s.description
          }), s.notes && /* @__PURE__ */ t(ae, {
            children: s.notes.map((g) => /* @__PURE__ */ t("li", {
              children: g
            }, crypto.randomUUID()))
          })]
        }), s == null ? void 0 : s.decorators]
      }) : /* @__PURE__ */ c(ie, {
        children: [s.img && /* @__PURE__ */ t(on, {
          src: s.img,
          alt: s.description
        }), /* @__PURE__ */ t(tn, {
          children: s.quantity
  ...
  children: [/* @__PURE__ */ t(An, {
    ...
    children: [/* @__PURE__ */ c(sn, {
      children: [o && /* @__PURE__ */ c("span", {
        children: [/* @__PURE__ */ t(dn, {}), o]
      }), r.map((a) => /* @__PURE__ */ t("span", {
        children: a
      }))]
    }), /* @__PURE__ */ c(pn, {
      children: [e, " ", n]
...
`, se = ({
  ...
  justify-content: center;
`, Rn = l.span`
  color: ${({ isZero: e, error: n = !1, theme: o }) => e ? n ? o.color.ALERT[900] : o.color.NEUTRAL[500] : o.color.PRIMARY[900]};
  text-align: center;
  padding: 0 8px;
  min-width: 6ch;
`, En = l.span`
...
`, Mn = ({
  ...
  const [E, k] = w(!1), C = Number(e || 0), y = e === null || C <= i, B = (b) => {
    b.stopPropagation();
    const R = C % 1 !== 0 ? Math.ceil(C) : C + 1;
    n(R);
  }, U = (b) => {
    ...
    const R = C % 1 > 0 ? Math.floor(C) : C - 1;
    n(R);
  }, N = (b) => {
    const R = a ? Math.round(b) : b;
    n(R <= i ? i : R), k(!1);
  };
  return /* @__PURE__ */ c(z, {
...
`, ar = ({
  ...
  return /* @__PURE__ */ c(In, {
    children: [/* @__PURE__ */ c(Tn, {
      ...
      canClick: !!h,
      children: [(e == null ? void 0 : e.src) && /* @__PURE__ */ t(Fn, {
        ...e
      }), /* @__PURE__ */ c(Bn, {
        children: [/* @__PURE__ */ c(Sn, {
          detailsActive: k,
          children: [n, /* @__PURE__ */ t(Ln, {
            size: 16,
            onClick: (B) => {
              B.stopPropagation(), C((U) => !U);
            }
          })]
        }), f && /* @__PURE__ */ t(zn, {
          children: f.label
        }), /* @__PURE__ */ c(jn, {
          children: [f && /* @__PURE__ */ c(Un, {
            children: ["-", o, f.discountedAmount.toFixed(2)]
          }), /* @__PURE__ */ c(pe, {
...
`, he = ({
  ...
  return /* @__PURE__ */ c(Gn, {
    ...
    children: [/* @__PURE__ */ c("span", {
      children: [e, n.toFixed(2), " x ", h]
    }), /* @__PURE__ */ c(Pn, {
      disabled: a,
      children: [r && /* @__PURE__ */ c(z, {
        children: [/* @__PURE__ */ c("span", {
...
`, lr = ({
  ...
  children: [/* @__PURE__ */ c(Wn, {
    children: [(n == null ? void 0 : n.src) && /* @__PURE__ */ t("img", {
      ...n
    }), /* @__PURE__ */ c(Qn, {
      hasDetails: !!d,
...
`, uo = ({
  ...
  children: [/* @__PURE__ */ c(so, {
    children: [/* @__PURE__ */ c(po, {
      children: [e && /* @__PURE__ */ t(ho, {
        children: e
      }), /* @__PURE__ */ t(fo, {
        children: n
      })]
    }), o.length > 0 && /* @__PURE__ */ t(fe, {
      children: o.map((r, a) => /* @__PURE__ */ t(F, {
        design: "solid",
        shape: "circular",
        size: "xs",
        fullWidth: !0,
  ...
  }), i.length > 0 && /* @__PURE__ */ t(fe, {
    bottom: !0,
    children: i.map((r, a) => /* @__PURE__ */ t(F, {
      design: "flat",
      size: "xs",
      fullWidth: !0,
      onClick: r.onClick,
...
`, Ar = ({
  ...
  return M(() => {
    ...
    children: [/* @__PURE__ */ t("input", {
      ...
      disabled: i,
      onChange: (h) => {
        o(h.target.value, a && !i), d(!a);
      },
      ...r
    }), /* @__PURE__ */ t("span", {
      children: a ? /* @__PURE__ */ t(go, {
        color: i ? "gray" : "#4318FF"
      }) : /* @__PURE__ */ t(xo, {
        color: i ? "gray" : "#4318FF"
      })
...
const pr = ({
  ...
  model: a,
  fullWidth: r,
  children: e.map((d) => /* @__PURE__ */ t(Co, {
    onClick: () => i(d.value),
    active: d.value === n,
    disabled: o,
    model: a,
...
`, ue = /* @__PURE__ */ t("div", {
  ...
  return /* @__PURE__ */ t(J, {
    ...
    children: /* @__PURE__ */ c(wo, {
      children: [/* @__PURE__ */ c(Ro, {
        ...
        direction: h,
        children: [!f && e.map((x, m) => "onClick" in x ? /* @__PURE__ */ c(P, {
          alert: x.alert,
          disabled: x.disabled || x.loading,
          onClick: () => {
            !x.loading && !x.disabled && (x.onClick(), n());
          },
          optionsInCenter: d,
          iconOrientation: u,
          children: [/* @__PURE__ */ t("span", {
        ...
        }, `option-${m}`)), f == null ? void 0 : f.options.map((x, m) => /* @__PURE__ */ c(P, {
          alert: x.alert,
          disabled: x.disabled || x.loading,
          onClick: () => {
          ...
          optionsInCenter: d,
          children: [x.text, " ", x.loading ? ue : x.icon]
        }, `suboption-${m}`))]
      })]
    })
  });
  ...
  const h = j(null), u = () => h.current.click(), s = () => {
    ...
    if (!m)
      return;
    if (!f(m.name)) {
      o("Tipo de archivo no permitido");
      return;
    }
    const v = yo(m, n);
    if (!v.success) {
      o((E = v.error) == null ? void 0 : E.message);
      return;
    }
    e(m);
  };
...
`, ur = ({
  ...
  const [r, a] = w(null), [d, h] = w(e || null), u = ye();
  return M(() => {
    let s = "";
    return r && (s = window.URL.createObjectURL(r), h(s)), () => {
      s && window.URL.revokeObjectURL(s);
    };
  }, [r]), M(() => {
    u || o(r, d || null);
  }, [d]), /* @__PURE__ */ t(Ee, {
    ...
    children: d ? /* @__PURE__ */ c(Fo, {
      children: [/* @__PURE__ */ c(Bo, {
        children: [/* @__PURE__ */ t("img", {
          src: d
        }), /* @__PURE__ */ c(So, {
          children: [/* @__PURE__ */ t("span", {
            children: (r == null ? void 0 : r.name) || ge(d)[0]
          }), /* @__PURE__ */ t("span", {
            children: (r == null ? void 0 : r.type) || ge(d)[1]
          })]
        })]
      }), /* @__PURE__ */ t(Mo, {
        variant: "secondary",
        onClick: (s) => {
          s.stopPropagation(), a(null), h(null);
        },
      ...
      children: n || /* @__PURE__ */ c(To, {
        children: [/* @__PURE__ */ t(Me, {
          color: A.color.SECONDARY[900],
          size: 18
...
`, gr = ({
  ...
  const [i, r] = w(n || []), [a, d] = w(null), h = ye(), u = (g) => {
    const f = window.URL.createObjectURL(g);
    r((x) => [...x, {
      file: g,
      url: f
    }]);
    ...
    const f = i[g];
    typeof f != "string" && window.URL.revokeObjectURL(f.url), r((x) => x.filter((m, v) => v !== g));
  };
  return M(() => {
    h || e(i);
  }, [i]), /* @__PURE__ */ c(zo, {
    children: [i.map((g, f) => /* @__PURE__ */ c(jo, {
      onMouseEnter: () => d(f),
      onMouseLeave: () => d(null),
      onTouchCancel: () => d(null),
      children: [/* @__PURE__ */ t("img", {
    ...
    }, `imgs-${f}`)), !(o && i.length >= o) && /* @__PURE__ */ t(Ee, {
      onError: alert,
      onSelectFile: u,
      acceptedFiles: "image/x-png,image/jpeg",
      validFileExtensions: ["jpg", "jpeg", "png"],
...
export {
  ...
  Oo as CodeInput,
  qo as Collapsible,
  dr as ConfirmationCard,
  cr as ConfirmationCardV2,
  uo as ConfirmationCardV3,
  fr as ConfirmationModalV3,
  nr as CurrentStatusCard,
  st as CustomSelect,
  $o as DropdownMenu,
  Mn as EditQuantityInput,
  Qo as Heading,
  D as IconV2,
  Jo as Loader,
  hr as MultipleOptionsModal,
  zt as OrderStatusBadge,
  _o as OrderTypeBanner,
  lr as ProductDetailsCard,
  Xo as ProfileImage,
  sr as Radio,
  rr as SectionCard,
  Vo as SelectField,
  ...
  lt as TextField,
  or as TotalsCard,
  Ut as TransparentBadge,
  Ee as UploadFileContainer,
  ur as UploadImage,
  gr as UploadMultipleImages,
  Bt as UserProfileIcon
};
