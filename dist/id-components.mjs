...
`, Ye = (e) => {
  ...
  padding-bottom: 8px;
  padding: 15px 10px 8px;
  ${({ location: e }) => Ye(e || "left")}
  ${({ separator: e }) => Qe(Boolean(e))}
