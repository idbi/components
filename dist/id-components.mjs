import l, { css as f, keyframes as F } from "styled-components";
...
const ze = {
  ...
  return o === "PRIMARY" || o === "NEUTRAL" || o === "SECONDARY" || o === "TERTIARY" || o === "QUATERNARY" || o === "STATE" || o === "ALERT" || o === "SUCCESS" ? a === 0 || a === 50 || a === 100 || a === 200 || a === 300 || a === 400 || a === 500 || a === 600 || a === 700 || a === 800 || a === 900 ? s.color[o][a] : s.color[o][900] : s.color.PRIMARY[900];
}, me = ({ fullWidth: e }) => e ? f`
      width: 100%;
    ` : f`
    width: auto;
...
`, Pe = l(Ge)`
  ...
  ${({ size: e }) => Y({ size: e })};
  ${({ shape: e }) => je({ shape: e })};
  ${({ design: e, color: n, fontColor: r }) => Ue({ design: e, color: n, fontColor: r })};
  ${({ fullWidth: e }) => me({ fullWidth: e })};
  ${({ isLoading: e }) => De({ isLoading: e })};
  ${({ disabled: e }) => He({ disabled: e })};
  ${({ m: e, mb: n, mt: r, mr: i, ml: o, my: a, mx: c, p, pb: u, pt: A, pr: h, pl: g, py: m, px: x }) => be({ m: e, mb: n, mt: r, mr: i, ml: o, my: a, mx: c, p, pb: u, pt: A, pr: h, pl: g, py: m, px: x })};
...
function Ye(e, n, r) {
  ...
  y(() => {
    ...
    if (r) {
      const o = i(), a = o.map((u) => u.value), c = r.split(""), p = c.length === a.length ? c : a;
      o.forEach((u, A) => {
        const h = p[A];
        h && (u.value = h);
      });
...
`, We = {
  ...
  ${({ m: e, mb: n, mt: r, mr: i, ml: o, my: a, mx: c, p, pb: u, pt: A, pr: h, pl: g, py: m, px: x }) => be({ m: e, mb: n, mt: r, mr: i, ml: o, my: a, mx: c, p, pb: u, pt: A, pr: h, pl: g, py: m, px: x })};
`, Oe = (e) => {
  const n = e === "h1" || e === "h2" || e === "h3" || e === "h4" || e === "h5" || e === "h6", r = n ? "bold" : "medium", i = n ? K[e] : K.text, o = "PRIMARY/900";
  return f`
    font-weight: ${({ weight: a = r }) => ze[a] || "500"};
...
`, L = (e) => e.rightIcon || e.leftIcon ? /* @__PURE__ */ d(Xe, {
...
`, ve = (e) => {
  ...
  border-radius: 8px;
  border: 1px solid
    ${({ error: e, success: n, isFocused: r }) => e ? s.color.ALERT[900] : n && r ? s.color.SUCCESS[900] : r ? s.color.QUATERNARY[900] : s.color.NEUTRAL[300]};
  background: #fff;
  min-height: 45px;
  ::placeholder {
    color: ${() => s.color.NEUTRAL[500]};
...
const Ce = (e, n) => {
  y(() => {
    const r = (i) => {
      if (Array.isArray(e)) {
        for (const o of e)
          if (!i.target || !o.current || o.current.contains(i.target))
            return;
...
`, st = W(({
  ...
  const g = j(null), [m, x] = w(o), [v, E] = w(""), [k, C] = w(!1);
  Ce(g, () => {
    C(!1);
  });
  const M = G(() => {
    const b = o.filter((R) => R.label.toLowerCase().includes(v.toLowerCase()));
    x(b);
  }, [o, i]), B = G((b) => {
    u(o.find((R) => R.label === b)), C(!1), E(""), x(o);
  }, [M]), U = G((b) => {
    E(b.target.value);
    const R = o.filter((q) => q.label.toLowerCase().includes(b.target.value.toLowerCase()));
    x(R);
  }, []), H = () => {
    const b = g.current;
    if (b) {
...
`, Vr = ({
  ...
  children: [/* @__PURE__ */ d("button", {
    type: "button",
    onClick: e,
    children: [/* @__PURE__ */ t(N, {}), /* @__PURE__ */ t(L, {
      color: "NEUTRAL/900",
      children: n
    })]
  }), i || /* @__PURE__ */ t("img", {
...
`, Mt = ({
  ...
  const [r, i] = w(!1), o = j(null), a = (c) => {
    if (o.current && clearTimeout(o.current), c) {
      i(!0);
      return;
    }
  ...
  return /* @__PURE__ */ d(Z, {
    ...
    children: [e, " ", /* @__PURE__ */ t("div", {
      ...
      children: /* @__PURE__ */ t(ke, {
        children: n.map((c, p) => /* @__PURE__ */ d(Z, {
          alert: c.alert,
  ...
  children: e.map((n, r) => "options" in n ? /* @__PURE__ */ t(Mt, {
    ...n
  }, `option-${r}`) : /* @__PURE__ */ d(Z, {
...
`, Xr = ({
  ...
  return y(() => {
    if (!(!u.reference.current || !u.floating.current))
      return Se(u.reference.current, u.floating.current, p);
  }, [A, p]), Ce(u.reference, () => {
    h(!1);
  }), /* @__PURE__ */ d("div", {
    ref: o,
...
`, _ = (e, n, r) => e >= n && e <= r ? e : e < n ? n : r, jt = ({
  ...
  const a = _(e, 0, 1), c = _(n, 0, 1), p = 256 * a;
...
`, te = (e) => /* @__PURE__ */ d("svg", {
  ...
  pending: /* @__PURE__ */ t(Pt, {}),
  rejected: /* @__PURE__ */ t(te, {}),
  accepted: /* @__PURE__ */ t(ne, {
    color: "#4318FF"
  }),
  canceled: /* @__PURE__ */ t(te, {}),
  preparing: /* @__PURE__ */ t(Zt, {
    color: "#F79E1B"
  }),
  readyforpickup: /* @__PURE__ */ t(Yt, {
    color: "#FF82AF"
  }),
  ...
  statusName: e,
  radius: o,
  children: [i || Wt[e], (n === "default" || r === "default" || n.length > 1 || r.length > 1) && /* @__PURE__ */ d("div", {
...
`, _r = ({
  ...
  children: [(n || i) && /* @__PURE__ */ d(Jt, {
    ...
    children: e.map((A) => /* @__PURE__ */ d(_t, {
      remark: Boolean(A.remark),
      children: [o ? /* @__PURE__ */ d(ie, {
        children: [/* @__PURE__ */ d("div", {
  ...
  children: [/* @__PURE__ */ t(cn, {
    ...
    children: [/* @__PURE__ */ d(An, {
      children: [r && /* @__PURE__ */ d("span", {
        children: [/* @__PURE__ */ t(ln, {}), r]
      }), o.map((a) => /* @__PURE__ */ t("span", {
        children: a
      }))]
    }), /* @__PURE__ */ d(sn, {
      children: [e, " ", n]
    ...
    children: [/* @__PURE__ */ t(wn, {
      children: /* @__PURE__ */ d(En, {
        ...
        children: [!x && /* @__PURE__ */ t("button", {
          disabled: p,
          onClick: U,
          children: M && r ? /* @__PURE__ */ t(Rn, {
            children: /* @__PURE__ */ t(Re, {
              color: s.color.ALERT[900]
            })
          }) : "-"
        }), /* @__PURE__ */ t(kn, {
          children: `${e === null ? "-" : e} ${e !== null && o || ""}`
        }), !v && /* @__PURE__ */ t("button", {
          onClick: B,
          disabled: p,
          children: "+"
...
`, he = ({
  ...
  return /* @__PURE__ */ d(Nn, {
    ...
    children: [/* @__PURE__ */ d("span", {
      ...
      disabled: a,
      children: [o && /* @__PURE__ */ d(z, {
        children: [/* @__PURE__ */ d("span", {
          children: [e, o.prevTotal.toFixed(2)]
        }), /* @__PURE__ */ t(Pn, {
          children: o.label
        })]
      }), /* @__PURE__ */ d("span", {
  ...
  background-color: ${({ disabled: e, theme: n }) => e ? n.color.NEUTRAL[50] : "transparent"};
  border: 1px solid ${({ theme: e }) => e.color.NEUTRAL[100]};
  border-radius: 8px;
...
`, hr = ({
  ...
  children: [/* @__PURE__ */ d(cr, {
    children: [/* @__PURE__ */ d(Ar, {
      children: [e && /* @__PURE__ */ t(sr, {
        children: e
      }), /* @__PURE__ */ t(pr, {
        children: n
      })]
    }), r.length > 0 && /* @__PURE__ */ t(fe, {
      children: r.map((o) => /* @__PURE__ */ t(T, {
        design: "solid",
        shape: "circular",
        size: "xs",
        fullWidth: !0,
        onClick: o.onClick,
        disabled: o.disabled,
        color: o.type === "primary" ? "SECONDARY/900" : "QUATERNARY/200",
        fontColor: o.type === "primary" ? "SECONDARY/0" : "SECONDARY/900",
        style: {
          gap: 0
        },
        children: o.content
...
`, ao = ({
  ...
  return y(() => {
    ...
    children: [/* @__PURE__ */ t("input", {
      ...
      disabled: i,
      onChange: (p) => {
        r(p.target.value, a && !i), c(!a);
      },
      ...o
    }), /* @__PURE__ */ t("span", {
      children: a ? /* @__PURE__ */ t(fr, {
        color: i ? "gray" : "#4318FF"
      }) : /* @__PURE__ */ t(ur, {
        color: i ? "gray" : "#4318FF"
      })
...
`, ue = /* @__PURE__ */ t("div", {
  ...
  return /* @__PURE__ */ t(J, {
    ...
    children: /* @__PURE__ */ d(mr, {
      children: [/* @__PURE__ */ d(vr, {
        ...
        }), o.length > 0 && /* @__PURE__ */ t(L, {
          color: "NEUTRAL/400",
          size: "sm",
          weight: "regular",
          children: (A == null ? void 0 : A.description) || o
        })]
      }), /* @__PURE__ */ d(Cr, {
        children: [!A && e.map((h, g) => "onClick" in h ? /* @__PURE__ */ d(P, {
          alert: h.alert,
        ...
        }, `option-${g}`)), A == null ? void 0 : A.options.map((h, g) => /* @__PURE__ */ d(P, {
          alert: h.alert,
          disabled: h.disabled || h.loading,
          onClick: () => {
  ...
  const p = j(null), u = () => p.current.click(), A = () => {
    ...
    m(v);
  }, g = (x) => o ? new RegExp(`${o.join("|")}$`, "i").exec(x.toLowerCase()) : !0, m = (x) => {
    var E;
    if (!x)
      return;
    if (!g(x.name)) {
    ...
    const v = wr(x, n);
    if (!v.success) {
      r((E = v.error) == null ? void 0 : E.message);
      return;
    }
    e(x);
  };
...
`, so = ({
  ...
  const [o, a] = w(null), [c, p] = w(e || null), u = Me();
  return y(() => {
    let A = "";
    return o && (A = window.URL.createObjectURL(o), p(A)), () => {
    ...
    children: c ? /* @__PURE__ */ d(yr, {
      children: [/* @__PURE__ */ d(Lr, {
        children: [/* @__PURE__ */ t("img", {
          src: c
        }), /* @__PURE__ */ d(Ir, {
          children: [/* @__PURE__ */ t("span", {
            children: (o == null ? void 0 : o.name) || ge(c)[0]
          }), /* @__PURE__ */ t("span", {
            children: (o == null ? void 0 : o.type) || ge(c)[1]
          })]
        })]
      }), /* @__PURE__ */ t(kr, {
        variant: "secondary",
...
`, po = ({
  ...
  const [i, o] = w(n || []), [a, c] = w(null), p = Me(), u = (h) => {
    ...
    const g = i[h];
    typeof g != "string" && window.URL.revokeObjectURL(g.url), o((m) => m.filter((x, v) => v !== h));
  };
  return y(() => {
    p || e(i);
  }, [i]), /* @__PURE__ */ d(Fr, {
    children: [i.map((h, g) => /* @__PURE__ */ d(Tr, {
      onMouseEnter: () => c(g),
      onMouseLeave: () => c(null),
    ...
    }, `imgs-${g}`)), !(r && i.length >= r) && /* @__PURE__ */ t(Ee, {
      onError: alert,
      onSelectFile: u,
      acceptedFiles: "image/x-png,image/jpeg",
      validFileExtensions: ["jpg", "jpeg", "png"],
...
export {
  ...
  Yr as CodeInput,
  Or as Collapsible,
  oo as ConfirmationCard,
  io as ConfirmationCardV2,
  hr as ConfirmationCardV3,
  Ao as ConfirmationModalV3,
  $r as CurrentStatusCard,
  st as CustomSelect,
  Xr as DropdownMenu,
  ...
  D as IconV2,
  Qr as Loader,
  co as MultipleOptionsModal,
  St as OrderStatusBadge,
  Jr as OrderTypeBanner,
  ro as ProductDetailsCard,
  Wr as ProfileImage,
  lo as Radio,
  eo as SectionCard,
  Zr as SelectField,
  ...
  lt as TextField,
  _r as TotalsCard,
  jt as TransparentBadge,
  Ee as UploadFileContainer,
  so as UploadImage,
  po as UploadMultipleImages,
  Tt as UserProfileIcon
};
