...
import { useEffect as y, forwardRef as H, useState as C, useRef as F, useCallback as Y, useMemo as Ue } from "react";
import Pe from "react-loading-skeleton";
import Ye from "react-select";
import * as W from "@radix-ui/react-collapsible";
import { useFloating as Qe, autoUpdate as Ze } from "@floating-ui/react-dom";
const Oe = {
  bold: 700,
  medium: 500,
  regular: 400,
  ...
  return r === "PRIMARY" || r === "NEUTRAL" || r === "SECONDARY" || r === "TERTIARY" || r === "QUATERNARY" || r === "STATE" || r === "ALERT" || r === "SUCCESS" ? l === 0 || l === 50 || l === 100 || l === 200 || l === 300 || l === 400 || l === 500 || l === 600 || l === 700 || l === 800 || l === 900 ? d.color[r][l] : d.color[r][900] : d.color.PRIMARY[900];
}, Ce = ({ fullWidth: e }) => e ? s`
      width: 100%;
    ` : s`
    width: auto;
...
`, Je = a(Ve)`
  ...
  ${({ size: e }) => Z({ size: e })};
  ${({ shape: e }) => He({ shape: e })};
  ${({ design: e, color: o, fontColor: n }) => We({ design: e, color: o, fontColor: n })};
  ${({ fullWidth: e }) => Ce({ fullWidth: e })};
  ${({ isLoading: e }) => Me({ isLoading: e })};
  ${({ disabled: e }) => G({ disabled: e })};
  ${({ m: e, mb: o, mt: n, mr: i, ml: r, my: l, mx: A, p: h, pb: g, pt: p, pr: u, pl: f, py: x, px: m }) => Re({ m: e, mb: o, mt: n, mr: i, ml: r, my: l, mx: A, p: h, pb: g, pt: p, pr: u, pl: f, py: x, px: m })};
...
`, qe = {
  ...
  ${({ m: e, mb: o, mt: n, mr: i, ml: r, my: l, mx: A, p: h, pb: g, pt: p, pr: u, pl: f, py: x, px: m }) => Re({ m: e, mb: o, mt: n, mr: i, ml: r, my: l, mx: A, p: h, pb: g, pt: p, pr: u, pl: f, py: x, px: m })};
`, _e = (e) => {
  const o = e === "h1" || e === "h2" || e === "h3" || e === "h4" || e === "h5" || e === "h6", n = o ? "bold" : "medium", i = o ? $[e] : $.text, r = "PRIMARY/900";
  return s`
    font-weight: ${({ weight: l = n }) => Oe[l] || "500"};
    font-size: ${({ size: l = i }) => ve[l] || l};
    color: ${({ color: l = r }) => {
...
`, E = (e) => e.rightIcon || e.leftIcon ? /* @__PURE__ */ c(tt, {
...
`, it = {
  control: (e, o) => ({
    ...
    border: `1px solid ${o.isFocused ? d.color.QUATERNARY[900] : d.color.NEUTRAL[300]}`,
    boxShadow: "none",
    cursor: "pointer"
  }),
  singleValue: () => ({
...
`, ke = (e) => {
  ...
  border-radius: 8px;
  border: 1px solid
    ${({ error: e, success: o, isFocused: n }) => e ? d.color.ALERT[900] : o && n ? d.color.SUCCESS[900] : n ? d.color.QUATERNARY[900] : d.color.NEUTRAL[300]};
  background: #fff;
  min-height: 45px;
  ::placeholder {
    color: ${() => d.color.NEUTRAL[500]};
...
`, jt = ({
  ...
  children: [o && /* @__PURE__ */ t(Nt, {
    children: o
  }), e.map((n, i) => "options" in n ? /* @__PURE__ */ t(jt, {
    ...n
...
`, Tr = ({
  ...
  return y(() => {
    if (!(!p.reference.current || !p.floating.current))
      return Ze(p.reference.current, p.floating.current, g);
  }, [u, g]), Ie(p.reference, () => {
    f(!1);
  }), /* @__PURE__ */ c("div", {
    ref: l,
...
`, Zt = ({
  ...
  const i = n.slice(0, 2).toUpperCase();
...
`, ee = (e, o, n) => e >= o && e <= n ? e : e < o ? o : n, Gt = ({
  ...
  const l = ee(e, 0, 1), A = ee(o, 0, 1), h = 256 * l;
...
`, oe = (e) => /* @__PURE__ */ c("svg", {
  ...
  pending: /* @__PURE__ */ t(_t, {}),
  rejected: /* @__PURE__ */ t(oe, {}),
  accepted: /* @__PURE__ */ t(ne, {
    color: "#4318FF"
  }),
  canceled: /* @__PURE__ */ t(oe, {}),
  preparing: /* @__PURE__ */ t(to, {
    color: "#F79E1B"
  }),
  readyforpickup: /* @__PURE__ */ t(eo, {
    color: "#FF82AF"
  }),
  ...
  statusName: e,
  radius: r,
  children: [i || oo[e], (o === "default" || n === "default" || o.length > 1 || n.length > 1) && /* @__PURE__ */ c("div", {
    children: [o === "default" ? /* @__PURE__ */ t(te, {
      children: re[e].title
    }) : /* @__PURE__ */ t(te, {
      children: o
...
`, Sr = ({
  ...
  children: [(o || i) && /* @__PURE__ */ c(lo, {
    ...
    children: e.map((p) => /* @__PURE__ */ c(po, {
      remark: Boolean(p.remark),
      children: [r ? /* @__PURE__ */ c(ae, {
        children: [/* @__PURE__ */ c("div", {
          children: [/* @__PURE__ */ t("span", {
            children: p.description
          }), p.notes && /* @__PURE__ */ t(le, {
            children: p.notes.map((u) => /* @__PURE__ */ t("li", {
              children: u
            }, crypto.randomUUID()))
          })]
        }), p == null ? void 0 : p.decorators]
      }) : /* @__PURE__ */ c(ae, {
        children: [p.img && /* @__PURE__ */ t(go, {
          src: p.img,
          alt: p.description
        }), /* @__PURE__ */ t(ho, {
          children: p.quantity
...
`, Pr = ({
  ...
  children: [(() => {
    ...
    children: [e && /* @__PURE__ */ t(To, {
      children: e
    }), o && /* @__PURE__ */ c(Lo, {
      children: [o, " ", i && i.onClick && /* @__PURE__ */ t(Do, {
        onClick: (A) => {
...
`, Bo = "data:image/svg+xml;base64,", Yr = ({
  ...
  children: [(i == null ? void 0 : i.component) && /* @__PURE__ */ t(zo, {
    padding: i == null ? void 0 : i.padding,
    children: i == null ? void 0 : i.component
  }), r && /* @__PURE__ */ t(So, {
    src: r != null && r.url ? r == null ? void 0 : r.url : Bo,
...
`, Ko = ({
  ...
  const [k, M] = C(!1), v = Number(e || 0), I = e === null || v <= i, N = (b) => {
    ...
    const R = v % 1 > 0 ? Math.floor(v) : v - 1;
    o(R);
  }, U = (b) => {
...
`, Qr = ({
  ...
  return /* @__PURE__ */ c($o, {
    children: [/* @__PURE__ */ c(_o, {
      ...
      canClick: !!h,
      children: [(e == null ? void 0 : e.src) && /* @__PURE__ */ t(en, {
        ...e
      }), /* @__PURE__ */ c(tn, {
  ...
  children: [/* @__PURE__ */ c(zn, {
    children: [/* @__PURE__ */ c(jn, {
      ...
      children: n.map((r, l) => /* @__PURE__ */ t(L, {
        ...
        children: r.content
      }, `confirmation-option-${l}`))
    })]
  }), i.length > 0 && /* @__PURE__ */ t(ue, {
    bottom: !0,
...
const Vr = ({
  ...
  model: l,
  fullWidth: r,
  children: e.map((A) => /* @__PURE__ */ t(On, {
    onClick: () => i(A.value),
    active: A.value === o,
    disabled: n,
    model: l,
...
`, be = /* @__PURE__ */ t("div", {
    ...
    children: /* @__PURE__ */ c(Vn, {
      children: [/* @__PURE__ */ c(Xn, {
        ...
        children: [!f && e.map((x, m) => "onClick" in x ? /* @__PURE__ */ c(Q, {
          ...
          optionsInCenter: A,
          children: [x.text, " ", x.loading ? be : x.icon]
        }, `suboption-${m}`))]
      })]
    })
  });
  ...
  const h = F(null), g = () => h.current.click(), p = () => {
    ...
    const w = qn(m, o);
    if (!w.success) {
      n((k = w.error) == null ? void 0 : k.message);
      return;
    }
    e(m);
  };
...
`, qr = ({
  ...
  const [r, l] = C(null), [A, h] = C(e || null), g = je();
  return y(() => {
    let p = "";
    ...
    children: A ? /* @__PURE__ */ c(tr, {
      children: [/* @__PURE__ */ c(or, {
        children: [/* @__PURE__ */ t("img", {
          src: A
        }), /* @__PURE__ */ c(nr, {
          children: [/* @__PURE__ */ t("span", {
            children: (r == null ? void 0 : r.name) || we(A)[0]
          }), /* @__PURE__ */ t("span", {
            children: (r == null ? void 0 : r.type) || we(A)[1]
          })]
        })]
      }), /* @__PURE__ */ t(Fe, {
        variant: "secondary",
...
`, $r = ({
  ...
  const [i, r] = C(o || []), [l, A] = C(null), h = je(), g = (u) => {
  ...
  return y(() => {
    ...
    children: [i.map((u, f) => /* @__PURE__ */ c(ir, {
      onMouseEnter: () => A(f),
      onMouseLeave: () => A(null),
    ...
    }, `imgs-${f}`)), !(n && i.length >= n) && /* @__PURE__ */ t(ze, {
      onError: alert,
      onSelectFile: g,
      acceptedFiles: "image/x-png,image/jpeg",
      validFileExtensions: ["jpg", "jpeg", "png"],
...
`, ei = ({
  ...
  return /* @__PURE__ */ c(sr, {
    ...
    children: [n != null && n.hide ? /* @__PURE__ */ t("div", {}) : /* @__PURE__ */ t(Fe, {
      ...
      children: (i = o == null ? void 0 : o.options) == null ? void 0 : i.map((r, l) => /* @__PURE__ */ t(hr, {
        onClick: r.onClick,
        type: "button",
        mode: r.mode,
        disabled: r.disabled,
...
export {
  ...
  Mr as CodeInput,
  yr as Collapsible,
  Or as ConfirmationCard,
  Hr as ConfirmationCardV2,
  Bn as ConfirmationCardV3,
  Kr as ConfirmationModalV3,
  Fr as CurrentStatusCard,
  mt as CustomSelect,
  Tr as DropdownMenu,
  Ko as EditQuantityInput,
  _r as GridTable,
  Cr as Heading,
  Yr as IDCard,
  B as IconV2,
  Ir as Loader,
  ei as ModalHeader,
  Xr as MultipleOptionsModal,
  Lr as NoData,
  Ht as OrderStatusBadge,
  Nr as OrderTypeBanner,
  Zr as ProductDetailsCard,
  kr as ProfileImage,
  Gr as Radio,
  Br as SectionCard,
  Rr as SelectField,
  ...
  Pr as ToastCard,
  Sr as TotalsCard,
  Gt as TransparentBadge,
  ze as UploadFileContainer,
  qr as UploadImage,
  $r as UploadMultipleImages,
  Zt as UserProfileIcon
};
