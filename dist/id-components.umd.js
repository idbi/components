(function(p,s){typeof exports=="object"&&typeof module<"u"?s(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("react-loading-skeleton"),require("react-select"),require("@radix-ui/react-collapsible"),require("@floating-ui/react-dom")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","react-loading-skeleton","react-select","@radix-ui/react-collapsible","@floating-ui/react-dom"],s):(p=typeof globalThis<"u"?globalThis:p||self,s(p["ID-Components"]={},p.styled,p["react/jsx-runtime"].js,p.React,p.Skeleton,p.Select,p["@radix-ui/react-collapsible"],p["@floating-ui/react-dom"]))})(this,function(p,s,o,b,Oe,Ze,He,J){"use strict";const U=e=>e&&typeof e=="object"&&"default"in e?e:{default:e};function We(e){if(e&&e.__esModule)return e;const t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const r in e)if(r!=="default"){const n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(t,r,n.get?n:{enumerable:!0,get:()=>e[r]})}}return t.default=e,Object.freeze(t)}const a=U(s),Ge=U(Oe),Ve=U(Ze),P=We(He),Je={bold:700,medium:500,regular:400,light:300},R={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},X={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},d={color:{NEUTRAL:{0:"#FFFFFF",20:"#FFFFFF",50:"#F5F5F5",100:"#EBEBEB",200:"#dfdfdf",300:"#bfbfbf",400:"#9f9f9f",500:"#808080",600:"#404040",700:"#383838",800:"#202020",900:"#000000"},PRIMARY:{0:"#FFFFFF",50:"#F1F2F9",100:"#E6E8F4",200:"#DDDFF0",300:"#BBBFE2",400:"#999FD3",500:"#777fc5",600:"#545fb6",700:"#414a98",800:"#333a76",900:"#242954"},SECONDARY:{0:"#FFFFFF",20:"#F7F5FF",50:"#EFEBFF",100:"#E6E0FF",200:"#d0c5ff",300:"#d0c5ff",400:"#b9a8ff",500:"#a18cff",600:"#8a6fff",700:"#7252ff",800:"#5b35ff",900:"#4318FF"},TERTIARY:{0:"#FFFFFF",50:"#FFFAFC",100:"#FFF5F9",200:"#ffeff5",300:"#ffe0eb",400:"#ffd0e1",500:"#ffc1d7",600:"#ffb1cd",700:"#FFA1C3",800:"#ff92b9",900:"#FF82AF"},QUATERNARY:{0:"#FFFFFF",50:"#FBFCFE",100:"#F2F6FD",200:"#ebf1fc",300:"#D8E4FA",400:"#c4d6f8",500:"#b0c8f5",600:"#9cbbf3",700:"#88adf0",800:"#75a0ed",900:"#6192EB"},STATE:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEF7EB",200:"#fef3e3",300:"#fde7c6",400:"#fcdba9",500:"#fbcf8d",600:"#fac270",700:"#f9b654",800:"#f8aa38",900:"#F79E1B"},ALERT:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEEDEC",200:"#fde3e2",300:"#fbc8c5",400:"#f9ada8",500:"#f7918b",600:"#f4756d",700:"#F25A50",800:"#F03E33",900:"#EE2316"},SUCCESS:{0:"#FFFFFF",50:"#F7FDFA",100:"#EEFBF4",200:"#e4f9ed",300:"#c9f3db",400:"#aeedc9",500:"#93e7b7",600:"#78e1a4",700:"#5DDB92",800:"#42D580",900:"#2DC96F"},OTHER:{color1:"#151E5A"},STATUS:{DEFAULT:{0:"#F5F5F5",1:"#808080"},DRAFT:{0:"#F5F5F5",1:"#808080"},PENDING:{0:"#DFDFDF",1:"#404040"},REJECTED:{0:"#FDE3E2",1:"#EE2316"},ACCEPTED:{0:"#D0C5FF",1:"#4318FF"},CANCELED:{0:"#FDE3E2",1:"#EE2316"},PREPARING:{0:"#FEF3E3",1:"#F79E1B"},READYFORPICKUP:{0:"#FFEFF5",1:"#FF82AF"},DELIVERED:{0:"#E4F9ED",1:"#2DC96F"}}},effect:{darkShadow:{4:"0px 0px 4px 1px rgba(139, 139, 139, 0.32)",6:"0px 1px 6px rgba(60, 60, 60, 0.2)",8:"0px 1px 6px rgba(107, 107, 107, 0.2)",12:"0px 0px 12px 2px #F6F6F6",24:"0px 0px 24px 4px rgba(0, 14, 51, 0.2)",30:"0px 10px 30px rgba(0, 0, 0, 0.08)"},lightShadow:{2:"0px 0px 2px 1px rgba(149, 178, 254, 0.2)",16:"0px 4px 16px rgba(153, 181, 255, 0.2)"}}},Re=({shape:e})=>{switch(e){case"rounded":return s.css`
      ...
      `;default:return s.css`
        border-radius: 0.625rem;
      `}},Xe=({design:e,color:t,fontColor:r})=>{switch(e){case"solid":return s.css`
...
`,$e=a.default(qe)`
  ...
  ${({size:e})=>Q({size:e})};
  ${({shape:e})=>Re({shape:e})};
  ${({design:e,color:t,fontColor:r})=>Xe({design:e,color:t,fontColor:r})};
  ${({fullWidth:e})=>K({fullWidth:e})};
  ${({isLoading:e})=>q({isLoading:e})};
  ${({disabled:e})=>Y({disabled:e})};
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:g,pt:A,pr:x,pl:h,py:u,px:w})=>$({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:g,pt:A,pr:x,pl:h,py:u,px:w})};
...
`,L=({children:e,...t})=>o.jsxs($e,{...t,children:[t.leftIcon,e,t.rightIcon]});function _e(e,t,r){const n=()=>{const i=document.querySelectorAll("input");return Array.from(i).filter(c=>c.className===t)};b.useEffect(()=>{const i=l=>{l.key==="Backspace"&&setTimeout(()=>{const c=n(),f=document.activeElement;f.value="";const g=c.indexOf(f);g>0&&c[g-1].focus()},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),b.useEffect(()=>{const i=l=>{if(l.key!=="Backspace"){const c=l.key.toLowerCase();setTimeout(()=>{if(c.length===1){const f=n(),g=document.activeElement;g.value=c;const A=f.indexOf(g);A<f.length-1&&f[A+1].focus()}},0)}};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),b.useEffect(()=>{if(e){const i=l=>{const c=l.key.toLowerCase();(c.length===1||c==="backspace")&&setTimeout(()=>{const g=n().map(A=>A.value).join("");e(g)},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)}},[]),b.useEffect(()=>{if(r){const i=n(),l=i.map(g=>g.value),c=r.split(""),f=c.length===l.length?c:l;i.forEach((g,A)=>{const x=f[A];x&&(g.value=x)})}},[r])}const eo=s.keyframes`
  0% {
    opacity: 0;
...
`,O=a.default.div`
  ...
  ${({shouldAppear:e})=>e&&s.css`
      animation: ${eo} 0.2s ease-in;
      animation-fill-mode: forwards;
    `}
`,oo={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},to=s.css`
  ...
  ${({align:e})=>Ke({align:e})}
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:g,pt:A,pr:x,pl:h,py:u,px:w})=>$({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:g,pt:A,pr:x,pl:h,py:u,px:w})};
`,ro=e=>{const t=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",r=t?"bold":"medium",n=t?X[e]:X.text,i="PRIMARY/900";return s.css`
    font-weight: ${({weight:l=r})=>Je[l]||"500"};
    font-size: ${({size:l=n})=>R[l]||l};
    color: ${({color:l=i})=>{const c=l==null?void 0:l.split("/")[0],f=Number(l==null?void 0:l.split("/")[1]);return d.color[c][f]}};
  `},no=a.default.div`
  ${to}
  ${({as:e})=>ro(e)}
`,N=({as:e,...t})=>{const r=oo[e];return o.jsx(no,{as:r,...t})},io={H1:e=>o.jsx(N,{as:"h1",...e}),H2:e=>o.jsx(N,{as:"h2",...e}),H3:e=>o.jsx(N,{as:"h3",...e}),H4:e=>o.jsx(N,{as:"h4",...e}),H5:e=>o.jsx(N,{as:"h5",...e}),H6:e=>o.jsx(N,{as:"h6",...e})},ao=a.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
  transition: 0.3s ease-out;
`,E=e=>e.rightIcon||e.leftIcon?o.jsxs(ao,{children:[e.leftIcon,o.jsx(N,{as:e.as||"p",...e}),e.rightIcon]}):o.jsx(N,{as:e.as||"p",...e}),lo=a.default.div`
  display: grid;
...
`,co=a.default.div`
  ...
  gap: 10px;
`,so=({id:e,value:t,length:r=4,errorMessage:n,success:i,onChange:l=()=>{},...c})=>(_e(l,e,t),o.jsxs(co,{children:[o.jsx(lo,{length:r,success:i,errorMessage:n,children:Array.from({length:r}).map((f,g)=>o.jsx("input",{id:g.toString(),className:e,maxLength:1,...c},g))}),n&&o.jsx(O,{shouldAppear:Boolean(n),children:o.jsx(E,{size:"xs",weight:"light",color:"ALERT/900",children:n})})]})),Ao=a.default.div`
  position: relative;
  width: 100%;
...
`,fo={control:(e,t)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${t.isFocused?d.color.QUATERNARY[900]:d.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:d.color.PRIMARY[900],fontWeight:500,fontSize:"14px"}),placeholder:e=>({...e,color:d.color.NEUTRAL[700]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"3px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"6px"})},po=({formatOptionLabel:e,options:t,loading:r=!1,style:n,error:i,firstOption:l,initialValue:c,value:f,onChange:g,isMulti:A,placeholder:x,label:h})=>{const u=l||{label:"Seleccione una opci\xF3n",value:""},w=[...t];return o.jsxs(Ao,{style:n,hasError:!!i,children:[h&&o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:h}),r?o.jsx(Ge.default,{style:{borderRadius:10},className:"loading-skeleton",height:46,width:"100%"}):o.jsx(Ve.default,{placeholder:x,value:f||void 0,defaultValue:c||u,options:w,onChange:g,styles:fo,isMulti:A,formatOptionLabel:e})]})},ho=a.default.div`
  width: ${e=>e.size}px;
  height: ${e=>e.size}px;
  position: relative;
  &::before {
...
`,Z=b.forwardRef(({type:e,leftAddon:t,rightAddon:r,placeholder:n,error:i,success:l,size:c,fullWidth:f,name:g,infoMessage:A,onFocus:x,onBlur:h,onChange:u,...w},C)=>{const[I,m]=b.useState(!1),M=!i&&!l&&A&&I;return o.jsxs(o.Fragment,{children:[o.jsxs(vo,{fullWidth:f,success:l,size:c,error:i,disabled:w.disabled,leftAddon:t,rightAddon:r,isFocused:I,children:[t&&o.jsx("span",{className:"leftAddon",children:t}),o.jsx("input",{ref:C,onFocus:T=>{x&&x(T),m(!0)},onBlur:T=>{h&&h(T),m(!1)},onChange:u,placeholder:n,type:e,name:g,...w}),r&&o.jsx("span",{className:"rightAddon",children:r}),i&&o.jsx("span",{className:"state",children:o.jsx(bo,{size:24,color:d.color.ALERT[900]})}),l&&o.jsx("span",{className:"state",children:o.jsx(wo,{size:20,color:d.color.SUCCESS[900]})})]}),M&&o.jsx(O,{shouldAppear:M,children:o.jsx(E,{size:"xs",color:"QUATERNARY/900",children:A})})]})});Z.displayName="TextInput";const Co=a.default.div`
...
`,ee=b.forwardRef(({label:e,type:t,error:r,isDirty:n,success:i,infoMessage:l,fullWidth:c,...f},g)=>{const A={...f,ref:g},[x,h]=b.useState(!1);return o.jsxs(Co,{fullWidth:c,children:[e&&o.jsxs("div",{className:"label-container",children:[o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:e}),t==="password"&&o.jsx("span",{onClick:()=>h(!x),children:x?o.jsx(uo,{size:20}):o.jsx(xo,{size:20})})]}),o.jsx(Z,{error:Boolean(r),success:i||!r&&n,infoMessage:l,fullWidth:c,type:x?"text":t,...A}),r&&o.jsx(O,{shouldAppear:Boolean(r),children:o.jsx(E,{size:"xs",color:"ALERT/900",children:r})})]})});ee.displayName="TextField";const oe=(e,t)=>{b.useEffect(()=>{const r=n=>{if(Array.isArray(e)){for(const i of e)if(!n.target||!i.current||i.current.contains(n.target))return}else if(!n.target||!e.current||e.current.contains(n.target))return;t(n)};return document.addEventListener("mousedown",r),document.addEventListener("touchstart",r),()=>{document.removeEventListener("mousedown",r),document.removeEventListener("touchstart",r)}},[e,t])},te=e=>o.jsx("svg",{height:e.size||16,width:e.size||16,fill:"none",viewBox:"0 0 16 16",...e,children:o.jsx("path",{d:"M12 5.333v2.534l-4 3.067-4-3.067V5.333L8 8.4l4-3.067Z",fill:"#6B6B6B"})}),Mo=e=>o.jsx("svg",{height:13,width:14,fill:"none",viewBox:"0 0 14 13",...e,children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5.821 1.606a4.715 4.715 0 1 0 0 9.43 4.715 4.715 0 0 0 0-9.43ZM.125 6.32A5.696 5.696 0 1 1 10.178 9.99l2.553 2.547a.49.49 0 0 1-.693.695l-2.553-2.55A5.696 5.696 0 0 1 .125 6.32Z",fill:"#242954"})}),mo=a.default.div`
  position: relative;
...
`,re=b.forwardRef(({label:e,searchable:t=!0,autoSize:r,value:n,options:i,placeholder:l="Seleccione una opci\xF3n",fullWidth:c,fullWidthOptions:f,onChange:g,formatOptionLabel:A,formatSelectedOption:x})=>{const h=b.useRef(null),[u,w]=b.useState(i),[C,I]=b.useState(""),[m,M]=b.useState(!1);oe(h,()=>{M(!1)});const T=b.useCallback(()=>{const v=i.filter(k=>k.label.toLowerCase().includes(C.toLowerCase()));w(v)},[i,n]),y=b.useCallback(v=>{g(i.find(k=>k.label===v)),M(!1),I(""),w(i)},[T]),S=b.useCallback(v=>{I(v.target.value);const k=i.filter(Qe=>Qe.label.toLowerCase().includes(v.target.value.toLowerCase()));w(k)},[]),B=()=>{const v=h.current;if(v){const k=v.getBoundingClientRect();return window.innerHeight-k.bottom-20}};return o.jsxs(mo,{fullWidth:c,ref:h,children:[e&&o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),o.jsxs("div",{className:"select-btn",onClick:()=>M(!m),tabIndex:0,onKeyUpCapture:v=>{v.key==="Enter"&&M(!m)},children:[o.jsx(E,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:x?x(n):A?A(n):n.label}),o.jsx(te,{size:20})]}),m&&o.jsxs(ko,{maxOptionsHeight:r?B():285,fullWidthOptions:f,children:[t&&o.jsx("div",{className:"search-box",children:o.jsx(Z,{leftAddon:o.jsx(Mo,{}),type:"text",placeholder:l,value:C,onChange:S,fullWidth:!0})}),o.jsx("div",{className:"options",children:u.map(v=>o.jsx(E,{as:"li",color:"NEUTRAL/700",className:v.value===n.value?"selected":"",tabIndex:0,onClick:()=>y(v.label),onKeyUpCapture:k=>{k.key==="Enter"&&y(v.label)},children:A?A(v):v.label},`${v.label}-${v.value}`))})]})]})});re.displayName="CustomSelect";const Io=a.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,Eo=({imageUrl:e,size:t=128,onChange:r})=>{const n=b.useRef(null),i=l=>{var f;const c=(f=l.target.files)==null?void 0:f[0];if(c){const g=URL.createObjectURL(c);r({file:c,url:g})}};return o.jsxs(Io,{size:t,children:[o.jsx(E,{color:"NEUTRAL/400",weight:"regular",size:"xs",children:"Agrega tu foto"}),o.jsxs("div",{className:"profile-input__container",children:[o.jsx("input",{type:"file",accept:"image/png, image/jpeg",onChange:i,ref:n}),o.jsx("img",{width:t,height:t,src:e||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"}),o.jsx(L,{type:"button",size:"lg",design:"flat",shape:"circular",onClick:()=>{var l;return(l=n.current)==null?void 0:l.click()},children:"+"})]})]})},To=s.keyframes`
  0%,
  100% {
...
`,Yo=({onBack:e,backLabel:t,profileImageUrl:r,rightContent:n})=>o.jsxs(Po,{children:[o.jsxs("button",{type:"button",onClick:e,children:[o.jsx(j,{}),o.jsx(E,{color:"NEUTRAL/900",children:t})]}),n||o.jsx("img",{width:28,height:28,src:r||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"})]}),Qo=s.keyframes`
  100% {
    transform: rotate(360deg);
  }
`,Oo=a.default.div`
  ...
  border-radius: 50%;
  animation: ${Qo} 1s infinite linear;
`,H=e=>o.jsx(Oo,{width:e.width,height:e.height,borderWidth:e.borderWidth,margin:e.margin}),ne=a.default.ul`
...
`,Ho=a.default.div`
  ...
  top: 0;
  right: calc(100% + 8px);
`,Wo=({text:e,options:t})=>{const[r,n]=b.useState(!1),i=b.useRef(null),l=c=>{if(i.current&&clearTimeout(i.current),c){n(!0);return}i.current=setTimeout(()=>{r!==c&&n(c)},50)};return o.jsxs(W,{onMouseEnter:()=>l(!0),onMouseLeave:()=>l(!1),active:r,onClick:c=>c.stopPropagation(),children:[e," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(j,{})}),r&&o.jsx(Ho,{children:o.jsx(ne,{children:t.map((c,f)=>o.jsxs(W,{alert:c.alert,onClick:g=>c.disabled||c.loading?g.stopPropagation():c.onClick(),disabled:c.disabled||c.loading,loading:c.loading,children:[c.text," ",c.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(H,{width:"20px",height:"20px"})}):c.icon]},`suboption-${f}`))})})]})},Go=({options:e,header:t})=>o.jsxs(ne,{children:[t&&o.jsx(Zo,{children:t}),e.map((r,n)=>"options"in r?o.jsx(Wo,{...r},`option-${n}`):o.jsxs(W,{disabled:r.disabled||r.loading,alert:r.alert,onClick:r.disabled||r.loading?i=>i.stopPropagation():r.onClick,loading:r.loading,children:[r.text," ",r.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(H,{width:"20px",height:"20px"})}):r.icon]},`option-${n}`))]}),Vo=a.default.div`
  display: flex;
  cursor: pointer;
  text-align: right;
  * {
...
`,Jo=({options:e,activator:t,header:r})=>{const{x:n,y:i,reference:l,floating:c,strategy:f,update:g,refs:A}=J.useFloating({placement:"bottom-end"}),[x,h]=b.useState(!1);return b.useEffect(()=>{if(!(!A.reference.current||!A.floating.current))return J.autoUpdate(A.reference.current,A.floating.current,g)},[x,g]),oe(A.reference,()=>{h(!1)}),o.jsxs("div",{ref:l,children:[o.jsx(Vo,{onClick:()=>h(!x),children:t||o.jsx(te,{size:25})}),x&&o.jsx("div",{ref:c,style:{position:f,top:i!=null?i:0,left:n!=null?n:0,zIndex:100},onClick:()=>h(!x),children:o.jsx(Go,{options:e,header:r})})]})},Ro=a.default.div`
  text-align: center;
  font-weight: 300;
  font-size: 0.75rem;
...
`,ie=({img:e,size:t=36,initials:r})=>{const n=r.slice(0,2).toUpperCase();return o.jsx(_o,{hasImg:!(e!=null&&e.src),style:{width:`${t}px`,height:`${t}px`,fontSize:`${t/(r.length===1?2:2.25)}px`},children:e!=null&&e.src?o.jsx("img",{...e}):n})},et=a.default.span`
  ...
  ${({statusName:e,removeBackground:t})=>{if(e==="draft")return s.css`
      ...
      `}};
`,ae={default:"...",draft:"Borrador",pending:"Pendiente",rejected:"Rechazado",accepted:"Aceptado",canceled:"Anulado",preparing:"Preparando",readyforpickup:"Listo para recojo",delivered:"Entregado"},le=({statusName:e,text:t,removeBackground:r})=>{const n=i=>ae[i]||ae.default;return o.jsx(et,{statusName:e,removeBackground:r,children:t||n(e)})},ot=a.default.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
  font-size: 1em;
  display: inline-block;
  font-weight: bold;
`,de=(e,t,r)=>e>=t&&e<=r?e:e<t?t:r,ce=({intensity:e=.8,opacity:t=.5,children:r,style:n={},...i})=>{const l=de(e,0,1),c=de(t,0,1),f=256*l;return o.jsx(ot,{style:{backgroundColor:`rgba(${f}, ${f}, ${f}, ${c})`,...n},...i,children:r})},tt=a.default.span`
  ...
  ${({applyFlex:e})=>e&&s.css`
      ...
      gap: 5px;
    `}
`,rt=({text:e,padding:t,color:r,background:n,applyFlex:i,maxWidth:l})=>o.jsx(tt,{padding:t,color:r,background:n,applyFlex:i,maxWidth:l,children:e}),nt=a.default.div`
  min-height: 50px;
  display: flex;
  justify-content: center;
...
`,xt=({design:e="primary",header:t,options:r,optionsFormatter:n,content:i,withSeparator:l})=>o.jsxs(gt,{design:e,withSeparator:l,children:[t&&o.jsx("header",{children:t}),r&&n&&o.jsx("ul",{children:r.map(c=>o.jsx("li",{children:n(c)},c.value))}),i&&i]}),ut=a.default.div`
  padding: 20px;
  border-radius: 10px;
  background: #fff;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,he=a.default.span`
  color: #151E5A;
  font-weight: 500;
`,wt=({items:e,creationDescription:t,creationDate:r,title:n,children:i})=>o.jsxs(ut,{children:[n&&o.jsx(bt,{children:n}),e.map(l=>o.jsxs("div",{children:[o.jsxs("p",{children:[l.description&&o.jsx("span",{children:l.description})," ",o.jsx(le,{statusName:l.statusName,removeBackground:!0})]}),o.jsx(he,{children:l.statusDate})]},crypto.randomUUID())),r&&o.jsxs("div",{children:[t&&o.jsx("span",{children:t}),o.jsx(he,{children:r})]}),i]}),vt=a.default.div`
...
`,Lt=a.default.img`
  ...
  font-size: 9px;
  object-fit: cover;
`,Dt=({items:e,title:t="",onAction:r=()=>{},actionName:n="",hideQuantity:i=!1,children:l,gap:c=10,background:f,padding:g})=>o.jsxs(vt,{background:f,padding:g,children:[(t||n)&&o.jsxs(Ct,{children:[o.jsx(Mt,{children:t}),o.jsx(mt,{onClick:()=>r(),children:n})]}),o.jsx(kt,{style:{gap:c},children:e.map(A=>o.jsxs(It,{remark:Boolean(A.remark),children:[i?o.jsxs(ge,{children:[o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(xe,{children:A.notes.map(x=>o.jsx("li",{children:x},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}):o.jsxs(ge,{children:[A.img&&o.jsx(Lt,{src:A.img,alt:A.description}),o.jsx(Et,{children:A.quantity}),o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(xe,{children:A.notes.map(x=>o.jsx("li",{children:x},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}),o.jsxs(Tt,{remark:Boolean(A.remark),children:[A.currency," ",A.amount.toFixed(2)]})]},crypto.randomUUID()))}),l]}),Nt=a.default.div`
  background-color: white;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,Pt=a.default.span`
  ...
  font-weight: 500;
  line-height: 1em;
`,Yt=({name:e,lastName:t,idNumber:r,img:n,otherSections:i=[]})=>o.jsxs(Ft,{children:[o.jsx(Bt,{children:o.jsx(ie,{img:n,initials:t?`${e.charAt(0)}${t.charAt(0)}`:e.charAt(0)})}),o.jsxs("div",{children:[o.jsxs(Ut,{children:[r&&o.jsxs("span",{children:[o.jsx(jt,{}),r]}),i.map(l=>o.jsx("span",{children:l}))]}),o.jsxs(Pt,{children:[e," ",t]})]})]}),Qt=()=>o.jsx("svg",{width:22,height:22,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11 2a9 9 0 1 0 0 18 9 9 0 0 0 0-18ZM.5 11C.5 5.201 5.201.5 11 .5S21.5 5.201 21.5 11 16.799 21.5 11 21.5.5 16.799.5 11Zm6.173-4.28a.75.75 0 0 1 1.06 0L11 9.986l3.266-3.266a.75.75 0 1 1 1.06 1.06l-3.265 3.267 3.266 3.266a.75.75 0 0 1-1.06 1.06L11 12.108l-3.266 3.267a.75.75 0 1 1-1.061-1.061l3.266-3.266L6.673 7.78a.75.75 0 0 1 0-1.06Z",fill:"#F25A50"})}),Ot=()=>o.jsxs("svg",{width:20,height:20,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("path",{d:"m9.046 11.153 1.26-1.32c.743-.776 1.485-1.553 2.228-2.327.267-.28.614-.309.878-.081a.667.667 0 0 1 .112.87c-.041.06-.092.114-.142.167l-3.818 3.992c-.35.364-.688.365-1.035.002-.65-.68-1.302-1.36-1.95-2.042-.295-.31-.284-.738.017-.996a.585.585 0 0 1 .766-.01c.095.078.178.17.263.259l1.421 1.486Z",fill:"#2DC96F"}),o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M10 18.5a8.5 8.5 0 1 0 0-17 8.5 8.5 0 0 0 0 17Zm0 1.5c5.523 0 10-4.477 10-10S15.523 0 10 0 0 4.477 0 10s4.477 10 10 10Z",fill:"#2DC96F"})]}),Zt=({color:e="#6192EB"})=>o.jsxs("svg",{width:20,height:20,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M8.393 1.005A1.815 1.815 0 0 1 10 0c.671 0 1.288.386 1.607 1.005l8.146 15.836C20.486 18.27 19.498 20 17.95 20H2.05C.5 20-.487 18.269.248 16.841L8.393 1.005ZM10 1.429a.458.458 0 0 0-.405.253l-.597-.336.597.336-8.146 15.837c-.245.475.085 1.052.6 1.052H17.95c.517 0 .846-.577.6-1.053L10.406 1.682A.457.457 0 0 0 10 1.429Z",fill:e}),o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M10 6.3a.7.7 0 0 1 .7.7v6a.7.7 0 1 1-1.4 0V7a.7.7 0 0 1 .7-.7ZM10 14.3a.7.7 0 0 1 .7.7v1a.7.7 0 1 1-1.4 0v-1a.7.7 0 0 1 .7-.7Z",fill:e})]}),ue=({color:e="#F79E1B"})=>o.jsx("svg",{width:20,height:20,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M10 1.429a8.571 8.571 0 1 0 0 17.142A8.571 8.571 0 0 0 10 1.43ZM0 10C0 4.477 4.477 0 10 0s10 4.477 10 10-4.477 10-10 10S0 15.523 0 10Zm10-5.714c.395 0 .714.32.714.714v1.429a.714.714 0 0 1-1.428 0V5c0-.394.32-.714.714-.714Zm0 4.285c.395 0 .714.32.714.715V15a.714.714 0 1 1-1.428 0V9.286c0-.395.32-.715.714-.715Z",fill:e})}),Ht=e=>e==="success"?s.css`
...
`,Jt=a.default.span`
  ...
  text-decoration: underline;
  cursor: pointer;
`,Rt=({title:e="",description:t="",type:r,link:n,icon:i})=>{const l=()=>{if(i)return i;if(r==="success")return o.jsx(Ot,{});if(r==="warning")return o.jsx(ue,{});if(r==="error")return o.jsx(Qt,{});if(r==="blue")return o.jsx(Zt,{});if(r==="pink")return o.jsx(ue,{color:"#FF82AF"})};return o.jsxs(Wt,{toastType:r||"primary",children:[l(),o.jsxs("div",{children:[e&&o.jsx(Gt,{children:e}),t&&o.jsxs(Vt,{children:[t," ",n&&n.onClick&&o.jsx(Jt,{onClick:c=>{c.stopPropagation(),n.onClick&&n.onClick()},children:(n==null?void 0:n.text)||"Ver m\xE1s"})]})]})]})},be={xs:"(min-width: 360px)",sm:"(min-width: 591px)",md:"(min-width: 800px)",lg:"(min-width: 1400px)"},Xt=a.default.div`
  font-family: 'Poppins';
  font-style: normal;
  display: flex;
  align-items: center;
...
`,rr=({onClose:e=()=>{},backdropOpacity:t,zIndex:r})=>(b.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),o.jsx(tr,{onClick:n=>{n.stopPropagation(),e()},opacity:t,zIndex:r})),ve=s.keyframes`
  from {
...
`,ir=({children:e,onClose:t,backdropOpacity:r,zIndex:n,contentLocation:i="center",contentLocationInDesktop:l="center",boxShadow:c,boxShadowInDesktop:f,fullWidth:g})=>o.jsxs(o.Fragment,{children:[o.jsx(rr,{onClose:t,backdropOpacity:r,zIndex:n||4}),o.jsx(nr,{zIndex:n||4,contentLocation:i,contentLocationInDesktop:l,onClick:A=>A.stopPropagation(),boxShadow:c,boxShadowInDesktop:f,fullWidth:g,children:e})]}),ke=s.css`
  ::-webkit-scrollbar {
    width: 4px;
    height: 4px;
  }
...
`,F=({children:e,onClose:t,backdropOpacity:r,padding:n,borderRadius:i,borderRadiusInDesktop:l,maxHeight:c,height:f,maxWidth:g,width:A,zIndex:x,overflow:h,contentLocation:u="center",contentLocationInDesktop:w="center",closeIcon:C,closeIconInDesktop:I,background:m="#fff",boxShadow:M,boxShadowInDesktop:T})=>o.jsx(ir,{onClose:t,backdropOpacity:r,zIndex:x,contentLocation:u,contentLocationInDesktop:w,boxShadow:M,boxShadowInDesktop:T,children:o.jsxs(ar,{padding:n,borderRadius:i,borderRadiusInDesktop:l,maxHeight:c,height:f,maxWidth:g,width:A,background:m,overflow:h,contentLocation:u,contentLocationInDesktop:w,children:[(C||I)&&o.jsx(lr,{onClick:t,closeIconInDesktop:I,closeIcon:C,children:o.jsx(we,{})}),e]})}),dr=a.default.h2`
...
`,Ie=({onConfirm:e,onClose:t,zIndex:r,onlyIntegers:n,initialValue:i})=>{const l=b.useRef(null),[c,f]=b.useState(i||""),g=x=>{const h=x.target.value;let u=/^[0-9]\d*(\.(\d*))?$/;n&&(u=/^[0-9]*$/),!(h!==""&&!u.test(h))&&f(h)};b.useEffect(()=>{l.current.focus()},[]);const A=Number(c);return o.jsxs(F,{onClose:t,maxWidth:"350px",zIndex:r||6,children:[o.jsx(dr,{children:"Especifica la cantidad"}),o.jsxs(cr,{children:[o.jsx("input",{type:"text",inputMode:n?"numeric":"decimal",value:c,onChange:g,ref:l}),o.jsx(L,{design:"solid",size:"xs",onClick:()=>e(A),disabled:A<=0,children:"Agregar"})]})]})},Ee=e=>o.jsx(z,{viewBox:"0 0 12 12",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M4.86399 0.666504C4.21911 0.666504 3.69633 1.18928 3.69633 1.83416V2.1813H1.077C0.850426 2.1813 0.666748 2.36497 0.666748 2.59155C0.666748 2.81813 0.850426 3.00181 1.077 3.00181H1.80284V9.40812C1.80284 10.4713 2.66472 11.3332 3.72789 11.3332H8.27227C9.33545 11.3332 10.1973 10.4713 10.1973 9.40812V3.00181H10.9232C11.1497 3.00181 11.3334 2.81813 11.3334 2.59155C11.3334 2.36497 11.1497 2.1813 10.9232 2.1813H8.30383V1.83416C8.30383 1.18928 7.78105 0.666504 7.13618 0.666504H4.86399ZM4.51685 1.83416C4.51685 1.64244 4.67227 1.48702 4.86399 1.48702H7.13618C7.32789 1.48702 7.48332 1.64244 7.48332 1.83416V2.1813H4.51685V1.83416ZM2.62336 9.40812V3.00181H9.37681V9.40812C9.37681 10.0181 8.88229 10.5127 8.27227 10.5127H3.72789C3.11787 10.5127 2.62336 10.0181 2.62336 9.40812ZM6.00008 4.07479C5.7735 4.07479 5.58982 4.25847 5.58982 4.48504L5.58982 9.02942C5.58982 9.256 5.7735 9.43968 6.00008 9.43968C6.22666 9.43968 6.41034 9.256 6.41034 9.02942L6.41034 4.48504C6.41034 4.25847 6.22666 4.07479 6.00008 4.07479Z",fill:"currentColor"})}),sr=a.default.div`
  display: flex;
  justify-content: center;
`,Ar=a.default.span`
...
`,Te=({value:e,onSetQuantity:t,onDelete:r,minimumQuantity:n=1,measureUnit:i,onlyIntegers:l,blockInputModal:c,disabled:f,hasError:g,variant:A,renderModal:x,zIndex:h,style:u,noDecrement:w,noIncrement:C})=>{const[I,m]=b.useState(!1),M=Number(e||0),T=e===null||M<=n,y=v=>{v.stopPropagation();const k=M%1!==0?Math.ceil(M):M+1;t(k)},S=v=>{if(v.stopPropagation(),T){r&&r();return}const k=M%1>0?Math.floor(M):M-1;t(k)},B=v=>{const k=l?Math.round(v):v;t(k<=n?n:k),m(!1)};return o.jsxs(o.Fragment,{children:[o.jsx(sr,{children:o.jsxs(pr,{isDisabled:f,onClick:()=>{c||f||m(!0)},minQuantity:T,canDelete:!!r,variant:A,error:g,style:u,children:[!w&&o.jsx("button",{disabled:f,onClick:S,children:T&&r?o.jsx(fr,{children:o.jsx(Ee,{color:d.color.ALERT[900]})}):"-"}),o.jsx(Ar,{children:`${e===null?"-":e} ${e!==null&&i||""}`}),!C&&o.jsx("button",{onClick:y,disabled:f,children:"+"})]})}),I&&!c&&(x?x(o.jsx(Ie,{onClose:()=>m(!1),onConfirm:B,initialValue:e?e.toString():"",onlyIntegers:l,zIndex:h})):o.jsx(Ie,{onClose:()=>m(!1),onConfirm:B,initialValue:e?e.toString():"",onlyIntegers:l,zIndex:h}))]})},hr=e=>o.jsx(z,{viewBox:"0 0 15 9",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M0.692211 1.06721C0.948493 0.81093 1.36401 0.81093 1.62029 1.06721L7.28125 6.72817L12.9422 1.06721C13.1985 0.81093 13.614 0.81093 13.8703 1.06721C14.1266 1.32349 14.1266 1.73901 13.8703 1.99529L7.74529 8.12029C7.48901 8.37657 7.07349 8.37657 6.81721 8.12029L0.692211 1.99529C0.43593 1.73901 0.43593 1.32349 0.692211 1.06721Z",fill:"currentColor"})}),gr=a.default.div`
  background-color: white;
...
`,Ir=a.default.div`
  ...
  justify-content: space-between;
  align-items: center;
`,Er=({img:e,name:t,currencySymbol:r,total:n,unitPrice:i,quantity:l,comment:c,onClick:f,onChangeQuantity:g,onDeleteProduct:A,onChangeComment:x,discount:h,measureUnit:u,productDetails:w,renderModal:C,onlyIntegers:I})=>{const[m,M]=b.useState(!0),T=u||"u.";return o.jsxs(gr,{children:[o.jsxs(xr,{onClick:f||(()=>{}),canClick:!!f,children:[(e==null?void 0:e.src)&&o.jsx(ur,{...e}),o.jsxs(br,{children:[o.jsxs(wr,{detailsActive:m,children:[t,o.jsx(hr,{size:16,onClick:y=>{y.stopPropagation(),M(S=>!S)}})]}),h&&o.jsx(vr,{children:h.label}),o.jsxs(Cr,{children:[h&&o.jsxs(Mr,{children:["-",r,h.discountedAmount.toFixed(2)]}),o.jsxs(Le,{children:[r,o.jsx("span",{children:n.toFixed(2)})]})]})]})]}),m&&o.jsxs("div",{children:[o.jsx(mr,{value:c,onChange:y=>x(y.target.value),placeholder:"Agregar alg\xFAn comentario"}),w&&o.jsx(kr,{children:w})]}),o.jsxs(Ir,{children:[o.jsxs(Le,{children:[r,o.jsx("span",{children:i.toFixed(2)})," x ",T]}),o.jsx(Te,{value:l,onSetQuantity:g,measureUnit:T,onDelete:A,renderModal:C,onlyIntegers:I})]})]})},Tr=a.default.div`
  padding-right: 5px;
...
`,Dr=a.default.span`
  ...
  font-size: 10px;
  font-weight: 700;
`,De=({currencySymbol:e,unitPrice:t,total:r,measureUnit:n,discount:i,disabled:l,bottom:c})=>{const f=n||"u.";return o.jsxs(Tr,{disabled:l,bottom:c,children:[o.jsxs("span",{children:[e,t.toFixed(2)," x ",f]}),o.jsxs(Lr,{disabled:l,children:[i&&o.jsxs(o.Fragment,{children:[o.jsxs("span",{children:[e,i.prevTotal.toFixed(2)]}),o.jsx(Dr,{children:i.label})]}),o.jsxs("span",{children:[e,o.jsx("span",{children:r.toFixed(2)})]})]})]})},Nr=a.default.div`
...
`,jr=a.default.div`
  ...
  margin-top: 8px;
  font-size: 12px;
`,Fr=({name:e,img:t,quantity:r,currencySymbol:n,unitPrice:i,total:l,productDetails:c,discount:f,measureUnit:g,disabled:A})=>o.jsxs(Nr,{disabled:A,hasDetails:!!c,children:[o.jsxs(yr,{children:[(t==null?void 0:t.src)&&o.jsx("img",{...t}),o.jsxs(zr,{hasDetails:!!c,children:[o.jsxs(Sr,{disabled:A,children:[o.jsx(ce,{opacity:.4,children:r}),e]}),c&&o.jsx(jr,{children:c}),!c&&o.jsx(De,{currencySymbol:n,unitPrice:i,total:l,discount:f,disabled:A})]})]}),c&&o.jsx(De,{currencySymbol:n,unitPrice:i,total:l,discount:f,disabled:A,bottom:!0})]}),Br=a.default.div`
  padding: 20px;
...
`;function Kr(e="(min-width: 768px)"){const[t,r]=b.useState({matches:window.innerWidth>(()=>{const i=e.match(/(\d+)/);return i?i[0]:768})()});return b.useEffect(()=>{let i=window.matchMedia(e);return i.addEventListener("change",r),()=>i.removeEventListener("change",r)},[]),{status:Boolean(t&&t.matches)}}const qr=({children:e,note:t="Esta acci\xF3n no se puede revertir.",btnLeft:r={onClick:()=>{},text:"Cancelar"},btnRight:n={onClick:()=>{},text:"Eliminar"}})=>{const{status:i}=Kr("(min-width: 1023px)");return o.jsxs(Wr,{children:[o.jsxs(Xr,{children:[o.jsxs(Gr,{children:[o.jsx(Rr,{children:e}),o.jsx(Vr,{children:t})]}),o.jsxs(Jr,{children:[i&&o.jsx(L,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{borderRadius:"32px",padding:"20px 0"},children:r.text}),o.jsx(L,{design:"solid",fullWidth:!0,onClick:()=>n.onClick(),style:{borderRadius:"32px",padding:"20px 60px"},children:n.text})]})]}),!i&&o.jsx(L,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{margin:"0 15px 15px",width:"calc(100% - 30px)",padding:"20px",borderRadius:"15px"},children:r.text})]})},$r=a.default.div`
  background: transparent;
  color: #383838;
  border-radius: 20px;
  font-weight: 500;
...
`,Ne=a.default.div`
  ...
  ${({bottom:e})=>{if(e)return s.css`
      ...
      `}}
`,ye=({title:e,content:t,options:r,cancelOptions:n})=>o.jsxs($r,{children:[o.jsxs(_r,{children:[o.jsxs(e0,{children:[e&&o.jsx(o0,{children:e}),o.jsx(t0,{children:t})]}),r.length>0&&o.jsx(Ne,{children:r.map((i,l)=>o.jsx(L,{design:"solid",shape:"circular",size:"xs",fullWidth:!0,onClick:i.onClick,disabled:i.disabled,color:i.type==="primary"?"SECONDARY/900":"QUATERNARY/200",fontColor:i.type==="primary"?"SECONDARY/0":"SECONDARY/900",style:{gap:0},children:i.content},`confirmation-option-${l}`))})]}),n.length>0&&o.jsx(Ne,{bottom:!0,children:n.map((i,l)=>o.jsx(L,{design:"flat",size:"xs",fullWidth:!0,onClick:i.onClick,disabled:i.disabled,color:"PRIMARY/900",style:{gap:0},children:i.content},`cancel-option-${l}`))})]}),r0=({color:e="#4318FF"})=>o.jsxs("svg",{width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M22.53 3.47a.75.75 0 0 1 0 1.06l-10 10a.75.75 0 0 1-1.06 0l-3-3a.75.75 0 1 1 1.06-1.06L12 12.94l9.47-9.47a.75.75 0 0 1 1.06 0Z",fill:e}),o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5 3.75A1.25 1.25 0 0 0 3.75 5v14A1.25 1.25 0 0 0 5 20.25h14A1.25 1.25 0 0 0 20.25 19v-7a.75.75 0 0 1 1.5 0v7A2.75 2.75 0 0 1 19 21.75H5A2.75 2.75 0 0 1 2.25 19V5A2.75 2.75 0 0 1 5 2.25h11a.75.75 0 0 1 0 1.5H5Z",fill:e})]}),n0=({color:e="#4318FF"})=>o.jsx("svg",{width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5 3.75c-.69 0-1.25.56-1.25 1.25v14c0 .69.56 1.25 1.25 1.25h14c.69 0 1.25-.56 1.25-1.25V5c0-.69-.56-1.25-1.25-1.25H5ZM2.25 5A2.75 2.75 0 0 1 5 2.25h14A2.75 2.75 0 0 1 21.75 5v14A2.75 2.75 0 0 1 19 21.75H5A2.75 2.75 0 0 1 2.25 19V5Z",fill:e})}),i0=a.default.label`
  display: flex;
  gap: 9px;
  font-weight: 500;
  font-size: 0.8125rem;
...
`,a0=({children:e,value:t="value",callbackOnChange:r=()=>{},disabled:n=!1,...i})=>{const[l,c]=b.useState(!1);return b.useEffect(()=>{i.checked&&c(i.checked)},[]),o.jsxs(i0,{disabled:n,children:[o.jsx("input",{type:"checkbox",value:t,disabled:n,onChange:f=>{r(f.target.value,l&&!n),c(!l)},...i}),o.jsx("span",{children:l?o.jsx(r0,{color:n?"gray":"#4318FF"}):o.jsx(n0,{color:n?"gray":"#4318FF"})}),e]})},l0=a.default.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 9px;
...
`,d0=({text:e,...t})=>o.jsxs(l0,{disabled:Boolean(t.disabled),children:[o.jsx("input",{type:"radio",...t}),o.jsx("label",{htmlFor:t==null?void 0:t.id,children:e})]}),c0=a.default.div`
  background-color: white;
...
`;a.default.div`
  ...
  bottom: 0;
  left: 0;
`;const A0=({options:e,selected:t,disabled:r,onSelect:n,fullWidth:i,model:l})=>o.jsx(c0,{disabled:r,onClick:c=>{r&&c.stopPropagation()},model:l,fullWidth:i,children:e.map(c=>o.jsx(s0,{onClick:()=>n(c.value),active:c.value===t,disabled:r,model:l,children:c.label},c.value))}),f0=a.default.div`
...
`,h0=a.default.span`
  ...
  line-height: 1.25rem;
  color: ${d.color.PRIMARY[900]};
`,g0=({description:e,defaultValue:t,value:r,onChange:n=()=>{},placeholder:i,suffix:l,disabled:c,readingMode:f})=>o.jsxs(f0,{disabled:c,withDescription:Boolean(e),readingMode:f,children:[e&&o.jsx(p0,{children:e}),f?o.jsxs(ze,{readingMode:f,children:[o.jsx(h0,{children:t}),l&&!c&&o.jsx(Se,{children:l})]}):o.jsxs(ze,{children:[o.jsx("input",{type:"text",placeholder:i,disabled:c,onChange:g=>n(g.target.value),value:r}),l&&!c&&o.jsx(Se,{children:l})]})]}),x0=a.default.div`
...
`,je=o.jsx("div",{style:{display:"inline-block"},children:o.jsx(H,{width:"20px",height:"20px"})}),v0=({options:e,onClose:t,contentLocation:r,contentLocationInDesktop:n,defaultDescription:i="",defaultTitle:l="",optionsInCenter:c=!1,direction:f="row",iconOrientation:g="horizontal"})=>{const[A,x]=b.useState(null),h=b.useMemo(()=>{if(A===null)return null;const u=e[A];if(u&&"options"in u)return u},[A,e]);return o.jsx(F,{maxWidth:"500px",padding:"20px 0",onClose:t,contentLocation:r||"bottom",contentLocationInDesktop:n||"center",closeIcon:!0,children:o.jsxs(x0,{children:[o.jsxs(b0,{children:[o.jsxs(u0,{children:[h&&o.jsx(j,{onClick:()=>x(null)}),o.jsx(E,{as:"h2",size:"md",children:(h==null?void 0:h.text)||l})]}),i.length>0&&o.jsx(E,{color:"NEUTRAL/400",size:"sm",weight:"regular",children:(h==null?void 0:h.description)||i})]}),o.jsxs(w0,{direction:f,children:[!h&&e.map((u,w)=>"onClick"in u?o.jsxs(G,{alert:u.alert,disabled:u.disabled||u.loading,onClick:()=>{!u.loading&&!u.disabled&&(u.onClick(),t())},optionsInCenter:c,iconOrientation:g,children:[o.jsx("span",{children:u.text}),u.loading?je:u.icon]},`option-${w}`):o.jsxs(G,{onClick:()=>{x(w)},optionsInCenter:c,children:[u.text," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(j,{})})]},`option-${w}`)),h==null?void 0:h.options.map((u,w)=>o.jsxs(G,{alert:u.alert,disabled:u.disabled||u.loading,onClick:()=>{!u.loading&&!u.disabled&&u.onClick()},optionsInCenter:c,children:[u.text," ",u.loading?je:u.icon]},`suboption-${w}`))]})]})})},C0=({cardProps:e,...t})=>o.jsx(F,{background:"transparent",boxShadowInDesktop:"none",padding:"0 10px",contentLocation:"bottom",maxWidth:"650px",...e,children:o.jsx(ye,{...t})}),M0=(e,t=1024*8)=>{let r=!0,n=null;return e.size/1024>t&&(r=!1,n={code:"F0001",message:`El archivo ${e.name} pesa ${(e.size/1024/1024).toFixed(2)} MB. Intenta subir una imagen menor a ${t/1024} MB `}),{success:r,error:n}},V=({onSelectFile:e,maxKBSize:t,onError:r=()=>{},acceptedFiles:n,validFileExtensions:i,children:l,style:c})=>{const f=b.useRef(null),g=()=>f.current.click(),A=()=>{const w=f.current.files[0];u(w)},x=w=>{w.stopPropagation(),w.preventDefault();const C=w.dataTransfer.files[0];u(C)},h=w=>i?new RegExp(`${i.join("|")}$`,"i").exec(w.toLowerCase()):!0,u=w=>{var I;if(!w)return;if(!h(w.name)){r("Tipo de archivo no permitido");return}const C=M0(w,t);if(!C.success){r((I=C.error)==null?void 0:I.message);return}e(w)};return o.jsxs("div",{onClick:g,onDragOver:w=>w.preventDefault(),onDrop:x,style:c,children:[l,o.jsx("input",{ref:f,style:{display:"none"},onChange:A,type:"file",accept:n})]})},Fe=()=>{const e=b.useRef(!0);return b.useEffect(()=>{e.current=!1},[]),e.current},Be=a.default.button`
...
`,D0=({initialImgUrl:e,placeholder:t,onChange:r,onError:n})=>{const[i,l]=b.useState(null),[c,f]=b.useState(e||null),g=Fe();return b.useEffect(()=>{let A="";return i&&(A=window.URL.createObjectURL(i),f(A)),()=>{A&&window.URL.revokeObjectURL(A)}},[i]),b.useEffect(()=>{g||r(i,c||null)},[c]),o.jsx(V,{onError:n||alert,onSelectFile:A=>l(A),acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:c?o.jsxs(E0,{children:[o.jsxs(T0,{children:[o.jsx("img",{src:c}),o.jsxs(L0,{children:[o.jsx("span",{children:(i==null?void 0:i.name)||Ue(c)[0]}),o.jsx("span",{children:(i==null?void 0:i.type)||Ue(c)[1]})]})]}),o.jsx(Be,{variant:"secondary",onClick:A=>{A.stopPropagation(),l(null),f(null)},children:o.jsx(m0,{size:12})})]}):o.jsx(k0,{children:t||o.jsxs(I0,{children:[o.jsx(Pe,{color:d.color.SECONDARY[900],size:18})," Sube un imagen ",o.jsx("span",{children:"aqu\xED"})]})})})},Ye=a.default.div`
  width: 55px;
  height: 55px;
  border-radius: 7px;
`,N0=a.default.div`
...
`,S0=a.default.div`
  ...
  right: 0;
  bottom: 0;
`,j0=({onChange:e,initialImages:t,limit:r})=>{const[n,i]=b.useState(t||[]),[l,c]=b.useState(null),f=Fe(),g=x=>{const h=window.URL.createObjectURL(x);i(u=>[...u,{file:x,url:h}])},A=x=>{const h=n[x];typeof h!="string"&&window.URL.revokeObjectURL(h.url),i(u=>u.filter((w,C)=>C!==x))};return b.useEffect(()=>{f||e(n)},[n]),o.jsxs(N0,{children:[n.map((x,h)=>o.jsxs(y0,{onMouseEnter:()=>c(h),onMouseLeave:()=>c(null),onTouchCancel:()=>c(null),children:[o.jsx("img",{src:typeof x=="string"?x:x.url}),l===h&&o.jsx(S0,{onClick:()=>A(h),children:o.jsx(Ee,{size:16})})]},`imgs-${h}`)),!(r&&n.length>=r)&&o.jsx(V,{onError:alert,onSelectFile:g,acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:o.jsx(z0,{children:o.jsx(Pe,{})})})]})},F0=a.default.div`
  display: grid;
...
`,B0=a.default.div`
  overflow-x: auto;
  ${ke}
`,U0=({gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:l,header:c,body:f})=>o.jsx(B0,{children:o.jsxs(F0,{gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:l,children:[c&&c,f&&f]})}),P0=s.css`
  background: none;
  outline: none;
  border: none;
  padding: none;
...
`,O0=a.default.button`
  ...
  ${({isLoading:e})=>q({isLoading:e})};
  ${({disabled:e})=>Y({disabled:e})};
`,Z0=({container:e,options:t,closeIcon:r})=>{var n;return o.jsxs(Y0,{marginBottom:e==null?void 0:e.marginBottom,isSticky:e==null?void 0:e.isSticky,zIndex:e==null?void 0:e.zIndex,children:[r!=null&&r.hide?o.jsx("div",{}):o.jsx(Be,{style:{marginLeft:(r==null?void 0:r.marginLeft)||"20px"},children:o.jsx(we,{})}),o.jsx(Q0,{minWidthForOptions:t.minWidth,paddingForOptions:t.padding,children:(n=t==null?void 0:t.options)==null?void 0:n.map((i,l)=>o.jsx(O0,{onClick:i.onClick,type:"button",mode:i.mode,disabled:i.disabled,children:i.text},`${l}${i.id}`))})]})},H0=a.default.div`
  display: flex;
  gap: ${({gap:e})=>e||"15px"};
  align-items: center;
  justify-content: center;
  ...
  left: 0;
  z-index: ${({zIndex:e})=>e||"5"};
`,W0=({description:e,buttons:t,container:r})=>o.jsxs(H0,{padding:r==null?void 0:r.padding,gap:r==null?void 0:r.gap,marginTop:r==null?void 0:r.marginTop,isFixed:r==null?void 0:r.isFixed,zIndex:r==null?void 0:r.zIndex,boxShadow:r==null?void 0:r.boxShadow,children:[e&&o.jsx("div",{children:e}),t==null?void 0:t.map(n=>o.jsx(L,{...n},crypto.randomUUID()))]});p.Badge=rt,p.Button=L,p.ButtonsSwitch=A0,p.Card=xt,p.CardModal=F,p.CartProduct=Er,p.Checkbox=a0,p.ClientCard=Yt,p.CodeInput=so,p.Collapsible=Uo,p.ConfirmationCard=Hr,p.ConfirmationCardV2=qr,p.ConfirmationCardV3=ye,p.ConfirmationModalV3=C0,p.CurrentStatusCard=wt,p.CustomSelect=re,p.DropdownMenu=Jo,p.EditQuantityInput=Te,p.GridTable=U0,p.Heading=io,p.IDCard=or,p.IconV2=z,p.Loader=No,p.ModalHeader=Z0,p.MultipleOptionsModal=v0,p.NoData=qo,p.OrderStatusBadge=le,p.OrderTypeBanner=dt,p.ProductDetailsCard=Fr,p.ProfileImage=Eo,p.Radio=d0,p.SectionCard=St,p.SelectField=po,p.SimpleFooter=W0,p.StatusBanner=ht,p.StickyHeader=Yo,p.SupplyInput=g0,p.Text=E,p.TextField=ee,p.ToastCard=Rt,p.TotalsCard=Dt,p.TransparentBadge=ce,p.UploadFileContainer=V,p.UploadImage=D0,p.UploadMultipleImages=j0,p.UserProfileIcon=ie,Object.defineProperties(p,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
