...
`,ro=a.default(to)`
  ...
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:h,pt:A,pr:x,pl:g,py:u,px:w})=>_({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:h,pt:A,pr:x,pl:g,py:u,px:w})};
...
`,D=({children:e,...t})=>o.jsxs(ro,{...t,children:[t.leftIcon,e,t.rightIcon]});function no(e,t,r){const n=()=>{const i=document.querySelectorAll("input");return Array.from(i).filter(c=>c.className===t)};b.useEffect(()=>{const i=l=>{l.key==="Backspace"&&setTimeout(()=>{const c=n(),f=document.activeElement;f.value="";const h=c.indexOf(f);h>0&&c[h-1].focus()},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),b.useEffect(()=>{const i=l=>{if(l.key!=="Backspace"){const c=l.key.toLowerCase();setTimeout(()=>{if(c.length===1){const f=n(),h=document.activeElement;h.value=c;const A=f.indexOf(h);A<f.length-1&&f[A+1].focus()}},0)}};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),b.useEffect(()=>{if(e){const i=l=>{const c=l.key.toLowerCase();(c.length===1||c==="backspace")&&setTimeout(()=>{const h=n().map(A=>A.value).join("");e(h)},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)}},[]),b.useEffect(()=>{if(r){const i=n(),l=i.map(h=>h.value),c=r.split(""),f=c.length===l.length?c:l;i.forEach((h,A)=>{const x=f[A];x&&(h.value=x)})}},[r])}const io=s.keyframes`
  0% {
    opacity: 0;
...
`,O=a.default.div`
  ...
  ${({shouldAppear:e})=>e&&s.css`
      animation: ${io} 0.2s ease-in;
      animation-fill-mode: forwards;
    `}
`,ao={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},lo=s.css`
  ...
  ${({align:e})=>oo({align:e})}
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:h,pt:A,pr:x,pl:g,py:u,px:w})=>_({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:c,p:f,pb:h,pt:A,pr:x,pl:g,py:u,px:w})};
`,co=e=>{const t=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",r=t?"bold":"medium",n=t?K[e]:K.text,i="PRIMARY/900";return s.css`
    font-weight: ${({weight:l=r})=>$e[l]||"500"};
    font-size: ${({size:l=n})=>X[l]||l};
    color: ${({color:l=i})=>{const c=l==null?void 0:l.split("/")[0],f=Number(l==null?void 0:l.split("/")[1]);return d.color[c][f]}};
  `},so=a.default.div`
  ${lo}
  ${({as:e})=>co(e)}
`,S=({as:e,...t})=>{const r=ao[e];return o.jsx(so,{as:r,...t})},Ao={H1:e=>o.jsx(S,{as:"h1",...e}),H2:e=>o.jsx(S,{as:"h2",...e}),H3:e=>o.jsx(S,{as:"h3",...e}),H4:e=>o.jsx(S,{as:"h4",...e}),H5:e=>o.jsx(S,{as:"h5",...e}),H6:e=>o.jsx(S,{as:"h6",...e})},fo=a.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
  transition: 0.3s ease-out;
`,E=e=>e.rightIcon||e.leftIcon?o.jsxs(fo,{children:[e.leftIcon,o.jsx(S,{as:e.as||"p",...e}),e.rightIcon]}):o.jsx(S,{as:e.as||"p",...e}),po=a.default.div`
  display: grid;
...
`,ho=a.default.div`
  ...
  gap: 10px;
`,go=({id:e,value:t,length:r=4,errorMessage:n,success:i,onChange:l=()=>{},...c})=>(no(l,e,t),o.jsxs(ho,{children:[o.jsx(po,{length:r,success:i,errorMessage:n,children:Array.from({length:r}).map((f,h)=>o.jsx("input",{id:h.toString(),className:e,maxLength:1,...c},h))}),n&&o.jsx(O,{shouldAppear:Boolean(n),children:o.jsx(E,{size:"xs",weight:"light",color:"ALERT/900",children:n})})]})),xo=a.default.div`
  position: relative;
  width: 100%;
...
`,uo={control:(e,t)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${t.isFocused?d.color.QUATERNARY[900]:d.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:d.color.PRIMARY[900],fontWeight:500,fontSize:"14px"}),placeholder:e=>({...e,color:d.color.NEUTRAL[700]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"3px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"6px"})},bo=({formatOptionLabel:e,options:t,loading:r=!1,style:n,error:i,firstOption:l,initialValue:c,value:f,onChange:h,isMulti:A,placeholder:x,label:g})=>{const u=l||{label:"Seleccione una opci\xF3n",value:""},w=[...t];return o.jsxs(xo,{style:n,hasError:!!i,children:[g&&o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:g}),r?o.jsx(Ke.default,{style:{borderRadius:10},className:"loading-skeleton",height:46,width:"100%"}):o.jsx(qe.default,{placeholder:x,value:f||void 0,defaultValue:c||u,options:w,onChange:h,styles:uo,isMulti:A,formatOptionLabel:e})]})},wo=a.default.div`
  width: ${e=>e.size}px;
  height: ${e=>e.size}px;
  position: relative;
  &::before {
...
`,Z=b.forwardRef(({type:e,leftAddon:t,rightAddon:r,placeholder:n,error:i,success:l,size:c,fullWidth:f,name:h,infoMessage:A,onFocus:x,onBlur:g,onChange:u,...w},C)=>{const[I,m]=b.useState(!1),M=!i&&!l&&A&&I;return o.jsxs(o.Fragment,{children:[o.jsxs(Io,{fullWidth:f,success:l,size:c,error:i,disabled:w.disabled,leftAddon:t,rightAddon:r,isFocused:I,children:[t&&o.jsx("span",{className:"leftAddon",children:t}),o.jsx("input",{ref:C,onFocus:T=>{x&&x(T),m(!0)},onBlur:T=>{g&&g(T),m(!1)},onChange:u,placeholder:n,type:e,name:h,...w}),r&&o.jsx("span",{className:"rightAddon",children:r}),i&&o.jsx("span",{className:"state",children:o.jsx(mo,{size:24,color:d.color.ALERT[900]})}),l&&o.jsx("span",{className:"state",children:o.jsx(ko,{size:20,color:d.color.SUCCESS[900]})})]}),M&&o.jsx(O,{shouldAppear:M,children:o.jsx(E,{size:"xs",color:"QUATERNARY/900",children:A})})]})});Z.displayName="TextInput";const Eo=a.default.div`
...
`,oe=b.forwardRef(({label:e,type:t,error:r,isDirty:n,success:i,infoMessage:l,fullWidth:c,...f},h)=>{const A={...f,ref:h},[x,g]=b.useState(!1);return o.jsxs(Eo,{fullWidth:c,children:[e&&o.jsxs("div",{className:"label-container",children:[o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:e}),t==="password"&&o.jsx("span",{onClick:()=>g(!x),children:x?o.jsx(Mo,{size:20}):o.jsx(Co,{size:20})})]}),o.jsx(Z,{error:Boolean(r),success:i||!r&&n,infoMessage:l,fullWidth:c,type:x?"text":t,...A}),r&&o.jsx(O,{shouldAppear:Boolean(r),children:o.jsx(E,{size:"xs",color:"ALERT/900",children:r})})]})});oe.displayName="TextField";const te=(e,t)=>{b.useEffect(()=>{const r=n=>{if(Array.isArray(e)){for(const i of e)if(!n.target||!i.current||i.current.contains(n.target))return}else if(!n.target||!e.current||e.current.contains(n.target))return;t(n)};return document.addEventListener("mousedown",r),document.addEventListener("touchstart",r),()=>{document.removeEventListener("mousedown",r),document.removeEventListener("touchstart",r)}},[e,t])},re=e=>o.jsx("svg",{height:e.size||16,width:e.size||16,fill:"none",viewBox:"0 0 16 16",...e,children:o.jsx("path",{d:"M12 5.333v2.534l-4 3.067-4-3.067V5.333L8 8.4l4-3.067Z",fill:"#6B6B6B"})}),To=e=>o.jsx("svg",{height:13,width:14,fill:"none",viewBox:"0 0 14 13",...e,children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5.821 1.606a4.715 4.715 0 1 0 0 9.43 4.715 4.715 0 0 0 0-9.43ZM.125 6.32A5.696 5.696 0 1 1 10.178 9.99l2.553 2.547a.49.49 0 0 1-.693.695l-2.553-2.55A5.696 5.696 0 0 1 .125 6.32Z",fill:"#242954"})}),Do=a.default.div`
  position: relative;
...
`,ne=b.forwardRef(({label:e,searchable:t=!0,autoSize:r,value:n,options:i,placeholder:l="Seleccione una opci\xF3n",fullWidth:c,fullWidthOptions:f,onChange:h,formatOptionLabel:A,formatSelectedOption:x})=>{const g=b.useRef(null),[u,w]=b.useState(i),[C,I]=b.useState(""),[m,M]=b.useState(!1);te(g,()=>{M(!1)});const T=b.useCallback(()=>{const v=i.filter(k=>k.label.toLowerCase().includes(C.toLowerCase()));w(v)},[i,n]),N=b.useCallback(v=>{h(i.find(k=>k.label===v)),M(!1),I(""),w(i)},[T]),z=b.useCallback(v=>{I(v.target.value);const k=i.filter(Ge=>Ge.label.toLowerCase().includes(v.target.value.toLowerCase()));w(k)},[]),B=()=>{const v=g.current;if(v){const k=v.getBoundingClientRect();return window.innerHeight-k.bottom-20}};return o.jsxs(Do,{fullWidth:c,ref:g,children:[e&&o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),o.jsxs("div",{className:"select-btn",onClick:()=>M(!m),tabIndex:0,onKeyUpCapture:v=>{v.key==="Enter"&&M(!m)},children:[o.jsx(E,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:x?x(n):A?A(n):n.label}),o.jsx(re,{size:20})]}),m&&o.jsxs(Lo,{maxOptionsHeight:r?B():285,fullWidthOptions:f,children:[t&&o.jsx("div",{className:"search-box",children:o.jsx(Z,{leftAddon:o.jsx(To,{}),type:"text",placeholder:l,value:C,onChange:z,fullWidth:!0})}),o.jsx("div",{className:"options",children:u.map(v=>o.jsx(E,{as:"li",color:"NEUTRAL/700",className:v.value===n.value?"selected":"",tabIndex:0,onClick:()=>N(v.label),onKeyUpCapture:k=>{k.key==="Enter"&&N(v.label)},children:A?A(v):v.label},`${v.label}-${v.value}`))})]})]})});ne.displayName="CustomSelect";const No=a.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,So=({imageUrl:e,size:t=128,onChange:r})=>{const n=b.useRef(null),i=l=>{var f;const c=(f=l.target.files)==null?void 0:f[0];if(c){const h=URL.createObjectURL(c);r({file:c,url:h})}};return o.jsxs(No,{size:t,children:[o.jsx(E,{color:"NEUTRAL/400",weight:"regular",size:"xs",children:"Agrega tu foto"}),o.jsxs("div",{className:"profile-input__container",children:[o.jsx("input",{type:"file",accept:"image/png, image/jpeg",onChange:i,ref:n}),o.jsx("img",{width:t,height:t,src:e||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"}),o.jsx(D,{type:"button",size:"lg",design:"flat",shape:"circular",onClick:()=>{var l;return(l=n.current)==null?void 0:l.click()},children:"+"})]})]})},yo=s.keyframes`
  0%,
  100% {
...
`,Wo=({onBack:e,backLabel:t,profileImageUrl:r,rightContent:n})=>o.jsxs(Ho,{children:[o.jsxs("button",{type:"button",onClick:e,children:[o.jsx(j,{}),o.jsx(E,{color:"NEUTRAL/900",children:t})]}),n||o.jsx("img",{width:28,height:28,src:r||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"})]}),Go=s.keyframes`
  100% {
    transform: rotate(360deg);
  }
`,Vo=a.default.div`
...
`,H=e=>o.jsx(Vo,{width:e.width,height:e.height,borderWidth:e.borderWidth,margin:e.margin}),ie=a.default.ul`
...
`,Jo=a.default.div`
  ...
  top: 0;
  right: calc(100% + 8px);
`,Xo=({text:e,options:t})=>{const[r,n]=b.useState(!1),i=b.useRef(null),l=c=>{if(i.current&&clearTimeout(i.current),c){n(!0);return}i.current=setTimeout(()=>{r!==c&&n(c)},50)};return o.jsxs(W,{onMouseEnter:()=>l(!0),onMouseLeave:()=>l(!1),active:r,onClick:c=>c.stopPropagation(),children:[e," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(j,{})}),r&&o.jsx(Jo,{children:o.jsx(ie,{children:t.map((c,f)=>o.jsxs(W,{alert:c.alert,onClick:h=>c.disabled||c.loading?h.stopPropagation():c.onClick(),disabled:c.disabled||c.loading,loading:c.loading,children:[c.text," ",c.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(H,{width:"20px",height:"20px"})}):c.icon]},`suboption-${f}`))})})]})},Ko=({options:e,header:t})=>o.jsxs(ie,{children:[t&&o.jsx(Ro,{children:t}),e.map((r,n)=>"options"in r?o.jsx(Xo,{...r},`option-${n}`):o.jsxs(W,{disabled:r.disabled||r.loading,alert:r.alert,onClick:r.disabled||r.loading?i=>i.stopPropagation():r.onClick,loading:r.loading,children:[r.text," ",r.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(H,{width:"20px",height:"20px"})}):r.icon]},`option-${n}`))]}),qo=a.default.div`
  display: flex;
  cursor: pointer;
  text-align: right;
  * {
...
`,$o=({options:e,activator:t,header:r})=>{const{x:n,y:i,reference:l,floating:c,strategy:f,update:h,refs:A}=J.useFloating({placement:"bottom-end"}),[x,g]=b.useState(!1);return b.useEffect(()=>{if(!(!A.reference.current||!A.floating.current))return J.autoUpdate(A.reference.current,A.floating.current,h)},[x,h]),te(A.reference,()=>{g(!1)}),o.jsxs("div",{ref:l,children:[o.jsx(qo,{onClick:()=>g(!x),children:t||o.jsx(re,{size:25})}),x&&o.jsx("div",{ref:c,style:{position:f,top:i!=null?i:0,left:n!=null?n:0,zIndex:100},onClick:()=>g(!x),children:o.jsx(Ko,{options:e,header:r})})]})},_o=a.default.div`
  text-align: center;
  font-weight: 300;
  font-size: 0.75rem;
...
`,ae=({img:e,size:t=36,initials:r})=>{const n=r.slice(0,2).toUpperCase();return o.jsx(nt,{hasImg:!(e!=null&&e.src),style:{width:`${t}px`,height:`${t}px`,fontSize:`${t/(r.length===1?2:2.25)}px`},children:e!=null&&e.src?o.jsx("img",{...e}):n})},it=a.default.span`
  ...
  ${({statusName:e,removeBackground:t})=>{if(e==="draft")return s.css`
      ...
      `}};
`,le={default:"...",draft:"Borrador",pending:"Pendiente",rejected:"Rechazado",accepted:"Aceptado",canceled:"Anulado",preparing:"Preparando",readyforpickup:"Listo para recojo",delivered:"Entregado",finished:"Finalizado"},de=({statusName:e,text:t,removeBackground:r})=>{const n=i=>le[i]||le.default;return o.jsx(it,{statusName:e,removeBackground:r,children:t||n(e)})},at=a.default.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
  font-size: 1em;
  display: inline-block;
  font-weight: bold;
`,ce=(e,t,r)=>e>=t&&e<=r?e:e<t?t:r,se=({intensity:e=.8,opacity:t=.5,children:r,style:n={},...i})=>{const l=ce(e,0,1),c=ce(t,0,1),f=256*l;return o.jsx(at,{style:{backgroundColor:`rgba(${f}, ${f}, ${f}, ${c})`,...n},...i,children:r})},lt=a.default.span`
...
${({withBorder:e,color:t})=>e&&s.css`
    ...
    `}
`,dt=({text:e,padding:t,color:r,background:n,applyFlex:i,maxWidth:l,weight:c,borderRadius:f,withBorder:h})=>o.jsx(lt,{padding:t,color:r,background:n,applyFlex:i,maxWidth:l,weigth:c,borderRadius:f,withBorder:h,children:e}),ct=a.default.div`
  min-height: 50px;
  display: flex;
  justify-content: center;
...
`,ge=a.default.span`
  color: #151E5A;
  font-weight: 500;
`,kt=({items:e,creationDescription:t,creationDate:r,title:n,children:i})=>o.jsxs(Mt,{children:[n&&o.jsx(mt,{children:n}),e.map(l=>o.jsxs("div",{children:[o.jsxs("p",{children:[l.description&&o.jsx("span",{children:l.description})," ",o.jsx(de,{statusName:l.statusName,removeBackground:!0})]}),o.jsx(ge,{children:l.statusDate})]},crypto.randomUUID())),r&&o.jsxs("div",{children:[t&&o.jsx("span",{children:t}),o.jsx(ge,{children:r})]}),i]}),It=a.default.div`
...
`,zt=a.default.img`
  ...
  font-size: 9px;
  object-fit: cover;
`,jt=({items:e,title:t="",onAction:r=()=>{},actionName:n="",hideQuantity:i=!1,children:l,gap:c=10,background:f,padding:h})=>o.jsxs(It,{background:f,padding:h,children:[(t||n)&&o.jsxs(Et,{children:[o.jsx(Tt,{children:t}),o.jsx(Dt,{onClick:()=>r(),children:n})]}),o.jsx(Lt,{style:{gap:c},children:e.map(A=>o.jsxs(Nt,{remark:Boolean(A.remark),children:[i?o.jsxs(xe,{children:[o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(ue,{children:A.notes.map(x=>o.jsx("li",{children:x},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}):o.jsxs(xe,{children:[A.img&&o.jsx(zt,{src:A.img,alt:A.description}),o.jsx(St,{children:A.quantity}),o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(ue,{children:A.notes.map(x=>o.jsx("li",{children:x},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}),o.jsxs(yt,{remark:Boolean(A.remark),children:[A.currency," ",A.amount.toFixed(2)]})]},crypto.randomUUID()))}),l]}),Ft=a.default.div`
  background-color: white;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,F=({show:e=!0,children:t,onClose:r,backdropOpacity:n,padding:i,borderRadius:l,borderRadiusInDesktop:c,maxHeight:f,height:h,maxWidth:A,width:x,zIndex:g,overflow:u,contentLocation:w="center",contentLocationInDesktop:C="center",closeIcon:I,closeIconInDesktop:m,background:M="#fff",boxShadow:T,boxShadowInDesktop:N})=>e?o.jsx(sr,{onClose:r,backdropOpacity:n,zIndex:g,contentLocation:w,contentLocationInDesktop:C,boxShadow:T,boxShadowInDesktop:N,children:o.jsxs(Ar,{padding:i,borderRadius:l,borderRadiusInDesktop:c,maxHeight:f,height:h,maxWidth:A,width:x,background:M,overflow:u,contentLocation:w,contentLocationInDesktop:C,children:[(I||m)&&o.jsx(fr,{onClick:r,closeIconInDesktop:m,closeIcon:I,children:o.jsx(ve,{})}),t]})}):null,pr=a.default.h2`
...
`,De=({value:e,onSetQuantity:t,onDelete:r,minimumQuantity:n=1,measureUnit:i,onlyIntegers:l,blockInputModal:c,disabled:f,hasError:h,variant:A,renderModal:x,zIndex:g,style:u,noDecrement:w,noIncrement:C})=>{const[I,m]=b.useState(!1),M=Number(e||0),T=e===null||M<=n,N=v=>{v.stopPropagation();const k=M%1!==0?Math.ceil(M):M+1;t(k)},z=v=>{if(v.stopPropagation(),T){r&&r();return}const k=M%1>0?Math.floor(M):M-1;t(k)},B=v=>{const k=l?Math.round(v):v;t(k<=n?n:k),m(!1)};return o.jsxs(o.Fragment,{children:[o.jsx(gr,{children:o.jsxs(br,{isDisabled:f,onClick:()=>{c||f||m(!0)},minQuantity:T,canDelete:!!r,variant:A,error:h,style:u,children:[!w&&o.jsx("button",{disabled:f,onClick:z,children:T&&r?o.jsx(ur,{children:o.jsx(Te,{color:d.color.ALERT[900]})}):"-"}),o.jsx(xr,{children:`${e===null?"-":e} ${e!==null&&i||""}`}),!C&&o.jsx("button",{onClick:N,disabled:f,children:"+"})]})}),I&&!c&&(x?x(o.jsx(Ee,{onClose:()=>m(!1),onConfirm:B,initialValue:e?e.toString():"",onlyIntegers:l,zIndex:g})):o.jsx(Ee,{onClose:()=>m(!1),onConfirm:B,initialValue:e?e.toString():"",onlyIntegers:l,zIndex:g}))]})},wr=e=>o.jsx(y,{viewBox:"0 0 15 9",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M0.692211 1.06721C0.948493 0.81093 1.36401 0.81093 1.62029 1.06721L7.28125 6.72817L12.9422 1.06721C13.1985 0.81093 13.614 0.81093 13.8703 1.06721C14.1266 1.32349 14.1266 1.73901 13.8703 1.99529L7.74529 8.12029C7.48901 8.37657 7.07349 8.37657 6.81721 8.12029L0.692211 1.99529C0.43593 1.73901 0.43593 1.32349 0.692211 1.06721Z",fill:"currentColor"})}),vr=a.default.div`
  background-color: white;
...
`,Nr=a.default.div`
  ...
  justify-content: space-between;
  align-items: center;
`,Sr=({img:e,name:t,currencySymbol:r,total:n,unitPrice:i,quantity:l,comment:c,onClick:f,onChangeQuantity:h,onDeleteProduct:A,onChangeComment:x,discount:g,measureUnit:u,productDetails:w,renderModal:C,onlyIntegers:I})=>{const[m,M]=b.useState(!0),T=u||"u.";return o.jsxs(vr,{children:[o.jsxs(Cr,{onClick:f||(()=>{}),canClick:!!f,children:[(e==null?void 0:e.src)&&o.jsx(Mr,{...e}),o.jsxs(mr,{children:[o.jsxs(kr,{detailsActive:m,children:[t,o.jsx(wr,{size:16,onClick:N=>{N.stopPropagation(),M(z=>!z)}})]}),g&&o.jsx(Ir,{children:g.label}),o.jsxs(Er,{children:[g&&o.jsxs(Tr,{children:["-",r,g.discountedAmount.toFixed(2)]}),o.jsxs(Le,{children:[r,o.jsx("span",{children:n.toFixed(2)})]})]})]})]}),m&&o.jsxs("div",{children:[o.jsx(Dr,{value:c,onChange:N=>x(N.target.value),placeholder:"Agregar alg\xFAn comentario"}),w&&o.jsx(Lr,{children:w})]}),o.jsxs(Nr,{children:[o.jsxs(Le,{children:[r,o.jsx("span",{children:i.toFixed(2)})," x ",T]}),o.jsx(De,{value:l,onSetQuantity:h,measureUnit:T,onDelete:A,renderModal:C,onlyIntegers:I})]})]})},yr=a.default.div`
  padding-right: 5px;
...
`,jr=a.default.span`
  ...
  font-size: 10px;
  font-weight: 700;
`,Ne=({currencySymbol:e,unitPrice:t,total:r,measureUnit:n,discount:i,disabled:l,bottom:c})=>{const f=n||"u.";return o.jsxs(yr,{disabled:l,bottom:c,children:[o.jsxs("span",{children:[e,t.toFixed(2)," x ",f]}),o.jsxs(zr,{disabled:l,children:[i&&o.jsxs(o.Fragment,{children:[o.jsxs("span",{children:[e,i.prevTotal.toFixed(2)]}),o.jsx(jr,{children:i.label})]}),o.jsxs("span",{children:[e,o.jsx("span",{children:r.toFixed(2)})]})]})]})},Fr=a.default.div`
...
`,Yr=a.default.div`
  ...
  margin-top: 8px;
  font-size: 12px;
`,Qr=({name:e,img:t,quantity:r,currencySymbol:n,unitPrice:i,total:l,productDetails:c,discount:f,measureUnit:h,disabled:A})=>o.jsxs(Fr,{disabled:A,hasDetails:!!c,children:[o.jsxs(Br,{children:[(t==null?void 0:t.src)&&o.jsx("img",{...t}),o.jsxs(Ur,{hasDetails:!!c,children:[o.jsxs(Pr,{disabled:A,children:[o.jsx(se,{opacity:.4,children:r}),e]}),c&&o.jsx(Yr,{children:c}),!c&&o.jsx(Ne,{currencySymbol:n,unitPrice:i,total:l,discount:f,disabled:A})]})]}),c&&o.jsx(Ne,{currencySymbol:n,unitPrice:i,total:l,discount:f,disabled:A,bottom:!0})]}),Or=a.default.div`
  padding: 20px;
...
`;function o0(e="(min-width: 768px)"){const[t,r]=b.useState({matches:window.innerWidth>(()=>{const i=e.match(/(\d+)/);return i?i[0]:768})()});return b.useEffect(()=>{let i=window.matchMedia(e);return i.addEventListener("change",r),()=>i.removeEventListener("change",r)},[]),{status:Boolean(t&&t.matches)}}const t0=({children:e,note:t="Esta acci\xF3n no se puede revertir.",btnLeft:r={onClick:()=>{},text:"Cancelar",disabled:!1},btnRight:n={onClick:()=>{},text:"Eliminar",disabled:!1}})=>{const{status:i}=o0("(min-width: 1023px)");return o.jsxs(Xr,{children:[o.jsxs(e0,{children:[o.jsxs(Kr,{children:[o.jsx(_r,{children:e}),o.jsx(qr,{children:t})]}),o.jsxs($r,{children:[i&&o.jsx(D,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{borderRadius:"32px",padding:"20px 0"},disabled:r.disabled,children:r.text}),o.jsx(D,{design:"solid",fullWidth:!0,onClick:()=>n.onClick(),style:{borderRadius:"32px",padding:"20px 60px"},disabled:n.disabled,children:n.text})]})]}),!i&&o.jsx(D,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{margin:"0 15px 15px",width:"calc(100% - 30px)",padding:"20px",borderRadius:"15px"},children:r.text})]})},r0=a.default.div`
  background: transparent;
  color: #383838;
  border-radius: 20px;
  font-weight: 500;
...
`,Fe=o.jsx("div",{style:{display:"inline-block"},children:o.jsx(H,{width:"20px",height:"20px"})}),I0=({options:e,onClose:t,contentLocation:r,contentLocationInDesktop:n,defaultDescription:i="",defaultTitle:l="",optionsInCenter:c=!1,direction:f="row",iconOrientation:h="horizontal"})=>{const[A,x]=b.useState(null),g=b.useMemo(()=>{if(A===null)return null;const u=e[A];if(u&&"options"in u)return u},[A,e]);return o.jsx(F,{maxWidth:"500px",padding:"20px 0",onClose:t,contentLocation:r||"bottom",contentLocationInDesktop:n||"center",closeIcon:!0,children:o.jsxs(C0,{children:[o.jsxs(m0,{children:[o.jsxs(M0,{children:[g&&o.jsx(j,{onClick:()=>x(null)}),o.jsx(E,{as:"h2",size:"md",children:(g==null?void 0:g.text)||l})]}),i.length>0&&o.jsx(E,{color:"NEUTRAL/400",size:"sm",weight:"regular",children:(g==null?void 0:g.description)||i})]}),o.jsxs(k0,{direction:f,children:[!g&&e.map((u,w)=>"onClick"in u?o.jsxs(G,{alert:u.alert,disabled:u.disabled||u.loading,onClick:()=>{!u.loading&&!u.disabled&&(u.onClick(),t())},optionsInCenter:c,iconOrientation:h,children:[o.jsx("span",{children:u.text}),u.loading?Fe:u.icon]},`option-${w}`):o.jsxs(G,{onClick:()=>{x(w)},optionsInCenter:c,children:[u.text," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(j,{})})]},`option-${w}`)),g==null?void 0:g.options.map((u,w)=>o.jsxs(G,{alert:u.alert,disabled:u.disabled||u.loading,onClick:()=>{!u.loading&&!u.disabled&&u.onClick()},optionsInCenter:c,children:[u.text," ",u.loading?Fe:u.icon]},`suboption-${w}`))]})]})})},E0=({cardProps:e,...t})=>o.jsx(F,{background:"transparent",boxShadowInDesktop:"none",padding:"0 10px",contentLocation:"bottom",maxWidth:"650px",...e,children:o.jsx(ye,{...t})}),T0=(e,t=1024*8)=>{let r=!0,n=null;return e.size/1024>t&&(r=!1,n={code:"F0001",message:`El archivo ${e.name} pesa ${(e.size/1024/1024).toFixed(2)} MB. Intenta subir una imagen menor a ${t/1024} MB `}),{success:r,error:n}},V=({onSelectFile:e,maxKBSize:t,onError:r=()=>{},acceptedFiles:n,validFileExtensions:i,children:l,style:c})=>{const f=b.useRef(null),h=()=>f.current.click(),A=()=>{const w=f.current.files[0];u(w)},x=w=>{w.stopPropagation(),w.preventDefault();const C=w.dataTransfer.files[0];u(C)},g=w=>i?new RegExp(`${i.join("|")}$`,"i").exec(w.toLowerCase()):!0,u=w=>{var I;if(!w)return;if(!g(w.name)){r("Tipo de archivo no permitido");return}const C=T0(w,t);if(!C.success){r((I=C.error)==null?void 0:I.message);return}e(w)};return o.jsxs("div",{onClick:h,onDragOver:w=>w.preventDefault(),onDrop:x,style:c,children:[l,o.jsx("input",{ref:f,style:{display:"none"},onChange:A,type:"file",accept:n})]})},Be=()=>{const e=b.useRef(!0);return b.useEffect(()=>{e.current=!1},[]),e.current},Ue=a.default.button`
...
`,j0=({initialImgUrl:e,placeholder:t,onChange:r,onError:n})=>{const[i,l]=b.useState(null),[c,f]=b.useState(e||null),h=Be();return b.useEffect(()=>{let A="";return i&&(A=window.URL.createObjectURL(i),f(A)),()=>{A&&window.URL.revokeObjectURL(A)}},[i]),b.useEffect(()=>{h||r(i,c||null)},[c]),o.jsx(V,{onError:n||alert,onSelectFile:A=>l(A),acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:c?o.jsxs(S0,{children:[o.jsxs(y0,{children:[o.jsx("img",{src:c}),o.jsxs(z0,{children:[o.jsx("span",{children:(i==null?void 0:i.name)||Pe(c)[0]}),o.jsx("span",{children:(i==null?void 0:i.type)||Pe(c)[1]})]})]}),o.jsx(Ue,{variant:"secondary",onClick:A=>{A.stopPropagation(),l(null),f(null)},children:o.jsx(D0,{size:12})})]}):o.jsx(L0,{children:t||o.jsxs(N0,{children:[o.jsx(Ye,{color:d.color.SECONDARY[900],size:18})," Sube un imagen ",o.jsx("span",{children:"aqu\xED"})]})})})},Qe=a.default.div`
  width: 55px;
  height: 55px;
  border-radius: 7px;
`,F0=a.default.div`
...
`,P0=a.default.div`
  ...
  right: 0;
  bottom: 0;
`,Y0=({onChange:e,initialImages:t,limit:r})=>{const[n,i]=b.useState(t||[]),[l,c]=b.useState(null),f=Be(),h=x=>{const g=window.URL.createObjectURL(x);i(u=>[...u,{file:x,url:g}])},A=x=>{const g=n[x];typeof g!="string"&&window.URL.revokeObjectURL(g.url),i(u=>u.filter((w,C)=>C!==x))};return b.useEffect(()=>{f||e(n)},[n]),o.jsxs(F0,{children:[n.map((x,g)=>o.jsxs(B0,{onMouseEnter:()=>c(g),onMouseLeave:()=>c(null),onTouchCancel:()=>c(null),children:[o.jsx("img",{src:typeof x=="string"?x:x.url}),l===g&&o.jsx(P0,{onClick:()=>A(g),children:o.jsx(Te,{size:16})})]},`imgs-${g}`)),!(r&&n.length>=r)&&o.jsx(V,{onError:alert,onSelectFile:h,acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:o.jsx(U0,{children:o.jsx(Ye,{})})})]})},Q0=a.default.div`
  display: grid;
...
`,W0=a.default.div`
  ...
  ${({gridColumn:e})=>R(e)}
`,G0={Table:({gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:l,header:c,body:f})=>o.jsx(O0,{children:o.jsxs(Q0,{gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:l,children:[c&&c,f&&f]})}),Th:Z0,Td:H0,Tr:W0},V0=s.css`
  background: none;
  outline: none;
  border: none;
  padding: none;
...
`,K0=({container:e,options:t,closeIcon:r})=>{var n;return o.jsxs(R0,{marginBottom:e==null?void 0:e.marginBottom,padding:e==null?void 0:e.padding,isSticky:e==null?void 0:e.isSticky,zIndex:e==null?void 0:e.zIndex,children:[r!=null&&r.hide?o.jsx("div",{}):o.jsx(Ue,{onClick:r.onClick,style:{marginLeft:(r==null?void 0:r.marginLeft)||"20px"},children:o.jsx(ve,{})}),o.jsx(J0,{minWidthForOptions:t.minWidth,paddingForOptions:t.padding,children:(n=t==null?void 0:t.options)==null?void 0:n.map((i,l)=>o.jsx(X0,{onClick:i.onClick,type:"button",mode:i.mode,disabled:i.disabled,children:i.text},`${l}${i.id}`))})]})},q0=a.default.div`
  ...
  left: 0;
  z-index: ${({zIndex:e})=>e||"5"};
`,$0=({description:e,buttons:t,container:r})=>o.jsxs(q0,{padding:r==null?void 0:r.padding,gap:r==null?void 0:r.gap,marginTop:r==null?void 0:r.marginTop,isFixed:r==null?void 0:r.isFixed,zIndex:r==null?void 0:r.zIndex,boxShadow:r==null?void 0:r.boxShadow,children:[e&&o.jsx("div",{children:e}),t==null?void 0:t.map(n=>o.jsx(D,{...n},crypto.randomUUID()))]});p.Badge=dt,p.Button=D,p.ButtonsSwitch=x0,p.Card=Ct,p.CardModal=F,p.CartProduct=Sr,p.Checkbox=A0,p.ClientCard=Wt,p.CodeInput=go,p.Collapsible=Zo,p.ConfirmationCard=Jr,p.ConfirmationCardV2=t0,p.ConfirmationCardV3=ye,p.ConfirmationModalV3=E0,p.CurrentStatusCard=kt,p.CustomSelect=ne,p.DropdownMenu=$o,p.EditQuantityInput=De,p.GridTable=G0,p.Heading=Ao,p.IDCard=ar,p.IconV2=y,p.Loader=Fo,p.ModalHeader=K0,p.MultipleOptionsModal=I0,p.NoData=tt,p.OrderStatusBadge=de,p.OrderTypeBanner=pt,p.ProductDetailsCard=Qr,p.ProfileImage=So,p.Radio=p0,p.SectionCard=Pt,p.SelectField=bo,p.SimpleFooter=$0,p.StatusBanner=wt,p.StickyHeader=Wo,p.SupplyInput=v0,p.Text=E,p.TextField=oe,p.ToastCard=_t,p.TotalsCard=jt,p.TransparentBadge=se,p.UploadFileContainer=V,p.UploadImage=j0,p.UploadMultipleImages=Y0,p.UserProfileIcon=ae,Object.defineProperties(p,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
