(function(u,p){typeof exports=="object"&&typeof module<"u"?p(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("@radix-ui/react-collapsible"),require("@floating-ui/react-dom"),require("react-loading-skeleton"),require("react-select")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","@radix-ui/react-collapsible","@floating-ui/react-dom","react-loading-skeleton","react-select"],p):(u=typeof globalThis<"u"?globalThis:u||self,p(u["ID-Components"]={},u.styled,u["react/jsx-runtime"].js,u.React,u["@radix-ui/react-collapsible"],u["@floating-ui/react-dom"],u.Skeleton,u.Select))})(this,function(u,p,o,w,Co,B,Mo,Lo){"use strict";const O=e=>e&&typeof e=="object"&&"default"in e?e:{default:e};function ko(e){if(e&&e.__esModule)return e;const t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const r in e)if(r!=="default"){const n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(t,r,n.get?n:{enumerable:!0,get:()=>e[r]})}}return t.default=e,Object.freeze(t)}const l=O(p),G=ko(Co),S=O(Mo),mo=O(Lo),yo={bold:700,medium:500,regular:400,light:300},ae={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},de={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},c={color:{NEUTRAL:{0:"#FFFFFF",20:"#FFFFFF",50:"#F5F5F5",100:"#EBEBEB",200:"#dfdfdf",300:"#bfbfbf",400:"#9f9f9f",500:"#808080",600:"#404040",700:"#383838",800:"#202020",900:"#000000"},PRIMARY:{0:"#FFFFFF",50:"#F1F2F9",100:"#E6E8F4",200:"#DDDFF0",300:"#BBBFE2",400:"#999FD3",500:"#777fc5",600:"#545fb6",700:"#414a98",800:"#333a76",900:"#242954"},SECONDARY:{0:"#FFFFFF",20:"#F7F5FF",50:"#EFEBFF",100:"#E6E0FF",200:"#d0c5ff",300:"#d0c5ff",400:"#b9a8ff",500:"#a18cff",600:"#8a6fff",700:"#7252ff",800:"#5b35ff",900:"#4318FF"},TERTIARY:{0:"#FFFFFF",50:"#FFFAFC",100:"#FFF5F9",200:"#ffeff5",300:"#ffe0eb",400:"#ffd0e1",500:"#ffc1d7",600:"#ffb1cd",700:"#FFA1C3",800:"#ff92b9",900:"#FF82AF"},QUATERNARY:{0:"#FFFFFF",50:"#FBFCFE",100:"#F2F6FD",200:"#ebf1fc",300:"#D8E4FA",400:"#c4d6f8",500:"#b0c8f5",600:"#9cbbf3",700:"#88adf0",800:"#75a0ed",900:"#6192EB"},STATE:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEF7EB",200:"#fef3e3",300:"#fde7c6",400:"#fcdba9",500:"#fbcf8d",600:"#fac270",700:"#f9b654",800:"#f8aa38",900:"#F79E1B"},ALERT:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEEDEC",200:"#fde3e2",300:"#fbc8c5",400:"#f9ada8",500:"#f7918b",600:"#f4756d",700:"#F25A50",800:"#F03E33",900:"#EE2316"},SUCCESS:{0:"#FFFFFF",50:"#F7FDFA",100:"#EEFBF4",200:"#e4f9ed",300:"#c9f3db",400:"#aeedc9",500:"#93e7b7",600:"#78e1a4",700:"#5DDB92",800:"#42D580",900:"#2DC96F"},OTHER:{color1:"#151E5A"},STATUS:{DEFAULT:{0:"#F5F5F5",1:"#808080"},DRAFT:{0:"#F5F5F5",1:"#808080"},PENDING:{0:"#DFDFDF",1:"#404040"},REJECTED:{0:"#FDE3E2",1:"#EE2316"},ACCEPTED:{0:"#D0C5FF",1:"#4318FF"},CANCELED:{0:"#FDE3E2",1:"#EE2316"},PREPARING:{0:"#FEF3E3",1:"#F79E1B"},READYFORPICKUP:{0:"#FFEFF5",1:"#FF82AF"},DELIVERED:{0:"#E4F9ED",1:"#2DC96F"},FINISHED:{0:"#DDDFF0",1:"#414A98 "}}},effect:{darkShadow:{4:"0px 0px 4px 1px rgba(139, 139, 139, 0.32)",6:"0px 1px 6px rgba(60, 60, 60, 0.2)",8:"0px 1px 6px rgba(107, 107, 107, 0.2)",12:"0px 0px 12px 2px #F6F6F6",24:"0px 0px 24px 4px rgba(0, 14, 51, 0.2)",30:"0px 10px 30px rgba(0, 0, 0, 0.08)"},lightShadow:{2:"0px 0px 2px 1px rgba(149, 178, 254, 0.2)",16:"0px 4px 16px rgba(153, 181, 255, 0.2)"}}},Eo=({shape:e})=>{switch(e){case"rounded":return p.css`
      ...
      `;default:return p.css`
        border-radius: 0.625rem;
      `}},To=({design:e,color:t,fontColor:r})=>{switch(e){case"solid":return p.css`
      ...
      `;default:return p.css`
        background-color: ${()=>D({color:t})};
        color: #fff;
      `}},D=({color:e="SECONDARY/900",design:t,hover:r})=>{const n=e.split("/"),i=n[0];let a=+n[1];if(r&&a>=300)switch(t){case"solid":a-=100;break;case"outline":a=100;break;case"flat":a=100;break;default:a>=400?a-=100:a+=100;break}if(r&&a<300)switch(t){case"solid":a+=100;break;case"outline":a=100;break;case"flat":a=100;break;default:a-=100;break}return i==="PRIMARY"||i==="NEUTRAL"||i==="SECONDARY"||i==="TERTIARY"||i==="QUATERNARY"||i==="STATE"||i==="ALERT"||i==="SUCCESS"?a===0||a===50||a===100||a===200||a===300||a===400||a===500||a===600||a===700||a===800||a===900?c.color[i][a]:c.color[i][900]:c.color.PRIMARY[900]},ce=({fullWidth:e})=>e?p.css`
      width: 100%;
    `:p.css`
    width: auto;
  `,se=({isLoading:e})=>e?p.css`
      cursor: not-allowed;
      opacity: 0.5;
    `:p.css`
    cursor: pointer;
    opacity: 1;
  `,V=({disabled:e})=>e?p.css`
      cursor: not-allowed;
      opacity: 0.5;
    `:p.css`
    cursor: pointer;
...
`,So=l.default(No)`
  ...
  ${({size:e})=>J({size:e})};
  ${({shape:e})=>Eo({shape:e})};
  ${({design:e,color:t,fontColor:r})=>To({design:e,color:t,fontColor:r})};
  ${({fullWidth:e})=>ce({fullWidth:e})};
  ${({isLoading:e})=>se({isLoading:e})};
  ${({disabled:e})=>V({disabled:e})};
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:a,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:x})=>pe({m:e,mb:t,mt:r,mr:n,ml:i,my:a,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:x})};
...
`,N=({children:e,...t})=>o.jsxs(So,{...t,children:[t.leftIcon,e,t.rightIcon]});function Do(e,t,r){const n=()=>{const i=document.querySelectorAll("input");return Array.from(i).filter(d=>d.className===t)};w.useEffect(()=>{const i=a=>{a.key==="Backspace"&&setTimeout(()=>{const d=n(),s=document.activeElement;s.value="";const h=d.indexOf(s);h>0&&d[h-1].focus()},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),w.useEffect(()=>{const i=a=>{if(a.key!=="Backspace"){const d=a.key.toLowerCase();setTimeout(()=>{if(d.length===1){const s=n(),h=document.activeElement;h.value=d;const A=s.indexOf(h);A<s.length-1&&s[A+1].focus()}},0)}};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),w.useEffect(()=>{if(e){const i=a=>{const d=a.key.toLowerCase();(d.length===1||d==="backspace")&&setTimeout(()=>{const h=n().map(A=>A.value).join("");e(h)},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)}},[]),w.useEffect(()=>{if(r){const i=n(),a=i.map(h=>h.value),d=r.split(""),s=d.length===a.length?d:a;i.forEach((h,A)=>{const f=s[A];f&&(h.value=f)})}},[r])}const Fo=p.keyframes`
  0% {
    opacity: 0;
...
`,X=l.default.div`
  ...
  ${({shouldAppear:e})=>e&&p.css`
      animation: ${Fo} 0.2s ease-in;
      animation-fill-mode: forwards;
    `}
`,zo={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},Bo=p.css`
  ...
  ${({align:e})=>Io({align:e})}
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:a,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:x})=>pe({m:e,mb:t,mt:r,mr:n,ml:i,my:a,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:x})};
`,jo=e=>{const t=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",r=t?"bold":"medium",n=t?de[e]:de.text,i="PRIMARY/900";return p.css`
    font-weight: ${({weight:a=r})=>yo[a]||"500"};
    font-size: ${({size:a=n})=>ae[a]||a};
    color: ${({color:a=i})=>{const d=a==null?void 0:a.split("/")[0],s=Number(a==null?void 0:a.split("/")[1]);return c.color[d][s]}};
  `},Uo=l.default.div`
  ${Bo}
  ${({as:e})=>jo(e)}
`,z=({as:e,...t})=>{const r=zo[e];return o.jsx(Uo,{as:r,...t})},Ho={H1:e=>o.jsx(z,{as:"h1",...e}),H2:e=>o.jsx(z,{as:"h2",...e}),H3:e=>o.jsx(z,{as:"h3",...e}),H4:e=>o.jsx(z,{as:"h4",...e}),H5:e=>o.jsx(z,{as:"h5",...e}),H6:e=>o.jsx(z,{as:"h6",...e})},Po=l.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
  transition: 0.3s ease-out;
`,E=e=>e.rightIcon||e.leftIcon?o.jsxs(Po,{children:[e.leftIcon,o.jsx(z,{as:e.as||"p",...e}),e.rightIcon]}):o.jsx(z,{as:e.as||"p",...e}),Zo=l.default.div`
  display: grid;
...
`,K=w.forwardRef(({type:e,leftAddon:t,rightAddon:r,placeholder:n,error:i,success:a,size:d,fullWidth:s,name:h,infoMessage:A,onFocus:f,onBlur:g,onChange:b,...x},v)=>{const[k,M]=w.useState(!1),C=!i&&!a&&A&&k;return o.jsxs(o.Fragment,{children:[o.jsxs(Vo,{fullWidth:s,success:a,size:d,error:i,disabled:x.disabled,leftAddon:t,rightAddon:r,isFocused:k,children:[t&&o.jsx("span",{className:"leftAddon",children:t}),o.jsx("input",{ref:v,onFocus:m=>{f&&f(m),M(!0)},onBlur:m=>{g&&g(m),M(!1)},onChange:b,placeholder:n,type:e,name:h,...x}),r&&o.jsx("span",{className:"rightAddon",children:r}),i&&o.jsx("span",{className:"state",children:o.jsx(Oo,{size:24,color:c.color.ALERT[900]})}),a&&o.jsx("span",{className:"state",children:o.jsx(Go,{size:20,color:c.color.SUCCESS[900]})})]}),C&&o.jsx(X,{shouldAppear:C,children:o.jsx(E,{size:"xs",color:"QUATERNARY/900",children:A})})]})});K.displayName="TextInput";const Jo=l.default.div`
  position: relative;
...
`,fe=w.forwardRef(({label:e,searchable:t=!0,autoSize:r,value:n,options:i,placeholder:a="Seleccione una opci\xF3n",fullWidth:d,fullWidthOptions:s,onChange:h,formatOptionLabel:A,formatSelectedOption:f})=>{const g=w.useRef(null),[b,x]=w.useState(i),[v,k]=w.useState(""),[M,C]=w.useState(!1);H(g,()=>{C(!1)});const m=w.useCallback(()=>{const L=i.filter(y=>y.label.toLowerCase().includes(v.toLowerCase()));x(L)},[i,n]),T=w.useCallback(L=>{h(i.find(y=>y.label===L)),C(!1),k(""),x(i)},[m]),I=w.useCallback(L=>{k(L.target.value);const y=i.filter(W=>W.label.toLowerCase().includes(L.target.value.toLowerCase()));x(y)},[]),U=()=>{const L=g.current;if(L){const y=L.getBoundingClientRect();return window.innerHeight-y.bottom-20}};return o.jsxs(Jo,{fullWidth:d,ref:g,children:[e&&o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),o.jsxs("div",{className:"select-btn",onClick:()=>C(!M),tabIndex:0,onKeyUpCapture:L=>{L.key==="Enter"&&C(!M)},children:[o.jsx(E,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:f?f(n):A?A(n):n.label}),o.jsx(Ae,{size:20})]}),M&&o.jsxs(Xo,{maxOptionsHeight:r?U():285,fullWidthOptions:s,children:[t&&o.jsx("div",{className:"search-box",children:o.jsx(K,{leftAddon:o.jsx(Wo,{}),type:"text",placeholder:a,value:v,onChange:I,fullWidth:!0})}),o.jsx("div",{className:"options",children:b.map(L=>o.jsx(E,{as:"li",color:"NEUTRAL/700",className:L.value===n.value?"selected":"",tabIndex:0,onClick:()=>T(L.label),onKeyUpCapture:y=>{y.key==="Enter"&&T(L.label)},children:A?A(L):L.label},`${L.label}-${L.value}`))})]})]})});fe.displayName="CustomSelect";const Ko=l.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,qo=({imageUrl:e,size:t=128,onChange:r})=>{const n=w.useRef(null),i=a=>{var s;const d=(s=a.target.files)==null?void 0:s[0];if(d){const h=URL.createObjectURL(d);r({file:d,url:h})}};return o.jsxs(Ko,{size:t,children:[o.jsx(E,{color:"NEUTRAL/400",weight:"regular",size:"xs",children:"Agrega tu foto"}),o.jsxs("div",{className:"profile-input__container",children:[o.jsx("input",{type:"file",accept:"image/png, image/jpeg",onChange:i,ref:n}),o.jsx("img",{width:t,height:t,src:e||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"}),o.jsx(N,{type:"button",size:"lg",design:"flat",shape:"circular",onClick:()=>{var a;return(a=n.current)==null?void 0:a.click()},children:"+"})]})]})},Ro=p.keyframes`
  0%,
  100% {
...
`,ct=({onBack:e,backLabel:t,profileImageUrl:r,rightContent:n})=>o.jsxs(dt,{children:[o.jsxs("button",{type:"button",onClick:e,children:[o.jsx(Z,{}),o.jsx(E,{color:"NEUTRAL/900",children:t})]}),n||o.jsx("img",{width:28,height:28,src:r||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"})]}),st=p.keyframes`
  100% {
    transform: rotate(360deg);
  }
`,pt=l.default.div`
...
`,q=e=>o.jsx(pt,{width:e.width,height:e.height,borderWidth:e.borderWidth,margin:e.margin}),he=l.default.ul`
...
`,ft=l.default.div`
  ...
  top: 0;
  right: calc(100% + 8px);
`,ht=({text:e,options:t})=>{const[r,n]=w.useState(!1),i=w.useRef(null),a=d=>{if(i.current&&clearTimeout(i.current),d){n(!0);return}i.current=setTimeout(()=>{r!==d&&n(d)},50)};return o.jsxs(R,{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),active:r,onClick:d=>d.stopPropagation(),children:[e," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(Z,{})}),r&&o.jsx(ft,{children:o.jsx(he,{children:t.map((d,s)=>o.jsxs(R,{alert:d.alert,onClick:h=>d.disabled||d.loading?h.stopPropagation():d.onClick(),disabled:d.disabled||d.loading,loading:d.loading,children:[d.text," ",d.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(q,{width:"20px",height:"20px"})}):d.icon]},`suboption-${s}`))})})]})},gt=({options:e,header:t})=>o.jsxs(he,{children:[t&&o.jsx(At,{children:t}),e.map((r,n)=>"options"in r?o.jsx(ht,{...r},`option-${n}`):o.jsxs(R,{disabled:r.disabled||r.loading,alert:r.alert,onClick:r.disabled||r.loading?i=>i.stopPropagation():r.onClick,loading:r.loading,children:[r.text," ",r.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(q,{width:"20px",height:"20px"})}):r.icon]},`option-${n}`))]}),xt=l.default.div`
  display: flex;
  cursor: pointer;
  text-align: right;
  * {
...
`,ut=({options:e,activator:t,header:r})=>{const{x:n,y:i,reference:a,floating:d,strategy:s,update:h,refs:A}=B.useFloating({placement:"bottom-end"}),[f,g]=w.useState(!1);return w.useEffect(()=>{if(!(!A.reference.current||!A.floating.current))return B.autoUpdate(A.reference.current,A.floating.current,h)},[f,h]),H(A.reference,()=>{g(!1)}),o.jsxs("div",{ref:a,children:[o.jsx(xt,{onClick:()=>g(!f),children:t||o.jsx(Ae,{size:25})}),f&&o.jsx("div",{ref:d,style:{position:s,top:i!=null?i:0,left:n!=null?n:0,zIndex:100},onClick:()=>g(!f),children:o.jsx(gt,{options:e,header:r})})]})},bt=l.default.div`
  text-align: center;
  font-weight: 300;
  font-size: 0.75rem;
...
`,mt=e=>e==="small"?"45px":e==="big"?"55px":`${e}px`,yt=l.default.input`
  width: 100%;
  height: ${({containerSize:e})=>mt(e)};
  padding: 8px 15px;
...
`,Y=({img:e,size:t=36,initials:r,containerProps:{style:n,...i}={}})=>{const a=r.slice(0,2).toUpperCase();return o.jsx(Bt,{hasImg:!(e!=null&&e.src),style:{width:`${t}px`,minWidth:`${t}px`,height:`${t}px`,fontSize:`${t/(r.length===1?2:2.25)}px`,...n||{}},...i,children:e!=null&&e.src?o.jsx("img",{...e}):a})},P=p.css`
  ::-webkit-scrollbar {
    width: 4px;
    height: 4px;
  }
...
`,Wt=({option:e,onClose:t,subOptions:r=[]})=>{const[n,i]=w.useState(!1);return o.jsxs("li",{onClick:()=>{r.length>0?i(!n):(e.onClick(),t())},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.text," ",r.length>0&&o.jsx(ee,{size:12,style:{display:"block",marginLeft:"auto",marginRight:"0",transform:n?"":"rotate(-90deg)"}})]}),n&&r.length>0&&o.jsx("ul",{children:r.map((a,d)=>o.jsx("li",{onClick:()=>{a.onClick(),t()},children:a.text},`${d}sub${e.key}`))})]})},Ot=({options:e=[],links:t=[],userIcon:r,searchOption:n,logoIcon:i,bellIcon:a,zIndex:d,isSticky:s})=>{const[h,A]=w.useState(!1),[f,g]=w.useState(!1),b=w.useRef(null);return H(b,()=>{A(!1),g(!1)}),o.jsxs(jt,{zIndex:d,isSticky:s,ref:b,children:[o.jsxs(Ut,{children:[o.jsxs(be,{children:[e.length>0&&o.jsx(zt,{size:20,color:"#151E5A",onClick:()=>{g(!1),A(!h)},styleContainer:{cursor:"pointer"}}),i!=null&&i.onClick?o.jsx(ue,{size:28,onClick:()=>{A(!1),g(!1),i==null||i.onClick()}}):o.jsx(ue,{size:28})]}),o.jsxs(Ht,{children:[o.jsx(Pt,{children:t.map((x,v)=>o.jsx("li",{onClick:()=>(x==null?void 0:x.onClick)&&(x==null?void 0:x.onClick()),children:x.text},`${v}navbarlinksfordesktop`))}),(n==null?void 0:n.show)&&o.jsx(xe,{...n,onSearch:x=>n.onSearch(x)}),(a==null?void 0:a.show)&&o.jsx(Dt,{size:16,onClick:()=>{a!=null&&a.onClick&&a.onClick(),A(!1),g(!f)}}),(r==null?void 0:r.show)&&o.jsxs(be,{children:[((r==null?void 0:r.name)||(r==null?void 0:r.note))&&o.jsxs(Zt,{children:[(r==null?void 0:r.name)&&o.jsx(E,{children:r==null?void 0:r.name}),(r==null?void 0:r.note)&&o.jsx(E,{color:"NEUTRAL/500",size:"xs",as:"span",children:r==null?void 0:r.note})]}),o.jsx(Y,{initials:(r==null?void 0:r.initials)||"ID",img:(r==null?void 0:r.img)||null,size:35,containerProps:{onClick:()=>{r!=null&&r.onClick&&(A(!1),g(!1),r.onClick())},style:r!=null&&r.onClick?{cursor:"pointer"}:{}}})]})]})]}),h&&o.jsx(Yt,{children:o.jsx("ul",{children:e.map((x,v)=>o.jsx(Wt,{option:x.option,subOptions:x.subOptions,onClose:()=>A(!h)},`${v}navbaroption`))})}),f&&o.jsx(Qt,{children:a==null?void 0:a.children})]})},Gt=e=>o.jsx(F,{viewBox:"0 0 8 8",...e,children:o.jsx("circle",{xmlns:"http://www.w3.org/2000/svg",cx:"4",cy:"4",r:"4",fill:"currentColor"})}),Vt=l.default.span`
...
`,we=({children:e,spacing:t,color:r,bulletSize:n,size:i})=>o.jsxs(Vt,{color:r,size:i,bulletSize:n,spacing:t,children:[o.jsx(Gt,{}),e]}),Jt=l.default.div`
  display: flex;
  align-items: center;
  gap: 15px;
`,ve=l.default.div`
  ...
  flex-grow: 1;
`,Xt=({children:e,thickness:t=1,hrMinWidth:r=15})=>o.jsxs(Jt,{children:[o.jsx(ve,{thickness:t,minWidth:r}),e,o.jsx(ve,{thickness:t,minWidth:r})]}),Kt=l.default.button`
  color: currentColor;
  background-color: transparent;
  border: none;
  font-size: 14px;
  ...
  ${({isActive:e,rounded:t,activeColor:r,tabWidth:n})=>e&&p.css`
    ...
    `};
`,qt=({children:e,active:t,tabWidth:r=24,activeColor:n=c.color.SECONDARY[900],...i})=>o.jsx(Kt,{isActive:t,noWrap:!0,activeColor:n,tabWidth:r,...i,children:e});function Ce(e="(min-width: 768px)"){const[t,r]=w.useState({matches:window.innerWidth>(()=>{const i=e.match(/(\d+)/);return i?i[0]:768})()});return w.useEffect(()=>{let i=window.matchMedia(e);return i.addEventListener("change",r),()=>i.removeEventListener("change",r)},[]),{status:Boolean(t&&t.matches)}}const Rt=l.default.div`
...
`,_t=({render:e,tooltipContent:t,tooltipStyles:r={},placement:n,offset:i,strategy:a,middlewares:d=[]})=>{const[s,h]=w.useState(!1),A=w.useRef(null),{x:f,y:g,reference:b,floating:x,strategy:v,update:k,refs:M,middlewareData:C,placement:m}=B.useFloating({placement:n||"top",strategy:a,middleware:[B.offset(i!=null?i:10),...d,B.arrow({element:A})]}),{x:T,y:I}=C.arrow||{},{status:U}=Ce("(hover: hover)"),L=(W=!0)=>{U&&h(W)};w.useEffect(()=>{if(!(!M.reference.current||!M.floating.current))return B.autoUpdate(M.reference.current,M.floating.current,k)},[s,k]);const y={top:"bottom",right:"left",bottom:"top",left:"right"}[m.split("-")[0]];return o.jsxs(o.Fragment,{children:[e({ref:b,onMouseEnter:()=>L(),onMouseLeave:()=>L(!1)}),s&&o.jsxs(Rt,{ref:x,style:{position:v,top:g!=null?g:0,left:f!=null?f:0,...r},children:[t,o.jsx($t,{ref:A,style:{left:T!=null?`${T}px`:"",top:I!=null?`${I}px`:"",[y]:"-3px"}})]})]})},er=(...e)=>e.reduce((t,r)=>t+(r||"").charAt(0),"").toUpperCase(),Me=({name:e,lastname:t,img:r,size:n,tooltipProps:i={}})=>o.jsx(_t,{tooltipContent:`${e} ${t||""}`,render:a=>o.jsx(Y,{initials:er(e,t),img:r,size:n,containerProps:{...a}}),...i}),or=e=>o.jsx(F,{viewBox:"0 0 12 12",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M5.99935 0.166992C6.31623 0.166992 6.57312 0.446814 6.57312 0.791992V5.37532L11.2589 5.37532C11.5758 5.37532 11.8327 5.65515 11.8327 6.00032C11.8327 6.3455 11.5758 6.62532 11.2589 6.62532L6.57312 6.62532V11.2087C6.57312 11.5538 6.31623 11.8337 5.99935 11.8337C5.68246 11.8337 5.42558 11.5538 5.42558 11.2087V6.62532L0.739786 6.62533C0.422901 6.62533 0.166016 6.3455 0.166016 6.00033C0.166016 5.65515 0.422901 5.37533 0.739786 5.37533L5.42558 5.37532V0.791992C5.42558 0.446814 5.68246 0.166992 5.99935 0.166992Z",fill:"currentColor"})}),tr=l.default.div`
  display: flex;
...
`,nr=({users:e,onAdd:t,iconSize:r=34})=>o.jsxs(tr,{size:r,children:[t&&o.jsx(rr,{size:r,onClick:t,children:o.jsx(or,{size:r/2.5})}),[...e].reverse().map((n,i)=>o.jsx("div",{style:{height:r},children:o.jsx(Me,{...n,size:r,tooltipProps:{strategy:"fixed"}})},`user-${n.name}-${i}`))]}),ir=l.default.span`
  ...
  ${({statusName:e,removeBackground:t})=>{if(e==="draft")return p.css`
      ...
      `}};
`,Le={default:"...",draft:"Borrador",pending:"Pendiente",rejected:"Rechazado",accepted:"Aceptado",canceled:"Anulado",preparing:"Preparando",readyforpickup:"Listo para recojo",delivered:"Entregado",finished:"Finalizado"},ke=({statusName:e,text:t,removeBackground:r})=>{const n=i=>Le[i]||Le.default;return o.jsx(ir,{statusName:e,removeBackground:r,children:t||n(e)})},lr=l.default.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
  font-size: 1em;
  display: inline-block;
  font-weight: bold;
`,me=(e,t,r)=>e>=t&&e<=r?e:e<t?t:r,ye=({intensity:e=.8,opacity:t=.5,children:r,style:n={},...i})=>{const a=me(e,0,1),d=me(t,0,1),s=256*a;return o.jsx(lr,{style:{backgroundColor:`rgba(${s}, ${s}, ${s}, ${d})`,...n},...i,children:r})},ar=l.default.span`
...
${({withBorder:e,color:t})=>e&&p.css`
    ...
    `}
`,dr=({text:e,padding:t,color:r,background:n,applyFlex:i,maxWidth:a,weight:d,borderRadius:s,withBorder:h})=>o.jsx(ar,{padding:t,color:r,background:n,applyFlex:i,maxWidth:a,weigth:d,borderRadius:s,withBorder:h,children:e}),cr=l.default.div`
  min-height: 50px;
  display: flex;
  justify-content: center;
...
`,Cr=({design:e="primary",header:t,options:r,optionsFormatter:n,content:i,withSeparator:a})=>o.jsxs(vr,{design:e,withSeparator:a,children:[t&&o.jsx("header",{children:t}),r&&n&&o.jsx("ul",{children:r.map(d=>o.jsx("li",{children:n(d)},d.value))}),i&&i]}),Mr=l.default.div`
  padding: 20px;
  border-radius: 10px;
  background: #fff;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,Se=l.default.span`
  color: #151E5A;
  font-weight: 500;
`,kr=({items:e,creationDescription:t,creationDate:r,title:n,children:i})=>o.jsxs(Mr,{children:[n&&o.jsx(Lr,{children:n}),e.map(a=>o.jsxs("div",{children:[o.jsxs("p",{children:[a.description&&o.jsx("span",{children:a.description})," ",o.jsx(ke,{statusName:a.statusName,removeBackground:!0})]}),o.jsx(Se,{children:a.statusDate})]},crypto.randomUUID())),r&&o.jsxs("div",{children:[t&&o.jsx("span",{children:t}),o.jsx(Se,{children:r})]}),i]}),mr=l.default.div`
...
`,Fr=l.default.img`
  ...
  font-size: 9px;
  object-fit: cover;
`,zr=({items:e,title:t="",onAction:r=()=>{},actionName:n="",hideQuantity:i=!1,children:a,gap:d=10,background:s,padding:h})=>o.jsxs(mr,{background:s,padding:h,children:[(t||n)&&o.jsxs(yr,{children:[o.jsx(Er,{children:t}),o.jsx(Tr,{onClick:()=>r(),children:n})]}),o.jsx(Ir,{style:{gap:d},children:e.map(A=>o.jsxs(Nr,{remark:Boolean(A.remark),children:[i?o.jsxs(De,{children:[o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(Fe,{children:A.notes.map(f=>o.jsx("li",{children:f},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}):o.jsxs(De,{children:[A.img&&o.jsx(Fr,{src:A.img,alt:A.description}),o.jsx(Sr,{children:A.quantity}),o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(Fe,{children:A.notes.map(f=>o.jsx("li",{children:f},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}),o.jsxs(Dr,{remark:Boolean(A.remark),children:[A.currency," ",A.amount.toFixed(2)]})]},crypto.randomUUID()))}),a]}),Br=l.default.div`
  background-color: white;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,Vr=({name:e,lastName:t,idNumber:r,img:n,otherSections:i=[],onDelete:a})=>o.jsxs(Yr,{children:[o.jsx(Qr,{children:o.jsx(Y,{img:n,initials:t?`${e.charAt(0)}${t.charAt(0)}`:e.charAt(0)})}),o.jsxs("div",{children:[o.jsxs(Wr,{children:[r&&o.jsxs("span",{children:[o.jsx(Zr,{}),r]}),i.map(d=>o.jsx("span",{children:d}))]}),o.jsxs(Or,{children:[e," ",t]})]}),!!a&&o.jsx(Gr,{children:o.jsx(ze,{onClick:a})})]}),Jr=()=>o.jsx("svg",{width:22,height:22,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11 2a9 9 0 1 0 0 18 9 9 0 0 0 0-18ZM.5 11C.5 5.201 5.201.5 11 .5S21.5 5.201 21.5 11 16.799 21.5 11 21.5.5 16.799.5 11Zm6.173-4.28a.75.75 0 0 1 1.06 0L11 9.986l3.266-3.266a.75.75 0 1 1 1.06 1.06l-3.265 3.267 3.266 3.266a.75.75 0 0 1-1.06 1.06L11 12.108l-3.266 3.267a.75.75 0 1 1-1.061-1.061l3.266-3.266L6.673 7.78a.75.75 0 0 1 0-1.06Z",fill:"#F25A50"})}),Xr=()=>o.jsxs("svg",{width:20,height:20,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("path",{d:"m9.046 11.153 1.26-1.32c.743-.776 1.485-1.553 2.228-2.327.267-.28.614-.309.878-.081a.667.667 0 0 1 .112.87c-.041.06-.092.114-.142.167l-3.818 3.992c-.35.364-.688.365-1.035.002-.65-.68-1.302-1.36-1.95-2.042-.295-.31-.284-.738.017-.996a.585.585 0 0 1 .766-.01c.095.078.178.17.263.259l1.421 1.486Z",fill:"#2DC96F"}),o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M10 18.5a8.5 8.5 0 1 0 0-17 8.5 8.5 0 0 0 0 17Zm0 1.5c5.523 0 10-4.477 10-10S15.523 0 10 0 0 4.477 0 10s4.477 10 10 10Z",fill:"#2DC96F"})]}),Kr=({color:e="#6192EB"})=>o.jsxs("svg",{width:20,height:20,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M8.393 1.005A1.815 1.815 0 0 1 10 0c.671 0 1.288.386 1.607 1.005l8.146 15.836C20.486 18.27 19.498 20 17.95 20H2.05C.5 20-.487 18.269.248 16.841L8.393 1.005ZM10 1.429a.458.458 0 0 0-.405.253l-.597-.336.597.336-8.146 15.837c-.245.475.085 1.052.6 1.052H17.95c.517 0 .846-.577.6-1.053L10.406 1.682A.457.457 0 0 0 10 1.429Z",fill:e}),o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M10 6.3a.7.7 0 0 1 .7.7v6a.7.7 0 1 1-1.4 0V7a.7.7 0 0 1 .7-.7ZM10 14.3a.7.7 0 0 1 .7.7v1a.7.7 0 1 1-1.4 0v-1a.7.7 0 0 1 .7-.7Z",fill:e})]}),Be=({color:e="#F79E1B"})=>o.jsx("svg",{width:20,height:20,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M10 1.429a8.571 8.571 0 1 0 0 17.142A8.571 8.571 0 0 0 10 1.43ZM0 10C0 4.477 4.477 0 10 0s10 4.477 10 10-4.477 10-10 10S0 15.523 0 10Zm10-5.714c.395 0 .714.32.714.714v1.429a.714.714 0 0 1-1.428 0V5c0-.394.32-.714.714-.714Zm0 4.285c.395 0 .714.32.714.715V15a.714.714 0 1 1-1.428 0V9.286c0-.395.32-.715.714-.715Z",fill:e})}),qr=e=>e==="success"?p.css`
...
`,e0=l.default.span`
  ...
  text-decoration: underline;
  cursor: pointer;
`,o0=({title:e="",description:t="",type:r,link:n,icon:i})=>{const a=()=>{if(i)return i;if(r==="success")return o.jsx(Xr,{});if(r==="warning")return o.jsx(Be,{});if(r==="error")return o.jsx(Jr,{});if(r==="quaternary")return o.jsx(Kr,{});if(r==="tertiary")return o.jsx(Be,{color:"#FF82AF"})};return o.jsxs(Rr,{toastType:r||"primary",children:[a(),o.jsxs("div",{children:[e&&o.jsx($r,{children:e}),t&&o.jsxs(_r,{children:[t," ",n&&n.onClick&&o.jsx(e0,{onClick:d=>{d.stopPropagation(),n.onClick&&n.onClick()},children:(n==null?void 0:n.text)||"Ver m\xE1s"})]})]})]})},je={xs:"(min-width: 360px)",sm:"(min-width: 591px)",md:"(min-width: 800px)",lg:"(min-width: 1400px)"},t0=l.default.div`
  font-family: 'Poppins';
  font-style: normal;
  display: flex;
  align-items: center;
...
`,s0=({onClose:e=()=>{},backdropOpacity:t,zIndex:r})=>(w.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),o.jsx(c0,{onClick:n=>{n.stopPropagation(),e()},opacity:t,zIndex:r})),Ue=p.keyframes`
  from {
...
`,A0=({children:e,onClose:t,backdropOpacity:r,zIndex:n,contentLocation:i="center",contentLocationInDesktop:a="center",boxShadow:d,boxShadowInDesktop:s,fullWidth:h,styleContainer:A})=>o.jsxs(o.Fragment,{children:[o.jsx(s0,{onClose:t,backdropOpacity:r,zIndex:n||4}),o.jsx(p0,{zIndex:n||4,contentLocation:i,contentLocationInDesktop:a,onClick:f=>f.stopPropagation(),boxShadow:d,boxShadowInDesktop:s,fullWidth:h,style:A,children:e})]}),f0=l.default.div`
...
`,j=({show:e=!0,children:t,onClose:r,backdropOpacity:n,padding:i,borderRadius:a,borderRadiusInDesktop:d,maxHeight:s,height:h,maxWidth:A,width:f,zIndex:g,overflow:b,contentLocation:x="center",contentLocationInDesktop:v="center",closeIcon:k,closeIconInDesktop:M,background:C="#fff",boxShadow:m,boxShadowInDesktop:T,styleContainer:I})=>e?o.jsx(A0,{onClose:r,backdropOpacity:n,zIndex:g,contentLocation:x,contentLocationInDesktop:v,boxShadow:m,boxShadowInDesktop:T,styleContainer:I,children:o.jsxs(f0,{padding:i,borderRadius:a,borderRadiusInDesktop:d,maxHeight:s,height:h,maxWidth:A,width:f,background:C,overflow:b,contentLocation:x,contentLocationInDesktop:v,children:[(k||M)&&o.jsx(h0,{onClick:r,closeIconInDesktop:M,closeIcon:k,children:o.jsx($,{})}),t]})}):null,g0=l.default.h2`
...
`,Ye=({onConfirm:e,onClose:t,zIndex:r,onlyIntegers:n,initialValue:i})=>{const a=w.useRef(null),[d,s]=w.useState(i||""),h=f=>{const g=f.target.value;let b=/^[0-9]\d*(\.(\d*))?$/;n&&(b=/^[0-9]*$/),!(g!==""&&!b.test(g))&&s(g)};w.useEffect(()=>{a.current.focus()},[]);const A=Number(d);return o.jsxs(j,{onClose:t,maxWidth:"350px",zIndex:r||6,children:[o.jsx(g0,{children:"Especifica la cantidad"}),o.jsxs(x0,{children:[o.jsx("input",{type:"text",inputMode:n?"numeric":"decimal",value:d,onChange:h,ref:a}),o.jsx(N,{design:"solid",size:"xs",onClick:()=>e(A),disabled:A<=0,children:"Agregar"})]})]})},Qe=e=>o.jsx(F,{viewBox:"0 0 12 12",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M4.86399 0.666504C4.21911 0.666504 3.69633 1.18928 3.69633 1.83416V2.1813H1.077C0.850426 2.1813 0.666748 2.36497 0.666748 2.59155C0.666748 2.81813 0.850426 3.00181 1.077 3.00181H1.80284V9.40812C1.80284 10.4713 2.66472 11.3332 3.72789 11.3332H8.27227C9.33545 11.3332 10.1973 10.4713 10.1973 9.40812V3.00181H10.9232C11.1497 3.00181 11.3334 2.81813 11.3334 2.59155C11.3334 2.36497 11.1497 2.1813 10.9232 2.1813H8.30383V1.83416C8.30383 1.18928 7.78105 0.666504 7.13618 0.666504H4.86399ZM4.51685 1.83416C4.51685 1.64244 4.67227 1.48702 4.86399 1.48702H7.13618C7.32789 1.48702 7.48332 1.64244 7.48332 1.83416V2.1813H4.51685V1.83416ZM2.62336 9.40812V3.00181H9.37681V9.40812C9.37681 10.0181 8.88229 10.5127 8.27227 10.5127H3.72789C3.11787 10.5127 2.62336 10.0181 2.62336 9.40812ZM6.00008 4.07479C5.7735 4.07479 5.58982 4.25847 5.58982 4.48504L5.58982 9.02942C5.58982 9.256 5.7735 9.43968 6.00008 9.43968C6.22666 9.43968 6.41034 9.256 6.41034 9.02942L6.41034 4.48504C6.41034 4.25847 6.22666 4.07479 6.00008 4.07479Z",fill:"currentColor"})}),u0=l.default.div`
  display: flex;
  justify-content: center;
`,b0=l.default.span`
...
`,oe=({value:e,onSetQuantity:t,onDelete:r,minimumQuantity:n=1,measureUnit:i,onlyIntegers:a,blockInputModal:d,disabled:s,hasError:h,variant:A,renderModal:f,zIndex:g,style:b,noDecrement:x,noIncrement:v})=>{const[k,M]=w.useState(!1),C=Number(e||0),m=e===null||C<=n,T=L=>{L.stopPropagation();const y=C%1!==0?Math.ceil(C):C+1;t(y)},I=L=>{if(L.stopPropagation(),m){r&&r();return}const y=C%1>0?Math.floor(C):C-1;t(y)},U=L=>{const y=a?Math.round(L):L;t(y<=n?n:y),M(!1)};return o.jsxs(o.Fragment,{children:[o.jsx(u0,{children:o.jsxs(v0,{isDisabled:s,onClick:L=>{L.stopPropagation(),!(d||s)&&M(!0)},minQuantity:m,canDelete:!!r,variant:A,error:h,style:b,children:[!x&&o.jsx("button",{disabled:s,onClick:I,children:m&&r?o.jsx(w0,{children:o.jsx(Qe,{color:c.color.ALERT[900]})}):"-"}),o.jsx(b0,{children:`${e===null?"-":e} ${e!==null&&i||""}`}),!v&&o.jsx("button",{onClick:T,disabled:s,children:"+"})]})}),k&&!d&&(f?f(o.jsx(Ye,{onClose:()=>M(!1),onConfirm:U,initialValue:e?e.toString():"",onlyIntegers:a,zIndex:g})):o.jsx(Ye,{onClose:()=>M(!1),onConfirm:U,initialValue:e?e.toString():"",onlyIntegers:a,zIndex:g}))]})},C0=l.default.div`
  background-color: white;
...
`,S0=l.default.div`
  ...
  justify-content: space-between;
  align-items: center;
`,D0=({img:e,name:t,currencySymbol:r,total:n,unitPrice:i,quantity:a,comment:d,onClick:s,onChangeQuantity:h,onDeleteProduct:A,onChangeComment:f,discount:g,measureUnit:b,productDetails:x,renderModal:v,onlyIntegers:k})=>{const[M,C]=w.useState(!0),m=b||"u.";return o.jsxs(C0,{children:[o.jsxs(M0,{onClick:s||(()=>{}),canClick:!!s,children:[(e==null?void 0:e.src)&&o.jsx(L0,{...e}),o.jsxs(k0,{children:[o.jsxs(m0,{detailsActive:M,children:[t,o.jsx(ee,{size:16,onClick:T=>{T.stopPropagation(),C(I=>!I)}})]}),g&&o.jsx(y0,{children:g.label}),o.jsxs(E0,{children:[g&&o.jsxs(T0,{children:["-",r,g.discountedAmount.toFixed(2)]}),o.jsxs(We,{children:[r,o.jsx("span",{children:n.toFixed(2)})]})]})]})]}),M&&o.jsxs("div",{children:[o.jsx(I0,{value:d,onChange:T=>f(T.target.value),placeholder:"Agregar alg\xFAn comentario"}),x&&o.jsx(N0,{children:x})]}),o.jsxs(S0,{children:[o.jsxs(We,{children:[r,o.jsx("span",{children:i.toFixed(2)})," x ",m]}),o.jsx(oe,{value:a,onSetQuantity:h,measureUnit:m,onDelete:A,renderModal:v,onlyIntegers:k})]})]})},F0=l.default.div`
...
`,j0=l.default.button`
  ...
  ${({selected:e})=>e&&p.css`
    ...
    `}
`,Oe=({title:e,options:t,selected:r,onSelect:n})=>o.jsxs(F0,{children:[e&&o.jsx(z0,{children:e}),o.jsx(B0,{children:t.map(i=>o.jsx(j0,{selected:i.value===r,onClick:()=>n(i.value,i),disabled:!!i.disabled,children:i.content},`${i.value}-btn`))})]}),U0=Array.from(Array(5),(e,t)=>({content:`${t}`,value:`${t}`})),H0=l.default.div`
  position: absolute;
  top: calc(100% + 5px);
  left: 0;
`,P0=({selected:e,onSelect:t,onClose:r})=>{const n=w.useRef(null);return H(n,r),o.jsx(H0,{ref:n,children:o.jsx(Oe,{title:"Order de salida",options:U0,selected:e.toString(),onSelect:i=>{t(Number(i)),r()}})})},Z0=l.default.div`
  color: 1px solid ${({theme:e})=>e.color.NEUTRAL[700]};
  display: flex;
  gap: 10px;
  font-size: 12px;
...
`,q0=({img:e,name:t,currencySymbol:r,total:n,quantity:i,onClick:a,onChangeQuantity:d,onDeleteProduct:s,discount:h,productDetails:A,renderModal:f,onlyIntegers:g,dishNumber:b,onChangeDishNumber:x,measureUnit:v})=>{const[k,M]=w.useState(!1);return o.jsxs(Z0,{children:[b&&o.jsxs(Y0,{clickeable:!!x,children:["N\xB0",o.jsxs("div",{children:[o.jsx("button",{onClick:()=>{x&&M(!0)},children:b}),k&&x&&o.jsx(P0,{onClose:()=>M(!1),onSelect:C=>x(C),selected:b})]})]}),o.jsxs(Q0,{children:[(e==null?void 0:e.src)&&o.jsxs(W0,{children:[o.jsx(O0,{...e}),h&&o.jsx(G0,{children:h.label})]}),o.jsxs(V0,{clickeable:!!a,onClick:a||(()=>{}),children:[o.jsxs(Ge,{children:[o.jsx("span",{children:t}),A&&o.jsx(Ge,{children:A})]}),o.jsxs(J0,{children:[o.jsxs("div",{children:[o.jsxs(X0,{children:[r,o.jsx("span",{children:n.toFixed(2)})]}),h&&o.jsxs(K0,{children:[r," ",h.prevTotal.toFixed(2)]})]}),o.jsx(oe,{value:i,onSetQuantity:d,onDelete:s,renderModal:f,onlyIntegers:g,measureUnit:v!=null?v:"u."})]})]})]})]})},R0=l.default.div`
  padding-right: 5px;
...
`,_0=l.default.span`
  ...
  font-size: 10px;
  font-weight: 700;
`,Ve=({currencySymbol:e,unitPrice:t,total:r,measureUnit:n,discount:i,disabled:a,bottom:d})=>{const s=n||"u.";return o.jsxs(R0,{disabled:a,bottom:d,children:[o.jsxs("span",{children:[e,t.toFixed(2)," x ",s]}),o.jsxs($0,{disabled:a,children:[i&&o.jsxs(o.Fragment,{children:[o.jsxs("span",{children:[e,i.prevTotal.toFixed(2)]}),o.jsx(_0,{children:i.label})]}),o.jsxs("span",{children:[e,o.jsx("span",{children:r.toFixed(2)})]})]})]})},en=e=>{switch(e){case"prepared":return"Listo";case"preparing":return"Preparando";default:return"Aceptado"}},on=l.default.div`
...
`,dn=l.default.div`
  ...
  margin-top: 8px;
  font-size: 12px;
`,cn=({name:e,img:t,quantity:r,currencySymbol:n,unitPrice:i,total:a,productDetails:d,discount:s,measureUnit:h,disabled:A,status:f,imgLabel:g,discountBottom:b=!0})=>{const x=b?!!(d||s):!!d;return o.jsxs(on,{disabled:A,hasDetails:!!d,children:[o.jsxs(tn,{children:[(t==null?void 0:t.src)&&o.jsxs(rn,{children:[o.jsx("div",{children:o.jsx("img",{...t})}),g,f&&!g&&o.jsx(nn,{status:f,children:en(f)})]}),o.jsxs(ln,{hasDetails:!!x,children:[o.jsxs(an,{disabled:A,children:[o.jsx(ye,{opacity:.4,children:r}),e]}),d&&o.jsx(dn,{children:d}),!x&&o.jsx(Ve,{currencySymbol:n,unitPrice:i,total:a,discount:s,disabled:A})]})]}),x&&o.jsx(Ve,{currencySymbol:n,unitPrice:i,total:a,discount:s,disabled:A,bottom:!0})]})},sn=l.default.div`
  padding: 20px;
...
`,kn=({children:e,note:t="Esta acci\xF3n no se puede revertir.",btnLeft:r={onClick:()=>{},text:"Cancelar",disabled:!1},btnRight:n={onClick:()=>{},text:"Eliminar",disabled:!1}})=>{const{status:i}=Ce("(min-width: 1023px)");return o.jsxs(bn,{children:[o.jsxs(Ln,{children:[o.jsxs(wn,{children:[o.jsx(Mn,{children:e}),o.jsx(vn,{children:t})]}),o.jsxs(Cn,{children:[i&&o.jsx(N,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{borderRadius:"32px",padding:"20px 0"},disabled:r.disabled,children:r.text}),o.jsx(N,{design:"solid",fullWidth:!0,onClick:()=>n.onClick(),style:{borderRadius:"32px",padding:"20px 60px"},disabled:n.disabled,children:n.text})]})]}),!i&&o.jsx(N,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{margin:"0 15px 15px",width:"calc(100% - 30px)",padding:"20px",borderRadius:"15px"},children:r.text})]})},mn=l.default.div`
  background: transparent;
  color: #383838;
  border-radius: 20px;
  font-weight: 500;
...
`,Je=l.default.div`
  ...
  ${({bottom:e})=>{if(e)return p.css`
      ...
      `}}
`,Xe=({title:e,content:t,options:r,cancelOptions:n})=>o.jsxs(mn,{children:[o.jsxs(yn,{children:[(e||t)&&o.jsxs(En,{children:[e&&o.jsx(Tn,{children:e}),t&&o.jsx(In,{children:t})]}),r.length>0&&o.jsx(Je,{children:r.map((i,a)=>o.jsx(N,{design:"solid",shape:"circular",size:"xs",fullWidth:!0,onClick:i.onClick,disabled:i.disabled,color:i.type==="primary"?"SECONDARY/900":"QUATERNARY/200",fontColor:i.type==="primary"?"SECONDARY/0":"SECONDARY/900",style:{gap:0},children:i.content},`confirmation-option-${a}`))})]}),n.length>0&&o.jsx(Je,{bottom:!0,children:n.map((i,a)=>o.jsx(N,{design:"flat",size:"xs",fullWidth:!0,onClick:i.onClick,disabled:i.disabled,color:"PRIMARY/900",style:{gap:0},children:i.content},`cancel-option-${a}`))})]}),Nn=({color:e="#4318FF"})=>o.jsxs("svg",{width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M22.53 3.47a.75.75 0 0 1 0 1.06l-10 10a.75.75 0 0 1-1.06 0l-3-3a.75.75 0 1 1 1.06-1.06L12 12.94l9.47-9.47a.75.75 0 0 1 1.06 0Z",fill:e}),o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5 3.75A1.25 1.25 0 0 0 3.75 5v14A1.25 1.25 0 0 0 5 20.25h14A1.25 1.25 0 0 0 20.25 19v-7a.75.75 0 0 1 1.5 0v7A2.75 2.75 0 0 1 19 21.75H5A2.75 2.75 0 0 1 2.25 19V5A2.75 2.75 0 0 1 5 2.25h11a.75.75 0 0 1 0 1.5H5Z",fill:e})]}),Sn=({color:e="#4318FF"})=>o.jsx("svg",{width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5 3.75c-.69 0-1.25.56-1.25 1.25v14c0 .69.56 1.25 1.25 1.25h14c.69 0 1.25-.56 1.25-1.25V5c0-.69-.56-1.25-1.25-1.25H5ZM2.25 5A2.75 2.75 0 0 1 5 2.25h14A2.75 2.75 0 0 1 21.75 5v14A2.75 2.75 0 0 1 19 21.75H5A2.75 2.75 0 0 1 2.25 19V5Z",fill:e})}),Dn=l.default.label`
  display: flex;
  gap: 9px;
  font-weight: 500;
  font-size: 0.8125rem;
...
`,Fn=({children:e,value:t="value",callbackOnChange:r=()=>{},disabled:n=!1,...i})=>{const[a,d]=w.useState((i==null?void 0:i.checked)||!1);return w.useEffect(()=>{d(Boolean(i==null?void 0:i.checked))},[i==null?void 0:i.checked]),o.jsxs(Dn,{disabled:n,children:[o.jsx("input",{...i,type:"checkbox",value:t,disabled:n,onChange:s=>{d(!a),r(s.target.value,!a)},checked:a}),o.jsx("span",{children:a?o.jsx(Nn,{color:n?"gray":"#4318FF"}):o.jsx(Sn,{color:n?"gray":"#4318FF"})}),e]})},zn=l.default.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 9px;
...
`,Bn=({text:e,...t})=>o.jsxs(zn,{disabled:Boolean(t.disabled),children:[o.jsx("input",{type:"radio",...t}),o.jsx("label",{htmlFor:t==null?void 0:t.id,children:e})]}),jn=l.default.div`
  background-color: white;
...
`;l.default.div`
  ...
  bottom: 0;
  left: 0;
`;const Hn=({options:e,selected:t,disabled:r,onSelect:n,fullWidth:i,model:a})=>o.jsx(jn,{disabled:r,onClick:d=>{r&&d.stopPropagation()},model:a,fullWidth:i,children:e.map(d=>o.jsx(Un,{onClick:()=>n(d.value),active:d.value===t,disabled:r,model:a,children:d.label},d.value))}),Pn=l.default.div`
...
`,Yn=l.default.span`
  ...
  line-height: 1.25rem;
  color: ${c.color.PRIMARY[900]};
`,Qn=({description:e,defaultValue:t,value:r,onChange:n=()=>{},placeholder:i,suffix:a,disabled:d,readingMode:s})=>o.jsxs(Pn,{disabled:d,withDescription:Boolean(e),readingMode:s,children:[e&&o.jsx(Zn,{children:e}),s?o.jsxs(Ke,{readingMode:s,children:[o.jsx(Yn,{children:t}),a&&!d&&o.jsx(qe,{children:a})]}):o.jsxs(Ke,{children:[o.jsx("input",{type:"text",placeholder:i,disabled:d,onChange:h=>n(h.target.value),value:r}),a&&!d&&o.jsx(qe,{children:a})]})]}),Wn=l.default.div`
  background-color: white;
...
`,On=({alert:e,fullWidth:t,minHeight:r,startEl:n,endEl:i,inputRef:a,...d})=>o.jsxs(Wn,{alert:e,fullWidth:t,minHeight:r!=null?r:45,className:"base-input-container",children:[n,o.jsx("input",{ref:a,...d}),i]}),Gn=l.default.div`
  display: flex;
  justify-content: flex-start;
  align-items: center;
  cursor: pointer;
...
`;l.default.p`
  ...
  margin: 15px 0;
  padding: 0 20px;
`;const Kn=({initial:e=!1,onToggle:t=()=>{},disabled:r=!1,width:n,padding:i,styleOn:a,styleOff:d})=>{const[s,h]=w.useState(e),A=()=>{if(!r){const f=!s;h(f),t(f)}};return o.jsx(Gn,{disabled:r,children:o.jsxs(Vn,{onClick:f=>{f.stopPropagation(),A()},toggled:s,width:n,padding:i,styleOn:a,styleOff:d,children:[o.jsx(Jn,{toggled:s,width:n,padding:i}),o.jsx(Xn,{visible:s,styleOn:a})]})})},qn=l.default.div`
  position: relative;
  width: 100%;
...
`,Rn={control:(e,t)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${t.isFocused?c.color.QUATERNARY[900]:c.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:c.color.PRIMARY[900],fontWeight:400,fontSize:"0.875rem",fontFamily:"Poppins",fontStyle:"normal"}),placeholder:e=>({...e,color:c.color.NEUTRAL[500]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"10px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"15px"})},$n=({formatOptionLabel:e,options:t,loading:r=!1,style:n,firstOption:i={label:"Seleccione una opci\xF3n",value:""},initialValue:a,value:d,onChange:s,isMulti:h,placeholder:A,label:f})=>{const g=i,b=[...t];return o.jsxs(qn,{style:n,children:[f&&o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:f}),r?o.jsx(S.default,{style:{borderRadius:10,display:"block"},height:"45px",width:"100%"}):o.jsx(mo.default,{placeholder:A,value:d||void 0,defaultValue:a||g,options:b,onChange:s,styles:Rn,isMulti:h,formatOptionLabel:e})]})},_n=l.default.div`
  width: ${e=>e.size}px;
  height: ${e=>e.size}px;
  position: relative;
  &::before {
...
`,$e=w.forwardRef(({label:e,type:t,error:r,isDirty:n,success:i,infoMessage:a,fullWidth:d,...s},h)=>{const A={...s,ref:h},[f,g]=w.useState(!1);return o.jsxs(ri,{fullWidth:d,children:[e&&o.jsxs("div",{className:"label-container",children:[o.jsx(E,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:e}),t==="password"&&o.jsx("span",{onClick:()=>g(!f),children:f?o.jsx(ti,{size:20}):o.jsx(oi,{size:20})})]}),o.jsx(K,{error:Boolean(r),success:i||!r&&n,infoMessage:a,fullWidth:d,type:f?"text":t,...A}),r&&o.jsx(X,{shouldAppear:Boolean(r),children:o.jsx(E,{size:"xs",color:"ALERT/900",children:r})})]})});$e.displayName="TextField";const ni=l.default.div`
...
`,_e=o.jsx("div",{style:{display:"inline-block"},children:o.jsx(q,{width:"20px",height:"20px"})}),di=({options:e,onClose:t,contentLocation:r,contentLocationInDesktop:n,defaultDescription:i="",defaultTitle:a="",optionsInCenter:d=!1,direction:s="row",iconOrientation:h="horizontal"})=>{const[A,f]=w.useState(null),g=w.useMemo(()=>{if(A===null)return null;const b=e[A];if(b&&"options"in b)return b},[A,e]);return o.jsx(j,{maxWidth:"500px",padding:"20px 0",onClose:t,contentLocation:r||"bottom",contentLocationInDesktop:n||"center",closeIcon:!0,children:o.jsxs(ni,{children:[o.jsxs(li,{children:[o.jsxs(ii,{children:[g&&o.jsx(Z,{onClick:()=>f(null)}),o.jsx(E,{as:"h2",size:"md",children:(g==null?void 0:g.text)||a})]}),i.length>0&&o.jsx(E,{color:"NEUTRAL/400",size:"sm",weight:"regular",children:(g==null?void 0:g.description)||i})]}),o.jsxs(ai,{direction:s,children:[!g&&e.map((b,x)=>"onClick"in b?o.jsxs(te,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&(b.onClick(),t())},optionsInCenter:d,iconOrientation:h,children:[o.jsx("span",{children:b.text}),b.loading?_e:b.icon]},`option-${x}`):o.jsxs(te,{onClick:()=>{f(x)},optionsInCenter:d,children:[b.text," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(Z,{})})]},`option-${x}`)),g==null?void 0:g.options.map((b,x)=>o.jsxs(te,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&b.onClick()},optionsInCenter:d,children:[b.text," ",b.loading?_e:b.icon]},`suboption-${x}`))]})]})})},ci=({cardProps:e,...t})=>o.jsx(j,{background:"transparent",boxShadowInDesktop:"none",padding:"0 10px",contentLocation:"bottom",maxWidth:"650px",...e,children:o.jsx(Xe,{...t})}),si=l.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
...
`,eo=({title:e,options:t,selected:r,onSelect:n,onClose:i,modalProps:a={},optionMinHeight:d=50})=>o.jsxs(j,{onClose:i,closeIcon:!0,contentLocation:"bottom",padding:"0",maxWidth:"600px",...a,children:[o.jsx(si,{children:e}),o.jsx(pi,{children:t.map(s=>o.jsxs(Ai,{minHeight:d,selected:s.value===r,disabled:s.disabled,onClick:()=>{s.disabled||n(s.value,s)},children:[s.content," ",s.icon]},s.value))})]}),fi=e=>o.jsx(F,{viewBox:"0 0 10 8",fill:"none",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M0.75 3.99992L3.58 6.82992L9.25 1.16992",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),hi=l.default.div`
  color: ${({color:e})=>e};
  padding-left: 15px;
  display: flex;
  align-items: center;
  flex-grow: 1;
`,gi=({options:e,selectedIcon:t,...r})=>o.jsx(eo,{options:e.map(({content:n,color:i=c.color.NEUTRAL[800],...a})=>({content:o.jsx(hi,{color:i,children:o.jsx(we,{spacing:30,bulletSize:7,children:n})}),icon:a.value===r.selected?t||o.jsx(fi,{}):void 0,...a})),...r}),xi=l.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
  padding-bottom: 18px;
...
`,wi=({title:e,options:t,onClose:r,closeOnAction:n,modalProps:i={}})=>o.jsxs(j,{onClose:r,closeIcon:!0,contentLocation:"bottom",padding:"20px",maxWidth:"600px",...i,children:[o.jsx(xi,{children:e}),o.jsx(ui,{children:t.map((a,d)=>o.jsxs(bi,{disabled:a.disabled,onClick:()=>{a.disabled||(a.onClick(),n&&r())},children:[a.icon," ",a.content]},`modal-option-${d}`))})]}),vi=(e,t=1024*8)=>{let r=!0,n=null;return e.size/1024>t&&(r=!1,n={code:"F0001",message:`El archivo ${e.name} pesa ${(e.size/1024/1024).toFixed(2)} MB. Intenta subir una imagen menor a ${t/1024} MB `}),{success:r,error:n}},re=({onSelectFile:e,maxKBSize:t,onError:r=()=>{},acceptedFiles:n,validFileExtensions:i,children:a,style:d})=>{const s=w.useRef(null),h=()=>s.current.click(),A=()=>{const x=s.current.files[0];b(x)},f=x=>{x.stopPropagation(),x.preventDefault();const v=x.dataTransfer.files[0];b(v)},g=x=>i?new RegExp(`${i.join("|")}$`,"i").exec(x.toLowerCase()):!0,b=x=>{var k;if(!x)return;if(!g(x.name)){r("Tipo de archivo no permitido");return}const v=vi(x,t);if(!v.success){r((k=v.error)==null?void 0:k.message);return}e(x)};return o.jsxs("div",{onClick:h,onDragOver:x=>x.preventDefault(),onDrop:f,style:d,children:[a,o.jsx("input",{ref:s,style:{display:"none"},onChange:A,type:"file",accept:n})]})},oo=()=>{const e=w.useRef(!0);return w.useEffect(()=>{e.current=!1},[]),e.current},to=e=>{const t=e.slice(e.lastIndexOf("/"));return[t.slice(1,t.indexOf(".")),t.slice(t.lastIndexOf(".")+1).toUpperCase()]},ro=e=>o.jsx(F,{viewBox:"0 0 18 17",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M1 13.6923H1.75H1ZM14.5385 16V15.25V16ZM3.46154 16V16.75H3.46154L3.46154 16ZM17 3.30772H17.75H17ZM17 13.6923H16.25H17ZM14.5385 1.00002L14.5385 0.250023L14.5385 1.00002ZM3.46154 1L3.46154 1.75L3.46154 1ZM4.69231 7.92307L5.20526 7.37592C4.91677 7.10546 4.46784 7.10546 4.17935 7.37592L4.69231 7.92307ZM12.7947 16.5472C13.0969 16.8304 13.5715 16.8151 13.8548 16.513C14.1381 16.2108 14.1228 15.7361 13.8206 15.4528L12.7947 16.5472ZM16.487 13.6625C16.7892 13.9458 17.2639 13.9305 17.5472 13.6283C17.8305 13.3262 17.8151 12.8515 17.513 12.5682L16.487 13.6625ZM13.3077 9.65384L13.8206 9.10669C13.5322 8.83623 13.0832 8.83623 12.7947 9.10669L13.3077 9.65384ZM9.92308 12.8269L9.41012 13.3741L9.92308 12.8269ZM1 11.3846H0.25H1ZM14.5385 15.25L3.46154 15.25L3.46154 16.75L14.5385 16.75V15.25ZM16.25 3.30772L16.25 13.6923H17.75L17.75 3.30772H16.25ZM14.5385 0.250023L3.46155 0.25L3.46154 1.75L14.5385 1.75002L14.5385 0.250023ZM17.75 3.30772C17.75 1.57414 16.2658 0.250026 14.5385 0.250023L14.5385 1.75002C15.5301 1.75002 16.25 2.49229 16.25 3.30772H17.75ZM1.75 3.30769C1.75 2.49226 2.46995 1.75 3.46154 1.75L3.46155 0.25C1.73419 0.249996 0.250001 1.57411 0.25 3.30769H1.75ZM0.25 13.6923C0.25 15.4259 1.73418 16.75 3.46154 16.75V15.25C2.46995 15.25 1.75 14.5077 1.75 13.6923H0.25ZM14.5385 16.75C16.2658 16.75 17.75 15.4259 17.75 13.6923H16.25C16.25 14.5077 15.53 15.25 14.5385 15.25V16.75ZM13.7885 5.03846C13.7885 5.53526 13.344 6.01923 12.6923 6.01923V7.51923C14.0798 7.51923 15.2885 6.45341 15.2885 5.03846H13.7885ZM12.6923 6.01923C12.0406 6.01923 11.5962 5.53526 11.5962 5.03846H10.0962C10.0962 6.45341 11.3048 7.51923 12.6923 7.51923V6.01923ZM11.5962 5.03846C11.5962 4.54166 12.0406 4.05769 12.6923 4.05769V2.55769C11.3048 2.55769 10.0962 3.62351 10.0962 5.03846H11.5962ZM12.6923 4.05769C13.344 4.05769 13.7885 4.54165 13.7885 5.03846H15.2885C15.2885 3.62351 14.0798 2.55769 12.6923 2.55769V4.05769ZM17.513 12.5682L13.8206 9.10669L12.7947 10.201L16.487 13.6625L17.513 12.5682ZM4.17935 8.47023L9.41012 13.3741L10.436 12.2798L5.20526 7.37592L4.17935 8.47023ZM9.41012 13.3741L12.7947 16.5472L13.8206 15.4528L10.436 12.2798L9.41012 13.3741ZM12.7947 9.10669L9.41012 12.2798L10.436 13.3741L13.8206 10.201L12.7947 9.10669ZM0.25 3.30769L0.25 11.3846H1.75L1.75 3.30769H0.25ZM0.25 11.3846L0.25 13.6923H1.75L1.75 11.3846H0.25ZM1.51296 11.9318L5.20526 8.47023L4.17935 7.37592L0.487044 10.8375L1.51296 11.9318Z",fill:"currentColor"})}),Ci=l.default.div`
  min-height: 70px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,yi=({initialImgUrl:e,placeholder:t,onChange:r,onError:n})=>{const[i,a]=w.useState(null),[d,s]=w.useState(e||null),h=oo();return w.useEffect(()=>{let A="";return i&&(A=window.URL.createObjectURL(i),s(A)),()=>{A&&window.URL.revokeObjectURL(A)}},[i]),w.useEffect(()=>{h||r(i,d||null)},[d]),o.jsx(re,{onError:n||alert,onSelectFile:A=>a(A),acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:d?o.jsxs(Li,{children:[o.jsxs(ki,{children:[o.jsx("img",{src:d}),o.jsxs(mi,{children:[o.jsx("span",{children:(i==null?void 0:i.name)||to(d)[0]}),o.jsx("span",{children:(i==null?void 0:i.type)||to(d)[1]})]})]}),o.jsx(_,{variant:"secondary",onClick:A=>{A.stopPropagation(),a(null),s(null)},children:o.jsx(ze,{size:12})})]}):o.jsx(Ci,{children:t||o.jsxs(Mi,{children:[o.jsx(ro,{color:c.color.SECONDARY[900],size:18})," Sube un imagen ",o.jsx("span",{children:"aqu\xED"})]})})})},no=l.default.div`
  width: 55px;
  height: 55px;
  border-radius: 7px;
`,Ei=l.default.div`
...
`,Ni=l.default.div`
  ...
  right: 0;
  bottom: 0;
`,Si=({onChange:e,initialImages:t,limit:r})=>{const[n,i]=w.useState(t||[]),[a,d]=w.useState(null),s=oo(),h=f=>{const g=window.URL.createObjectURL(f);i(b=>[...b,{file:f,url:g}])},A=f=>{const g=n[f];typeof g!="string"&&window.URL.revokeObjectURL(g.url),i(b=>b.filter((x,v)=>v!==f))};return w.useEffect(()=>{s||e(n)},[n]),o.jsxs(Ei,{children:[n.map((f,g)=>o.jsxs(Ti,{onMouseEnter:()=>d(g),onMouseLeave:()=>d(null),onTouchCancel:()=>d(null),children:[o.jsx("img",{src:typeof f=="string"?f:f.url}),a===g&&o.jsx(Ni,{onClick:()=>A(g),children:o.jsx(Qe,{size:16})})]},`imgs-${g}`)),!(r&&n.length>=r)&&o.jsx(re,{onError:alert,onSelectFile:h,acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:o.jsx(Ii,{children:o.jsx(ro,{})})})]})},Di=l.default.div`
  display: grid;
...
`,lo=e=>{if(e==="center")return p.css`
  ...
  `;if(e==="right")return p.css`
    ...
    text-align: right;
    justify-content: flex-end;
  `},ao=e=>{if(e)return p.css`
    width: 100%;
    border-right: 1.5px solid ${c.color.QUATERNARY[300]};
  `},co=e=>{if(e)return p.css`
    display: flex;
    align-items: center;
    gap: 10px;
  `},ne=e=>{if(e!=null&&e.trim())return p.css`
    grid-column: ${e};
  `},zi=l.default.div`
  ${io}
  font-weight: 500;
  ...
  padding-bottom: 8px;
  padding: 15px 10px 8px;
  ${({location:e})=>lo(e||"left")}
  ${({separator:e})=>ao(Boolean(e))}
  ${({itemFlex:e})=>co(Boolean(e))}
  ${({gridColumn:e})=>ne(e)}
`,Bi=l.default.div`
  ${io}
  font-weight: 400;
...
`,ji=l.default.div`
  ...
  ${({gridColumn:e})=>ne(e)}
`,Ui={Table:({gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:a,header:d,body:s})=>o.jsx(Fi,{children:o.jsxs(Di,{gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:a,children:[d&&d,s&&s]})}),Th:zi,Td:Bi,Tr:ji},ie=({size:e=20,color:t="#242954",onClick:r,styleContainer:n})=>o.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:o.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:o.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},viewBox:"0 0 9 16",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M8.53033 0.46967C8.82322 0.762563 8.82322 1.23744 8.53033 1.53033L2.06066 8L8.53033 14.4697C8.82322 14.7626 8.82322 15.2374 8.53033 15.5303C8.23744 15.8232 7.76256 15.8232 7.46967 15.5303L0.46967 8.53033C0.176777 8.23744 0.176777 7.76256 0.46967 7.46967L7.46967 0.46967C7.76256 0.176777 8.23744 0.176777 8.53033 0.46967Z",fill:t})})})}),le=({size:e=20,color:t="#242954",onClick:r,styleContainer:n})=>o.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:o.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:o.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},viewBox:"0 0 10 16",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:o.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0.96967 15.5303C0.676777 15.2374 0.676777 14.7626 0.96967 14.4697L7.43934 8L0.96967 1.53033C0.676777 1.23744 0.676777 0.762563 0.96967 0.46967C1.26256 0.176777 1.73744 0.176777 2.03033 0.46967L9.03033 7.46967C9.32322 7.76256 9.32322 8.23744 9.03033 8.53033L2.03033 15.5303C1.73744 15.8232 1.26256 15.8232 0.96967 15.5303Z",fill:t})})})}),Hi=l.default.div`
  margin: 15px auto;
  height: 33px;
  display: flex;
  align-items: center;
...
`,so=({currentPage:e=1,lastPage:t=1,onChangePage:r=()=>{}})=>{const[n,i]=w.useState(String(e)||"");w.useEffect(()=>{e!==0&&(!e||(Number(e)||1)>t?(i(String(t)),r(Number(t))):(r(Number(e)),i(String(e))))},[e]);const a=f=>{if(!((Number(f)||1)>t)){if(t>0&&(Number(n)<1||!Number(f))){i("1"),r(1);return}if(!f)return i("");i(f),r(Number(f)||1)}},d=()=>Number(n)<=1?"1px solid #BFBFBF":"1px solid #4318FF",s=()=>Number(n)<=1?"#BFBFBF":"#4318FF",h=()=>Number(n)===t?"#BFBFBF":"#4318FF",A=()=>Number(n)===Number(t)||Number(n)===1;return o.jsxs(Hi,{disabled:A(),children:[o.jsxs("button",{type:"button",disabled:n==="1",onClick:()=>a(String(1)),style:{padding:"0px",backgroundColor:"#fff",border:d()},children:[o.jsx(ie,{size:12,color:s()}),o.jsx(ie,{size:12,color:s(),styleContainer:{marginLeft:"-5px"}})]}),o.jsx("button",{type:"button",disabled:n==="1",onClick:()=>a(String((Number(n)||1)-1)),style:{padding:"0px",backgroundColor:"#fff",border:d()},children:o.jsx(ie,{size:12,color:s()})}),o.jsx("input",{type:"number",value:Number(n),max:t,onChange:f=>a(f.target.value||"")}),o.jsxs("p",{style:{whiteSpace:"nowrap"},children:["de ",t]}),o.jsx("button",{type:"button",disabled:Number(n)===t,onClick:()=>a(String((Number(n)||1)+1)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===t?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:o.jsx(le,{size:12,color:h()})}),o.jsxs("button",{type:"button",disabled:Number(n)===t,onClick:()=>a(String(t)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===t?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:[o.jsx(le,{size:12,color:h()}),o.jsx(le,{size:12,color:h(),styleContainer:{marginLeft:"-5px"}})]})]})},Pi=e=>{const t=w.useRef(0),r=w.useRef(0),n=w.useRef(!1);w.useEffect(()=>{if(!e.current||n.current)return;const i=e.current,a=s=>{s.preventDefault();const A=s.pageX-i.offsetLeft-t.current;i.scrollLeft=r.current-A},d=()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",d)};return i.addEventListener("mousedown",s=>{t.current=s.pageX-i.offsetLeft,r.current=i.scrollLeft,window.addEventListener("mousemove",a),window.addEventListener("mouseup",d)}),n.current=!0,()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",d)}},[e])},Zi=l.default.div`
  width: 100%;
  overflow-x: auto;
...
`,Qi=({loading:e=!1,headers:t,body:r,noHover:n=!1,styleWrapper:i,styleTable:a,styleTHead:d,styleTBody:s,onScroll:h,showPagination:A=!0,pagination:f={onChangePage:()=>{},lastPage:1,currentPage:1}})=>{const[g,b]=w.useState([]),x=w.useRef(null),v=w.useRef(null);Pi(v),w.useLayoutEffect(()=>{b(Array.from(Array(t.props.children.length).keys()))},[t.props.children.length]);const k=M=>{!h||(x.current&&clearTimeout(x.current),x.current=setTimeout(()=>{var C;h(((C=M.target)==null?void 0:C.scrollLeft)||0)},50))};return o.jsxs(o.Fragment,{children:[o.jsx(Zi,{style:i,onScroll:k,ref:v,children:o.jsxs(Yi,{noHover:n,style:a,children:[o.jsx("thead",{style:d,children:o.jsx("tr",{children:t})}),o.jsx("tbody",{style:s,children:e?Array.from(Array(2).keys()).map(M=>o.jsx("tr",{children:g.map(C=>o.jsx("td",{children:o.jsx(S.default,{width:"100%",height:"100%"})},C))},M)):r})]})}),A&&!e&&o.jsx(so,{currentPage:f.currentPage,lastPage:f.lastPage,onChangePage:f.onChangePage}),A&&e&&o.jsx(S.default,{width:"240px",height:"20px",style:{display:"block",margin:"15px auto 0"}})]})},Wi=p.css`
  background: none;
  outline: none;
  border: none;
  padding: none;
...
`,Vi=l.default.button`
  ...
  ${({isLoading:e})=>se({isLoading:e})};
  ${({disabled:e})=>V({disabled:e})};
`,Ji=({container:e,options:t,closeIcon:r})=>{var n;return o.jsxs(Oi,{marginBottom:e==null?void 0:e.marginBottom,padding:e==null?void 0:e.padding,isSticky:e==null?void 0:e.isSticky,zIndex:e==null?void 0:e.zIndex,children:[r!=null&&r.hide?o.jsx("div",{}):o.jsx(_,{onClick:r.onClick,style:{marginLeft:(r==null?void 0:r.marginLeft)||"20px"},children:o.jsx($,{})}),o.jsx(Gi,{minWidthForOptions:t.minWidth,paddingForOptions:t.padding,children:(n=t==null?void 0:t.options)==null?void 0:n.map((i,a)=>o.jsx(Vi,{onClick:i.onClick,type:"button",mode:i.mode,disabled:i.disabled,children:i.text},`${a}${i.id}`))})]})},Xi=l.default.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  font-size: 14px;
...
`,qi=({title:e,subtitle:t,aside:r})=>o.jsxs(Xi,{children:[o.jsxs(Ki,{children:[e,t&&o.jsxs("span",{children:[o.jsx(ee,{size:10})," ",t]})]}),r]}),Ri=l.default.div`
  display: flex;
  gap: ${({gap:e})=>e||"15px"};
  align-items: center;
  justify-content: center;
...
`,el=({title:e,total_PEN:t,total_USD:r,tip_PEN:n,tip_USD:i,main:a,loading:d,autoWidth:s,noDecimals:h=!1,containerStyle:A})=>{const f=g=>po(g,h?0:2);return o.jsx(_i,{main:a,autoWidth:s,style:A,children:d?o.jsxs(o.Fragment,{children:[o.jsx(ho,{children:o.jsx(S.default,{width:"150px",height:"15px"})}),o.jsxs(go,{children:[o.jsxs(Q,{style:{marginRight:"30px"},children:[o.jsx(Ao,{})," ",o.jsx("span",{children:o.jsx(S.default,{width:"50px",height:"15px"})})]}),o.jsxs(Q,{children:[o.jsx(fo,{})," ",o.jsx("span",{children:o.jsx(S.default,{width:"50px",height:"15px"})})]})]}),o.jsx(xo,{children:o.jsx(S.default,{width:"150px",height:"15px"})})]}):o.jsxs(o.Fragment,{children:[o.jsx(ho,{children:e||""}),o.jsxs(go,{children:[t&&t>0?o.jsxs(Q,{style:{marginRight:"30px"},children:[o.jsx(Ao,{})," ",o.jsx("span",{children:f(t)})]}):null,r&&r>0?o.jsxs(Q,{children:[o.jsx(fo,{})," ",o.jsx("span",{children:f(r)})]}):null]}),o.jsx(xo,{children:n&&n>0||i&&i>0?o.jsxs(o.Fragment,{children:[o.jsx("span",{children:"Propina: "}),n&&n>0?o.jsxs("span",{children:[" ",` S/${f(n)}`]}):null,i&&i>0?o.jsxs("span",{children:[" ",` $/${f(i)}`]}):null]}):null})]})})},ol=({size:e=20,color:t="#242954",onClick:r,styleContainer:n})=>o.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:o.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:o.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},stroke:t,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:o.jsx("polyline",{points:"22 12 18 12 15 21 9 3 6 12 2 12"})})})}),tl=({size:e=20,color:t="#242954",onClick:r,styleContainer:n})=>o.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:o.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:o.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},stroke:t,viewBox:"0 0 24 24",strokeWidth:"0",xmlns:"http://www.w3.org/2000/svg",fill:t,children:o.jsx("path",{d:"M21 11H6.83l3.58-3.59L9 6l-6 6 6 6 1.41-1.41L6.83 13H21z"})})})}),uo=l.default.div`
...
`,rl=({name:e,symbol:t,currentAmount:r,oldAmount:n,loading:i,autoWidth:a=!1,noDecimals:d,containerStyle:s})=>{var b;const h=x=>po(x,d?0:2),A=()=>{if(!r||!n)return 0;const x=Math.round(r*100/n);return Number.isNaN(x-100)?0:Number.isFinite(x-100)?x:100},f={isUp:!r||!n?!1:r>=n,value:`${(b=h(A()))!=null?b:"0"}%`},g=`${t!=null?t:""} ${h(r||0)}`;return i?o.jsxs(uo,{autoWidth:Boolean(a),style:s,children:[e&&o.jsx(bo,{children:o.jsx(S.default,{width:"70px",height:"17px"})}),o.jsxs(wo,{children:[o.jsx(S.default,{width:"50px",height:"30px"}),f&&f.value&&o.jsx(vo,{isUp:f.isUp,children:o.jsx(S.default,{width:"50px",height:"15px"})})]})]}):o.jsxs(uo,{autoWidth:Boolean(a),style:s,children:[e&&o.jsxs(bo,{children:[o.jsx(ol,{size:14}),e]}),o.jsxs(wo,{children:[o.jsx("strong",{children:g}),f&&f.value&&o.jsx(vo,{isUp:f.isUp,children:o.jsxs("strong",{children:[o.jsx(tl,{size:14,color:f.isUp?"#27ae60":"#ea345f",styleContainer:{transform:f.isUp?"rotate(90deg)":"rotate(-90deg)"}}),f.value]})})]})]})};u.ActionOptionsModal=wi,u.Badge=dr,u.BaseInput=On,u.BulletOptionsModal=gi,u.BulletPoint=we,u.Button=N,u.ButtonsSelect=Oe,u.ButtonsSwitch=Hn,u.Card=Cr,u.CardModal=j,u.CartProduct=D0,u.CartProductV2=q0,u.Checkbox=Fn,u.ClientCard=Vr,u.CodeInput=Qo,u.Collapsible=at,u.ConfirmationCard=un,u.ConfirmationCardV2=kn,u.ConfirmationCardV3=Xe,u.ConfirmationModalV3=ci,u.CurrentStatusCard=kr,u.CustomSelect=fe,u.DropdownMenu=ut,u.EditQuantityInput=oe,u.GridTable=Ui,u.Heading=Ho,u.HorizontalDivision=Xt,u.IDCard=d0,u.IconV2=F,u.KpiCard=el,u.KpiCardV2=rl,u.Loader=et,u.ModalHeader=Ji,u.MultipleOptionsModal=di,u.Navbar=Ot,u.NoData=Ct,u.OptionsModal=eo,u.OrderStatusBadge=ke,u.OrderTypeBanner=fr,u.Pagination=so,u.ProductDetailsCard=cn,u.ProfileImage=qo,u.Radio=Bn,u.Search=xe,u.SectionCard=Pr,u.SectionHeader=qi,u.SelectField=$n,u.SimpleFooter=$i,u.StatusBanner=wr,u.StickyHeader=ct,u.SupplyInput=Qn,u.Tab=qt,u.Table=Qi,u.Text=E,u.TextField=$e,u.ToastCard=o0,u.ToggleSwitch=Kn,u.TotalsCard=zr,u.TransparentBadge=ye,u.UploadFileContainer=re,u.UploadImage=yi,u.UploadMultipleImages=Si,u.UserIconTooltip=Me,u.UserProfileIcon=Y,u.UsersList=nr,Object.defineProperties(u,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
