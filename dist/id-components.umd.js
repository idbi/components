(function(v,f){typeof exports=="object"&&typeof module<"u"?f(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("@radix-ui/react-collapsible"),require("@floating-ui/react-dom"),require("react-loading-skeleton"),require("react-select"),require("date-fns"),require("react-date-range"),require("google-map-react")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","@radix-ui/react-collapsible","@floating-ui/react-dom","react-loading-skeleton","react-select","date-fns","react-date-range","google-map-react"],f):(v=typeof globalThis<"u"?globalThis:v||self,f(v["ID-Components"]={},v.styled,v["react/jsx-runtime"].js,v.React,v["@radix-ui/react-collapsible"],v["@floating-ui/react-dom"],v.Skeleton,v.Select,v["date-fns"],v["react-date-range"],v["google-map-react"]))})(this,function(v,f,t,x,Zt,U,Wt,Qt,Ot,Vt,Gt){"use strict";const Z=e=>e&&typeof e=="object"&&"default"in e?e:{default:e};function Xt(e){if(e&&e.__esModule)return e;const o=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const r in e)if(r!=="default"){const n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(o,r,n.get?n:{enumerable:!0,get:()=>e[r]})}}return o.default=e,Object.freeze(o)}const l=Z(f),P=Z(x),R=Xt(Zt),F=Z(Wt),Jt=Z(Qt),Kt=Z(Gt),qt={bold:700,medium:500,regular:400,light:300},be={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},ve={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},d={color:{NEUTRAL:{0:"#FFFFFF",20:"#FFFFFF",50:"#F5F5F5",100:"#EBEBEB",200:"#dfdfdf",300:"#bfbfbf",400:"#9f9f9f",500:"#808080",600:"#404040",700:"#383838",800:"#202020",900:"#000000"},PRIMARY:{0:"#FFFFFF",50:"#F1F2F9",100:"#E6E8F4",200:"#DDDFF0",300:"#BBBFE2",400:"#999FD3",500:"#777fc5",600:"#545fb6",700:"#414a98",800:"#333a76",900:"#242954"},SECONDARY:{0:"#FFFFFF",20:"#F7F5FF",50:"#EFEBFF",100:"#E6E0FF",200:"#d0c5ff",300:"#d0c5ff",400:"#b9a8ff",500:"#a18cff",600:"#8a6fff",700:"#7252ff",800:"#5b35ff",900:"#4318FF"},TERTIARY:{0:"#FFFFFF",50:"#FFFAFC",100:"#FFF5F9",200:"#ffeff5",300:"#ffe0eb",400:"#ffd0e1",500:"#ffc1d7",600:"#ffb1cd",700:"#FFA1C3",800:"#ff92b9",900:"#FF82AF"},QUATERNARY:{0:"#FFFFFF",50:"#FBFCFE",100:"#F2F6FD",200:"#ebf1fc",300:"#D8E4FA",400:"#c4d6f8",500:"#b0c8f5",600:"#9cbbf3",700:"#88adf0",800:"#75a0ed",900:"#6192EB"},STATE:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEF7EB",200:"#fef3e3",300:"#fde7c6",400:"#fcdba9",500:"#fbcf8d",600:"#fac270",700:"#f9b654",800:"#f8aa38",900:"#F79E1B"},ALERT:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEEDEC",200:"#fde3e2",300:"#fbc8c5",400:"#f9ada8",500:"#f7918b",600:"#f4756d",700:"#F25A50",800:"#F03E33",900:"#EE2316"},SUCCESS:{0:"#FFFFFF",50:"#F7FDFA",100:"#EEFBF4",200:"#e4f9ed",300:"#c9f3db",400:"#aeedc9",500:"#93e7b7",600:"#78e1a4",700:"#5DDB92",800:"#42D580",900:"#2DC96F"},OTHER:{color1:"#151E5A"},STATUS:{DEFAULT:{0:"#F5F5F5",1:"#808080"},DRAFT:{0:"#F5F5F5",1:"#808080"},PENDING:{0:"#DFDFDF",1:"#404040"},REJECTED:{0:"#FDE3E2",1:"#EE2316"},ACCEPTED:{0:"#D0C5FF",1:"#4318FF"},CANCELED:{0:"#FDE3E2",1:"#EE2316"},PREPARING:{0:"#FEF3E3",1:"#F79E1B"},READYFORPICKUP:{0:"#FFEFF5",1:"#FF82AF"},DELIVERED:{0:"#E4F9ED",1:"#2DC96F"},FINISHED:{0:"#DDDFF0",1:"#414A98 "}}},effect:{darkShadow:{4:"0px 0px 4px 1px rgba(139, 139, 139, 0.32)",6:"0px 1px 6px rgba(60, 60, 60, 0.2)",8:"0px 1px 6px rgba(107, 107, 107, 0.2)",12:"0px 0px 12px 2px #F6F6F6",24:"0px 0px 24px 4px rgba(0, 14, 51, 0.2)",30:"0px 10px 30px rgba(0, 0, 0, 0.08)"},lightShadow:{2:"0px 0px 2px 1px rgba(149, 178, 254, 0.2)",16:"0px 4px 16px rgba(153, 181, 255, 0.2)"}}},Rt=({shape:e})=>{switch(e){case"rounded":return f.css`
      ...
      `;default:return f.css`
        border-radius: 0.625rem;
      `}},$t=({design:e,color:o,fontColor:r})=>{switch(e){case"solid":return f.css`
        background-color: ${()=>j({color:o})};
        color: ${r?j({color:r}):"#fff"};
      `;case"outline":return f.css`
        background-color: white;
        border: 1px solid ${()=>j({color:o})};
        color: ${()=>j({color:o})};
      ...
      `;case"link":return f.css`
        ...
        &:hover {
          color: ${()=>j({color:o,hover:!0})};
          text-decoration: underline;
        }
      `;default:return f.css`
        background-color: ${()=>j({color:o})};
        color: #fff;
      `}},j=({color:e="SECONDARY/900",design:o,hover:r})=>{const n=e.split("/"),i=n[0];let a=+n[1];if(r&&a>=300)switch(o){case"solid":a-=100;break;case"outline":a=100;break;case"flat":a=100;break;default:a>=400?a-=100:a+=100;break}if(r&&a<300)switch(o){case"solid":a+=100;break;case"outline":a=100;break;case"flat":a=100;break;default:a-=100;break}return i==="PRIMARY"||i==="NEUTRAL"||i==="SECONDARY"||i==="TERTIARY"||i==="QUATERNARY"||i==="STATE"||i==="ALERT"||i==="SUCCESS"?a===0||a===50||a===100||a===200||a===300||a===400||a===500||a===600||a===700||a===800||a===900?d.color[i][a]:d.color[i][900]:d.color.PRIMARY[900]},we=({fullWidth:e})=>e?f.css`
      width: 100%;
    `:f.css`
    width: auto;
...
`,tr=l.default(er)`
  ...
  ${({size:e})=>_({size:e})};
  ${({shape:e})=>Rt({shape:e})};
  ${({design:e,color:o,fontColor:r})=>$t({design:e,color:o,fontColor:r})};
  ${({fullWidth:e})=>we({fullWidth:e})};
  ${({isLoading:e})=>Ce({isLoading:e})};
  ${({disabled:e})=>$({disabled:e})};
  ${({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:s,p:c,pb:h,pt:p,pr:A,pl:u,py:b,px:g})=>me({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:s,p:c,pb:h,pt:p,pr:A,pl:u,py:b,px:g})};

  &:hover:not(:disabled) {
    background-color: ${({color:e,design:o})=>o==="link"?"transparent":j({color:e,design:o,hover:!0})};
  }
...
`,S=({children:e,...o})=>t.jsxs(tr,{...o,children:[o.leftIcon,e,o.rightIcon]});function rr(e,o,r){const n=()=>{const i=document.querySelectorAll("input");return Array.from(i).filter(s=>s.className===o)};x.useEffect(()=>{const i=a=>{a.key==="Backspace"&&setTimeout(()=>{const s=n(),c=document.activeElement;c.value="";const h=s.indexOf(c);h>0&&s[h-1].focus()},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),x.useEffect(()=>{const i=a=>{if(a.key!=="Backspace"){const s=a.key.toLowerCase();setTimeout(()=>{if(s.length===1){const c=n(),h=document.activeElement;h.value=s;const p=c.indexOf(h);p<c.length-1&&c[p+1].focus()}},0)}};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),x.useEffect(()=>{if(e){const i=a=>{const s=a.key.toLowerCase();(s.length===1||s==="backspace")&&setTimeout(()=>{const h=n().map(p=>p.value).join("");e(h)},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)}},[]),x.useEffect(()=>{if(r){const i=n(),a=i.map(h=>h.value),s=r.split(""),c=s.length===a.length?s:a;i.forEach((h,p)=>{const A=c[p];A&&(h.value=A)})}},[r])}const or=f.keyframes`
  0% {
    opacity: 0;
...
`,ee=l.default.div`
  ...
  ${({shouldAppear:e})=>e&&f.css`
      animation: ${or} 0.2s ease-in;
      animation-fill-mode: forwards;
    `}
`,nr={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},ir=f.css`
  ...
  ${({align:e})=>_t({align:e})}
  ${({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:s,p:c,pb:h,pt:p,pr:A,pl:u,py:b,px:g})=>me({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:s,p:c,pb:h,pt:p,pr:A,pl:u,py:b,px:g})};
`,ar=e=>{const o=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",r=o?"bold":"medium",n=o?ve[e]:ve.text,i="PRIMARY/900";return f.css`
    font-weight: ${({weight:a=r})=>qt[a]||"500"};
    font-size: ${({size:a=n})=>be[a]||a};
    color: ${({color:a=i})=>{const s=a==null?void 0:a.split("/")[0],c=Number(a==null?void 0:a.split("/")[1]);return d.color[s][c]}};
  `},lr=l.default.div`
  ${ir}
  ${({as:e})=>ar(e)}
`,B=({as:e,...o})=>{const r=nr[e];return t.jsx(lr,{as:r,...o})},dr={H1:e=>t.jsx(B,{as:"h1",...e}),H2:e=>t.jsx(B,{as:"h2",...e}),H3:e=>t.jsx(B,{as:"h3",...e}),H4:e=>t.jsx(B,{as:"h4",...e}),H5:e=>t.jsx(B,{as:"h5",...e}),H6:e=>t.jsx(B,{as:"h6",...e})},sr=l.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
  transition: 0.3s ease-out;
`,N=e=>e.rightIcon||e.leftIcon?t.jsxs(sr,{children:[e.leftIcon,t.jsx(B,{as:e.as||"p",...e}),e.rightIcon]}):t.jsx(B,{as:e.as||"p",...e}),cr=l.default.div`
  display: grid;
  ...
  > input {
    ...
    height: 45px;
    border: 1px solid
      ${({errorMessage:e,success:o})=>e?d.color.ALERT[900]:o?d.color.SUCCESS[900]:d.color.NEUTRAL[300]};
    border-radius: 8px;
    background: #fff;
...
`,fr=({id:e,value:o,length:r=4,errorMessage:n,success:i,onChange:a=()=>{},...s})=>(rr(a,e,o),t.jsxs(pr,{children:[t.jsx(cr,{length:r,success:i,errorMessage:n,children:Array.from({length:r}).map((c,h)=>t.jsx("input",{id:h.toString(),className:e,maxLength:1,...s},h))}),n&&t.jsx(ee,{shouldAppear:Boolean(n),children:t.jsx(N,{size:"xs",weight:"light",color:"ALERT/900",children:n})})]})),W=(e,o)=>{x.useEffect(()=>{const r=n=>{if(Array.isArray(e)){for(const i of e)if(!n.target||!i.current||i.current.contains(n.target))return}else if(!n.target||!e.current||e.current.contains(n.target))return;o(n)};return document.addEventListener("mousedown",r),document.addEventListener("touchstart",r),()=>{document.removeEventListener("mousedown",r),document.removeEventListener("touchstart",r)}},[e,o])},Me=e=>t.jsx("svg",{height:e.size||16,width:e.size||16,fill:"none",viewBox:"0 0 16 16",...e,children:t.jsx("path",{d:"M12 5.333v2.534l-4 3.067-4-3.067V5.333L8 8.4l4-3.067Z",fill:"#6B6B6B"})}),hr=e=>t.jsx("svg",{height:13,width:14,fill:"none",viewBox:"0 0 14 13",...e,children:t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5.821 1.606a4.715 4.715 0 1 0 0 9.43 4.715 4.715 0 0 0 0-9.43ZM.125 6.32A5.696 5.696 0 1 1 10.178 9.99l2.553 2.547a.49.49 0 0 1-.693.695l-2.553-2.55A5.696 5.696 0 0 1 .125 6.32Z",fill:"#242954"})}),Ar=e=>t.jsx("svg",{stroke:"currentColor",fill:"currentColor",strokeWidth:0,color:e.color||"#EE2316",height:24,width:24,viewBox:"0 0 24 24",...e,children:t.jsxs("g",{stroke:"none",children:[t.jsx("path",{fill:"none",d:"M0 0h24v24H0z"}),t.jsx("path",{d:"M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-1-5h2v2h-2v-2zm0-8h2v6h-2V7z"})]})}),gr=e=>t.jsx("svg",{stroke:"currentColor",fill:"currentColor",strokeWidth:0,color:e.color||"#2DC96F",height:20,width:20,viewBox:"0 0 1024 1024",...e,children:t.jsx("path",{d:"M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 0 0-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z",stroke:"none"})}),ur=l.default.div`
  ...
  border-radius: 8px;
  border: 1px solid
    ${({error:e,success:o,isFocused:r})=>e?d.color.ALERT[900]:o&&r?d.color.SUCCESS[900]:r?d.color.QUATERNARY[900]:d.color.NEUTRAL[300]};
  background: #fff;
  min-height: 45px;
  ::placeholder {
    color: ${()=>d.color.NEUTRAL[500]};
...
`,te=x.forwardRef(({type:e,leftAddon:o,rightAddon:r,placeholder:n,error:i,success:a,size:s,fullWidth:c,name:h,infoMessage:p,onFocus:A,onBlur:u,onChange:b,...g},w)=>{const[C,k]=x.useState(!1),m=!i&&!a&&p&&C;return t.jsxs(t.Fragment,{children:[t.jsxs(ur,{fullWidth:c,success:a,size:s,error:i,disabled:g.disabled,leftAddon:o,rightAddon:r,isFocused:C,children:[o&&t.jsx("span",{className:"leftAddon",children:o}),t.jsx("input",{ref:w,onFocus:M=>{A&&A(M),k(!0)},onBlur:M=>{u&&u(M),k(!1)},onChange:b,placeholder:n,type:e,name:h,...g}),r&&t.jsx("span",{className:"rightAddon",children:r}),i&&t.jsx("span",{className:"state",children:t.jsx(Ar,{size:24,color:d.color.ALERT[900]})}),a&&t.jsx("span",{className:"state",children:t.jsx(gr,{size:20,color:d.color.SUCCESS[900]})})]}),m&&t.jsx(ee,{shouldAppear:m,children:t.jsx(N,{size:"xs",color:"QUATERNARY/900",children:p})})]})});te.displayName="TextInput";const xr=l.default.div`
  position: relative;
...
`,ke=x.forwardRef(({label:e,searchable:o=!0,autoSize:r,value:n,options:i,placeholder:a="Seleccione una opci\xF3n",fullWidth:s,fullWidthOptions:c,onChange:h,formatOptionLabel:p,formatSelectedOption:A})=>{const u=x.useRef(null),[b,g]=x.useState(i),[w,C]=x.useState(""),[k,m]=x.useState(!1);W(u,()=>{m(!1)});const M=x.useCallback(()=>{const L=i.filter(T=>T.label.toLowerCase().includes(w.toLowerCase()));g(L)},[i,n]),E=x.useCallback(L=>{h(i.find(T=>T.label===L)),m(!1),C(""),g(i)},[M]),y=x.useCallback(L=>{C(L.target.value);const T=i.filter(I=>I.label.toLowerCase().includes(L.target.value.toLowerCase()));g(T)},[]),D=()=>{const L=u.current;if(L){const T=L.getBoundingClientRect();return window.innerHeight-T.bottom-20}};return t.jsxs(xr,{fullWidth:s,ref:u,children:[e&&t.jsx(N,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),t.jsxs("div",{className:"select-btn",onClick:()=>m(!k),tabIndex:0,onKeyUpCapture:L=>{L.key==="Enter"&&m(!k)},children:[t.jsx(N,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:A?A(n):p?p(n):n.label}),t.jsx(Me,{size:20})]}),k&&t.jsxs(br,{maxOptionsHeight:r?D():285,fullWidthOptions:c,children:[o&&t.jsx("div",{className:"search-box",children:t.jsx(te,{leftAddon:t.jsx(hr,{}),type:"text",placeholder:a,value:w,onChange:y,fullWidth:!0})}),t.jsx("div",{className:"options",children:b.map(L=>t.jsx(N,{as:"li",color:"NEUTRAL/700",className:L.value===n.value?"selected":"",tabIndex:0,onClick:()=>E(L.label),onKeyUpCapture:T=>{T.key==="Enter"&&E(L.label)},children:p?p(L):L.label},`${L.label}-${L.value}`))})]})]})});ke.displayName="CustomSelect";const vr=l.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,wr=({imageUrl:e,size:o=128,onChange:r})=>{const n=x.useRef(null),i=a=>{var c;const s=(c=a.target.files)==null?void 0:c[0];if(s){const h=URL.createObjectURL(s);r({file:s,url:h})}};return t.jsxs(vr,{size:o,children:[t.jsx(N,{color:"NEUTRAL/400",weight:"regular",size:"xs",children:"Agrega tu foto"}),t.jsxs("div",{className:"profile-input__container",children:[t.jsx("input",{type:"file",accept:"image/png, image/jpeg",onChange:i,ref:n}),t.jsx("img",{width:o,height:o,src:e||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"}),t.jsx(S,{type:"button",size:"lg",design:"flat",shape:"circular",onClick:()=>{var a;return(a=n.current)==null?void 0:a.click()},children:"+"})]})]})},Cr=f.keyframes`
  0%,
  100% {
...
`,zr=({onBack:e,backLabel:o,profileImageUrl:r,rightContent:n})=>t.jsxs(Sr,{children:[t.jsxs("button",{type:"button",onClick:e,children:[t.jsx(X,{}),t.jsx(N,{color:"NEUTRAL/900",children:o})]}),n||t.jsx("img",{width:28,height:28,src:r||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"})]}),Fr=f.keyframes`
  100% {
    transform: rotate(360deg);
  }
`,jr=l.default.div`
...
`,re=e=>t.jsx(jr,{width:e.width,height:e.height,borderWidth:e.borderWidth,margin:e.margin}),Le=l.default.ul`
...
`,Hr=l.default.div`
  ...
  top: 0;
  right: calc(100% + 8px);
`,Pr=({text:e,options:o})=>{const[r,n]=x.useState(!1),i=x.useRef(null),a=s=>{if(i.current&&clearTimeout(i.current),s){n(!0);return}i.current=setTimeout(()=>{r!==s&&n(s)},50)};return t.jsxs(oe,{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),active:r,onClick:s=>s.stopPropagation(),children:[e," ",t.jsx("div",{style:{transform:"rotateY(180deg)"},children:t.jsx(X,{})}),r&&t.jsx(Hr,{children:t.jsx(Le,{children:o.map((s,c)=>t.jsxs(oe,{alert:s.alert,onClick:h=>s.disabled||s.loading?h.stopPropagation():s.onClick(),disabled:s.disabled||s.loading,loading:s.loading,children:[s.text," ",s.loading?t.jsx("div",{style:{width:"24px"},children:t.jsx(re,{width:"20px",height:"20px"})}):s.icon]},`suboption-${c}`))})})]})},Ur=({options:e,header:o})=>t.jsxs(Le,{children:[o&&t.jsx(Br,{children:o}),e.map((r,n)=>"options"in r?t.jsx(Pr,{...r},`option-${n}`):t.jsxs(oe,{disabled:r.disabled||r.loading,alert:r.alert,onClick:r.disabled||r.loading?i=>i.stopPropagation():r.onClick,loading:r.loading,children:[r.text," ",r.loading?t.jsx("div",{style:{width:"24px"},children:t.jsx(re,{width:"20px",height:"20px"})}):r.icon]},`option-${n}`))]}),Yr=l.default.div`
  display: flex;
  cursor: pointer;
  text-align: right;
  * {
...
`,Zr=({options:e,activator:o,header:r})=>{const{x:n,y:i,reference:a,floating:s,strategy:c,update:h,refs:p}=U.useFloating({placement:"bottom-end"}),[A,u]=x.useState(!1);return x.useEffect(()=>{if(!(!p.reference.current||!p.floating.current))return U.autoUpdate(p.reference.current,p.floating.current,h)},[A,h]),W(p.reference,()=>{u(!1)}),t.jsxs("div",{ref:a,children:[t.jsx(Yr,{onClick:()=>u(!A),children:o||t.jsx(Me,{size:25})}),A&&t.jsx("div",{ref:s,style:{position:c,top:i!=null?i:0,left:n!=null?n:0,zIndex:100},onClick:()=>u(!A),children:t.jsx(Ur,{options:e,header:r})})]})},Wr=l.default.div`
  text-align: center;
  font-weight: 300;
  font-size: 0.75rem;
...
`,Kr=e=>e==="small"?"45px":e==="big"?"55px":`${e}px`,qr=l.default.input`
  width: 100%;
  height: ${({containerSize:e})=>Kr(e)};
  padding: 8px 15px;
...
`,to=({show:e=!0,data:o,onSelectItem:r={hideOnSelect:!0,onSelect:()=>{}},getLabel:n,containerStyle:i,hideOnBlur:a=!0,enableScannerBehavior:s=!1,addCreateOption:c={show:!1,location:"top"},loading:h,searchRef:p,handleCleanOption:A,search:u})=>{var m;if(!e)return null;const b=x.useRef(null),[g,w]=x.useState(!1);W([b,p],()=>{if(a)return w(!0)});const C=()=>{A(),w(!0)};x.useEffect(()=>{w(!1)},[(m=p==null?void 0:p.current)==null?void 0:m.value]),x.useEffect(()=>{(o==null?void 0:o.length)===1&&s&&(C(),r!=null&&r.onSelect&&r.onSelect(o[0]))},[o]);const k=()=>t.jsx(eo,{onClick:()=>{c!=null&&c.onCreate&&(c==null||c.onCreate(u),C())},children:(c==null?void 0:c.text)||"Crear"});return t.jsxs(Rr,{style:i,ref:b,active:Boolean(!g&&o&&u.length>=1),children:[c.show&&c.location==="top"&&k(),!h&&o&&o.length>0?o.map((M,E)=>{var y;return t.jsx(ye,{onClick:()=>{r!=null&&r.onSelect&&r.onSelect(M),r!=null&&r.hideOnSelect&&C()},children:n?n(M):`${M.name} ${M.quantity} ${(y=M.kardex_unit)==null?void 0:y.symbol}`},`${E}search`)}):t.jsx(ye,{style:{color:"#cbbcbb"},children:h?"Buscando":"Sin resultados"}),c.show&&c.location==="bottom"&&k()]})},Ee=({onSearch:e,initSearch:o,placeholder:r,loading:n=!1,disabled:i=!1,addSearchIcon:a=!1,addCleanOption:s=!1,size:c="small",delay:h=400,alert:p=!1,foundItems:A})=>{const u=x.useRef(null),b=x.useRef(null),[g,w]=x.useState(o||""),C=()=>{w(""),e("")},k=m=>{b.current!==null&&clearTimeout(b.current),w(m),b.current=setTimeout(()=>e(m),h)};return t.jsxs(Xr,{children:[t.jsxs(Jr,{disabled:i,children:[a&&t.jsx("div",{className:"icon",children:t.jsx(Gr,{})}),t.jsx(qr,{ref:u,value:g,onChange:m=>{var M;return k(((M=m==null?void 0:m.target)==null?void 0:M.value)||"")},placeholder:r,addSearchIcon:a,addCleanOption:s,containerSize:c,disabled:i,alert:p}),s&&t.jsx(ie,{onClick:()=>C(),className:"clean",children:t.jsx(ne,{})})]}),t.jsx($r,{children:t.jsx(_r,{active:n})}),t.jsx(to,{...A,loading:n,searchRef:u,handleCleanOption:C,search:g})]})};var Te={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},De=P.default.createContext&&P.default.createContext(Te),H=globalThis&&globalThis.__assign||function(){return H=Object.assign||function(e){for(var o,r=1,n=arguments.length;r<n;r++){o=arguments[r];for(var i in o)Object.prototype.hasOwnProperty.call(o,i)&&(e[i]=o[i])}return e},H.apply(this,arguments)},ro=globalThis&&globalThis.__rest||function(e,o){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&o.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)o.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r};function Ne(e){return e&&e.map(function(o,r){return P.default.createElement(o.tag,H({key:r},o.attr),Ne(o.child))})}function oo(e){return function(o){return P.default.createElement(no,H({attr:H({},e.attr)},o),Ne(e.child))}}function no(e){var o=function(r){var n=e.attr,i=e.size,a=e.title,s=ro(e,["attr","size","title"]),c=i||r.size||"1em",h;return r.className&&(h=r.className),e.className&&(h=(h?h+" ":"")+e.className),P.default.createElement("svg",H({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},r.attr,n,s,{className:h,style:H(H({color:e.color||r.color},r.style),e.style),height:c,width:c,xmlns:"http://www.w3.org/2000/svg"}),a&&P.default.createElement("title",null,a),e.children)};return De!==void 0?P.default.createElement(De.Consumer,null,function(r){return o(r)}):o(Te)}function io(e){return oo({tag:"svg",attr:{viewBox:"0 0 1024 1024"},child:[{tag:"path",attr:{d:"M904 160H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0 624H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8zm0-312H120c-4.4 0-8 3.6-8 8v64c0 4.4 3.6 8 8 8h784c4.4 0 8-3.6 8-8v-64c0-4.4-3.6-8-8-8z"}}]})(e)}const Ie=({size:e=20,color:o,onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",height:`${e}px`,width:`${e}px`,minHeight:`${e}px`,minWidth:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsxs("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},viewBox:"0 0 51 38",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:[t.jsx("path",{d:"M8.68468 37.2785H1.76362C0.793549 37.2785 0 36.4597 0 35.4591V1.81935C0 0.818547 0.793549 0 1.76362 0H8.68468C9.65499 0 10.4484 0.818547 10.4484 1.81935V35.4591C10.4485 36.4596 9.65499 37.2785 8.68468 37.2785Z",fill:o||"#FF82AF"}),t.jsx("path",{d:"M47.7558 28.1164C46.1966 30.9598 43.9696 33.1973 41.0768 34.8301C38.1827 36.4619 34.8128 37.2785 30.9667 37.2785H20.0311C17.6019 37.2785 15.6328 35.2839 15.6328 32.8226V0H30.9667C34.8128 0 38.1827 0.789835 41.0768 2.36914C43.9696 3.94904 46.1966 6.14324 47.7558 8.95055C49.3154 11.7597 50.0951 14.9531 50.0951 18.5339C50.0951 22.0796 49.3155 25.2734 47.7558 28.1164ZM36.1125 24.6941C37.6371 23.2552 38.3996 21.2016 38.3996 18.534C38.3996 15.8666 37.6371 13.8132 36.1125 12.3735C34.5871 10.9343 32.5262 10.2148 29.9276 10.2148H27.1723V24.0626C27.1723 25.6038 28.4058 26.8533 29.9276 26.8533C32.5262 26.8531 34.5871 26.1341 36.1125 24.6941Z",fill:o||"#242954"})]})})}),ao=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},viewBox:"0 0 16 18",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.99997 1.54286C7.2999 1.54286 6.81803 2.06181 6.81803 2.6V3.48048L6.33422 3.67554C5.27841 4.10122 4.60179 4.91758 4.18003 5.67403C3.97081 6.04929 3.83178 6.3971 3.7457 6.64935C3.70285 6.77493 3.67364 6.87529 3.65573 6.94158C3.64969 6.96392 3.64495 6.98234 3.64142 6.99646L3.23612 10.7743L1.57986 13.5343C1.56644 13.5567 1.55975 13.5709 1.55678 13.5781C1.52881 13.7706 1.57445 13.8892 1.60956 13.9386C1.62593 13.9616 1.64422 13.9772 1.66835 13.9892C1.69311 14.0014 1.74309 14.019 1.83233 14.019H14.1676C14.2545 14.019 14.3041 14.0024 14.3293 13.9903C14.3538 13.9786 14.3717 13.9636 14.3874 13.9427C14.4204 13.8987 14.4659 13.7923 14.4476 13.6139C14.4428 13.6039 14.4322 13.5848 14.4112 13.5566L12.349 10.7781V6.9595C12.3475 6.95384 12.3459 6.94787 12.3442 6.94158C12.3263 6.87529 12.2971 6.77493 12.2543 6.64935C12.1682 6.3971 12.0291 6.0493 11.8199 5.67404C11.3982 4.91759 10.7215 4.10122 9.66573 3.67555L9.18192 3.48049V2.6C9.18192 2.06181 8.70005 1.54286 7.99997 1.54286ZM13.1232 6.86667L13.8804 6.70597L13.8974 6.78543V10.2695L15.6562 12.6392C15.7912 12.8212 15.9441 13.0854 15.9837 13.4184C16.0424 13.9121 15.9465 14.442 15.6269 14.8674C15.2923 15.3127 14.7721 15.5619 14.1676 15.5619H11.1175C10.7498 16.9878 9.38528 18 7.83231 18C6.27933 18 4.91484 16.9878 4.54709 15.5619H1.83233C1.20881 15.5619 0.677517 15.2968 0.345961 14.8303C0.0304641 14.3864 -0.0508217 13.8379 0.0281842 13.3315C0.0662252 13.0877 0.163889 12.8875 0.250905 12.7425L1.73263 10.2733L2.11117 6.745L2.11951 6.70597L2.87673 6.86667C2.11951 6.70597 2.11944 6.70628 2.11951 6.70597L2.11978 6.7047L2.12012 6.70316L2.12096 6.69928L2.1234 6.68838L2.13136 6.65437C2.13808 6.62642 2.1477 6.58806 2.16056 6.54047C2.18625 6.44538 2.22503 6.31292 2.27971 6.15268C2.3887 5.83328 2.56293 5.39745 2.82647 4.92477C3.29164 4.09044 4.05903 3.10048 5.27306 2.46682C5.34647 1.05189 6.58345 0 7.99997 0C9.4165 0 10.6535 1.05189 10.7269 2.46683C11.9409 3.10049 12.7083 4.09044 13.1735 4.92477C13.437 5.39745 13.6112 5.83328 13.7202 6.15268C13.7749 6.31292 13.8137 6.44538 13.8394 6.54047C13.8523 6.58806 13.8619 6.62642 13.8686 6.65437L13.8765 6.68837L13.879 6.69928L13.8798 6.70316L13.8802 6.7047L13.8804 6.70597C13.8805 6.70628 13.8804 6.70597 13.1232 6.86667ZM6.20854 15.5619C6.50779 16.0815 7.10213 16.4571 7.83231 16.4571C8.56249 16.4571 9.15682 16.0815 9.45607 15.5619H6.20854Z",fill:o})})})}),lo=l.default.svg`
  vertical-align: middle;
`,z=({color:e="currentColor",size:o,children:r,...n})=>t.jsx(lo,{color:e,height:o?`${o}px`:"1em",width:o?`${o}px`:"1em",xmlns:"http://www.w3.org/2000/svg",...n,children:r}),ae=e=>t.jsx(z,{viewBox:"0 0 15 9",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M0.692211 1.06721C0.948493 0.81093 1.36401 0.81093 1.62029 1.06721L7.28125 6.72817L12.9422 1.06721C13.1985 0.81093 13.614 0.81093 13.8703 1.06721C14.1266 1.32349 14.1266 1.73901 13.8703 1.99529L7.74529 8.12029C7.48901 8.37657 7.07349 8.37657 6.81721 8.12029L0.692211 1.99529C0.43593 1.73901 0.43593 1.32349 0.692211 1.06721Z",fill:"currentColor"})}),so=l.default.div`
...
`,J=({img:e,size:o=36,initials:r,containerProps:{style:n,...i}={}})=>{const a=r.slice(0,2).toUpperCase();return t.jsx(so,{hasImg:!(e!=null&&e.src),style:{width:`${o}px`,minWidth:`${o}px`,height:`${o}px`,fontSize:`${o/(r.length===1?2:2.25)}px`,...n||{}},...i,children:e!=null&&e.src?t.jsx("img",{...e}):a})},Q=f.css`
  ::-webkit-scrollbar {
    width: 4px;
    height: 4px;
  }
...
`,xo=({option:e,onClose:o,subOptions:r=[]})=>{const[n,i]=x.useState(!1);return t.jsxs("li",{onClick:()=>{r.length>0?i(!n):(e.onClick(),o())},children:[t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.text," ",r.length>0&&t.jsx(ae,{size:12,style:{display:"block",marginLeft:"auto",marginRight:"0",transform:n?"":"rotate(-90deg)"}})]}),n&&r.length>0&&t.jsx("ul",{children:r.map((a,s)=>t.jsx("li",{onClick:()=>{a.onClick(),o()},children:a.text},`${s}sub${e.key}`))})]})},bo=({options:e=[],links:o=[],userIcon:r,searchOption:n,logoIcon:i,bellIcon:a,zIndex:s,isSticky:c})=>{const[h,p]=x.useState(!1),[A,u]=x.useState(!1),b=x.useRef(null);return W(b,()=>{p(!1),u(!1)}),t.jsxs(co,{zIndex:s,isSticky:c,ref:b,children:[t.jsxs(po,{children:[t.jsxs(Se,{children:[e.length>0&&t.jsx(io,{size:20,color:"#151E5A",onClick:()=>{u(!1),p(!h)},style:{cursor:"pointer"}}),i!=null&&i.onClick?t.jsx(Ie,{size:28,onClick:()=>{p(!1),u(!1),i==null||i.onClick()}}):t.jsx(Ie,{size:28})]}),t.jsxs(fo,{children:[t.jsx(ho,{children:o.map((g,w)=>t.jsx("li",{onClick:()=>(g==null?void 0:g.onClick)&&(g==null?void 0:g.onClick()),children:g.text},`${w}navbarlinksfordesktop`))}),(n==null?void 0:n.show)&&t.jsx(Ee,{...n,onSearch:g=>n.onSearch(g)}),(a==null?void 0:a.show)&&t.jsx(ao,{size:16,onClick:()=>{a!=null&&a.onClick&&a.onClick(),p(!1),u(!A)}}),(r==null?void 0:r.show)&&t.jsxs(Se,{children:[((r==null?void 0:r.name)||(r==null?void 0:r.note))&&t.jsxs(Ao,{children:[(r==null?void 0:r.name)&&t.jsx(N,{children:r==null?void 0:r.name}),(r==null?void 0:r.note)&&t.jsx(N,{color:"NEUTRAL/500",size:"xs",as:"span",children:r==null?void 0:r.note})]}),t.jsx(J,{initials:(r==null?void 0:r.initials)||"ID",img:(r==null?void 0:r.img)||null,size:35,containerProps:{onClick:()=>{r!=null&&r.onClick&&(p(!1),u(!1),r.onClick())},style:r!=null&&r.onClick?{cursor:"pointer"}:{}}})]})]})]}),h&&t.jsx(go,{children:t.jsx("ul",{children:e.map((g,w)=>t.jsx(xo,{option:g.option,subOptions:g.subOptions,onClose:()=>p(!h)},`${w}navbaroption`))})}),A&&t.jsx(uo,{children:a==null?void 0:a.children})]})},vo=e=>t.jsx(z,{viewBox:"0 0 8 8",...e,children:t.jsx("circle",{xmlns:"http://www.w3.org/2000/svg",cx:"4",cy:"4",r:"4",fill:"currentColor"})}),wo=l.default.span`
...
`,ze=({children:e,spacing:o,color:r,bulletSize:n,size:i})=>t.jsxs(wo,{color:r,size:i,bulletSize:n,spacing:o,children:[t.jsx(vo,{}),e]}),Co=l.default.div`
  display: flex;
  align-items: center;
  gap: 15px;
`,Fe=l.default.div`
  ...
  flex-grow: 1;
`,mo=({children:e,thickness:o=1,hrMinWidth:r=15})=>t.jsxs(Co,{children:[t.jsx(Fe,{thickness:o,minWidth:r}),e,t.jsx(Fe,{thickness:o,minWidth:r})]}),Mo=l.default.button`
  color: currentColor;
  background-color: transparent;
  border: none;
  font-size: 14px;
  ...
  ${({isActive:e,rounded:o,activeColor:r,tabWidth:n,tabFullWidth:i,tabHeight:a})=>e&&f.css`
      color: ${r};
      ::before {
        content: "";
        background-color: ${r};
    ...
    `};
`,ko=({children:e,active:o,tabWidth:r=24,tabHeight:n=4,activeColor:i=d.color.SECONDARY[900],...a})=>t.jsx(Mo,{isActive:o,noWrap:!0,activeColor:i,tabWidth:r,tabHeight:n,...a,children:e});function je(e="(min-width: 768px)"){const[o,r]=x.useState({matches:window.innerWidth>(()=>{const i=e.match(/(\d+)/);return i?i[0]:768})()});return x.useEffect(()=>{let i=window.matchMedia(e);return i.addEventListener("change",r),()=>i.removeEventListener("change",r)},[]),{status:Boolean(o&&o.matches)}}const Lo=l.default.div`
...
`,Eo=({render:e,tooltipContent:o,tooltipStyles:r={},placement:n,offset:i,strategy:a,middlewares:s=[]})=>{const[c,h]=x.useState(!1),p=x.useRef(null),{x:A,y:u,reference:b,floating:g,strategy:w,update:C,refs:k,middlewareData:m,placement:M}=U.useFloating({placement:n||"top",strategy:a,middleware:[U.offset(i!=null?i:10),...s,U.arrow({element:p})]}),{x:E,y}=m.arrow||{},{status:D}=je("(hover: hover)"),L=(I=!0)=>{D&&h(I)};x.useEffect(()=>{if(!(!k.reference.current||!k.floating.current))return U.autoUpdate(k.reference.current,k.floating.current,C)},[c,C]);const T={top:"bottom",right:"left",bottom:"top",left:"right"}[M.split("-")[0]];return t.jsxs(t.Fragment,{children:[e({ref:b,onMouseEnter:()=>L(),onMouseLeave:()=>L(!1)}),c&&t.jsxs(Lo,{ref:g,style:{position:w,top:u!=null?u:0,left:A!=null?A:0,...r},children:[o,t.jsx(yo,{ref:p,style:{left:E!=null?`${E}px`:"",top:y!=null?`${y}px`:"",[T]:"-3px"}})]})]})},To=(...e)=>e.reduce((o,r)=>o+(r||"").charAt(0),"").toUpperCase(),Be=({name:e,lastname:o,img:r,size:n,tooltipProps:i={}})=>t.jsx(Eo,{tooltipContent:`${e} ${o||""}`,render:a=>t.jsx(J,{initials:To(e,o),img:r,size:n,containerProps:{...a}}),...i}),He=e=>t.jsx(z,{viewBox:"0 0 12 12",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M5.99935 0.166992C6.31623 0.166992 6.57312 0.446814 6.57312 0.791992V5.37532L11.2589 5.37532C11.5758 5.37532 11.8327 5.65515 11.8327 6.00032C11.8327 6.3455 11.5758 6.62532 11.2589 6.62532L6.57312 6.62532V11.2087C6.57312 11.5538 6.31623 11.8337 5.99935 11.8337C5.68246 11.8337 5.42558 11.5538 5.42558 11.2087V6.62532L0.739786 6.62533C0.422901 6.62533 0.166016 6.3455 0.166016 6.00033C0.166016 5.65515 0.422901 5.37533 0.739786 5.37533L5.42558 5.37532V0.791992C5.42558 0.446814 5.68246 0.166992 5.99935 0.166992Z",fill:"currentColor"})}),Do=l.default.div`
  display: flex;
...
`,Io=({users:e,onAdd:o,iconSize:r=34})=>t.jsxs(Do,{size:r,children:[o&&t.jsx(No,{size:r,onClick:o,children:t.jsx(He,{size:r/2.5})}),[...e].reverse().map((n,i)=>t.jsx("div",{style:{height:r},children:t.jsx(Be,{...n,size:r,tooltipProps:{strategy:"fixed"}})},`user-${n.name}-${i}`))]}),So=l.default.span`
  ...
  ${({statusName:e,removeBackground:o})=>{if(e==="draft")return f.css`
        background: ${o?"transparent":d.color.STATUS.DRAFT[0]};
        color: ${d.color.STATUS.DRAFT[1]};
      `;if(e==="pending")return f.css`
        background: ${o?"transparent":d.color.STATUS.PENDING[0]};
        color: ${d.color.STATUS.PENDING[1]};
      `;if(e==="rejected")return f.css`
        background: ${o?"transparent":d.color.STATUS.REJECTED[0]};
        color: ${d.color.STATUS.REJECTED[1]};
      `;if(e==="accepted")return f.css`
        background: ${o?"transparent":d.color.STATUS.ACCEPTED[0]};
        color: ${d.color.STATUS.ACCEPTED[1]};
      `;if(e==="canceled")return f.css`
        background: ${o?"transparent":d.color.STATUS.CANCELED[0]};
        color: ${d.color.STATUS.CANCELED[1]};
      `;if(e==="preparing")return f.css`
        background: ${o?"transparent":d.color.STATUS.PREPARING[0]};
        color: ${d.color.STATUS.PREPARING[1]};
      `;if(e==="readyforpickup")return f.css`
        background: ${o?"transparent":d.color.STATUS.READYFORPICKUP[0]};
...
`,Pe={default:"...",draft:"Borrador",pending:"Pendiente",rejected:"Rechazado",accepted:"Aceptado",canceled:"Anulado",preparing:"Preparando",readyforpickup:"Listo para recojo",delivered:"Entregado",finished:"Finalizado"},Ue=({statusName:e,text:o,removeBackground:r})=>{const n=i=>Pe[i]||Pe.default;return t.jsx(So,{statusName:e,removeBackground:r,children:o||n(e)})},zo=l.default.span`
  ...
  display: inline-block;
  font-weight: bold;
`,Ye=(e,o,r)=>e>=o&&e<=r?e:e<o?o:r,Ze=({intensity:e=.8,opacity:o=.5,children:r,style:n={},...i})=>{const a=Ye(e,0,1),s=Ye(o,0,1),c=256*a;return t.jsx(zo,{style:{backgroundColor:`rgba(${c}, ${c}, ${c}, ${s})`,...n},...i,children:r})},Fo=l.default.span`
...
${({withBorder:e,color:o})=>e&&f.css`
      border: 1px solid ${o||d.color.STATUS.DEFAULT[1]};
    `}
`,jo=({text:e,padding:o,color:r,background:n,applyFlex:i,maxWidth:a,weight:s,borderRadius:c,withBorder:h})=>t.jsx(Fo,{padding:o,color:r,background:n,applyFlex:i,maxWidth:a,weigth:s,borderRadius:c,withBorder:h,children:e}),Bo=l.default.div`
  min-height: 50px;
  display: flex;
  justify-content: center;
...
`,Jo=({design:e="primary",header:o,options:r,optionsFormatter:n,content:i,withSeparator:a})=>t.jsxs(Xo,{design:e,withSeparator:a,children:[o&&t.jsx("header",{children:o}),r&&n&&t.jsx("ul",{children:r.map(s=>t.jsx("li",{children:n(s)},s.value))}),i&&i]}),Ko=l.default.div`
  padding: 20px;
  border-radius: 10px;
  background: #fff;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,Ge=l.default.span`
  color: #151E5A;
  font-weight: 500;
`,Ro=({items:e,creationDescription:o,creationDate:r,title:n,children:i})=>t.jsxs(Ko,{children:[n&&t.jsx(qo,{children:n}),e.map(a=>t.jsxs("div",{children:[t.jsxs("p",{children:[a.description&&t.jsx("span",{children:a.description})," ",t.jsx(Ue,{statusName:a.statusName,removeBackground:!0})]}),t.jsx(Ge,{children:a.statusDate})]},crypto.randomUUID())),r&&t.jsxs("div",{children:[o&&t.jsx("span",{children:o}),t.jsx(Ge,{children:r})]}),i]}),$o=l.default.div`
...
`,ln=l.default.img`
  ...
  font-size: 9px;
  object-fit: cover;
`,dn=({items:e,title:o="",onAction:r=()=>{},actionName:n="",hideQuantity:i=!1,children:a,gap:s=10,background:c,padding:h})=>t.jsxs($o,{background:c,padding:h,children:[(o||n)&&t.jsxs(_o,{children:[t.jsx(en,{children:o}),t.jsx(tn,{onClick:()=>r(),children:n})]}),t.jsx(rn,{style:{gap:s},children:e.map(p=>t.jsxs(on,{remark:Boolean(p.remark),children:[i?t.jsxs(Xe,{children:[t.jsxs("div",{children:[t.jsx("span",{children:p.description}),p.notes&&t.jsx(Je,{children:p.notes.map(A=>t.jsx("li",{children:A},crypto.randomUUID()))})]}),p==null?void 0:p.decorators]}):t.jsxs(Xe,{children:[p.img&&t.jsx(ln,{src:p.img,alt:p.description}),t.jsx(nn,{children:p.quantity}),t.jsxs("div",{children:[t.jsx("span",{children:p.description}),p.notes&&t.jsx(Je,{children:p.notes.map(A=>t.jsx("li",{children:A},crypto.randomUUID()))})]}),p==null?void 0:p.decorators]}),t.jsxs(an,{remark:Boolean(p.remark),children:[p.currency," ",p.amount.toFixed(2)]})]},crypto.randomUUID()))}),a]}),sn=l.default.div`
  background-color: white;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,Tn=l.default.span`
  ...
  text-decoration: underline;
  cursor: pointer;
`,Dn=({title:e="",description:o="",type:r,link:n,icon:i})=>{const a=()=>{if(i)return i;if(r==="success")return t.jsx(mn,{});if(r==="warning")return t.jsx(Ke,{});if(r==="error")return t.jsx(Cn,{});if(r==="quaternary")return t.jsx(Mn,{});if(r==="tertiary")return t.jsx(Ke,{color:"#FF82AF"})};return t.jsxs(Ln,{toastType:r||"primary",children:[a(),t.jsxs("div",{children:[e&&t.jsx(yn,{children:e}),o&&t.jsxs(En,{children:[o," ",n&&n.onClick&&t.jsx(Tn,{onClick:s=>{s.stopPropagation(),n.onClick&&n.onClick()},children:(n==null?void 0:n.text)||"Ver m\xE1s"})]})]})]})},qe={xs:"(min-width: 360px)",sm:"(min-width: 591px)",md:"(min-width: 800px)",lg:"(min-width: 1400px)"},Nn=l.default.div`
  font-family: 'Poppins';
  font-style: normal;
  display: flex;
  align-items: center;
...
`,Pn=({onClose:e=()=>{},backdropOpacity:o,zIndex:r})=>(x.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),t.jsx(Hn,{onClick:n=>{n.stopPropagation(),e()},opacity:o,zIndex:r})),Re=f.keyframes`
  from {
...
`,Yn=({children:e,onClose:o,backdropOpacity:r,zIndex:n,contentLocation:i="center",contentLocationInDesktop:a="center",boxShadow:s,boxShadowInDesktop:c,fullWidth:h,styleContainer:p})=>t.jsxs(t.Fragment,{children:[t.jsx(Pn,{onClose:o,backdropOpacity:r,zIndex:n||4}),t.jsx(Un,{zIndex:n||4,contentLocation:i,contentLocationInDesktop:a,onClick:A=>A.stopPropagation(),boxShadow:s,boxShadowInDesktop:c,fullWidth:h,style:p,children:e})]}),Zn=l.default.div`
...
`,Y=({show:e=!0,children:o,onClose:r,backdropOpacity:n,padding:i,borderRadius:a,borderRadiusInDesktop:s,maxHeight:c,height:h,maxWidth:p,width:A,zIndex:u,overflow:b,contentLocation:g="center",contentLocationInDesktop:w="center",closeIcon:C,closeIconInDesktop:k,background:m="#fff",boxShadow:M,boxShadowInDesktop:E,styleContainer:y})=>e?t.jsx(Yn,{onClose:r,backdropOpacity:n,zIndex:u,contentLocation:g,contentLocationInDesktop:w,boxShadow:M,boxShadowInDesktop:E,styleContainer:y,children:t.jsxs(Zn,{padding:i,borderRadius:a,borderRadiusInDesktop:s,maxHeight:c,height:h,maxWidth:p,width:A,background:m,overflow:b,contentLocation:g,contentLocationInDesktop:w,children:[(C||k)&&t.jsx(Wn,{onClick:r,closeIconInDesktop:k,closeIcon:C,children:t.jsx(ne,{})}),o]})}):null,Qn=l.default.h2`
  color: ${d.color.PRIMARY[900]};
  margin-bottom: 20px;
  font-size: 20px;
`,On=l.default.div`
...
`,tt=({onConfirm:e,onClose:o,zIndex:r,onlyIntegers:n,initialValue:i})=>{const a=x.useRef(null),[s,c]=x.useState(i||""),h=A=>{const u=A.target.value;let b=/^[0-9]\d*(\.(\d*))?$/;n&&(b=/^[0-9]*$/),!(u!==""&&!b.test(u))&&c(u)};x.useEffect(()=>{a.current.focus()},[]);const p=Number(s);return t.jsxs(Y,{onClose:o,maxWidth:"350px",zIndex:r||6,children:[t.jsx(Qn,{children:"Especifica la cantidad"}),t.jsxs(On,{children:[t.jsx("input",{type:"text",inputMode:n?"numeric":"decimal",value:s,onChange:h,ref:a}),t.jsx(S,{design:"solid",size:"xs",onClick:()=>e(p),disabled:p<=0,children:"Agregar"})]})]})},rt=e=>t.jsx(z,{viewBox:"0 0 12 12",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M4.86399 0.666504C4.21911 0.666504 3.69633 1.18928 3.69633 1.83416V2.1813H1.077C0.850426 2.1813 0.666748 2.36497 0.666748 2.59155C0.666748 2.81813 0.850426 3.00181 1.077 3.00181H1.80284V9.40812C1.80284 10.4713 2.66472 11.3332 3.72789 11.3332H8.27227C9.33545 11.3332 10.1973 10.4713 10.1973 9.40812V3.00181H10.9232C11.1497 3.00181 11.3334 2.81813 11.3334 2.59155C11.3334 2.36497 11.1497 2.1813 10.9232 2.1813H8.30383V1.83416C8.30383 1.18928 7.78105 0.666504 7.13618 0.666504H4.86399ZM4.51685 1.83416C4.51685 1.64244 4.67227 1.48702 4.86399 1.48702H7.13618C7.32789 1.48702 7.48332 1.64244 7.48332 1.83416V2.1813H4.51685V1.83416ZM2.62336 9.40812V3.00181H9.37681V9.40812C9.37681 10.0181 8.88229 10.5127 8.27227 10.5127H3.72789C3.11787 10.5127 2.62336 10.0181 2.62336 9.40812ZM6.00008 4.07479C5.7735 4.07479 5.58982 4.25847 5.58982 4.48504L5.58982 9.02942C5.58982 9.256 5.7735 9.43968 6.00008 9.43968C6.22666 9.43968 6.41034 9.256 6.41034 9.02942L6.41034 4.48504C6.41034 4.25847 6.22666 4.07479 6.00008 4.07479Z",fill:"currentColor"})}),Vn=l.default.div`
  display: flex;
  justify-content: center;
`,Gn=l.default.span`
  color: ${({isZero:e,error:o=!1})=>e?o?d.color.ALERT[900]:d.color.NEUTRAL[500]:d.color.PRIMARY[900]};
  text-align: center;
  padding: 0 8px;
  min-width: 6ch;
`,Xn=l.default.span`
...
`,le=({value:e,onSetQuantity:o,onDelete:r,minimumQuantity:n=1,measureUnit:i,onlyIntegers:a,blockInputModal:s,disabled:c,hasError:h,variant:p,renderModal:A,zIndex:u,style:b,noDecrement:g,noIncrement:w})=>{const[C,k]=x.useState(!1),m=Number(e||0),M=e===null||m<=n,E=L=>{L.stopPropagation();const T=m%1!==0?Math.ceil(m):m+1;o(T)},y=L=>{if(L.stopPropagation(),M){r&&r();return}const T=m%1>0?Math.floor(m):m-1;o(T)},D=L=>{const T=a?Math.round(L):L;o(T<=n?n:T),k(!1)};return t.jsxs(t.Fragment,{children:[t.jsx(Vn,{children:t.jsxs(Jn,{isDisabled:c,onClick:L=>{L.stopPropagation(),!(s||c)&&k(!0)},minQuantity:M,canDelete:!!r,variant:p,error:h,style:b,children:[!g&&t.jsx("button",{disabled:c,onClick:y,children:M&&r?t.jsx(Xn,{children:t.jsx(rt,{color:d.color.ALERT[900]})}):"-"}),t.jsx(Gn,{children:`${e===null?"-":e} ${e!==null&&i||""}`}),!w&&t.jsx("button",{onClick:E,disabled:c,children:"+"})]})}),C&&!s&&(A?A(t.jsx(tt,{onClose:()=>k(!1),onConfirm:D,initialValue:e?e.toString():"",onlyIntegers:a,zIndex:u})):t.jsx(tt,{onClose:()=>k(!1),onConfirm:D,initialValue:e?e.toString():"",onlyIntegers:a,zIndex:u}))]})},Kn=l.default.div`
  background-color: white;
...
`,ot=({value:e,onChange:o,onFocus:r,onBlur:n,disabled:i,resize:a=!0,startEl:s,endEl:c,...h})=>{const[p,A]=x.useState(!1),u=x.useRef(null),b=()=>{const g=u.current;g.style.height="",g.style.height=`${g.scrollHeight+2}px`};return x.useEffect(()=>{a&&b()},[e,a]),t.jsxs(Kn,{"data-focused":p,"data-disabled":i,children:[s,t.jsx(qn,{ref:u,value:e,disabled:i,onChange:g=>{o&&o(g.target.value,g),a&&!e&&b()},onFocus:g=>{A(!0),r&&r(g)},onBlur:g=>{A(!1),n&&n(g)},...h}),c]})},Rn=l.default.div`
  background-color: white;
...
`,l0=l.default.div`
  ...
  justify-content: space-between;
  align-items: center;
`,d0=({img:e,name:o,currencySymbol:r,total:n,unitPrice:i,quantity:a,comment:s,onClick:c,onChangeQuantity:h,onDeleteProduct:p,onChangeComment:A,discount:u,measureUnit:b,productDetails:g,renderModal:w,onlyIntegers:C,textarea:k})=>{const[m,M]=x.useState(!0),E=b||"u.";return t.jsxs(Rn,{children:[t.jsxs($n,{onClick:c||(()=>{}),canClick:!!c,children:[(e==null?void 0:e.src)&&t.jsx(_n,{...e}),t.jsxs(e0,{children:[t.jsxs(t0,{detailsActive:m,children:[o,t.jsx(ae,{size:16,onClick:y=>{y.stopPropagation(),M(D=>!D)}})]}),u&&t.jsx(r0,{children:u.label}),t.jsxs(o0,{children:[u&&t.jsxs(n0,{children:["-",r,u.discountedAmount.toFixed(2)]}),t.jsxs(nt,{children:[r,t.jsx("span",{children:n.toFixed(2)})]})]})]})]}),m&&t.jsxs("div",{children:[k?t.jsx(ot,{value:s,onChange:y=>A(y),placeholder:"Agregar alg\xFAn comentario"}):t.jsx(i0,{value:s,onChange:y=>A(y.target.value),placeholder:"Agregar alg\xFAn comentario"}),g&&t.jsx(a0,{children:g})]}),t.jsxs(l0,{children:[t.jsxs(nt,{children:[r,t.jsx("span",{children:i.toFixed(2)})," x ",E]}),t.jsx(le,{value:a,onSetQuantity:h,measureUnit:E,onDelete:p,renderModal:w,onlyIntegers:C})]})]})},s0=l.default.div`
...
`,f0=l.default.button`
  ...
  ${({selected:e})=>e&&f.css`
    ...
    `}
`,it=({title:e,options:o,selected:r,onSelect:n})=>t.jsxs(s0,{children:[e&&t.jsx(c0,{children:e}),t.jsx(p0,{children:o.map(i=>t.jsx(f0,{selected:i.value===r,onClick:()=>n(i.value,i),disabled:!!i.disabled,children:i.content},`${i.value}-btn`))})]}),h0=Array.from(Array(5),(e,o)=>({content:`${o}`,value:`${o}`})),A0=l.default.div`
  position: absolute;
  top: calc(100% + 5px);
  left: 0;
`,g0=({selected:e,onSelect:o,onClose:r})=>{const n=x.useRef(null);return W(n,r),t.jsx(A0,{ref:n,children:t.jsx(it,{title:"Order de salida",options:h0,selected:e.toString(),onSelect:i=>{o(Number(i)),r()}})})},u0=l.default.div`
...
`,y0=({img:e,name:o,currencySymbol:r,total:n,quantity:i,onClick:a,onChangeQuantity:s,onDeleteProduct:c,discount:h,productDetails:p,renderModal:A,onlyIntegers:u,dishNumber:b,onChangeDishNumber:g,measureUnit:w})=>{const[C,k]=x.useState(!1);return t.jsxs(u0,{children:[b&&t.jsxs(x0,{clickeable:!!g,children:["N\xB0",t.jsxs("div",{children:[t.jsx("button",{onClick:()=>{g&&k(!0)},children:b}),C&&g&&t.jsx(g0,{onClose:()=>k(!1),onSelect:m=>g(m),selected:b})]})]}),t.jsxs(b0,{children:[(e==null?void 0:e.src)&&t.jsxs(v0,{children:[t.jsx(w0,{...e}),h&&t.jsx(C0,{children:h.label})]}),t.jsxs(m0,{clickeable:!!a,onClick:a||(()=>{}),children:[t.jsxs(at,{children:[t.jsx("span",{children:o}),p&&t.jsx(at,{children:p})]}),t.jsxs(M0,{children:[t.jsxs("div",{children:[t.jsxs(k0,{children:[r,t.jsx("span",{children:n.toFixed(2)})]}),h&&t.jsxs(L0,{children:[r," ",h.prevTotal.toFixed(2)]})]}),t.jsx(le,{value:i,onSetQuantity:s,onDelete:c,renderModal:A,onlyIntegers:u,measureUnit:w!=null?w:"u."})]})]})]})]})},E0=l.default.div`
  padding-right: 5px;
...
`,D0=l.default.span`
  ...
  font-size: 10px;
  font-weight: 700;
`,lt=({currencySymbol:e,unitPrice:o=null,total:r,measureUnit:n,discount:i,disabled:a,bottom:s})=>{const c=n||"u.";return t.jsxs(E0,{disabled:a,bottom:s,children:[t.jsx("span",{children:o!==null&&t.jsxs(t.Fragment,{children:[e,o.toFixed(2)," x ",c]})}),t.jsxs(T0,{disabled:a,children:[i&&t.jsxs(t.Fragment,{children:[t.jsx("span",{children:(!!i.prevTotal||i.prevTotal===0)&&t.jsxs(t.Fragment,{children:[e,i.prevTotal.toFixed(2)]})}),t.jsx(D0,{children:i.label})]}),t.jsxs("span",{children:[e,t.jsx("span",{children:r.toFixed(2)})]})]})]})},dt=e=>{switch(e){case"draft":return"Borrador";case"pending":return"Pendiente";case"accepted":return"Aceptado";case"preparing":return"Preparando";case"prepared":return"Listo";case"collected":return"Enviado";case"delivered":return"Entregado";case"canceled":return"Anulado";default:return""}},N0=l.default.div`
...
`,z0=l.default.div`
  ...
  ${({status:e})=>{switch(e){case"draft":return f.css`
          background-color: ${d.color.NEUTRAL[100]};
          color: ${d.color.NEUTRAL[500]};
...
`,B0=l.default.div`
  ...
  margin-top: 8px;
  font-size: 12px;
`,H0=({name:e,img:o,quantity:r,currencySymbol:n,unitPrice:i,total:a,productDetails:s,discount:c,measureUnit:h,disabled:p,status:A,imgLabel:u,discountBottom:b=!0})=>{const g=b?!!(s||c):!!s;return t.jsxs(N0,{disabled:p,hasDetails:!!s,children:[t.jsxs(I0,{children:[(o==null?void 0:o.src)&&t.jsxs(S0,{children:[t.jsx("div",{children:t.jsx("img",{...o})}),u,A&&!u&&!!dt(A)&&t.jsx(z0,{status:A,children:dt(A)})]}),t.jsxs(F0,{hasDetails:!!g,children:[t.jsxs(j0,{disabled:p,children:[t.jsx(Ze,{opacity:.4,children:r}),e]}),s&&t.jsx(B0,{children:s}),!g&&t.jsx(lt,{currencySymbol:n,unitPrice:i,total:a,discount:c,disabled:p})]})]}),g&&t.jsx(lt,{currencySymbol:n,unitPrice:i,total:a,discount:c,disabled:p,bottom:!0})]})},P0=l.default.div`
  padding: 20px;
...
`,$0=({children:e,note:o="Esta acci\xF3n no se puede revertir.",btnLeft:r={onClick:()=>{},text:"Cancelar",disabled:!1},btnRight:n={onClick:()=>{},text:"Eliminar",disabled:!1}})=>{const{status:i}=je("(min-width: 1023px)");return t.jsxs(G0,{children:[t.jsxs(R0,{children:[t.jsxs(X0,{children:[t.jsx(q0,{children:e}),t.jsx(J0,{children:o})]}),t.jsxs(K0,{children:[i&&t.jsx(S,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{borderRadius:"32px",padding:"20px 0"},disabled:r.disabled,children:r.text}),t.jsx(S,{design:"solid",fullWidth:!0,onClick:()=>n.onClick(),style:{borderRadius:"32px",padding:"20px 60px"},disabled:n.disabled,children:n.text})]})]}),!i&&t.jsx(S,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{margin:"0 15px 15px",width:"calc(100% - 30px)",padding:"20px",borderRadius:"15px"},children:r.text})]})},_0=l.default.div`
  background: transparent;
  color: #383838;
  border-radius: 20px;
  font-weight: 500;
...
`,st=l.default.div`
  ...
  ${({bottom:e})=>{if(e)return f.css`
      ...
      `}}
`,ct=({title:e,content:o,options:r,cancelOptions:n})=>t.jsxs(_0,{children:[t.jsxs(ei,{children:[(e||o)&&t.jsxs(ti,{children:[e&&t.jsx(ri,{children:e}),o&&t.jsx(oi,{children:o})]}),r.length>0&&t.jsx(st,{children:r.map((i,a)=>t.jsx(S,{design:"solid",shape:"circular",size:"xs",fullWidth:!0,onClick:i.onClick,disabled:i.disabled,color:i.type==="primary"?"SECONDARY/900":"QUATERNARY/200",fontColor:i.type==="primary"?"SECONDARY/0":"SECONDARY/900",style:{gap:0},children:i.content},`confirmation-option-${a}`))})]}),n.length>0&&t.jsx(st,{bottom:!0,children:n.map((i,a)=>t.jsx(S,{design:"flat",size:"xs",fullWidth:!0,onClick:i.onClick,disabled:i.disabled,color:"PRIMARY/900",style:{gap:0},children:i.content},`cancel-option-${a}`))})]}),ni=({color:e="#4318FF"})=>t.jsxs("svg",{width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M22.53 3.47a.75.75 0 0 1 0 1.06l-10 10a.75.75 0 0 1-1.06 0l-3-3a.75.75 0 1 1 1.06-1.06L12 12.94l9.47-9.47a.75.75 0 0 1 1.06 0Z",fill:e}),t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5 3.75A1.25 1.25 0 0 0 3.75 5v14A1.25 1.25 0 0 0 5 20.25h14A1.25 1.25 0 0 0 20.25 19v-7a.75.75 0 0 1 1.5 0v7A2.75 2.75 0 0 1 19 21.75H5A2.75 2.75 0 0 1 2.25 19V5A2.75 2.75 0 0 1 5 2.25h11a.75.75 0 0 1 0 1.5H5Z",fill:e})]}),ii=({color:e="#4318FF"})=>t.jsx("svg",{width:24,height:24,fill:"none",xmlns:"http://www.w3.org/2000/svg",children:t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M5 3.75c-.69 0-1.25.56-1.25 1.25v14c0 .69.56 1.25 1.25 1.25h14c.69 0 1.25-.56 1.25-1.25V5c0-.69-.56-1.25-1.25-1.25H5ZM2.25 5A2.75 2.75 0 0 1 5 2.25h14A2.75 2.75 0 0 1 21.75 5v14A2.75 2.75 0 0 1 19 21.75H5A2.75 2.75 0 0 1 2.25 19V5Z",fill:e})}),ai=l.default.label`
  display: flex;
  gap: 9px;
  font-weight: 500;
  font-size: 0.8125rem;
...
`,li=({children:e,value:o="value",callbackOnChange:r=()=>{},disabled:n=!1,...i})=>{const[a,s]=x.useState((i==null?void 0:i.checked)||!1);return x.useEffect(()=>{s(Boolean(i==null?void 0:i.checked))},[i==null?void 0:i.checked]),t.jsxs(ai,{disabled:n,children:[t.jsx("input",{...i,type:"checkbox",value:o,disabled:n,onChange:c=>{s(!a),r(c.target.value,!a)},checked:a}),t.jsx("span",{children:a?t.jsx(ni,{color:n?"gray":"#4318FF"}):t.jsx(ii,{color:n?"gray":"#4318FF"})}),e]})},di=l.default.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 9px;
...
`,si=({text:e,...o})=>t.jsxs(di,{disabled:Boolean(o.disabled),children:[t.jsx("input",{type:"radio",...o}),t.jsx("label",{htmlFor:o==null?void 0:o.id,children:e})]}),ci=e=>t.jsx(z,{viewBox:"0 0 15 2",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M1.88086 1H13.8809",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),pi=l.default.div`
  min-width: 134px;
  width: ${({fullWidth:e})=>e?"100%":"auto"};
  display: inline-flex;
  align-items: center;
...
`,fi=l.default.div`
  ...
  font-weight: 500;
  flex-grow: 0.5;
`,hi=({quantity:e,onChange:o,icon:r,increase:n,decrease:i,fullWidth:a})=>{var s,c;return t.jsxs(pi,{fullWidth:a,children:[((s=i==null?void 0:i.available)!=null?s:!0)&&t.jsx(pt,{onClick:()=>o(e-1),disabled:e<=1||!!(i!=null&&i.disabled),children:t.jsx(ci,{size:17})}),t.jsxs(fi,{children:[e," ",r]}),((c=n==null?void 0:n.available)!=null?c:!0)&&t.jsx(pt,{onClick:()=>o(e+1),disabled:!!(n!=null&&n.disabled),children:t.jsx(He,{size:17})})]})},Ai=l.default.div`
  background-color: white;
  ...
  ${({model:e,theme:o})=>{if(e==="secondary")return f.css`
        border: none;
      ...
      `;if(e==="tertiary")return f.css`
        gap: 1px;
        padding: 0px;
        border: 1px solid ${o.color.PRIMARY[200]};
        border-radius: 10px;
      `}}
`,gi=l.default.button`
  background-color: white;
  ...
  ${({model:e,theme:o,active:r})=>{if(e==="tertiary")return f.css`
        background-color: ${r?o.color.SECONDARY[50]:"white"};
        outline: ${r?`1px solid ${o.color.SECONDARY[500]}`:"1px solid transparent"};
        color: ${r?o.color.SECONDARY[900]:o.color.SECONDARY[600]};
        border-radius: 0;
        min-height: 45px;
        z-index: ${r?1:"auto"};
...
`;l.default.div`
  ...
  bottom: 0;
  left: 0;
`;const ui=({options:e,selected:o,disabled:r,onSelect:n,fullWidth:i,model:a,equalBtns:s})=>t.jsx(Ai,{disabled:r,onClick:c=>{r&&c.stopPropagation()},model:a,fullWidth:i,children:e.map(c=>t.jsx(gi,{onClick:()=>n(c.value),active:c.value===o,disabled:r,model:a,equal:s,children:c.label},c.value))}),xi=l.default.div`
...
`,vi=l.default.span`
  ...
  line-height: 1.25rem;
  color: ${d.color.PRIMARY[900]};
`,wi=({description:e,defaultValue:o,value:r,onChange:n=()=>{},placeholder:i,suffix:a,disabled:s,readingMode:c})=>t.jsxs(xi,{disabled:s,withDescription:Boolean(e),readingMode:c,children:[e&&t.jsx(bi,{children:e}),c?t.jsxs(ft,{readingMode:c,children:[t.jsx(vi,{children:o}),a&&!s&&t.jsx(ht,{children:a})]}):t.jsxs(ft,{children:[t.jsx("input",{type:"text",placeholder:i,disabled:s,onChange:h=>n(h.target.value),value:r}),a&&!s&&t.jsx(ht,{children:a})]})]}),Ci=l.default.div`
  background-color: white;
...
`,de=({alert:e,fullWidth:o,minHeight:r,startEl:n,endEl:i,inputRef:a,containerProps:s={},...c})=>t.jsxs(Ci,{alert:e,fullWidth:o,minHeight:r!=null?r:45,className:"base-input-container",...s,children:[n,t.jsx("input",{ref:a,...c}),i]}),mi=l.default.div`
  display: flex;
  justify-content: flex-start;
  align-items: center;
  cursor: pointer;
...
`,Mi=l.default.div`
  ...
  ${({toggled:e,styleOn:o,styleOff:r})=>e?f.css`
...
`,ki=l.default.div`
  ...
  ${({toggled:e,styleOn:o,styleOff:r,width:n})=>e?f.css`
...
`;l.default.p`
  ...
  margin: 15px 0;
  padding: 0 20px;
`;const yi=({initial:e=!1,onToggle:o=()=>{},disabled:r=!1,width:n,padding:i,styleOn:a,styleOff:s})=>{const[c,h]=x.useState(e),p=()=>{if(!r){const A=!c;h(A),o(A)}};return t.jsx(mi,{disabled:r,children:t.jsxs(Mi,{onClick:A=>{A.stopPropagation(),p()},toggled:c,width:n,padding:i,styleOn:a,styleOff:s,children:[t.jsx(ki,{toggled:c,width:n,padding:i}),t.jsx(Li,{visible:c,styleOn:a})]})})},Ei=l.default.div`
  position: relative;
  width: 100%;
...
`,Ti={control:(e,o)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${o.isFocused?d.color.QUATERNARY[900]:d.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:d.color.PRIMARY[900],fontWeight:400,fontSize:"0.875rem",fontFamily:"Poppins",fontStyle:"normal"}),placeholder:e=>({...e,color:d.color.NEUTRAL[500]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"10px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"15px"})},Di=({formatOptionLabel:e,options:o,loading:r=!1,style:n,firstOption:i={label:"Seleccione una opci\xF3n",value:""},initialValue:a,value:s,onChange:c,isMulti:h,placeholder:p,label:A})=>{const u=i,b=[...o];return t.jsxs(Ei,{style:n,children:[A&&t.jsx(N,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:A}),r?t.jsx(F.default,{style:{borderRadius:10,display:"block"},height:"45px",width:"100%"}):t.jsx(Jt.default,{placeholder:p,value:s||void 0,defaultValue:a||u,options:b,onChange:c,styles:Ti,isMulti:h,formatOptionLabel:e})]})},Ni=l.default.div`
  width: ${e=>e.size}px;
  height: ${e=>e.size}px;
  position: relative;
  &::before {
...
`,gt=x.forwardRef(({label:e,type:o,error:r,isDirty:n,success:i,infoMessage:a,fullWidth:s,...c},h)=>{const p={...c,ref:h},[A,u]=x.useState(!1);return t.jsxs(Fi,{fullWidth:s,children:[e&&t.jsxs("div",{className:"label-container",children:[t.jsx(N,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:e}),o==="password"&&t.jsx("span",{onClick:()=>u(!A),children:A?t.jsx(zi,{size:20}):t.jsx(Si,{size:20})})]}),t.jsx(te,{error:Boolean(r),success:i||!r&&n,infoMessage:a,fullWidth:s,type:A?"text":o,...p}),r&&t.jsx(ee,{shouldAppear:Boolean(r),children:t.jsx(N,{size:"xs",color:"ALERT/900",children:r})})]})});gt.displayName="TextField";function se(e){return function(){var o=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},r=o.width?String(o.width):e.defaultWidth,n=e.formats[r]||e.formats[e.defaultWidth];return n}}function O(e){return function(o,r){var n=r!=null&&r.context?String(r.context):"standalone",i;if(n==="formatting"&&e.formattingValues){var a=e.defaultFormattingWidth||e.defaultWidth,s=r!=null&&r.width?String(r.width):a;i=e.formattingValues[s]||e.formattingValues[a]}else{var c=e.defaultWidth,h=r!=null&&r.width?String(r.width):e.defaultWidth;i=e.values[h]||e.values[c]}var p=e.argumentCallback?e.argumentCallback(o):o;return i[p]}}function V(e){return function(o){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=r.width,i=n&&e.matchPatterns[n]||e.matchPatterns[e.defaultMatchWidth],a=o.match(i);if(!a)return null;var s=a[0],c=n&&e.parsePatterns[n]||e.parsePatterns[e.defaultParseWidth],h=Array.isArray(c)?Bi(c,function(u){return u.test(s)}):ji(c,function(u){return u.test(s)}),p;p=e.valueCallback?e.valueCallback(h):h,p=r.valueCallback?r.valueCallback(p):p;var A=o.slice(s.length);return{value:p,rest:A}}}function ji(e,o){for(var r in e)if(e.hasOwnProperty(r)&&o(e[r]))return r}function Bi(e,o){for(var r=0;r<e.length;r++)if(o(e[r]))return r}function Hi(e){return function(o){var r=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=o.match(e.matchPattern);if(!n)return null;var i=n[0],a=o.match(e.parsePattern);if(!a)return null;var s=e.valueCallback?e.valueCallback(a[0]):a[0];s=r.valueCallback?r.valueCallback(s):s;var c=o.slice(i.length);return{value:s,rest:c}}}var Pi={lessThanXSeconds:{one:"menos de un segundo",other:"menos de {{count}} segundos"},xSeconds:{one:"1 segundo",other:"{{count}} segundos"},halfAMinute:"medio minuto",lessThanXMinutes:{one:"menos de un minuto",other:"menos de {{count}} minutos"},xMinutes:{one:"1 minuto",other:"{{count}} minutos"},aboutXHours:{one:"alrededor de 1 hora",other:"alrededor de {{count}} horas"},xHours:{one:"1 hora",other:"{{count}} horas"},xDays:{one:"1 d\xEDa",other:"{{count}} d\xEDas"},aboutXWeeks:{one:"alrededor de 1 semana",other:"alrededor de {{count}} semanas"},xWeeks:{one:"1 semana",other:"{{count}} semanas"},aboutXMonths:{one:"alrededor de 1 mes",other:"alrededor de {{count}} meses"},xMonths:{one:"1 mes",other:"{{count}} meses"},aboutXYears:{one:"alrededor de 1 a\xF1o",other:"alrededor de {{count}} a\xF1os"},xYears:{one:"1 a\xF1o",other:"{{count}} a\xF1os"},overXYears:{one:"m\xE1s de 1 a\xF1o",other:"m\xE1s de {{count}} a\xF1os"},almostXYears:{one:"casi 1 a\xF1o",other:"casi {{count}} a\xF1os"}},Ui=function(o,r,n){var i,a=Pi[o];return typeof a=="string"?i=a:r===1?i=a.one:i=a.other.replace("{{count}}",r.toString()),n!=null&&n.addSuffix?n.comparison&&n.comparison>0?"en "+i:"hace "+i:i};const Yi=Ui;var Zi={full:"EEEE, d 'de' MMMM 'de' y",long:"d 'de' MMMM 'de' y",medium:"d MMM y",short:"dd/MM/y"},Wi={full:"HH:mm:ss zzzz",long:"HH:mm:ss z",medium:"HH:mm:ss",short:"HH:mm"},Qi={full:"{{date}} 'a las' {{time}}",long:"{{date}} 'a las' {{time}}",medium:"{{date}}, {{time}}",short:"{{date}}, {{time}}"},Oi={date:se({formats:Zi,defaultWidth:"full"}),time:se({formats:Wi,defaultWidth:"full"}),dateTime:se({formats:Qi,defaultWidth:"full"})};const Vi=Oi;var Gi={lastWeek:"'el' eeee 'pasado a la' p",yesterday:"'ayer a la' p",today:"'hoy a la' p",tomorrow:"'ma\xF1ana a la' p",nextWeek:"eeee 'a la' p",other:"P"},Xi={lastWeek:"'el' eeee 'pasado a las' p",yesterday:"'ayer a las' p",today:"'hoy a las' p",tomorrow:"'ma\xF1ana a las' p",nextWeek:"eeee 'a las' p",other:"P"},Ji=function(o,r,n,i){return r.getUTCHours()!==1?Xi[o]:Gi[o]};const Ki=Ji;var qi={narrow:["AC","DC"],abbreviated:["AC","DC"],wide:["antes de cristo","despu\xE9s de cristo"]},Ri={narrow:["1","2","3","4"],abbreviated:["T1","T2","T3","T4"],wide:["1\xBA trimestre","2\xBA trimestre","3\xBA trimestre","4\xBA trimestre"]},$i={narrow:["e","f","m","a","m","j","j","a","s","o","n","d"],abbreviated:["ene","feb","mar","abr","may","jun","jul","ago","sep","oct","nov","dic"],wide:["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"]},_i={narrow:["d","l","m","m","j","v","s"],short:["do","lu","ma","mi","ju","vi","s\xE1"],abbreviated:["dom","lun","mar","mi\xE9","jue","vie","s\xE1b"],wide:["domingo","lunes","martes","mi\xE9rcoles","jueves","viernes","s\xE1bado"]},ea={narrow:{am:"a",pm:"p",midnight:"mn",noon:"md",morning:"ma\xF1ana",afternoon:"tarde",evening:"tarde",night:"noche"},abbreviated:{am:"AM",pm:"PM",midnight:"medianoche",noon:"mediodia",morning:"ma\xF1ana",afternoon:"tarde",evening:"tarde",night:"noche"},wide:{am:"a.m.",pm:"p.m.",midnight:"medianoche",noon:"mediodia",morning:"ma\xF1ana",afternoon:"tarde",evening:"tarde",night:"noche"}},ta={narrow:{am:"a",pm:"p",midnight:"mn",noon:"md",morning:"de la ma\xF1ana",afternoon:"de la tarde",evening:"de la tarde",night:"de la noche"},abbreviated:{am:"AM",pm:"PM",midnight:"medianoche",noon:"mediodia",morning:"de la ma\xF1ana",afternoon:"de la tarde",evening:"de la tarde",night:"de la noche"},wide:{am:"a.m.",pm:"p.m.",midnight:"medianoche",noon:"mediodia",morning:"de la ma\xF1ana",afternoon:"de la tarde",evening:"de la tarde",night:"de la noche"}},ra=function(o,r){var n=Number(o);return n+"\xBA"},oa={ordinalNumber:ra,era:O({values:qi,defaultWidth:"wide"}),quarter:O({values:Ri,defaultWidth:"wide",argumentCallback:function(o){return Number(o)-1}}),month:O({values:$i,defaultWidth:"wide"}),day:O({values:_i,defaultWidth:"wide"}),dayPeriod:O({values:ea,defaultWidth:"wide",formattingValues:ta,defaultFormattingWidth:"wide"})};const na=oa;var ia=/^(\d+)(º)?/i,aa=/\d+/i,la={narrow:/^(ac|dc|a|d)/i,abbreviated:/^(a\.?\s?c\.?|a\.?\s?e\.?\s?c\.?|d\.?\s?c\.?|e\.?\s?c\.?)/i,wide:/^(antes de cristo|antes de la era com[uú]n|despu[eé]s de cristo|era com[uú]n)/i},da={any:[/^ac/i,/^dc/i],wide:[/^(antes de cristo|antes de la era com[uú]n)/i,/^(despu[eé]s de cristo|era com[uú]n)/i]},sa={narrow:/^[1234]/i,abbreviated:/^T[1234]/i,wide:/^[1234](º)? trimestre/i},ca={any:[/1/i,/2/i,/3/i,/4/i]},pa={narrow:/^[efmajsond]/i,abbreviated:/^(ene|feb|mar|abr|may|jun|jul|ago|sep|oct|nov|dic)/i,wide:/^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre)/i},fa={narrow:[/^e/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^en/i,/^feb/i,/^mar/i,/^abr/i,/^may/i,/^jun/i,/^jul/i,/^ago/i,/^sep/i,/^oct/i,/^nov/i,/^dic/i]},ha={narrow:/^[dlmjvs]/i,short:/^(do|lu|ma|mi|ju|vi|s[áa])/i,abbreviated:/^(dom|lun|mar|mi[ée]|jue|vie|s[áa]b)/i,wide:/^(domingo|lunes|martes|mi[ée]rcoles|jueves|viernes|s[áa]bado)/i},Aa={narrow:[/^d/i,/^l/i,/^m/i,/^m/i,/^j/i,/^v/i,/^s/i],any:[/^do/i,/^lu/i,/^ma/i,/^mi/i,/^ju/i,/^vi/i,/^sa/i]},ga={narrow:/^(a|p|mn|md|(de la|a las) (mañana|tarde|noche))/i,any:/^([ap]\.?\s?m\.?|medianoche|mediodia|(de la|a las) (mañana|tarde|noche))/i},ua={any:{am:/^a/i,pm:/^p/i,midnight:/^mn/i,noon:/^md/i,morning:/mañana/i,afternoon:/tarde/i,evening:/tarde/i,night:/noche/i}},xa={ordinalNumber:Hi({matchPattern:ia,parsePattern:aa,valueCallback:function(o){return parseInt(o,10)}}),era:V({matchPatterns:la,defaultMatchWidth:"wide",parsePatterns:da,defaultParseWidth:"any"}),quarter:V({matchPatterns:sa,defaultMatchWidth:"wide",parsePatterns:ca,defaultParseWidth:"any",valueCallback:function(o){return o+1}}),month:V({matchPatterns:pa,defaultMatchWidth:"wide",parsePatterns:fa,defaultParseWidth:"any"}),day:V({matchPatterns:ha,defaultMatchWidth:"wide",parsePatterns:Aa,defaultParseWidth:"any"}),dayPeriod:V({matchPatterns:ga,defaultMatchWidth:"any",parsePatterns:ua,defaultParseWidth:"any"})},ba={code:"es",formatDistance:Yi,formatLong:Vi,formatRelative:Ki,localize:na,match:xa,options:{weekStartsOn:1,firstWeekContainsDate:1}};const ut=ba,Ul="",Yl="",va=({size:e=18,color:o="#242954"})=>t.jsx("div",{style:{display:"inline-flex",alignItems:"center",justifyContent:"center",height:`${e}px`,width:`${e}px`},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16",children:t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M4.7924 0.5C5.09626 0.5 5.34259 0.73427 5.34259 1.02326V1.57335L10.6574 1.57336L10.6574 1.02326C10.6574 0.73427 10.9037 0.5 11.2076 0.5C11.5115 0.5 11.7578 0.734269 11.7578 1.02326V1.57337L12.8114 1.57337C14.3239 1.57337 15.5 2.79576 15.5 4.24331V12.8301C15.5 14.2776 14.3239 15.5 12.8114 15.5L3.1886 15.5C1.67607 15.5 0.5 14.2776 0.5 12.8301L0.5 5.85343L0.5 4.2433C0.5 2.79574 1.67608 1.57335 3.1886 1.57335L4.2422 1.57335V1.02326C4.2422 0.73427 4.48853 0.5 4.7924 0.5ZM4.2422 2.61986L3.1886 2.61986C2.3391 2.61986 1.60039 3.31968 1.60039 4.2433L1.60039 5.33005H14.3996V4.24331C14.3996 3.3197 13.6609 2.61988 12.8114 2.61988L11.7578 2.61988V3.16995C11.7578 3.45893 11.5115 3.6932 11.2076 3.6932C10.9037 3.6932 10.6574 3.45893 10.6574 3.16995L10.6574 2.61988L5.34259 2.61987V3.16995C5.34259 3.45893 5.09626 3.6932 4.7924 3.6932C4.48853 3.6932 4.2422 3.45893 4.2422 3.16995V2.61986ZM14.3996 6.37657H1.60039L1.60039 12.8301C1.60039 13.7537 2.3391 14.4535 3.1886 14.4535L12.8114 14.4535C13.6609 14.4535 14.3996 13.7537 14.3996 12.8301V6.37657ZM3.7076 9.07335C3.7076 8.78436 3.95393 8.55009 4.2578 8.55009H5.327C5.63086 8.55009 5.87719 8.78436 5.87719 9.07335C5.87719 9.36233 5.63086 9.5966 5.327 9.5966H4.2578C3.95393 9.5966 3.7076 9.36233 3.7076 9.07335ZM6.91521 9.07335C6.91521 8.78436 7.16154 8.55009 7.4654 8.55009H8.5346C8.83846 8.55009 9.08479 8.78436 9.08479 9.07335C9.08479 9.36233 8.83846 9.5966 8.5346 9.5966H7.4654C7.16154 9.5966 6.91521 9.36233 6.91521 9.07335ZM10.1228 9.07335C10.1228 8.78436 10.3691 8.55009 10.673 8.55009H11.7422C12.0461 8.55009 12.2924 8.78436 12.2924 9.07335C12.2924 9.36233 12.0461 9.5966 11.7422 9.5966H10.673C10.3691 9.5966 10.1228 9.36233 10.1228 9.07335ZM3.7076 11.7567C3.7076 11.4677 3.95393 11.2335 4.2578 11.2335H5.327C5.63086 11.2335 5.87719 11.4677 5.87719 11.7567C5.87719 12.0457 5.63086 12.28 5.327 12.28H4.2578C3.95393 12.28 3.7076 12.0457 3.7076 11.7567ZM6.91521 11.7567C6.91521 11.4677 7.16154 11.2335 7.4654 11.2335H8.5346C8.83846 11.2335 9.08479 11.4677 9.08479 11.7567C9.08479 12.0457 8.83846 12.28 8.5346 12.28H7.4654C7.16154 12.28 6.91521 12.0457 6.91521 11.7567ZM10.1228 11.7567C10.1228 11.4677 10.3691 11.2335 10.673 11.2335H11.7422C12.0461 11.2335 12.2924 11.4677 12.2924 11.7567C12.2924 12.0457 12.0461 12.28 11.7422 12.28H10.673C10.3691 12.28 10.1228 12.0457 10.1228 11.7567Z",fill:o})})})}),wa=l.default.div`
  background: none;
...
`,ma=l.default.div`
  ...
  flex-direction: column;
  top: calc(100% + 5px);
  left: ${({hasOptions:e,isMobile:o})=>!e||o?"0":"210px"};
...
`,La=({onGetFilters:e,initState:o,showIconCalendar:r=!0,showTimeInputs:n=!1,direction:i="horizontal",dateFormatDisplayed:a="detailed",initWithToday:s=!1,...c})=>{const h=x.useRef(null),[p,A]=x.useState({from:"00:00",to:"23:59"}),[u,b]=x.useState(!1),[g,w]=x.useState(o?[o]:[{startDate:s?new Date(Date.now()):void 0,endDate:s?new Date(Date.now()):void 0,key:"selection"}]),C=M=>{var E,y;if((g==null?void 0:g.length)>0&&((E=g[0])==null?void 0:E.startDate)&&((y=g[0])==null?void 0:y.endDate)){const{startDate:D,endDate:L}=g[0],T=M==="from"?D:L;let I="";return n?I=a==="simple"?"dd/MM/yyyy HH:mm":"dd 'de' MMMM 'del' YYY hh:mm aaaaa'm'":I=a==="simple"?"dd/MM/yyyy":"dd 'de' MMMM 'del' YYY",Ot.format(T,I,{locale:ut})}},k=(M,E)=>{A(y=>({...y,[E]:M}))},m=M=>{var E,y,D,L;if(M)e(null),w([{startDate:void 0,endDate:void 0,key:"selection"}]);else{const[T,I]=(E=p==null?void 0:p.from)==null?void 0:E.split(":"),[q,Hl]=(y=p==null?void 0:p.to)==null?void 0:y.split(":");let G,xe;if((D=g[0])!=null&&D.startDate&&(G=new Date(g[0].startDate),G.setHours(Number(T||0),Number(I||0),0)),(L=g[0])!=null&&L.endDate&&(xe=new Date(g[0].endDate),xe.setHours(Number(q||23),Number(Hl||59),59)),G&&G){const Yt={...g[0],startDate:G,endDate:xe};w([Yt]),e(Yt)}}b(!1)};return x.useEffect(()=>{const M=E=>{var y;u&&h.current&&!((y=h.current)!=null&&y.contains(E.target))&&b(!1)};return document.addEventListener("mousedown",M),()=>{document.removeEventListener("mousedown",M)}},[u]),t.jsxs(wa,{ref:h,children:[t.jsxs(Ma,{onClick:()=>b(!0),children:[r&&t.jsx(va,{}),C("from")?t.jsx("p",{children:`${C("from")} - ${C("to")}`}):t.jsx("p",{style:{fontSize:"0.875rem"},children:"Seleccione una fecha"})]}),u&&t.jsxs(ma,{children:[t.jsx(Vt.DateRange,{onChange:M=>{var y,D;const E=Object.values(M);!Array.isArray(E)||(E==null?void 0:E.length)<1||w([{...g[0],startDate:(y=E[0])==null?void 0:y.startDate,endDate:(D=E[0])==null?void 0:D.endDate}])},showSelectionPreview:!0,moveRangeOnFirstSelection:!1,months:1,ranges:g,direction:i,locale:ut,...c}),t.jsxs(Ca,{children:[n&&t.jsxs(ka,{children:[t.jsxs("div",{children:[t.jsx(N,{as:"label",htmlFor:"hour-from",children:"desde:"}),t.jsx("input",{type:"time",id:"hour-from",value:p.from,onChange:M=>k(M.target.value,"from")})]}),t.jsxs("div",{children:[t.jsx(N,{as:"label",htmlFor:"hour-to",children:"hasta:"}),t.jsx("input",{type:"time",id:"hour-to",defaultValue:p.to,onChange:M=>k(M.target.value,"to")})]})]}),t.jsx(S,{size:"xs",py:"5px",onClick:()=>m(!1),children:"Aplicar"})]})]})]})},ya=l.default.div`
  @media (max-width: 600px) {
    padding-bottom: 15px;
  }
`,Ea=l.default.div`
...
`,xt=t.jsx("div",{style:{display:"inline-block"},children:t.jsx(re,{width:"20px",height:"20px"})}),Na=({options:e,onClose:o,contentLocation:r,contentLocationInDesktop:n,defaultDescription:i="",defaultTitle:a="",optionsInCenter:s=!1,direction:c="row",iconOrientation:h="horizontal"})=>{const[p,A]=x.useState(null),u=x.useMemo(()=>{if(p===null)return null;const b=e[p];if(b&&"options"in b)return b},[p,e]);return t.jsx(Y,{maxWidth:"500px",padding:"20px 0",onClose:o,contentLocation:r||"bottom",contentLocationInDesktop:n||"center",closeIcon:!0,children:t.jsxs(ya,{children:[t.jsxs(Ta,{children:[t.jsxs(Ea,{children:[u&&t.jsx(X,{onClick:()=>A(null)}),t.jsx(N,{as:"h2",size:"md",children:(u==null?void 0:u.text)||a})]}),i.length>0&&t.jsx(N,{color:"NEUTRAL/400",size:"sm",weight:"regular",children:(u==null?void 0:u.description)||i})]}),t.jsxs(Da,{direction:c,children:[!u&&e.map((b,g)=>"onClick"in b?t.jsxs(ce,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&(b.onClick(),o())},optionsInCenter:s,iconOrientation:h,children:[t.jsx("span",{children:b.text}),b.loading?xt:b.icon]},`option-${g}`):t.jsxs(ce,{onClick:()=>{A(g)},optionsInCenter:s,children:[b.text," ",t.jsx("div",{style:{transform:"rotateY(180deg)"},children:t.jsx(X,{})})]},`option-${g}`)),u==null?void 0:u.options.map((b,g)=>t.jsxs(ce,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&b.onClick()},optionsInCenter:s,children:[b.text," ",b.loading?xt:b.icon]},`suboption-${g}`))]})]})})},Ia=({cardProps:e,...o})=>t.jsx(Y,{background:"transparent",boxShadowInDesktop:"none",padding:"0 10px",contentLocation:"bottom",maxWidth:"650px",...e,children:t.jsx(ct,{...o})}),Sa=l.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
...
`,bt=({title:e,options:o,selected:r,onSelect:n,onClose:i,modalProps:a={},optionMinHeight:s=50})=>t.jsxs(Y,{onClose:i,closeIcon:!0,contentLocation:"bottom",padding:"0",maxWidth:"600px",...a,children:[t.jsx(Sa,{children:e}),t.jsx(za,{children:o.map(c=>t.jsxs(Fa,{minHeight:s,selected:c.value===r,disabled:c.disabled,onClick:()=>{c.disabled||n(c.value,c)},children:[c.content," ",c.icon]},c.value))})]}),ja=e=>t.jsx(z,{viewBox:"0 0 10 8",fill:"none",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M0.75 3.99992L3.58 6.82992L9.25 1.16992",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),Ba=l.default.div`
  color: ${({color:e})=>e};
  padding-left: 15px;
  display: flex;
  align-items: center;
  flex-grow: 1;
`,Ha=({options:e,selectedIcon:o,...r})=>t.jsx(bt,{options:e.map(({content:n,color:i=d.color.NEUTRAL[800],...a})=>({content:t.jsx(Ba,{color:i,children:t.jsx(ze,{spacing:30,bulletSize:7,children:n})}),icon:a.value===r.selected?o||t.jsx(ja,{}):void 0,...a})),...r}),Pa=l.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
  padding-bottom: 18px;
...
`,Za=({title:e,options:o,onClose:r,closeOnAction:n,modalProps:i={}})=>t.jsxs(Y,{onClose:r,closeIcon:!0,contentLocation:"bottom",padding:"20px",maxWidth:"600px",...i,children:[t.jsx(Pa,{children:e}),t.jsx(Ua,{children:o.map((a,s)=>t.jsxs(Ya,{disabled:a.disabled,onClick:()=>{a.disabled||(a.onClick(),n&&r())},children:[a.icon," ",a.content]},`modal-option-${s}`))})]}),Wa=(e,o=1024*8)=>{let r=!0,n=null;return e.size/1024>o&&(r=!1,n={code:"F0001",message:`El archivo ${e.name} pesa ${(e.size/1024/1024).toFixed(2)} MB. Intenta subir una imagen menor a ${o/1024} MB `}),{success:r,error:n}},pe=({onSelectFile:e,maxKBSize:o,onError:r=()=>{},acceptedFiles:n,validFileExtensions:i,children:a,style:s})=>{const c=x.useRef(null),h=()=>c.current.click(),p=()=>{const g=c.current.files[0];b(g)},A=g=>{g.stopPropagation(),g.preventDefault();const w=g.dataTransfer.files[0];b(w)},u=g=>i?new RegExp(`${i.join("|")}$`,"i").exec(g.toLowerCase()):!0,b=g=>{var C;if(!g)return;if(!u(g.name)){r("Tipo de archivo no permitido");return}const w=Wa(g,o);if(!w.success){r((C=w.error)==null?void 0:C.message);return}e(g)};return t.jsxs("div",{onClick:h,onDragOver:g=>g.preventDefault(),onDrop:A,style:s,children:[a,t.jsx("input",{ref:c,style:{display:"none"},onChange:p,type:"file",accept:n})]})},fe=()=>{const e=x.useRef(!0);return x.useEffect(()=>{e.current=!1},[]),e.current},vt=e=>{const o=e.slice(e.lastIndexOf("/"));return[o.slice(1,o.indexOf(".")),o.slice(o.lastIndexOf(".")+1).toUpperCase()]},wt=e=>t.jsx(z,{viewBox:"0 0 10 8",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M8.79444 1.53098C9.09821 1.24938 9.11617 0.774844 8.83457 0.471079C8.55297 0.167315 8.07843 0.149348 7.77467 0.43095L8.79444 1.53098ZM1.05554 6.65985C0.751779 6.94145 0.733813 7.41598 1.01541 7.71975C1.29702 8.02351 1.77155 8.04148 2.07532 7.75988L1.05554 6.65985ZM7.77467 7.75987C8.07844 8.04147 8.55297 8.02351 8.83457 7.71974C9.11617 7.41598 9.09821 6.94144 8.79444 6.65984L7.77467 7.75987ZM2.07532 0.430942C1.77155 0.14934 1.29702 0.167306 1.01541 0.471071C0.733813 0.774836 0.751779 1.24937 1.05554 1.53097L2.07532 0.430942ZM7.77467 0.43095L1.05554 6.65985L2.07532 7.75988L8.79444 1.53098L7.77467 0.43095ZM8.79444 6.65984L2.07532 0.430942L1.05554 1.53097L7.77467 7.75987L8.79444 6.65984Z",fill:"currentColor"})}),Ct=e=>t.jsx(z,{viewBox:"0 0 18 17",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M1 13.6923H1.75H1ZM14.5385 16V15.25V16ZM3.46154 16V16.75H3.46154L3.46154 16ZM17 3.30772H17.75H17ZM17 13.6923H16.25H17ZM14.5385 1.00002L14.5385 0.250023L14.5385 1.00002ZM3.46154 1L3.46154 1.75L3.46154 1ZM4.69231 7.92307L5.20526 7.37592C4.91677 7.10546 4.46784 7.10546 4.17935 7.37592L4.69231 7.92307ZM12.7947 16.5472C13.0969 16.8304 13.5715 16.8151 13.8548 16.513C14.1381 16.2108 14.1228 15.7361 13.8206 15.4528L12.7947 16.5472ZM16.487 13.6625C16.7892 13.9458 17.2639 13.9305 17.5472 13.6283C17.8305 13.3262 17.8151 12.8515 17.513 12.5682L16.487 13.6625ZM13.3077 9.65384L13.8206 9.10669C13.5322 8.83623 13.0832 8.83623 12.7947 9.10669L13.3077 9.65384ZM9.92308 12.8269L9.41012 13.3741L9.92308 12.8269ZM1 11.3846H0.25H1ZM14.5385 15.25L3.46154 15.25L3.46154 16.75L14.5385 16.75V15.25ZM16.25 3.30772L16.25 13.6923H17.75L17.75 3.30772H16.25ZM14.5385 0.250023L3.46155 0.25L3.46154 1.75L14.5385 1.75002L14.5385 0.250023ZM17.75 3.30772C17.75 1.57414 16.2658 0.250026 14.5385 0.250023L14.5385 1.75002C15.5301 1.75002 16.25 2.49229 16.25 3.30772H17.75ZM1.75 3.30769C1.75 2.49226 2.46995 1.75 3.46154 1.75L3.46155 0.25C1.73419 0.249996 0.250001 1.57411 0.25 3.30769H1.75ZM0.25 13.6923C0.25 15.4259 1.73418 16.75 3.46154 16.75V15.25C2.46995 15.25 1.75 14.5077 1.75 13.6923H0.25ZM14.5385 16.75C16.2658 16.75 17.75 15.4259 17.75 13.6923H16.25C16.25 14.5077 15.53 15.25 14.5385 15.25V16.75ZM13.7885 5.03846C13.7885 5.53526 13.344 6.01923 12.6923 6.01923V7.51923C14.0798 7.51923 15.2885 6.45341 15.2885 5.03846H13.7885ZM12.6923 6.01923C12.0406 6.01923 11.5962 5.53526 11.5962 5.03846H10.0962C10.0962 6.45341 11.3048 7.51923 12.6923 7.51923V6.01923ZM11.5962 5.03846C11.5962 4.54166 12.0406 4.05769 12.6923 4.05769V2.55769C11.3048 2.55769 10.0962 3.62351 10.0962 5.03846H11.5962ZM12.6923 4.05769C13.344 4.05769 13.7885 4.54165 13.7885 5.03846H15.2885C15.2885 3.62351 14.0798 2.55769 12.6923 2.55769V4.05769ZM17.513 12.5682L13.8206 9.10669L12.7947 10.201L16.487 13.6625L17.513 12.5682ZM4.17935 8.47023L9.41012 13.3741L10.436 12.2798L5.20526 7.37592L4.17935 8.47023ZM9.41012 13.3741L12.7947 16.5472L13.8206 15.4528L10.436 12.2798L9.41012 13.3741ZM12.7947 9.10669L9.41012 12.2798L10.436 13.3741L13.8206 10.201L12.7947 9.10669ZM0.25 3.30769L0.25 11.3846H1.75L1.75 3.30769H0.25ZM0.25 11.3846L0.25 13.6923H1.75L1.75 11.3846H0.25ZM1.51296 11.9318L5.20526 8.47023L4.17935 7.37592L0.487044 10.8375L1.51296 11.9318Z",fill:"currentColor"})}),Qa=l.default.div`
  min-height: 70px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Ja=({initialImgUrl:e,placeholder:o,onChange:r,onError:n})=>{const[i,a]=x.useState(null),[s,c]=x.useState(e||null),h=fe();return x.useEffect(()=>{let p="";return i&&(p=window.URL.createObjectURL(i),c(p)),()=>{p&&window.URL.revokeObjectURL(p)}},[i]),x.useEffect(()=>{h||r(i,s||null)},[s]),t.jsx(pe,{onError:n||alert,onSelectFile:p=>a(p),acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:s?t.jsxs(Va,{children:[t.jsxs(Ga,{children:[t.jsx("img",{src:s}),t.jsxs(Xa,{children:[t.jsx("span",{children:(i==null?void 0:i.name)||vt(s)[0]}),t.jsx("span",{children:(i==null?void 0:i.type)||vt(s)[1]})]})]}),t.jsx(ie,{variant:"secondary",onClick:p=>{p.stopPropagation(),a(null),c(null)},children:t.jsx(wt,{size:12})})]}):t.jsx(Qa,{children:o||t.jsxs(Oa,{children:[t.jsx(Ct,{color:d.color.SECONDARY[900],size:18})," Sube un imagen ",t.jsx("span",{children:"aqu\xED"})]})})})},mt=l.default.div`
  width: 55px;
  height: 55px;
  border-radius: 7px;
`,Ka=l.default.div`
...
`,$a=l.default.div`
  ...
  right: 0;
  bottom: 0;
`,_a=({onChange:e,initialImages:o,limit:r})=>{const[n,i]=x.useState(o||[]),[a,s]=x.useState(null),c=fe(),h=A=>{const u=window.URL.createObjectURL(A);i(b=>[...b,{file:A,url:u}])},p=A=>{const u=n[A];typeof u!="string"&&window.URL.revokeObjectURL(u.url),i(b=>b.filter((g,w)=>w!==A))};return x.useEffect(()=>{c||e(n)},[n]),t.jsxs(Ka,{children:[n.map((A,u)=>t.jsxs(qa,{onMouseEnter:()=>s(u),onMouseLeave:()=>s(null),onTouchCancel:()=>s(null),children:[t.jsx("img",{src:typeof A=="string"?A:A.url}),a===u&&t.jsx($a,{onClick:()=>p(u),children:t.jsx(rt,{size:16})})]},`imgs-${u}`)),!(r&&n.length>=r)&&t.jsx(pe,{onError:alert,onSelectFile:h,acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:t.jsx(Ra,{children:t.jsx(Ct,{})})})]})},el=l.default.div`
  display: grid;
  ...
  .tr {
    display: grid;
    grid-template-columns: ${({gridTemplateColumns:e})=>e||"auto"};
    grid-column: 1 / ${({gridTemplateColumns:e})=>{var o;return e?((o=e==null?void 0:e.split(" "))==null?void 0:o.length)+1:"auto"}};
    border-radius: 8px;
...
`,kt=e=>{if(e==="center")return f.css`
  ...
  ${({separator:e})=>Lt(Boolean(e))}
  ${({itemFlex:e})=>yt(Boolean(e))}
  ${({gridColumn:e})=>he(e)}
`,ol=l.default.div`
  ${Mt}
  font-weight: 400;
...
`,nl=l.default.div`
  ...
  ${({gridColumn:e})=>he(e)}
`,il={Table:({gridTemplateColumns:e,maxWidth:o,minWidth:r,gap:n,padding:i,margin:a,header:s,body:c})=>t.jsx(tl,{children:t.jsxs(el,{gridTemplateColumns:e,maxWidth:o,minWidth:r,gap:n,padding:i,margin:a,children:[s&&s,c&&c]})}),Th:rl,Td:ol,Tr:nl},Ae=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},viewBox:"0 0 9 16",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M8.53033 0.46967C8.82322 0.762563 8.82322 1.23744 8.53033 1.53033L2.06066 8L8.53033 14.4697C8.82322 14.7626 8.82322 15.2374 8.53033 15.5303C8.23744 15.8232 7.76256 15.8232 7.46967 15.5303L0.46967 8.53033C0.176777 8.23744 0.176777 7.76256 0.46967 7.46967L7.46967 0.46967C7.76256 0.176777 8.23744 0.176777 8.53033 0.46967Z",fill:o})})})}),ge=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},viewBox:"0 0 10 16",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:t.jsx("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M0.96967 15.5303C0.676777 15.2374 0.676777 14.7626 0.96967 14.4697L7.43934 8L0.96967 1.53033C0.676777 1.23744 0.676777 0.762563 0.96967 0.46967C1.26256 0.176777 1.73744 0.176777 2.03033 0.46967L9.03033 7.46967C9.32322 7.76256 9.32322 8.23744 9.03033 8.53033L2.03033 15.5303C1.73744 15.8232 1.26256 15.8232 0.96967 15.5303Z",fill:o})})})}),al=l.default.div`
  margin: 15px auto;
  height: 33px;
  display: flex;
  align-items: center;
...
`,Et=({currentPage:e=1,lastPage:o=1,onChangePage:r=()=>{}})=>{const[n,i]=x.useState(String(e)||"");x.useEffect(()=>{e!==0&&(!e||(Number(e)||1)>o?(i(String(o)),r(Number(o))):(r(Number(e)),i(String(e))))},[e]);const a=A=>{if(!((Number(A)||1)>o)){if(o>0&&(Number(n)<1||!Number(A))){i("1"),r(1);return}if(!A)return i("");i(A),r(Number(A)||1)}},s=()=>Number(n)<=1?"1px solid #BFBFBF":"1px solid #4318FF",c=()=>Number(n)<=1?"#BFBFBF":"#4318FF",h=()=>Number(n)===o?"#BFBFBF":"#4318FF",p=()=>Number(n)===Number(o)||Number(n)===1;return t.jsxs(al,{disabled:p(),children:[t.jsxs("button",{type:"button",disabled:n==="1",onClick:()=>a(String(1)),style:{padding:"0px",backgroundColor:"#fff",border:s()},children:[t.jsx(Ae,{size:12,color:c()}),t.jsx(Ae,{size:12,color:c(),styleContainer:{marginLeft:"-5px"}})]}),t.jsx("button",{type:"button",disabled:n==="1",onClick:()=>a(String((Number(n)||1)-1)),style:{padding:"0px",backgroundColor:"#fff",border:s()},children:t.jsx(Ae,{size:12,color:c()})}),t.jsx("input",{type:"number",value:Number(n),max:o,onChange:A=>a(A.target.value||"")}),t.jsxs("p",{style:{whiteSpace:"nowrap"},children:["de ",o]}),t.jsx("button",{type:"button",disabled:Number(n)===o,onClick:()=>a(String((Number(n)||1)+1)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===o?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:t.jsx(ge,{size:12,color:h()})}),t.jsxs("button",{type:"button",disabled:Number(n)===o,onClick:()=>a(String(o)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===o?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:[t.jsx(ge,{size:12,color:h()}),t.jsx(ge,{size:12,color:h(),styleContainer:{marginLeft:"-5px"}})]})]})},ll=e=>{const o=x.useRef(0),r=x.useRef(0),n=x.useRef(!1);x.useEffect(()=>{if(!e.current||n.current)return;const i=e.current,a=c=>{c.preventDefault();const p=c.pageX-i.offsetLeft-o.current;i.scrollLeft=r.current-p},s=()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",s)};return i.addEventListener("mousedown",c=>{o.current=c.pageX-i.offsetLeft,r.current=i.scrollLeft,window.addEventListener("mousemove",a),window.addEventListener("mouseup",s)}),n.current=!0,()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",s)}},[e])},dl=l.default.div`
  width: 100%;
  overflow-x: auto;
...
`,cl=({loading:e=!1,headers:o,body:r,noHover:n=!1,styleWrapper:i,styleTable:a,styleTHead:s,styleTBody:c,onScroll:h,showPagination:p=!0,pagination:A={onChangePage:()=>{},lastPage:1,currentPage:1}})=>{const[u,b]=x.useState([]),g=x.useRef(null),w=x.useRef(null);ll(w),x.useLayoutEffect(()=>{b(Array.from(Array(o.props.children.length).keys()))},[o.props.children.length]);const C=k=>{!h||(g.current&&clearTimeout(g.current),g.current=setTimeout(()=>{var m;h(((m=k.target)==null?void 0:m.scrollLeft)||0)},50))};return t.jsxs(t.Fragment,{children:[t.jsx(dl,{style:i,onScroll:C,ref:w,children:t.jsxs(sl,{noHover:n,style:a,children:[t.jsx("thead",{style:s,children:t.jsx("tr",{children:o})}),t.jsx("tbody",{style:c,children:e?Array.from(Array(2).keys()).map(k=>t.jsx("tr",{children:u.map(m=>t.jsx("td",{children:t.jsx(F.default,{width:"100%",height:"100%"})},m))},k)):r})]})}),p&&!e&&t.jsx(Et,{currentPage:A.currentPage,lastPage:A.lastPage,onChangePage:A.onChangePage}),p&&e&&t.jsx(F.default,{width:"240px",height:"20px",style:{display:"block",margin:"15px auto 0"}})]})},pl=f.css`
  background: none;
  outline: none;
  border: none;
  padding: none;
...
`,Al=l.default.button`
  ...
  ${({isLoading:e})=>Ce({isLoading:e})};
  ${({disabled:e})=>$({disabled:e})};
`,gl=({container:e,options:o,closeIcon:r})=>{var n;return t.jsxs(fl,{marginBottom:e==null?void 0:e.marginBottom,padding:e==null?void 0:e.padding,isSticky:e==null?void 0:e.isSticky,zIndex:e==null?void 0:e.zIndex,children:[r!=null&&r.hide?t.jsx("div",{}):t.jsx(ie,{onClick:r.onClick,style:{marginLeft:(r==null?void 0:r.marginLeft)||"20px"},children:t.jsx(ne,{})}),t.jsx(hl,{minWidthForOptions:o.minWidth,paddingForOptions:o.padding,children:(n=o==null?void 0:o.options)==null?void 0:n.map((i,a)=>t.jsx(Al,{onClick:i.onClick,type:"button",mode:i.mode,disabled:i.disabled,children:i.text},`${a}${i.id}`))})]})},ul=l.default.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  font-size: 14px;
...
`,bl=({title:e,subtitle:o,aside:r})=>t.jsxs(ul,{children:[t.jsxs(xl,{children:[e,o&&t.jsxs("span",{children:[t.jsx(ae,{size:10})," ",o]})]}),r]}),vl=l.default.div`
  display: flex;
  gap: ${({gap:e})=>e||"15px"};
  align-items: center;
  justify-content: center;
...
`,ml=({title:e,total_PEN:o,total_USD:r,tip_PEN:n,tip_USD:i,main:a,loading:s,autoWidth:c,noDecimals:h=!1,containerStyle:p})=>{const A=u=>Tt(u,h?0:2);return t.jsx(Cl,{main:a,autoWidth:c,style:p,children:s?t.jsxs(t.Fragment,{children:[t.jsx(It,{children:t.jsx(F.default,{width:"150px",height:"15px"})}),t.jsxs(St,{children:[t.jsxs(K,{style:{marginRight:"30px"},children:[t.jsx(Dt,{})," ",t.jsx("span",{children:t.jsx(F.default,{width:"50px",height:"15px"})})]}),t.jsxs(K,{children:[t.jsx(Nt,{})," ",t.jsx("span",{children:t.jsx(F.default,{width:"50px",height:"15px"})})]})]}),t.jsx(zt,{children:t.jsx(F.default,{width:"150px",height:"15px"})})]}):t.jsxs(t.Fragment,{children:[t.jsx(It,{children:e||""}),t.jsxs(St,{children:[o&&o>0?t.jsxs(K,{style:{marginRight:"30px"},children:[t.jsx(Dt,{})," ",t.jsx("span",{children:A(o)})]}):null,r&&r>0?t.jsxs(K,{children:[t.jsx(Nt,{})," ",t.jsx("span",{children:A(r)})]}):null]}),t.jsx(zt,{children:n&&n>0||i&&i>0?t.jsxs(t.Fragment,{children:[t.jsx("span",{children:"Propina: "}),n&&n>0?t.jsxs("span",{children:[" ",` S/${A(n)}`]}):null,i&&i>0?t.jsxs("span",{children:[" ",` $/${A(i)}`]}):null]}):null})]})})},Ml=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},stroke:o,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:t.jsx("polyline",{points:"22 12 18 12 15 21 9 3 6 12 2 12"})})})}),kl=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},stroke:o,viewBox:"0 0 24 24",strokeWidth:"0",xmlns:"http://www.w3.org/2000/svg",fill:o,children:t.jsx("path",{d:"M21 11H6.83l3.58-3.59L9 6l-6 6 6 6 1.41-1.41L6.83 13H21z"})})})}),Ft=l.default.div`
...
`,Ll=({name:e,symbol:o,currentAmount:r,oldAmount:n,loading:i,autoWidth:a=!1,noDecimals:s,containerStyle:c})=>{var b;const h=g=>Tt(g,s?0:2),p=()=>{if(!r||!n)return 0;const g=Math.round(r*100/n);return Number.isNaN(g-100)?0:Number.isFinite(g-100)?g:100},A={isUp:!r||!n?!1:r>=n,value:`${(b=h(p()))!=null?b:"0"}%`},u=`${o!=null?o:""} ${h(r||0)}`;return i?t.jsxs(Ft,{autoWidth:Boolean(a),style:c,children:[e&&t.jsx(jt,{children:t.jsx(F.default,{width:"70px",height:"17px"})}),t.jsxs(Bt,{children:[t.jsx(F.default,{width:"50px",height:"30px"}),A&&A.value&&t.jsx(Ht,{isUp:A.isUp,children:t.jsx(F.default,{width:"50px",height:"15px"})})]})]}):t.jsxs(Ft,{autoWidth:Boolean(a),style:c,children:[e&&t.jsxs(jt,{children:[t.jsx(Ml,{size:14}),e]}),t.jsxs(Bt,{children:[t.jsx("strong",{children:u}),A&&A.value&&t.jsx(Ht,{isUp:A.isUp,children:t.jsxs("strong",{children:[t.jsx(kl,{size:14,color:A.isUp?"#27ae60":"#ea345f",styleContainer:{transform:A.isUp?"rotate(90deg)":"rotate(-90deg)"}}),A.value]})})]})]})},Pt=x.createContext({}),yl={lat:0,lng:0,locality:"",address:""},El=({children:e,onSelectAddress:o,API_KEY:r,initialData:n={},onSelectCoordinates:i})=>{const[a,s]=x.useState({loaded:!1,api:null,instance:null}),[c,h]=x.useState({...yl,...n}),[p,A]=x.useState({lat:c.lat,lng:c.lng}),u=x.useRef(!1),b=fe(),g=C=>{C.viewport?a.instance.fitBounds(C.viewport):(a.instance.setCenter(C.location),a.instance.setZoom(17))},w=C=>{A(C),i&&i(C)};return x.useEffect(()=>{b||o(c)},[c]),t.jsx(Pt.Provider,{value:{API_KEY:r,map:a,setMap:s,onSelectAddress:o,addressState:c,setAddressState:h,coordinates:p,setCoordinates:w,setMapCenter:g,editedAddressRef:u},children:e})},ue=()=>x.useContext(Pt),Tl=l.default.div`
  position: absolute;
  top: 50%;
  left: 50%;
  transform: ${({placement:e})=>e==="center"?"translate(-50%, -50%)":"translate(-50%, -100%)"};
`,Ut=({children:e,placement:o})=>o?t.jsx(Tl,{children:e}):t.jsx(t.Fragment,{children:e}),Dl=e=>t.jsxs(z,{viewBox:"0 0 24 30",color:"#4318FF",fill:"none",...e,children:[t.jsx("path",{d:"M16.4 11.7692C16.4 14.1483 14.4301 16.0769 12 16.0769C9.56995 16.0769 7.6 14.1483 7.6 11.7692C7.6 9.39016 9.56995 7.46154 12 7.46154C14.4301 7.46154 16.4 9.39016 16.4 11.7692Z",fill:"currentColor"}),t.jsx("path",{d:"M23 11.4379C23 20.5162 12 29 12 29C12 29 1 20.5162 1 11.4379C1 5.67319 5.92487 1 12 1C18.0751 1 23 5.67319 23 11.4379Z",fill:"currentColor"}),t.jsx("path",{d:"M16.4 11.7692C16.4 14.1483 14.4301 16.0769 12 16.0769C9.56995 16.0769 7.6 14.1483 7.6 11.7692C7.6 9.39016 9.56995 7.46154 12 7.46154C14.4301 7.46154 16.4 9.39016 16.4 11.7692Z",stroke:e.borderColor||"#F5F5F5",strokeWidth:"2",strokeLinejoin:"round"}),t.jsx("path",{d:"M23 11.4379C23 20.5162 12 29 12 29C12 29 1 20.5162 1 11.4379C1 5.67319 5.92487 1 12 1C18.0751 1 23 5.67319 23 11.4379Z",stroke:e.borderColor||"#F5F5F5",strokeWidth:"2",strokeLinejoin:"round"})]}),Nl={lat:-12.1245726,lng:-77.0266616},Il=({children:e,defaultMarker:o=!0,defaultCenter:r,onMapLoad:n})=>{const{map:i,setMap:a,API_KEY:s,setMapCenter:c,coordinates:h,setCoordinates:p,setAddressState:A,editedAddressRef:u}=ue(),b=x.useRef(null),g=(C,k)=>{const m={lat:C,lng:k};p(m),b.current||(b.current=new i.api.Geocoder),b.current.geocode({location:m},(M,E)=>{if(E!=="OK"||!M[0])return;const y=M[0],D=y.address_components.find(I=>I.types.includes("locality")),L=(D==null?void 0:D.long_name)||"",T=y.formatted_address;y.geometry&&c(y.geometry),A(I=>{const q=u!=null&&u.current?I.address:T;return{...m,locality:L,address:q}})})},w=!!(h.lat&&h.lng);return t.jsxs(Kt.default,{defaultZoom:15,defaultCenter:r||(w?h:Nl),bootstrapURLKeys:{key:s,libraries:["places","geometry"]},yesIWantToUseGoogleMapApiInternals:!0,onGoogleApiLoaded:C=>{a({loaded:!0,api:C.maps,instance:C.map}),n&&n(C.maps,C.map)},onClick:C=>{g((C==null?void 0:C.lat)||0,(C==null?void 0:C.lng)||0)},children:[o&&w&&t.jsx(Ut,{text:"Location",placement:"center-bottom",...h,children:t.jsx(Dl,{size:28})}),e]})},Sl=(e,o=350)=>{const r=x.useRef(null);return(...i)=>{r.current&&clearTimeout(r.current),r.current=setTimeout(()=>{e(...i)},o)}},zl=({...e})=>{const{addressState:o,setAddressState:r,editedAddressRef:n}=ue(),[i,a]=x.useState(o.address),s=Sl(c=>{r(h=>({...h,address:c}))});return x.useEffect(()=>{a(o.address)},[o.address]),t.jsx(de,{value:i,placeholder:"Direcci\xF3n",onChange:c=>{const h=c.target.value;a(h),s(h),n.current=!0},...e})},Fl=e=>t.jsx(z,{viewBox:"0 0 12 12",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M5.36095 0.923077C2.90998 0.923077 0.923077 2.90998 0.923077 5.36095C0.923077 7.81191 2.90998 9.79882 5.36095 9.79882C6.58541 9.79882 7.69331 9.30353 8.49673 8.50126C9.30166 7.69747 9.79882 6.58771 9.79882 5.36095C9.79882 2.90998 7.81191 0.923077 5.36095 0.923077ZM0 5.36095C0 2.40018 2.40018 0 5.36095 0C8.32172 0 10.7219 2.40018 10.7219 5.36095C10.7219 6.67611 10.2478 7.88125 9.46204 8.81375L11.8645 11.2118C12.0449 11.3919 12.0452 11.6841 11.8651 11.8645C11.685 12.0449 11.3928 12.0452 11.2124 11.8651L8.80895 9.46608C7.87711 10.2495 6.67385 10.7219 5.36095 10.7219C2.40018 10.7219 0 8.32172 0 5.36095Z",fill:"currentColor"})}),jl=l.default.div`
  ...
  font-size: 11px;
  cursor: pointer;
`,Bl={Provider:El,Map:Il,Search:({onError:e,inputProps:o={}})=>{const{map:r,editedAddressRef:n,setMapCenter:i,setCoordinates:a,setAddressState:s}=ue(),c=x.useRef(null);return x.useEffect(()=>{if(!r.loaded)return;const h=new r.api.places.Autocomplete(c.current);return h.addListener("place_changed",()=>{var b,g;const p=h.getPlace(),A=(b=p==null?void 0:p.address_components)==null?void 0:b.find(w=>w.types.includes("locality"));if(!((g=p.geometry)!=null&&g.location)){const{name:w}=p;e&&w&&e(`No se encontaron detalles disponibles para: "${w}"`,w);return}const u={lat:p.geometry.location.lat(),lng:p.geometry.location.lng()};s({...u,address:p.formatted_address,locality:A==null?void 0:A.long_name}),i(p.geometry),a(u),c.current.value="",n.current=!0}),h.bindTo("bounds",r.instance),()=>{c.current&&r.api.event.clearInstanceListeners(c.current)}},[r]),t.jsx(de,{startEl:t.jsx(Fl,{size:13}),endEl:t.jsx(jl,{onClick:()=>{c.current.value=""},children:t.jsx(wt,{})}),inputRef:c,placeholder:"Ingresa una direcci\xF3n",...o})},AddressInput:zl,MarkerWrapper:Ut};v.ActionOptionsModal=Za,v.Badge=jo,v.BaseInput=de,v.BulletOptionsModal=Ha,v.BulletPoint=ze,v.Button=S,v.ButtonsSelect=it,v.ButtonsSwitch=ui,v.Card=Jo,v.CardModal=Y,v.CartProduct=d0,v.CartProductV2=y0,v.Checkbox=li,v.ClientCard=wn,v.CodeInput=fr,v.Collapsible=Ir,v.ConfirmationCard=V0,v.ConfirmationCardV2=$0,v.ConfirmationCardV3=ct,v.ConfirmationModalV3=Ia,v.CurrentStatusCard=Ro,v.CustomSelect=ke,v.DateRangePicker=La,v.DropdownMenu=Zr,v.EditQuantityInput=le,v.GridTable=il,v.Heading=dr,v.HorizontalDivision=mo,v.IDCard=Bn,v.IconV2=z,v.KpiCard=ml,v.KpiCardV2=Ll,v.Loader=kr,v.Map=Bl,v.ModalHeader=gl,v.MultipleOptionsModal=Na,v.Navbar=bo,v.NoData=Vr,v.OptionsModal=bt,v.OrderStatusBadge=Ue,v.OrderTypeBanner=Yo,v.Pagination=Et,v.ProductDetailsCard=H0,v.ProfileImage=wr,v.QuantityInputV2=hi,v.Radio=si,v.Search=Ee,v.SectionCard=hn,v.SectionHeader=bl,v.SelectField=Di,v.SimpleFooter=wl,v.StatusBanner=Go,v.StickyHeader=zr,v.SupplyInput=wi,v.Tab=ko,v.Table=cl,v.Text=N,v.TextField=gt,v.Textarea=ot,v.ToastCard=Dn,v.ToggleSwitch=yi,v.TotalsCard=dn,v.TransparentBadge=Ze,v.UploadFileContainer=pe,v.UploadImage=Ja,v.UploadMultipleImages=_a,v.UserIconTooltip=Be,v.UserProfileIcon=J,v.UsersList=Io,Object.defineProperties(v,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
