(function(f,c){typeof exports=="object"&&typeof module<"u"?c(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("react-loading-skeleton"),require("react-select"),require("@radix-ui/react-collapsible")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","react-loading-skeleton","react-select","@radix-ui/react-collapsible"],c):(f=typeof globalThis<"u"?globalThis:f||self,c(f["ID-Components"]={},f.styled,f["react/jsx-runtime"].js,f.React,f.Skeleton,f.Select,f["@radix-ui/react-collapsible"]))})(this,function(f,c,o,b,R,_,V){"use strict";const T=e=>e&&typeof e=="object"&&"default"in e?e:{default:e};function G(e){if(e&&e.__esModule)return e;const r=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const t in e)if(t!=="default"){const a=Object.getOwnPropertyDescriptor(e,t);Object.defineProperty(r,t,a.get?a:{enumerable:!0,get:()=>e[t]})}}return r.default=e,Object.freeze(r)}const u=T(c),J=T(R),q=T(_),C=G(V),K={bold:700,medium:500,regular:400,light:300},L={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},U={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},X=({shape:e})=>{switch(e){case"rounded":return c.css`
      ...
      `;default:return c.css`
        border-radius: 0.625rem;
      `}},j=({design:e,color:r})=>{switch(e){case"solid":return c.css`
...
`,ie=u.default(oe)`
  ...
  ${({size:e})=>S({size:e})};
  ${({shape:e})=>X({shape:e})};
  ${({design:e,color:r})=>j({design:e,color:r})};
  ${({fullWidth:e})=>B({fullWidth:e})};
  ${({isLoading:e})=>ee({isLoading:e})};
  ${({disabled:e})=>te({disabled:e})};
  ${({m:e,mb:r,mt:t,mr:a,ml:l,my:n,mx:i,p:s,pb:d,pt:h,pr:g,pl:x,py:N,px:v})=>O({m:e,mb:r,mt:t,mr:a,ml:l,my:n,mx:i,p:s,pb:d,pt:h,pr:g,pl:x,py:N,px:v})};
...
`,Y=({children:e,...r})=>o.jsxs(ie,{...r,children:[r.leftIcon,e,r.rightIcon]});function ne(e,r,t){const a=()=>{const l=document.querySelectorAll("input");return Array.from(l).filter(i=>i.className===r)};b.useEffect(()=>{const l=n=>{n.key==="Backspace"&&setTimeout(()=>{const i=a(),s=document.activeElement;s.value="";const d=i.indexOf(s);d>0&&i[d-1].focus()},0)};return document.addEventListener("keydown",l),()=>document.removeEventListener("keydown",l)},[]),b.useEffect(()=>{const l=n=>{if(n.key!=="Backspace"){const i=n.key.toLowerCase();setTimeout(()=>{if(i.length===1){const s=a(),d=document.activeElement;d.value=i;const h=s.indexOf(d);h<s.length-1&&s[h+1].focus()}},0)}};return document.addEventListener("keydown",l),()=>document.removeEventListener("keydown",l)},[]),b.useEffect(()=>{if(e){const l=n=>{const i=n.key.toLowerCase();(i.length===1||i==="backspace")&&setTimeout(()=>{const d=a().map(h=>h.value).join("");e(d)},0)};return document.addEventListener("keydown",l),()=>document.removeEventListener("keydown",l)}},[]),b.useEffect(()=>{if(t){const l=a();console.log({codeInputs:l.map(d=>d.value)});const n=l.map(d=>d.value),i=t.split(""),s=i.length===n.length?i:n;l.forEach((d,h)=>{const g=s[h];g&&(d.value=g)})}},[t])}const ae=c.keyframes`
  0% {
    opacity: 0;
...
`,le=c.css`
  ...
  ${({align:e})=>re({align:e})}
  ${({m:e,mb:r,mt:t,mr:a,ml:l,my:n,mx:i,p:s,pb:d,pt:h,pr:g,pl:x,py:N,px:v})=>O({m:e,mb:r,mt:t,mr:a,ml:l,my:n,mx:i,p:s,pb:d,pt:h,pr:g,pl:x,py:N,px:v})};
`,ce=e=>{const r=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",t=r?"bold":"medium",a=r?U[e]:U.text,l="PRIMARY/900";return c.css`
    font-weight: ${({weight:n=t})=>K[n]||"500"};
    font-size: ${({size:n=a})=>L[n]||n};
...
`,ye=b.forwardRef(({label:e,searchable:r=!0,isMobile:t,autoSize:a,value:l,options:n,placeholder:i="Seleccione una opci\xF3n",fullWidth:s,fullWidthOptions:d,onChange:h,formatOptionLabel:g,formatSelectedOption:x},N)=>{const v=b.useRef(null),[D,M]=b.useState(n),[I,E]=b.useState(""),[$,z]=b.useState(!1);Ee(v,()=>{z(!1)});const Ke=b.useCallback(()=>{const p=n.filter(A=>A.label.toLowerCase().includes(I.toLowerCase()));M(p)},[n,l]),W=b.useCallback(p=>{h(n.find(A=>A.label===p)),z(!1),E(""),M(n)},[Ke]),Xe=b.useCallback(p=>{E(p.target.value);const A=n.filter(Z=>Z.label.toLowerCase().includes(p.target.value.toLowerCase()));M(A)},[]),et=()=>{const p=v.current;if(p){const A=p.getBoundingClientRect();return window.innerHeight-A.bottom-20}};return o.jsxs(Ce,{fullWidth:s,ref:v,children:[e&&o.jsx(m,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),o.jsxs("div",{className:"select-btn",onClick:()=>z(!$),tabIndex:0,onKeyUpCapture:p=>{p.key==="Enter"&&z(!$)},children:[o.jsx(m,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:x?x(l):g?g(l):l.label}),o.jsx(ze,{size:20})]}),$&&o.jsxs(Se,{maxOptionsHeight:a?et():285,fullWidthOptions:d,children:[r&&o.jsx("div",{className:"search-box",children:o.jsx(Q,{leftAddon:o.jsx(Te,{}),type:"text",placeholder:i,value:I,onChange:Xe,fullWidth:!0})}),o.jsx("div",{className:"options",children:D.map(p=>o.jsx(m,{as:"li",color:"NEUTRAL/700",className:p.value===l.value?"selected":"",tabIndex:0,onClick:()=>W(p.label),onKeyUpCapture:A=>{A.key==="Enter"&&W(p.label)},children:g?g(p):p.label},`${p.label}-${p.value}`))})]})]})}),De=u.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,qe=({onBack:e,backLabel:r,profileImageUrl:t})=>o.jsxs(Je,{children:[o.jsxs("button",{type:"button",onClick:e,children:[o.jsx(Ge,{}),o.jsx(m,{color:"NEUTRAL/900",children:r})]}),o.jsx("img",{width:28,height:28,src:t||P,alt:"profile",referrerPolicy:"no-referrer"})]});f.Button=Y,f.Card=Qe,f.CodeInput=pe,f.Collapsible=Ve,f.CustomSelect=ye,f.Heading=fe,f.Loader=Oe,f.ProfileImage=Le,f.SelectField=me,f.StickyHeader=qe,f.Text=m,f.TextField=Ie,Object.defineProperties(f,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
