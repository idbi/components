(function(x,p){typeof exports=="object"&&typeof module<"u"?p(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("@radix-ui/react-collapsible"),require("@floating-ui/react-dom"),require("../node_modules/react-icons/ai/index.esm.js"),require("react-loading-skeleton"),require("react-select"),require("../node_modules/react-icons/fi/index.esm.js"),require("../node_modules/react-icons/md/index.esm.js")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","@radix-ui/react-collapsible","@floating-ui/react-dom","../node_modules/react-icons/ai/index.esm","react-loading-skeleton","react-select","../node_modules/react-icons/fi/index.esm","../node_modules/react-icons/md/index.esm"],p):(x=typeof globalThis<"u"?globalThis:x||self,p(x["ID-Components"]={},x.styled,x["react/jsx-runtime"].js,x.React,x["@radix-ui/react-collapsible"],x["@floating-ui/react-dom"],x.index_esm_js,x.Skeleton,x.Select,x.index_esm_js$1,x.index_esm_js$2))})(this,function(x,p,o,w,vo,B,Co,Mo,Lo,H,ko){"use strict";const G=e=>e&&typeof e=="object"&&"default"in e?e:{default:e};function mo(e){if(e&&e.__esModule)return e;const t=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const r in e)if(r!=="default"){const n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(t,r,n.get?n:{enumerable:!0,get:()=>e[r]})}}return t.default=e,Object.freeze(t)}const a=G(p),V=mo(vo),S=G(Mo),Eo=G(Lo),yo={bold:700,medium:500,regular:400,light:300},ae={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},le={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},c={color:{NEUTRAL:{0:"#FFFFFF",20:"#FFFFFF",50:"#F5F5F5",100:"#EBEBEB",200:"#dfdfdf",300:"#bfbfbf",400:"#9f9f9f",500:"#808080",600:"#404040",700:"#383838",800:"#202020",900:"#000000"},PRIMARY:{0:"#FFFFFF",50:"#F1F2F9",100:"#E6E8F4",200:"#DDDFF0",300:"#BBBFE2",400:"#999FD3",500:"#777fc5",600:"#545fb6",700:"#414a98",800:"#333a76",900:"#242954"},SECONDARY:{0:"#FFFFFF",20:"#F7F5FF",50:"#EFEBFF",100:"#E6E0FF",200:"#d0c5ff",300:"#d0c5ff",400:"#b9a8ff",500:"#a18cff",600:"#8a6fff",700:"#7252ff",800:"#5b35ff",900:"#4318FF"},TERTIARY:{0:"#FFFFFF",50:"#FFFAFC",100:"#FFF5F9",200:"#ffeff5",300:"#ffe0eb",400:"#ffd0e1",500:"#ffc1d7",600:"#ffb1cd",700:"#FFA1C3",800:"#ff92b9",900:"#FF82AF"},QUATERNARY:{0:"#FFFFFF",50:"#FBFCFE",100:"#F2F6FD",200:"#ebf1fc",300:"#D8E4FA",400:"#c4d6f8",500:"#b0c8f5",600:"#9cbbf3",700:"#88adf0",800:"#75a0ed",900:"#6192EB"},STATE:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEF7EB",200:"#fef3e3",300:"#fde7c6",400:"#fcdba9",500:"#fbcf8d",600:"#fac270",700:"#f9b654",800:"#f8aa38",900:"#F79E1B"},ALERT:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEEDEC",200:"#fde3e2",300:"#fbc8c5",400:"#f9ada8",500:"#f7918b",600:"#f4756d",700:"#F25A50",800:"#F03E33",900:"#EE2316"},SUCCESS:{0:"#FFFFFF",50:"#F7FDFA",100:"#EEFBF4",200:"#e4f9ed",300:"#c9f3db",400:"#aeedc9",500:"#93e7b7",600:"#78e1a4",700:"#5DDB92",800:"#42D580",900:"#2DC96F"},OTHER:{color1:"#151E5A"},STATUS:{DEFAULT:{0:"#F5F5F5",1:"#808080"},DRAFT:{0:"#F5F5F5",1:"#808080"},PENDING:{0:"#DFDFDF",1:"#404040"},REJECTED:{0:"#FDE3E2",1:"#EE2316"},ACCEPTED:{0:"#D0C5FF",1:"#4318FF"},CANCELED:{0:"#FDE3E2",1:"#EE2316"},PREPARING:{0:"#FEF3E3",1:"#F79E1B"},READYFORPICKUP:{0:"#FFEFF5",1:"#FF82AF"},DELIVERED:{0:"#E4F9ED",1:"#2DC96F"},FINISHED:{0:"#DDDFF0",1:"#414A98 "}}},effect:{darkShadow:{4:"0px 0px 4px 1px rgba(139, 139, 139, 0.32)",6:"0px 1px 6px rgba(60, 60, 60, 0.2)",8:"0px 1px 6px rgba(107, 107, 107, 0.2)",12:"0px 0px 12px 2px #F6F6F6",24:"0px 0px 24px 4px rgba(0, 14, 51, 0.2)",30:"0px 10px 30px rgba(0, 0, 0, 0.08)"},lightShadow:{2:"0px 0px 2px 1px rgba(149, 178, 254, 0.2)",16:"0px 4px 16px rgba(153, 181, 255, 0.2)"}}},To=({shape:e})=>{switch(e){case"rounded":return p.css`
      ...
      `;default:return p.css`
        border-radius: 0.625rem;
      `}},No=({design:e,color:t,fontColor:r})=>{switch(e){case"solid":return p.css`
...
`,Do=a.default(So)`
  ...
  ${({size:e})=>X({size:e})};
  ${({shape:e})=>To({shape:e})};
  ${({design:e,color:t,fontColor:r})=>No({design:e,color:t,fontColor:r})};
  ${({fullWidth:e})=>de({fullWidth:e})};
  ${({isLoading:e})=>ce({isLoading:e})};
  ${({disabled:e})=>J({disabled:e})};
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:u})=>se({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:u})};
...
`,I=({children:e,...t})=>o.jsxs(Do,{...t,children:[t.leftIcon,e,t.rightIcon]});function Fo(e,t,r){const n=()=>{const i=document.querySelectorAll("input");return Array.from(i).filter(d=>d.className===t)};w.useEffect(()=>{const i=l=>{l.key==="Backspace"&&setTimeout(()=>{const d=n(),s=document.activeElement;s.value="";const h=d.indexOf(s);h>0&&d[h-1].focus()},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),w.useEffect(()=>{const i=l=>{if(l.key!=="Backspace"){const d=l.key.toLowerCase();setTimeout(()=>{if(d.length===1){const s=n(),h=document.activeElement;h.value=d;const A=s.indexOf(h);A<s.length-1&&s[A+1].focus()}},0)}};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),w.useEffect(()=>{if(e){const i=l=>{const d=l.key.toLowerCase();(d.length===1||d==="backspace")&&setTimeout(()=>{const h=n().map(A=>A.value).join("");e(h)},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)}},[]),w.useEffect(()=>{if(r){const i=n(),l=i.map(h=>h.value),d=r.split(""),s=d.length===l.length?d:l;i.forEach((h,A)=>{const f=s[A];f&&(h.value=f)})}},[r])}const zo=p.keyframes`
  0% {
    opacity: 0;
...
`,K=a.default.div`
  ...
  ${({shouldAppear:e})=>e&&p.css`
      animation: ${zo} 0.2s ease-in;
      animation-fill-mode: forwards;
    `}
`,Bo={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},jo=p.css`
  ...
  ${({align:e})=>Io({align:e})}
  ${({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:u})=>se({m:e,mb:t,mt:r,mr:n,ml:i,my:l,mx:d,p:s,pb:h,pt:A,pr:f,pl:g,py:b,px:u})};
`,Uo=e=>{const t=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",r=t?"bold":"medium",n=t?le[e]:le.text,i="PRIMARY/900";return p.css`
    font-weight: ${({weight:l=r})=>yo[l]||"500"};
    font-size: ${({size:l=n})=>ae[l]||l};
    color: ${({color:l=i})=>{const d=l==null?void 0:l.split("/")[0],s=Number(l==null?void 0:l.split("/")[1]);return c.color[d][s]}};
  `},Ho=a.default.div`
  ${jo}
  ${({as:e})=>Uo(e)}
`,z=({as:e,...t})=>{const r=Bo[e];return o.jsx(Ho,{as:r,...t})},Po={H1:e=>o.jsx(z,{as:"h1",...e}),H2:e=>o.jsx(z,{as:"h2",...e}),H3:e=>o.jsx(z,{as:"h3",...e}),H4:e=>o.jsx(z,{as:"h4",...e}),H5:e=>o.jsx(z,{as:"h5",...e}),H6:e=>o.jsx(z,{as:"h6",...e})},Zo=a.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
  transition: 0.3s ease-out;
`,y=e=>e.rightIcon||e.leftIcon?o.jsxs(Zo,{children:[e.leftIcon,o.jsx(z,{as:e.as||"p",...e}),e.rightIcon]}):o.jsx(z,{as:e.as||"p",...e}),Yo=a.default.div`
  display: grid;
...
`,q=w.forwardRef(({type:e,leftAddon:t,rightAddon:r,placeholder:n,error:i,success:l,size:d,fullWidth:s,name:h,infoMessage:A,onFocus:f,onBlur:g,onChange:b,...u},v)=>{const[k,M]=w.useState(!1),C=!i&&!l&&A&&k;return o.jsxs(o.Fragment,{children:[o.jsxs(Jo,{fullWidth:s,success:l,size:d,error:i,disabled:u.disabled,leftAddon:t,rightAddon:r,isFocused:k,children:[t&&o.jsx("span",{className:"leftAddon",children:t}),o.jsx("input",{ref:v,onFocus:m=>{f&&f(m),M(!0)},onBlur:m=>{g&&g(m),M(!1)},onChange:b,placeholder:n,type:e,name:h,...u}),r&&o.jsx("span",{className:"rightAddon",children:r}),i&&o.jsx("span",{className:"state",children:o.jsx(Go,{size:24,color:c.color.ALERT[900]})}),l&&o.jsx("span",{className:"state",children:o.jsx(Vo,{size:20,color:c.color.SUCCESS[900]})})]}),C&&o.jsx(K,{shouldAppear:C,children:o.jsx(y,{size:"xs",color:"QUATERNARY/900",children:A})})]})});q.displayName="TextInput";const Xo=a.default.div`
  position: relative;
...
`,Ae=w.forwardRef(({label:e,searchable:t=!0,autoSize:r,value:n,options:i,placeholder:l="Seleccione una opci\xF3n",fullWidth:d,fullWidthOptions:s,onChange:h,formatOptionLabel:A,formatSelectedOption:f})=>{const g=w.useRef(null),[b,u]=w.useState(i),[v,k]=w.useState(""),[M,C]=w.useState(!1);P(g,()=>{C(!1)});const m=w.useCallback(()=>{const L=i.filter(E=>E.label.toLowerCase().includes(v.toLowerCase()));u(L)},[i,n]),T=w.useCallback(L=>{h(i.find(E=>E.label===L)),C(!1),k(""),u(i)},[m]),N=w.useCallback(L=>{k(L.target.value);const E=i.filter(O=>O.label.toLowerCase().includes(L.target.value.toLowerCase()));u(E)},[]),U=()=>{const L=g.current;if(L){const E=L.getBoundingClientRect();return window.innerHeight-E.bottom-20}};return o.jsxs(Xo,{fullWidth:d,ref:g,children:[e&&o.jsx(y,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),o.jsxs("div",{className:"select-btn",onClick:()=>C(!M),tabIndex:0,onKeyUpCapture:L=>{L.key==="Enter"&&C(!M)},children:[o.jsx(y,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:f?f(n):A?A(n):n.label}),o.jsx(pe,{size:20})]}),M&&o.jsxs(Ko,{maxOptionsHeight:r?U():285,fullWidthOptions:s,children:[t&&o.jsx("div",{className:"search-box",children:o.jsx(q,{leftAddon:o.jsx(Oo,{}),type:"text",placeholder:l,value:v,onChange:N,fullWidth:!0})}),o.jsx("div",{className:"options",children:b.map(L=>o.jsx(y,{as:"li",color:"NEUTRAL/700",className:L.value===n.value?"selected":"",tabIndex:0,onClick:()=>T(L.label),onKeyUpCapture:E=>{E.key==="Enter"&&T(L.label)},children:A?A(L):L.label},`${L.label}-${L.value}`))})]})]})});Ae.displayName="CustomSelect";const qo=a.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,Ro=({imageUrl:e,size:t=128,onChange:r})=>{const n=w.useRef(null),i=l=>{var s;const d=(s=l.target.files)==null?void 0:s[0];if(d){const h=URL.createObjectURL(d);r({file:d,url:h})}};return o.jsxs(qo,{size:t,children:[o.jsx(y,{color:"NEUTRAL/400",weight:"regular",size:"xs",children:"Agrega tu foto"}),o.jsxs("div",{className:"profile-input__container",children:[o.jsx("input",{type:"file",accept:"image/png, image/jpeg",onChange:i,ref:n}),o.jsx("img",{width:t,height:t,src:e||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"}),o.jsx(I,{type:"button",size:"lg",design:"flat",shape:"circular",onClick:()=>{var l;return(l=n.current)==null?void 0:l.click()},children:"+"})]})]})},$o=p.keyframes`
  0%,
  100% {
...
`,st=({onBack:e,backLabel:t,profileImageUrl:r,rightContent:n})=>o.jsxs(ct,{children:[o.jsxs("button",{type:"button",onClick:e,children:[o.jsx(Y,{}),o.jsx(y,{color:"NEUTRAL/900",children:t})]}),n||o.jsx("img",{width:28,height:28,src:r||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"})]}),pt=p.keyframes`
  100% {
    transform: rotate(360deg);
  }
`,At=a.default.div`
  ...
  border-radius: 50%;
  animation: ${pt} 1s infinite linear;
`,R=e=>o.jsx(At,{width:e.width,height:e.height,borderWidth:e.borderWidth,margin:e.margin}),fe=a.default.ul`
...
`,ht=a.default.div`
  ...
  top: 0;
  right: calc(100% + 8px);
`,gt=({text:e,options:t})=>{const[r,n]=w.useState(!1),i=w.useRef(null),l=d=>{if(i.current&&clearTimeout(i.current),d){n(!0);return}i.current=setTimeout(()=>{r!==d&&n(d)},50)};return o.jsxs($,{onMouseEnter:()=>l(!0),onMouseLeave:()=>l(!1),active:r,onClick:d=>d.stopPropagation(),children:[e," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(Y,{})}),r&&o.jsx(ht,{children:o.jsx(fe,{children:t.map((d,s)=>o.jsxs($,{alert:d.alert,onClick:h=>d.disabled||d.loading?h.stopPropagation():d.onClick(),disabled:d.disabled||d.loading,loading:d.loading,children:[d.text," ",d.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(R,{width:"20px",height:"20px"})}):d.icon]},`suboption-${s}`))})})]})},xt=({options:e,header:t})=>o.jsxs(fe,{children:[t&&o.jsx(ft,{children:t}),e.map((r,n)=>"options"in r?o.jsx(gt,{...r},`option-${n}`):o.jsxs($,{disabled:r.disabled||r.loading,alert:r.alert,onClick:r.disabled||r.loading?i=>i.stopPropagation():r.onClick,loading:r.loading,children:[r.text," ",r.loading?o.jsx("div",{style:{width:"24px"},children:o.jsx(R,{width:"20px",height:"20px"})}):r.icon]},`option-${n}`))]}),ut=a.default.div`
  display: flex;
  cursor: pointer;
  text-align: right;
  * {
...
`,bt=({options:e,activator:t,header:r})=>{const{x:n,y:i,reference:l,floating:d,strategy:s,update:h,refs:A}=B.useFloating({placement:"bottom-end"}),[f,g]=w.useState(!1);return w.useEffect(()=>{if(!(!A.reference.current||!A.floating.current))return B.autoUpdate(A.reference.current,A.floating.current,h)},[f,h]),P(A.reference,()=>{g(!1)}),o.jsxs("div",{ref:l,children:[o.jsx(ut,{onClick:()=>g(!f),children:t||o.jsx(pe,{size:25})}),f&&o.jsx("div",{ref:d,style:{position:s,top:i!=null?i:0,left:n!=null?n:0,zIndex:100},onClick:()=>g(!f),children:o.jsx(xt,{options:e,header:r})})]})},wt=a.default.div`
  text-align: center;
  font-weight: 300;
  font-size: 0.75rem;
...
`,Et=e=>e==="small"?"45px":e==="big"?"55px":`${e}px`,yt=a.default.input`
  width: 100%;
  height: ${({containerSize:e})=>Et(e)};
  padding: 8px 15px;
...
`,Q=({img:e,size:t=36,initials:r,containerProps:{style:n,...i}={}})=>{const l=r.slice(0,2).toUpperCase();return o.jsx(Bt,{hasImg:!(e!=null&&e.src),style:{width:`${t}px`,minWidth:`${t}px`,height:`${t}px`,fontSize:`${t/(r.length===1?2:2.25)}px`,...n||{}},...i,children:e!=null&&e.src?o.jsx("img",{...e}):l})},Z=p.css`
  ::-webkit-scrollbar {
    width: 4px;
    height: 4px;
  }
...
`,Wt=({option:e,onClose:t,subOptions:r=[]})=>{const[n,i]=w.useState(!1);return o.jsxs("li",{onClick:()=>{r.length>0?i(!n):(e.onClick(),t())},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.text," ",r.length>0&&o.jsx(oe,{size:12,style:{display:"block",marginLeft:"auto",marginRight:"0",transform:n?"":"rotate(-90deg)"}})]}),n&&r.length>0&&o.jsx("ul",{children:r.map((l,d)=>o.jsx("li",{onClick:()=>{l.onClick(),t()},children:l.text},`${d}sub${e.key}`))})]})},Ot=({options:e=[],links:t=[],userIcon:r,searchOption:n,logoIcon:i,bellIcon:l,zIndex:d,isSticky:s})=>{const[h,A]=w.useState(!1),[f,g]=w.useState(!1),b=w.useRef(null);return P(b,()=>{A(!1),g(!1)}),o.jsxs(jt,{zIndex:d,isSticky:s,ref:b,children:[o.jsxs(Ut,{children:[o.jsxs(ue,{children:[e.length>0&&o.jsx(Co.AiOutlineMenu,{size:20,color:"#151E5A",onClick:()=>{g(!1),A(!h)},style:{cursor:"pointer"}}),i!=null&&i.onClick?o.jsx(xe,{size:28,onClick:()=>{A(!1),g(!1),i==null||i.onClick()}}):o.jsx(xe,{size:28})]}),o.jsxs(Ht,{children:[o.jsx(Pt,{children:t.map((u,v)=>o.jsx("li",{onClick:()=>(u==null?void 0:u.onClick)&&(u==null?void 0:u.onClick()),children:u.text},`${v}navbarlinksfordesktop`))}),(n==null?void 0:n.show)&&o.jsx(ge,{...n,onSearch:u=>n.onSearch(u)}),(l==null?void 0:l.show)&&o.jsx(Ft,{size:16,onClick:()=>{l!=null&&l.onClick&&l.onClick(),A(!1),g(!f)}}),(r==null?void 0:r.show)&&o.jsxs(ue,{children:[((r==null?void 0:r.name)||(r==null?void 0:r.note))&&o.jsxs(Zt,{children:[(r==null?void 0:r.name)&&o.jsx(y,{children:r==null?void 0:r.name}),(r==null?void 0:r.note)&&o.jsx(y,{color:"NEUTRAL/500",size:"xs",as:"span",children:r==null?void 0:r.note})]}),o.jsx(Q,{initials:(r==null?void 0:r.initials)||"ID",img:(r==null?void 0:r.img)||null,size:35,containerProps:{onClick:()=>{r!=null&&r.onClick&&(A(!1),g(!1),r.onClick())},style:r!=null&&r.onClick?{cursor:"pointer"}:{}}})]})]})]}),h&&o.jsx(Yt,{children:o.jsx("ul",{children:e.map((u,v)=>o.jsx(Wt,{option:u.option,subOptions:u.subOptions,onClose:()=>A(!h)},`${v}navbaroption`))})}),f&&o.jsx(Qt,{children:l==null?void 0:l.children})]})},Gt=e=>o.jsx(F,{viewBox:"0 0 8 8",...e,children:o.jsx("circle",{xmlns:"http://www.w3.org/2000/svg",cx:"4",cy:"4",r:"4",fill:"currentColor"})}),Vt=a.default.span`
...
`,be=({children:e,spacing:t,color:r,bulletSize:n,size:i})=>o.jsxs(Vt,{color:r,size:i,bulletSize:n,spacing:t,children:[o.jsx(Gt,{}),e]}),Jt=a.default.div`
  display: flex;
  align-items: center;
  gap: 15px;
`,we=a.default.div`
  ...
  flex-grow: 1;
`,Xt=({children:e,thickness:t=1,hrMinWidth:r=15})=>o.jsxs(Jt,{children:[o.jsx(we,{thickness:t,minWidth:r}),e,o.jsx(we,{thickness:t,minWidth:r})]}),Kt=a.default.button`
  color: currentColor;
  background-color: transparent;
  border: none;
  font-size: 14px;
  ...
  ${({isActive:e,rounded:t,activeColor:r,tabWidth:n})=>e&&p.css`
    ...
    `};
`,qt=({children:e,active:t,tabWidth:r=24,activeColor:n=c.color.SECONDARY[900],...i})=>o.jsx(Kt,{isActive:t,noWrap:!0,activeColor:n,tabWidth:r,...i,children:e});function ve(e="(min-width: 768px)"){const[t,r]=w.useState({matches:window.innerWidth>(()=>{const i=e.match(/(\d+)/);return i?i[0]:768})()});return w.useEffect(()=>{let i=window.matchMedia(e);return i.addEventListener("change",r),()=>i.removeEventListener("change",r)},[]),{status:Boolean(t&&t.matches)}}const Rt=a.default.div`
...
`,_t=({render:e,tooltipContent:t,tooltipStyles:r={},placement:n,offset:i,strategy:l,middlewares:d=[]})=>{const[s,h]=w.useState(!1),A=w.useRef(null),{x:f,y:g,reference:b,floating:u,strategy:v,update:k,refs:M,middlewareData:C,placement:m}=B.useFloating({placement:n||"top",strategy:l,middleware:[B.offset(i!=null?i:10),...d,B.arrow({element:A})]}),{x:T,y:N}=C.arrow||{},{status:U}=ve("(hover: hover)"),L=(O=!0)=>{U&&h(O)};w.useEffect(()=>{if(!(!M.reference.current||!M.floating.current))return B.autoUpdate(M.reference.current,M.floating.current,k)},[s,k]);const E={top:"bottom",right:"left",bottom:"top",left:"right"}[m.split("-")[0]];return o.jsxs(o.Fragment,{children:[e({ref:b,onMouseEnter:()=>L(),onMouseLeave:()=>L(!1)}),s&&o.jsxs(Rt,{ref:u,style:{position:v,top:g!=null?g:0,left:f!=null?f:0,...r},children:[t,o.jsx($t,{ref:A,style:{left:T!=null?`${T}px`:"",top:N!=null?`${N}px`:"",[E]:"-3px"}})]})]})},er=(...e)=>e.reduce((t,r)=>t+(r||"").charAt(0),"").toUpperCase(),Ce=({name:e,lastname:t,img:r,size:n,tooltipProps:i={}})=>o.jsx(_t,{tooltipContent:`${e} ${t||""}`,render:l=>o.jsx(Q,{initials:er(e,t),img:r,size:n,containerProps:{...l}}),...i}),or=e=>o.jsx(F,{viewBox:"0 0 12 12",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M5.99935 0.166992C6.31623 0.166992 6.57312 0.446814 6.57312 0.791992V5.37532L11.2589 5.37532C11.5758 5.37532 11.8327 5.65515 11.8327 6.00032C11.8327 6.3455 11.5758 6.62532 11.2589 6.62532L6.57312 6.62532V11.2087C6.57312 11.5538 6.31623 11.8337 5.99935 11.8337C5.68246 11.8337 5.42558 11.5538 5.42558 11.2087V6.62532L0.739786 6.62533C0.422901 6.62533 0.166016 6.3455 0.166016 6.00033C0.166016 5.65515 0.422901 5.37533 0.739786 5.37533L5.42558 5.37532V0.791992C5.42558 0.446814 5.68246 0.166992 5.99935 0.166992Z",fill:"currentColor"})}),tr=a.default.div`
  display: flex;
...
`,nr=({users:e,onAdd:t,iconSize:r=34})=>o.jsxs(tr,{size:r,children:[t&&o.jsx(rr,{size:r,onClick:t,children:o.jsx(or,{size:r/2.5})}),[...e].reverse().map((n,i)=>o.jsx("div",{style:{height:r},children:o.jsx(Ce,{...n,size:r,tooltipProps:{strategy:"fixed"}})},`user-${n.name}-${i}`))]}),ir=a.default.span`
  ...
  ${({statusName:e,removeBackground:t})=>{if(e==="draft")return p.css`
      ...
      `}};
`,Me={default:"...",draft:"Borrador",pending:"Pendiente",rejected:"Rechazado",accepted:"Aceptado",canceled:"Anulado",preparing:"Preparando",readyforpickup:"Listo para recojo",delivered:"Entregado",finished:"Finalizado"},Le=({statusName:e,text:t,removeBackground:r})=>{const n=i=>Me[i]||Me.default;return o.jsx(ir,{statusName:e,removeBackground:r,children:t||n(e)})},ar=a.default.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
  font-size: 1em;
  display: inline-block;
  font-weight: bold;
`,ke=(e,t,r)=>e>=t&&e<=r?e:e<t?t:r,me=({intensity:e=.8,opacity:t=.5,children:r,style:n={},...i})=>{const l=ke(e,0,1),d=ke(t,0,1),s=256*l;return o.jsx(ar,{style:{backgroundColor:`rgba(${s}, ${s}, ${s}, ${d})`,...n},...i,children:r})},lr=a.default.span`
...
${({withBorder:e,color:t})=>e&&p.css`
    ...
    `}
`,dr=({text:e,padding:t,color:r,background:n,applyFlex:i,maxWidth:l,weight:d,borderRadius:s,withBorder:h})=>o.jsx(lr,{padding:t,color:r,background:n,applyFlex:i,maxWidth:l,weigth:d,borderRadius:s,withBorder:h,children:e}),cr=a.default.div`
  min-height: 50px;
  display: flex;
  justify-content: center;
...
`,Cr=({design:e="primary",header:t,options:r,optionsFormatter:n,content:i,withSeparator:l})=>o.jsxs(vr,{design:e,withSeparator:l,children:[t&&o.jsx("header",{children:t}),r&&n&&o.jsx("ul",{children:r.map(d=>o.jsx("li",{children:n(d)},d.value))}),i&&i]}),Mr=a.default.div`
  padding: 20px;
  border-radius: 10px;
  background: #fff;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,Ie=a.default.span`
  color: #151E5A;
  font-weight: 500;
`,kr=({items:e,creationDescription:t,creationDate:r,title:n,children:i})=>o.jsxs(Mr,{children:[n&&o.jsx(Lr,{children:n}),e.map(l=>o.jsxs("div",{children:[o.jsxs("p",{children:[l.description&&o.jsx("span",{children:l.description})," ",o.jsx(Le,{statusName:l.statusName,removeBackground:!0})]}),o.jsx(Ie,{children:l.statusDate})]},crypto.randomUUID())),r&&o.jsxs("div",{children:[t&&o.jsx("span",{children:t}),o.jsx(Ie,{children:r})]}),i]}),mr=a.default.div`
...
`,Fr=a.default.img`
  ...
  font-size: 9px;
  object-fit: cover;
`,zr=({items:e,title:t="",onAction:r=()=>{},actionName:n="",hideQuantity:i=!1,children:l,gap:d=10,background:s,padding:h})=>o.jsxs(mr,{background:s,padding:h,children:[(t||n)&&o.jsxs(Er,{children:[o.jsx(yr,{children:t}),o.jsx(Tr,{onClick:()=>r(),children:n})]}),o.jsx(Nr,{style:{gap:d},children:e.map(A=>o.jsxs(Ir,{remark:Boolean(A.remark),children:[i?o.jsxs(Se,{children:[o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(De,{children:A.notes.map(f=>o.jsx("li",{children:f},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}):o.jsxs(Se,{children:[A.img&&o.jsx(Fr,{src:A.img,alt:A.description}),o.jsx(Sr,{children:A.quantity}),o.jsxs("div",{children:[o.jsx("span",{children:A.description}),A.notes&&o.jsx(De,{children:A.notes.map(f=>o.jsx("li",{children:f},crypto.randomUUID()))})]}),A==null?void 0:A.decorators]}),o.jsxs(Dr,{remark:Boolean(A.remark),children:[A.currency," ",A.amount.toFixed(2)]})]},crypto.randomUUID()))}),l]}),Br=a.default.div`
  background-color: white;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,e0=a.default.span`
  ...
  text-decoration: underline;
  cursor: pointer;
`,o0=({title:e="",description:t="",type:r,link:n,icon:i})=>{const l=()=>{if(i)return i;if(r==="success")return o.jsx(Xr,{});if(r==="warning")return o.jsx(ze,{});if(r==="error")return o.jsx(Jr,{});if(r==="quaternary")return o.jsx(Kr,{});if(r==="tertiary")return o.jsx(ze,{color:"#FF82AF"})};return o.jsxs(Rr,{toastType:r||"primary",children:[l(),o.jsxs("div",{children:[e&&o.jsx($r,{children:e}),t&&o.jsxs(_r,{children:[t," ",n&&n.onClick&&o.jsx(e0,{onClick:d=>{d.stopPropagation(),n.onClick&&n.onClick()},children:(n==null?void 0:n.text)||"Ver m\xE1s"})]})]})]})},Be={xs:"(min-width: 360px)",sm:"(min-width: 591px)",md:"(min-width: 800px)",lg:"(min-width: 1400px)"},t0=a.default.div`
  font-family: 'Poppins';
  font-style: normal;
  display: flex;
  align-items: center;
...
`,s0=({onClose:e=()=>{},backdropOpacity:t,zIndex:r})=>(w.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),o.jsx(c0,{onClick:n=>{n.stopPropagation(),e()},opacity:t,zIndex:r})),je=p.keyframes`
  from {
...
`,A0=({children:e,onClose:t,backdropOpacity:r,zIndex:n,contentLocation:i="center",contentLocationInDesktop:l="center",boxShadow:d,boxShadowInDesktop:s,fullWidth:h,styleContainer:A})=>o.jsxs(o.Fragment,{children:[o.jsx(s0,{onClose:t,backdropOpacity:r,zIndex:n||4}),o.jsx(p0,{zIndex:n||4,contentLocation:i,contentLocationInDesktop:l,onClick:f=>f.stopPropagation(),boxShadow:d,boxShadowInDesktop:s,fullWidth:h,style:A,children:e})]}),f0=a.default.div`
...
`,j=({show:e=!0,children:t,onClose:r,backdropOpacity:n,padding:i,borderRadius:l,borderRadiusInDesktop:d,maxHeight:s,height:h,maxWidth:A,width:f,zIndex:g,overflow:b,contentLocation:u="center",contentLocationInDesktop:v="center",closeIcon:k,closeIconInDesktop:M,background:C="#fff",boxShadow:m,boxShadowInDesktop:T,styleContainer:N})=>e?o.jsx(A0,{onClose:r,backdropOpacity:n,zIndex:g,contentLocation:u,contentLocationInDesktop:v,boxShadow:m,boxShadowInDesktop:T,styleContainer:N,children:o.jsxs(f0,{padding:i,borderRadius:l,borderRadiusInDesktop:d,maxHeight:s,height:h,maxWidth:A,width:f,background:C,overflow:b,contentLocation:u,contentLocationInDesktop:v,children:[(k||M)&&o.jsx(h0,{onClick:r,closeIconInDesktop:M,closeIcon:k,children:o.jsx(_,{})}),t]})}):null,g0=a.default.h2`
...
`,Ze=({onConfirm:e,onClose:t,zIndex:r,onlyIntegers:n,initialValue:i})=>{const l=w.useRef(null),[d,s]=w.useState(i||""),h=f=>{const g=f.target.value;let b=/^[0-9]\d*(\.(\d*))?$/;n&&(b=/^[0-9]*$/),!(g!==""&&!b.test(g))&&s(g)};w.useEffect(()=>{l.current.focus()},[]);const A=Number(d);return o.jsxs(j,{onClose:t,maxWidth:"350px",zIndex:r||6,children:[o.jsx(g0,{children:"Especifica la cantidad"}),o.jsxs(x0,{children:[o.jsx("input",{type:"text",inputMode:n?"numeric":"decimal",value:d,onChange:h,ref:l}),o.jsx(I,{design:"solid",size:"xs",onClick:()=>e(A),disabled:A<=0,children:"Agregar"})]})]})},Ye=e=>o.jsx(F,{viewBox:"0 0 12 12",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M4.86399 0.666504C4.21911 0.666504 3.69633 1.18928 3.69633 1.83416V2.1813H1.077C0.850426 2.1813 0.666748 2.36497 0.666748 2.59155C0.666748 2.81813 0.850426 3.00181 1.077 3.00181H1.80284V9.40812C1.80284 10.4713 2.66472 11.3332 3.72789 11.3332H8.27227C9.33545 11.3332 10.1973 10.4713 10.1973 9.40812V3.00181H10.9232C11.1497 3.00181 11.3334 2.81813 11.3334 2.59155C11.3334 2.36497 11.1497 2.1813 10.9232 2.1813H8.30383V1.83416C8.30383 1.18928 7.78105 0.666504 7.13618 0.666504H4.86399ZM4.51685 1.83416C4.51685 1.64244 4.67227 1.48702 4.86399 1.48702H7.13618C7.32789 1.48702 7.48332 1.64244 7.48332 1.83416V2.1813H4.51685V1.83416ZM2.62336 9.40812V3.00181H9.37681V9.40812C9.37681 10.0181 8.88229 10.5127 8.27227 10.5127H3.72789C3.11787 10.5127 2.62336 10.0181 2.62336 9.40812ZM6.00008 4.07479C5.7735 4.07479 5.58982 4.25847 5.58982 4.48504L5.58982 9.02942C5.58982 9.256 5.7735 9.43968 6.00008 9.43968C6.22666 9.43968 6.41034 9.256 6.41034 9.02942L6.41034 4.48504C6.41034 4.25847 6.22666 4.07479 6.00008 4.07479Z",fill:"currentColor"})}),u0=a.default.div`
  display: flex;
  justify-content: center;
`,b0=a.default.span`
...
`,te=({value:e,onSetQuantity:t,onDelete:r,minimumQuantity:n=1,measureUnit:i,onlyIntegers:l,blockInputModal:d,disabled:s,hasError:h,variant:A,renderModal:f,zIndex:g,style:b,noDecrement:u,noIncrement:v})=>{const[k,M]=w.useState(!1),C=Number(e||0),m=e===null||C<=n,T=L=>{L.stopPropagation();const E=C%1!==0?Math.ceil(C):C+1;t(E)},N=L=>{if(L.stopPropagation(),m){r&&r();return}const E=C%1>0?Math.floor(C):C-1;t(E)},U=L=>{const E=l?Math.round(L):L;t(E<=n?n:E),M(!1)};return o.jsxs(o.Fragment,{children:[o.jsx(u0,{children:o.jsxs(v0,{isDisabled:s,onClick:L=>{L.stopPropagation(),!(d||s)&&M(!0)},minQuantity:m,canDelete:!!r,variant:A,error:h,style:b,children:[!u&&o.jsx("button",{disabled:s,onClick:N,children:m&&r?o.jsx(w0,{children:o.jsx(Ye,{color:c.color.ALERT[900]})}):"-"}),o.jsx(b0,{children:`${e===null?"-":e} ${e!==null&&i||""}`}),!v&&o.jsx("button",{onClick:T,disabled:s,children:"+"})]})}),k&&!d&&(f?f(o.jsx(Ze,{onClose:()=>M(!1),onConfirm:U,initialValue:e?e.toString():"",onlyIntegers:l,zIndex:g})):o.jsx(Ze,{onClose:()=>M(!1),onConfirm:U,initialValue:e?e.toString():"",onlyIntegers:l,zIndex:g}))]})},C0=a.default.div`
  background-color: white;
...
`,S0=a.default.div`
  ...
  justify-content: space-between;
  align-items: center;
`,D0=({img:e,name:t,currencySymbol:r,total:n,unitPrice:i,quantity:l,comment:d,onClick:s,onChangeQuantity:h,onDeleteProduct:A,onChangeComment:f,discount:g,measureUnit:b,productDetails:u,renderModal:v,onlyIntegers:k})=>{const[M,C]=w.useState(!0),m=b||"u.";return o.jsxs(C0,{children:[o.jsxs(M0,{onClick:s||(()=>{}),canClick:!!s,children:[(e==null?void 0:e.src)&&o.jsx(L0,{...e}),o.jsxs(k0,{children:[o.jsxs(m0,{detailsActive:M,children:[t,o.jsx(oe,{size:16,onClick:T=>{T.stopPropagation(),C(N=>!N)}})]}),g&&o.jsx(E0,{children:g.label}),o.jsxs(y0,{children:[g&&o.jsxs(T0,{children:["-",r,g.discountedAmount.toFixed(2)]}),o.jsxs(Qe,{children:[r,o.jsx("span",{children:n.toFixed(2)})]})]})]})]}),M&&o.jsxs("div",{children:[o.jsx(N0,{value:d,onChange:T=>f(T.target.value),placeholder:"Agregar alg\xFAn comentario"}),u&&o.jsx(I0,{children:u})]}),o.jsxs(S0,{children:[o.jsxs(Qe,{children:[r,o.jsx("span",{children:i.toFixed(2)})," x ",m]}),o.jsx(te,{value:l,onSetQuantity:h,measureUnit:m,onDelete:A,renderModal:v,onlyIntegers:k})]})]})},F0=a.default.div`
...
`,j0=a.default.button`
  ...
  ${({selected:e})=>e&&p.css`
    ...
    `}
`,We=({title:e,options:t,selected:r,onSelect:n})=>o.jsxs(F0,{children:[e&&o.jsx(z0,{children:e}),o.jsx(B0,{children:t.map(i=>o.jsx(j0,{selected:i.value===r,onClick:()=>n(i.value,i),disabled:!!i.disabled,children:i.content},`${i.value}-btn`))})]}),U0=Array.from(Array(5),(e,t)=>({content:`${t}`,value:`${t}`})),H0=a.default.div`
  position: absolute;
  top: calc(100% + 5px);
  left: 0;
`,P0=({selected:e,onSelect:t,onClose:r})=>{const n=w.useRef(null);return P(n,r),o.jsx(H0,{ref:n,children:o.jsx(We,{title:"Order de salida",options:U0,selected:e.toString(),onSelect:i=>{t(Number(i)),r()}})})},Z0=a.default.div`
  color: 1px solid ${({theme:e})=>e.color.NEUTRAL[700]};
  display: flex;
  gap: 10px;
  font-size: 12px;
...
`,q0=({img:e,name:t,currencySymbol:r,total:n,quantity:i,onClick:l,onChangeQuantity:d,onDeleteProduct:s,discount:h,productDetails:A,renderModal:f,onlyIntegers:g,dishNumber:b,onChangeDishNumber:u,measureUnit:v})=>{const[k,M]=w.useState(!1);return o.jsxs(Z0,{children:[b&&o.jsxs(Y0,{clickeable:!!u,children:["N\xB0",o.jsxs("div",{children:[o.jsx("button",{onClick:()=>{u&&M(!0)},children:b}),k&&u&&o.jsx(P0,{onClose:()=>M(!1),onSelect:C=>u(C),selected:b})]})]}),o.jsxs(Q0,{children:[(e==null?void 0:e.src)&&o.jsxs(W0,{children:[o.jsx(O0,{...e}),h&&o.jsx(G0,{children:h.label})]}),o.jsxs(V0,{clickeable:!!l,onClick:l||(()=>{}),children:[o.jsxs(Oe,{children:[o.jsx("span",{children:t}),A&&o.jsx(Oe,{children:A})]}),o.jsxs(J0,{children:[o.jsxs("div",{children:[o.jsxs(X0,{children:[r,o.jsx("span",{children:n.toFixed(2)})]}),h&&o.jsxs(K0,{children:[r," ",h.prevTotal.toFixed(2)]})]}),o.jsx(te,{value:i,onSetQuantity:d,onDelete:s,renderModal:f,onlyIntegers:g,measureUnit:v!=null?v:"u."})]})]})]})]})},R0=a.default.div`
  padding-right: 5px;
...
`,_0=a.default.span`
  ...
  font-size: 10px;
  font-weight: 700;
`,Ge=({currencySymbol:e,unitPrice:t,total:r,measureUnit:n,discount:i,disabled:l,bottom:d})=>{const s=n||"u.";return o.jsxs(R0,{disabled:l,bottom:d,children:[o.jsxs("span",{children:[e,t.toFixed(2)," x ",s]}),o.jsxs($0,{disabled:l,children:[i&&o.jsxs(o.Fragment,{children:[o.jsxs("span",{children:[e,i.prevTotal.toFixed(2)]}),o.jsx(_0,{children:i.label})]}),o.jsxs("span",{children:[e,o.jsx("span",{children:r.toFixed(2)})]})]})]})},en=e=>{switch(e){case"prepared":return"Listo";case"preparing":return"Preparando";default:return"Aceptado"}},on=a.default.div`
...
`,dn=a.default.div`
  ...
  margin-top: 8px;
  font-size: 12px;
`,cn=({name:e,img:t,quantity:r,currencySymbol:n,unitPrice:i,total:l,productDetails:d,discount:s,measureUnit:h,disabled:A,status:f,imgLabel:g,discountBottom:b=!0})=>{const u=b?!!(d||s):!!d;return o.jsxs(on,{disabled:A,hasDetails:!!d,children:[o.jsxs(tn,{children:[(t==null?void 0:t.src)&&o.jsxs(rn,{children:[o.jsx("div",{children:o.jsx("img",{...t})}),g,f&&!g&&o.jsx(nn,{status:f,children:en(f)})]}),o.jsxs(an,{hasDetails:!!u,children:[o.jsxs(ln,{disabled:A,children:[o.jsx(me,{opacity:.4,children:r}),e]}),d&&o.jsx(dn,{children:d}),!u&&o.jsx(Ge,{currencySymbol:n,unitPrice:i,total:l,discount:s,disabled:A})]})]}),u&&o.jsx(Ge,{currencySymbol:n,unitPrice:i,total:l,discount:s,disabled:A,bottom:!0})]})},sn=a.default.div`
  padding: 20px;
...
`,kn=({children:e,note:t="Esta acci\xF3n no se puede revertir.",btnLeft:r={onClick:()=>{},text:"Cancelar",disabled:!1},btnRight:n={onClick:()=>{},text:"Eliminar",disabled:!1}})=>{const{status:i}=ve("(min-width: 1023px)");return o.jsxs(bn,{children:[o.jsxs(Ln,{children:[o.jsxs(wn,{children:[o.jsx(Mn,{children:e}),o.jsx(vn,{children:t})]}),o.jsxs(Cn,{children:[i&&o.jsx(I,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{borderRadius:"32px",padding:"20px 0"},disabled:r.disabled,children:r.text}),o.jsx(I,{design:"solid",fullWidth:!0,onClick:()=>n.onClick(),style:{borderRadius:"32px",padding:"20px 60px"},disabled:n.disabled,children:n.text})]})]}),!i&&o.jsx(I,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{margin:"0 15px 15px",width:"calc(100% - 30px)",padding:"20px",borderRadius:"15px"},children:r.text})]})},mn=a.default.div`
  background: transparent;
  color: #383838;
  border-radius: 20px;
  font-weight: 500;
...
`,Fn=({children:e,value:t="value",callbackOnChange:r=()=>{},disabled:n=!1,...i})=>{const[l,d]=w.useState((i==null?void 0:i.checked)||!1);return w.useEffect(()=>{d(Boolean(i==null?void 0:i.checked))},[i==null?void 0:i.checked]),o.jsxs(Dn,{disabled:n,children:[o.jsx("input",{...i,type:"checkbox",value:t,disabled:n,onChange:s=>{d(!l),r(s.target.value,!l)},checked:l}),o.jsx("span",{children:l?o.jsx(In,{color:n?"gray":"#4318FF"}):o.jsx(Sn,{color:n?"gray":"#4318FF"})}),e]})},zn=a.default.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 9px;
...
`,Bn=({text:e,...t})=>o.jsxs(zn,{disabled:Boolean(t.disabled),children:[o.jsx("input",{type:"radio",...t}),o.jsx("label",{htmlFor:t==null?void 0:t.id,children:e})]}),jn=a.default.div`
  background-color: white;
...
`;a.default.div`
  ...
  bottom: 0;
  left: 0;
`;const Hn=({options:e,selected:t,disabled:r,onSelect:n,fullWidth:i,model:l})=>o.jsx(jn,{disabled:r,onClick:d=>{r&&d.stopPropagation()},model:l,fullWidth:i,children:e.map(d=>o.jsx(Un,{onClick:()=>n(d.value),active:d.value===t,disabled:r,model:l,children:d.label},d.value))}),Pn=a.default.div`
...
`,Yn=a.default.span`
  ...
  line-height: 1.25rem;
  color: ${c.color.PRIMARY[900]};
`,Qn=({description:e,defaultValue:t,value:r,onChange:n=()=>{},placeholder:i,suffix:l,disabled:d,readingMode:s})=>o.jsxs(Pn,{disabled:d,withDescription:Boolean(e),readingMode:s,children:[e&&o.jsx(Zn,{children:e}),s?o.jsxs(Xe,{readingMode:s,children:[o.jsx(Yn,{children:t}),l&&!d&&o.jsx(Ke,{children:l})]}):o.jsxs(Xe,{children:[o.jsx("input",{type:"text",placeholder:i,disabled:d,onChange:h=>n(h.target.value),value:r}),l&&!d&&o.jsx(Ke,{children:l})]})]}),Wn=a.default.div`
  background-color: white;
...
`,On=({alert:e,fullWidth:t,minHeight:r,startEl:n,endEl:i,inputRef:l,...d})=>o.jsxs(Wn,{alert:e,fullWidth:t,minHeight:r!=null?r:45,className:"base-input-container",children:[n,o.jsx("input",{ref:l,...d}),i]}),Gn=a.default.div`
  display: flex;
  justify-content: flex-start;
  align-items: center;
  cursor: pointer;
...
`;a.default.p`
  ...
  margin: 15px 0;
  padding: 0 20px;
`;const Kn=({initial:e=!1,onToggle:t=()=>{},disabled:r=!1,width:n,padding:i,styleOn:l,styleOff:d})=>{const[s,h]=w.useState(e),A=()=>{if(!r){const f=!s;h(f),t(f)}};return o.jsx(Gn,{disabled:r,children:o.jsxs(Vn,{onClick:f=>{f.stopPropagation(),A()},toggled:s,width:n,padding:i,styleOn:l,styleOff:d,children:[o.jsx(Jn,{toggled:s,width:n,padding:i}),o.jsx(Xn,{visible:s,styleOn:l})]})})},qn=a.default.div`
  position: relative;
  width: 100%;
...
`,Rn={control:(e,t)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${t.isFocused?c.color.QUATERNARY[900]:c.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:c.color.PRIMARY[900],fontWeight:400,fontSize:"0.875rem",fontFamily:"Poppins",fontStyle:"normal"}),placeholder:e=>({...e,color:c.color.NEUTRAL[500]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"10px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"15px"})},$n=({formatOptionLabel:e,options:t,loading:r=!1,style:n,firstOption:i={label:"Seleccione una opci\xF3n",value:""},initialValue:l,value:d,onChange:s,isMulti:h,placeholder:A,label:f})=>{const g=i,b=[...t];return o.jsxs(qn,{style:n,children:[f&&o.jsx(y,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:f}),r?o.jsx(S.default,{style:{borderRadius:10,display:"block"},height:"45px",width:"100%"}):o.jsx(Eo.default,{placeholder:A,value:d||void 0,defaultValue:l||g,options:b,onChange:s,styles:Rn,isMulti:h,formatOptionLabel:e})]})},_n=a.default.div`
  width: ${e=>e.size}px;
  height: ${e=>e.size}px;
  position: relative;
  &::before {
...
`,Re=w.forwardRef(({label:e,type:t,error:r,isDirty:n,success:i,infoMessage:l,fullWidth:d,...s},h)=>{const A={...s,ref:h},[f,g]=w.useState(!1);return o.jsxs(ri,{fullWidth:d,children:[e&&o.jsxs("div",{className:"label-container",children:[o.jsx(y,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:e}),t==="password"&&o.jsx("span",{onClick:()=>g(!f),children:f?o.jsx(ti,{size:20}):o.jsx(oi,{size:20})})]}),o.jsx(q,{error:Boolean(r),success:i||!r&&n,infoMessage:l,fullWidth:d,type:f?"text":t,...A}),r&&o.jsx(K,{shouldAppear:Boolean(r),children:o.jsx(y,{size:"xs",color:"ALERT/900",children:r})})]})});Re.displayName="TextField";const ni=a.default.div`
...
`,$e=o.jsx("div",{style:{display:"inline-block"},children:o.jsx(R,{width:"20px",height:"20px"})}),di=({options:e,onClose:t,contentLocation:r,contentLocationInDesktop:n,defaultDescription:i="",defaultTitle:l="",optionsInCenter:d=!1,direction:s="row",iconOrientation:h="horizontal"})=>{const[A,f]=w.useState(null),g=w.useMemo(()=>{if(A===null)return null;const b=e[A];if(b&&"options"in b)return b},[A,e]);return o.jsx(j,{maxWidth:"500px",padding:"20px 0",onClose:t,contentLocation:r||"bottom",contentLocationInDesktop:n||"center",closeIcon:!0,children:o.jsxs(ni,{children:[o.jsxs(ai,{children:[o.jsxs(ii,{children:[g&&o.jsx(Y,{onClick:()=>f(null)}),o.jsx(y,{as:"h2",size:"md",children:(g==null?void 0:g.text)||l})]}),i.length>0&&o.jsx(y,{color:"NEUTRAL/400",size:"sm",weight:"regular",children:(g==null?void 0:g.description)||i})]}),o.jsxs(li,{direction:s,children:[!g&&e.map((b,u)=>"onClick"in b?o.jsxs(re,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&(b.onClick(),t())},optionsInCenter:d,iconOrientation:h,children:[o.jsx("span",{children:b.text}),b.loading?$e:b.icon]},`option-${u}`):o.jsxs(re,{onClick:()=>{f(u)},optionsInCenter:d,children:[b.text," ",o.jsx("div",{style:{transform:"rotateY(180deg)"},children:o.jsx(Y,{})})]},`option-${u}`)),g==null?void 0:g.options.map((b,u)=>o.jsxs(re,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&b.onClick()},optionsInCenter:d,children:[b.text," ",b.loading?$e:b.icon]},`suboption-${u}`))]})]})})},ci=({cardProps:e,...t})=>o.jsx(j,{background:"transparent",boxShadowInDesktop:"none",padding:"0 10px",contentLocation:"bottom",maxWidth:"650px",...e,children:o.jsx(Je,{...t})}),si=a.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
...
`,_e=({title:e,options:t,selected:r,onSelect:n,onClose:i,modalProps:l={},optionMinHeight:d=50})=>o.jsxs(j,{onClose:i,closeIcon:!0,contentLocation:"bottom",padding:"0",maxWidth:"600px",...l,children:[o.jsx(si,{children:e}),o.jsx(pi,{children:t.map(s=>o.jsxs(Ai,{minHeight:d,selected:s.value===r,disabled:s.disabled,onClick:()=>{s.disabled||n(s.value,s)},children:[s.content," ",s.icon]},s.value))})]}),fi=e=>o.jsx(F,{viewBox:"0 0 10 8",fill:"none",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M0.75 3.99992L3.58 6.82992L9.25 1.16992",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),hi=a.default.div`
  color: ${({color:e})=>e};
  padding-left: 15px;
  display: flex;
  align-items: center;
  flex-grow: 1;
`,gi=({options:e,selectedIcon:t,...r})=>o.jsx(_e,{options:e.map(({content:n,color:i=c.color.NEUTRAL[800],...l})=>({content:o.jsx(hi,{color:i,children:o.jsx(be,{spacing:30,bulletSize:7,children:n})}),icon:l.value===r.selected?t||o.jsx(fi,{}):void 0,...l})),...r}),xi=a.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
  padding-bottom: 18px;
...
`,wi=({title:e,options:t,onClose:r,closeOnAction:n,modalProps:i={}})=>o.jsxs(j,{onClose:r,closeIcon:!0,contentLocation:"bottom",padding:"20px",maxWidth:"600px",...i,children:[o.jsx(xi,{children:e}),o.jsx(ui,{children:t.map((l,d)=>o.jsxs(bi,{disabled:l.disabled,onClick:()=>{l.disabled||(l.onClick(),n&&r())},children:[l.icon," ",l.content]},`modal-option-${d}`))})]}),vi=(e,t=1024*8)=>{let r=!0,n=null;return e.size/1024>t&&(r=!1,n={code:"F0001",message:`El archivo ${e.name} pesa ${(e.size/1024/1024).toFixed(2)} MB. Intenta subir una imagen menor a ${t/1024} MB `}),{success:r,error:n}},ne=({onSelectFile:e,maxKBSize:t,onError:r=()=>{},acceptedFiles:n,validFileExtensions:i,children:l,style:d})=>{const s=w.useRef(null),h=()=>s.current.click(),A=()=>{const u=s.current.files[0];b(u)},f=u=>{u.stopPropagation(),u.preventDefault();const v=u.dataTransfer.files[0];b(v)},g=u=>i?new RegExp(`${i.join("|")}$`,"i").exec(u.toLowerCase()):!0,b=u=>{var k;if(!u)return;if(!g(u.name)){r("Tipo de archivo no permitido");return}const v=vi(u,t);if(!v.success){r((k=v.error)==null?void 0:k.message);return}e(u)};return o.jsxs("div",{onClick:h,onDragOver:u=>u.preventDefault(),onDrop:f,style:d,children:[l,o.jsx("input",{ref:s,style:{display:"none"},onChange:A,type:"file",accept:n})]})},eo=()=>{const e=w.useRef(!0);return w.useEffect(()=>{e.current=!1},[]),e.current},oo=e=>{const t=e.slice(e.lastIndexOf("/"));return[t.slice(1,t.indexOf(".")),t.slice(t.lastIndexOf(".")+1).toUpperCase()]},to=e=>o.jsx(F,{viewBox:"0 0 18 17",...e,children:o.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M1 13.6923H1.75H1ZM14.5385 16V15.25V16ZM3.46154 16V16.75H3.46154L3.46154 16ZM17 3.30772H17.75H17ZM17 13.6923H16.25H17ZM14.5385 1.00002L14.5385 0.250023L14.5385 1.00002ZM3.46154 1L3.46154 1.75L3.46154 1ZM4.69231 7.92307L5.20526 7.37592C4.91677 7.10546 4.46784 7.10546 4.17935 7.37592L4.69231 7.92307ZM12.7947 16.5472C13.0969 16.8304 13.5715 16.8151 13.8548 16.513C14.1381 16.2108 14.1228 15.7361 13.8206 15.4528L12.7947 16.5472ZM16.487 13.6625C16.7892 13.9458 17.2639 13.9305 17.5472 13.6283C17.8305 13.3262 17.8151 12.8515 17.513 12.5682L16.487 13.6625ZM13.3077 9.65384L13.8206 9.10669C13.5322 8.83623 13.0832 8.83623 12.7947 9.10669L13.3077 9.65384ZM9.92308 12.8269L9.41012 13.3741L9.92308 12.8269ZM1 11.3846H0.25H1ZM14.5385 15.25L3.46154 15.25L3.46154 16.75L14.5385 16.75V15.25ZM16.25 3.30772L16.25 13.6923H17.75L17.75 3.30772H16.25ZM14.5385 0.250023L3.46155 0.25L3.46154 1.75L14.5385 1.75002L14.5385 0.250023ZM17.75 3.30772C17.75 1.57414 16.2658 0.250026 14.5385 0.250023L14.5385 1.75002C15.5301 1.75002 16.25 2.49229 16.25 3.30772H17.75ZM1.75 3.30769C1.75 2.49226 2.46995 1.75 3.46154 1.75L3.46155 0.25C1.73419 0.249996 0.250001 1.57411 0.25 3.30769H1.75ZM0.25 13.6923C0.25 15.4259 1.73418 16.75 3.46154 16.75V15.25C2.46995 15.25 1.75 14.5077 1.75 13.6923H0.25ZM14.5385 16.75C16.2658 16.75 17.75 15.4259 17.75 13.6923H16.25C16.25 14.5077 15.53 15.25 14.5385 15.25V16.75ZM13.7885 5.03846C13.7885 5.53526 13.344 6.01923 12.6923 6.01923V7.51923C14.0798 7.51923 15.2885 6.45341 15.2885 5.03846H13.7885ZM12.6923 6.01923C12.0406 6.01923 11.5962 5.53526 11.5962 5.03846H10.0962C10.0962 6.45341 11.3048 7.51923 12.6923 7.51923V6.01923ZM11.5962 5.03846C11.5962 4.54166 12.0406 4.05769 12.6923 4.05769V2.55769C11.3048 2.55769 10.0962 3.62351 10.0962 5.03846H11.5962ZM12.6923 4.05769C13.344 4.05769 13.7885 4.54165 13.7885 5.03846H15.2885C15.2885 3.62351 14.0798 2.55769 12.6923 2.55769V4.05769ZM17.513 12.5682L13.8206 9.10669L12.7947 10.201L16.487 13.6625L17.513 12.5682ZM4.17935 8.47023L9.41012 13.3741L10.436 12.2798L5.20526 7.37592L4.17935 8.47023ZM9.41012 13.3741L12.7947 16.5472L13.8206 15.4528L10.436 12.2798L9.41012 13.3741ZM12.7947 9.10669L9.41012 12.2798L10.436 13.3741L13.8206 10.201L12.7947 9.10669ZM0.25 3.30769L0.25 11.3846H1.75L1.75 3.30769H0.25ZM0.25 11.3846L0.25 13.6923H1.75L1.75 11.3846H0.25ZM1.51296 11.9318L5.20526 8.47023L4.17935 7.37592L0.487044 10.8375L1.51296 11.9318Z",fill:"currentColor"})}),Ci=a.default.div`
  min-height: 70px;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,Ei=({initialImgUrl:e,placeholder:t,onChange:r,onError:n})=>{const[i,l]=w.useState(null),[d,s]=w.useState(e||null),h=eo();return w.useEffect(()=>{let A="";return i&&(A=window.URL.createObjectURL(i),s(A)),()=>{A&&window.URL.revokeObjectURL(A)}},[i]),w.useEffect(()=>{h||r(i,d||null)},[d]),o.jsx(ne,{onError:n||alert,onSelectFile:A=>l(A),acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:d?o.jsxs(Li,{children:[o.jsxs(ki,{children:[o.jsx("img",{src:d}),o.jsxs(mi,{children:[o.jsx("span",{children:(i==null?void 0:i.name)||oo(d)[0]}),o.jsx("span",{children:(i==null?void 0:i.type)||oo(d)[1]})]})]}),o.jsx(ee,{variant:"secondary",onClick:A=>{A.stopPropagation(),l(null),s(null)},children:o.jsx(Fe,{size:12})})]}):o.jsx(Ci,{children:t||o.jsxs(Mi,{children:[o.jsx(to,{color:c.color.SECONDARY[900],size:18})," Sube un imagen ",o.jsx("span",{children:"aqu\xED"})]})})})},ro=a.default.div`
  width: 55px;
  height: 55px;
  border-radius: 7px;
`,yi=a.default.div`
...
`,Ii=a.default.div`
  ...
  right: 0;
  bottom: 0;
`,Si=({onChange:e,initialImages:t,limit:r})=>{const[n,i]=w.useState(t||[]),[l,d]=w.useState(null),s=eo(),h=f=>{const g=window.URL.createObjectURL(f);i(b=>[...b,{file:f,url:g}])},A=f=>{const g=n[f];typeof g!="string"&&window.URL.revokeObjectURL(g.url),i(b=>b.filter((u,v)=>v!==f))};return w.useEffect(()=>{s||e(n)},[n]),o.jsxs(yi,{children:[n.map((f,g)=>o.jsxs(Ti,{onMouseEnter:()=>d(g),onMouseLeave:()=>d(null),onTouchCancel:()=>d(null),children:[o.jsx("img",{src:typeof f=="string"?f:f.url}),l===g&&o.jsx(Ii,{onClick:()=>A(g),children:o.jsx(Ye,{size:16})})]},`imgs-${g}`)),!(r&&n.length>=r)&&o.jsx(ne,{onError:alert,onSelectFile:h,acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:o.jsx(Ni,{children:o.jsx(to,{})})})]})},Di=a.default.div`
  display: grid;
...
`,io=e=>{if(e==="center")return p.css`
  ...
  `},ao=e=>{if(e)return p.css`
    width: 100%;
    border-right: 1.5px solid ${c.color.QUATERNARY[300]};
  `},lo=e=>{if(e)return p.css`
    display: flex;
    align-items: center;
    gap: 10px;
  `},ie=e=>{if(e!=null&&e.trim())return p.css`
    grid-column: ${e};
  `},zi=a.default.div`
  ${no}
  font-weight: 500;
  ...
  padding-bottom: 8px;
  padding: 15px 10px 8px;
  ${({location:e})=>io(e||"left")}
  ${({separator:e})=>ao(Boolean(e))}
  ${({itemFlex:e})=>lo(Boolean(e))}
  ${({gridColumn:e})=>ie(e)}
`,Bi=a.default.div`
  ${no}
  font-weight: 400;
...
`,ji=a.default.div`
  ...
  ${({gridColumn:e})=>ie(e)}
`,Ui={Table:({gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:l,header:d,body:s})=>o.jsx(Fi,{children:o.jsxs(Di,{gridTemplateColumns:e,maxWidth:t,minWidth:r,gap:n,padding:i,margin:l,children:[d&&d,s&&s]})}),Th:zi,Td:Bi,Tr:ji},Hi=a.default.div`
  margin: 15px auto;
  height: 33px;
  display: flex;
  align-items: center;
...
`,co=({currentPage:e=1,lastPage:t=1,onChangePage:r=()=>{}})=>{const[n,i]=w.useState(String(e)||"");w.useEffect(()=>{e!==0&&(!e||(Number(e)||1)>t?(i(String(t)),r(Number(t))):(r(Number(e)),i(String(e))))},[e]);const l=f=>{if(!((Number(f)||1)>t)){if(t>0&&(Number(n)<1||!Number(f))){i("1"),r(1);return}if(!f)return i("");i(f),r(Number(f)||1)}},d=()=>Number(n)<=1?"1px solid #BFBFBF":"1px solid #4318FF",s=()=>Number(n)<=1?"#BFBFBF":"#4318FF",h=()=>Number(n)===t?"#BFBFBF":"#4318FF",A=()=>Number(n)===Number(t)||Number(n)===1;return o.jsxs(Hi,{disabled:A(),children:[o.jsx("button",{type:"button",disabled:n==="1",onClick:()=>l(String(1)),style:{padding:"0px",backgroundColor:"#fff",border:d()},children:o.jsx(H.FiChevronsLeft,{size:20,color:s()})}),o.jsx("button",{type:"button",disabled:n==="1",onClick:()=>l(String((Number(n)||1)-1)),style:{padding:"0px",backgroundColor:"#fff",border:d()},children:o.jsx(H.FiChevronLeft,{size:20,color:s()})}),o.jsx("input",{type:"number",value:Number(n),max:t,onChange:f=>l(f.target.value||"")}),o.jsxs("p",{children:["de ",t]}),o.jsx("button",{type:"button",disabled:Number(n)===t,onClick:()=>l(String((Number(n)||1)+1)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===t?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:o.jsx(H.FiChevronRight,{size:20,color:h()})}),o.jsx("button",{type:"button",disabled:Number(n)===t,onClick:()=>l(String(t)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===t?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:o.jsx(H.FiChevronsRight,{size:20,color:h()})})]})},Pi=e=>{const t=w.useRef(0),r=w.useRef(0),n=w.useRef(!1);w.useEffect(()=>{if(!e.current||n.current)return;const i=e.current,l=s=>{s.preventDefault();const A=s.pageX-i.offsetLeft-t.current;i.scrollLeft=r.current-A},d=()=>{window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",d)};return i.addEventListener("mousedown",s=>{t.current=s.pageX-i.offsetLeft,r.current=i.scrollLeft,window.addEventListener("mousemove",l),window.addEventListener("mouseup",d)}),n.current=!0,()=>{window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",d)}},[e])},Zi=a.default.div`
  width: 100%;
  overflow-x: auto;
...
`,Qi=({loading:e=!1,headers:t,body:r,noHover:n=!1,styleWrapper:i,styleTable:l,styleTHead:d,styleTBody:s,onScroll:h,showPagination:A=!0,pagination:f={onChangePage:()=>{},lastPage:1,currentPage:1}})=>{const[g,b]=w.useState([]),u=w.useRef(null),v=w.useRef(null);Pi(v),w.useLayoutEffect(()=>{b(Array.from(Array(t.props.children.length).keys()))},[t.props.children.length]);const k=M=>{!h||(u.current&&clearTimeout(u.current),u.current=setTimeout(()=>{var C;h(((C=M.target)==null?void 0:C.scrollLeft)||0)},50))};return o.jsxs(o.Fragment,{children:[o.jsx(Zi,{style:i,onScroll:k,ref:v,children:o.jsxs(Yi,{noHover:n,style:l,children:[o.jsx("thead",{style:d,children:o.jsx("tr",{children:t})}),o.jsx("tbody",{style:s,children:e?Array.from(Array(2).keys()).map(M=>o.jsx("tr",{children:g.map(C=>o.jsx("td",{children:o.jsx(S.default,{width:"100%",height:"100%"})},C))},M)):r})]})}),A&&!e&&o.jsx(co,{currentPage:f.currentPage,lastPage:f.lastPage,onChangePage:f.onChangePage}),A&&e&&o.jsx(S.default,{width:"240px",height:"20px",style:{display:"block",margin:"15px auto 0"}})]})},Wi=p.css`
  background: none;
  outline: none;
  border: none;
  padding: none;
...
`,Vi=a.default.button`
  ...
  ${({isLoading:e})=>ce({isLoading:e})};
  ${({disabled:e})=>J({disabled:e})};
`,Ji=({container:e,options:t,closeIcon:r})=>{var n;return o.jsxs(Oi,{marginBottom:e==null?void 0:e.marginBottom,padding:e==null?void 0:e.padding,isSticky:e==null?void 0:e.isSticky,zIndex:e==null?void 0:e.zIndex,children:[r!=null&&r.hide?o.jsx("div",{}):o.jsx(ee,{onClick:r.onClick,style:{marginLeft:(r==null?void 0:r.marginLeft)||"20px"},children:o.jsx(_,{})}),o.jsx(Gi,{minWidthForOptions:t.minWidth,paddingForOptions:t.padding,children:(n=t==null?void 0:t.options)==null?void 0:n.map((i,l)=>o.jsx(Vi,{onClick:i.onClick,type:"button",mode:i.mode,disabled:i.disabled,children:i.text},`${l}${i.id}`))})]})},Xi=a.default.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  font-size: 14px;
...
`,qi=({title:e,subtitle:t,aside:r})=>o.jsxs(Xi,{children:[o.jsxs(Ki,{children:[e,t&&o.jsxs("span",{children:[o.jsx(oe,{size:10})," ",t]})]}),r]}),Ri=a.default.div`
  display: flex;
  gap: ${({gap:e})=>e||"15px"};
  align-items: center;
  justify-content: center;
...
`,ea=({title:e,total_PEN:t,total_USD:r,tip_PEN:n,tip_USD:i,main:l,loading:d,autoWidth:s,noDecimals:h=!1,containerStyle:A})=>{const f=g=>so(g,h?0:2);return o.jsx(_i,{main:l,autoWidth:s,style:A,children:d?o.jsxs(o.Fragment,{children:[o.jsx(fo,{children:o.jsx(S.default,{width:"150px",height:"15px"})}),o.jsxs(ho,{children:[o.jsxs(W,{style:{marginRight:"30px"},children:[o.jsx(po,{})," ",o.jsx("span",{children:o.jsx(S.default,{width:"50px",height:"15px"})})]}),o.jsxs(W,{children:[o.jsx(Ao,{})," ",o.jsx("span",{children:o.jsx(S.default,{width:"50px",height:"15px"})})]})]}),o.jsx(go,{children:o.jsx(S.default,{width:"150px",height:"15px"})})]}):o.jsxs(o.Fragment,{children:[o.jsx(fo,{children:e||""}),o.jsxs(ho,{children:[t&&t>0?o.jsxs(W,{style:{marginRight:"30px"},children:[o.jsx(po,{})," ",o.jsx("span",{children:f(t)})]}):null,r&&r>0?o.jsxs(W,{children:[o.jsx(Ao,{})," ",o.jsx("span",{children:f(r)})]}):null]}),o.jsx(go,{children:n&&n>0||i&&i>0?o.jsxs(o.Fragment,{children:[o.jsx("span",{children:"Propina: "}),n&&n>0?o.jsxs("span",{children:[" ",` S/${f(n)}`]}):null,i&&i>0?o.jsxs("span",{children:[" ",` $/${f(i)}`]}):null]}):null})]})})},xo=a.default.div`
...
`,oa=({name:e,symbol:t,currentAmount:r,oldAmount:n,loading:i,autoWidth:l=!1,noDecimals:d,containerStyle:s})=>{var b;const h=u=>so(u,d?0:2),A=()=>{if(!r||!n)return 0;const u=Math.round(r*100/n);return Number.isNaN(u-100)?0:Number.isFinite(u-100)?u:100},f={isUp:!r||!n?!1:r>=n,value:`${(b=h(A()))!=null?b:"0"}%`},g=`${t!=null?t:""} ${h(r||0)}`;return i?o.jsxs(xo,{autoWidth:Boolean(l),style:s,children:[e&&o.jsx(uo,{children:o.jsx(S.default,{width:"70px",height:"17px"})}),o.jsxs(bo,{children:[o.jsx(S.default,{width:"50px",height:"30px"}),f&&f.value&&o.jsx(wo,{isUp:f.isUp,children:o.jsx(S.default,{width:"50px",height:"15px"})})]})]}):o.jsxs(xo,{autoWidth:Boolean(l),style:s,children:[e&&o.jsxs(uo,{children:[o.jsx(H.FiActivity,{color:"#151e5a"}),e]}),o.jsxs(bo,{children:[o.jsx("strong",{children:g}),f&&f.value&&o.jsx(wo,{isUp:f.isUp,children:o.jsxs("strong",{children:[o.jsx(ko.MdKeyboardBackspace,{}),f.value]})})]})]})};x.ActionOptionsModal=wi,x.Badge=dr,x.BaseInput=On,x.BulletOptionsModal=gi,x.BulletPoint=be,x.Button=I,x.ButtonsSelect=We,x.ButtonsSwitch=Hn,x.Card=Cr,x.CardModal=j,x.CartProduct=D0,x.CartProductV2=q0,x.Checkbox=Fn,x.ClientCard=Vr,x.CodeInput=Wo,x.Collapsible=dt,x.ConfirmationCard=un,x.ConfirmationCardV2=kn,x.ConfirmationCardV3=Je,x.ConfirmationModalV3=ci,x.CurrentStatusCard=kr,x.CustomSelect=Ae,x.DropdownMenu=bt,x.EditQuantityInput=te,x.GridTable=Ui,x.Heading=Po,x.HorizontalDivision=Xt,x.IDCard=d0,x.IconV2=F,x.KpiCard=ea,x.KpiCardV2=oa,x.Loader=ot,x.ModalHeader=Ji,x.MultipleOptionsModal=di,x.Navbar=Ot,x.NoData=Mt,x.OptionsModal=_e,x.OrderStatusBadge=Le,x.OrderTypeBanner=fr,x.Pagination=co,x.ProductDetailsCard=cn,x.ProfileImage=Ro,x.Radio=Bn,x.Search=ge,x.SectionCard=Pr,x.SectionHeader=qi,x.SelectField=$n,x.SimpleFooter=$i,x.StatusBanner=wr,x.StickyHeader=st,x.SupplyInput=Qn,x.Tab=qt,x.Table=Qi,x.Text=y,x.TextField=Re,x.ToastCard=o0,x.ToggleSwitch=Kn,x.TotalsCard=zr,x.TransparentBadge=me,x.UploadFileContainer=ne,x.UploadImage=Ei,x.UploadMultipleImages=Si,x.UserIconTooltip=Ce,x.UserProfileIcon=Q,x.UsersList=nr,Object.defineProperties(x,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
