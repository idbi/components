(function(x,f){typeof exports=="object"&&typeof module<"u"?f(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("@radix-ui/react-collapsible"),require("@floating-ui/react-dom"),require("react-loading-skeleton"),require("react-select"),require("date-fns"),require("react-date-range")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","@radix-ui/react-collapsible","@floating-ui/react-dom","react-loading-skeleton","react-select","date-fns","react-date-range"],f):(x=typeof globalThis<"u"?globalThis:x||self,f(x["ID-Components"]={},x.styled,x["react/jsx-runtime"].js,x.React,x["@radix-ui/react-collapsible"],x["@floating-ui/react-dom"],x.Skeleton,x.Select,x["date-fns"],x["react-date-range"]))})(this,function(x,f,t,v,jt,U,Bt,Ht,Pt,Ut){"use strict";const G=e=>e&&typeof e=="object"&&"default"in e?e:{default:e};function Yt(e){if(e&&e.__esModule)return e;const o=Object.create(null,{[Symbol.toStringTag]:{value:"Module"}});if(e){for(const r in e)if(r!=="default"){const n=Object.getOwnPropertyDescriptor(e,r);Object.defineProperty(o,r,n.get?n:{enumerable:!0,get:()=>e[r]})}}return o.default=e,Object.freeze(o)}const l=G(f),P=G(v),q=Yt(jt),S=G(Bt),Zt=G(Ht),Wt={bold:700,medium:500,regular:400,light:300},Ae={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},ge={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},d={color:{NEUTRAL:{0:"#FFFFFF",20:"#FFFFFF",50:"#F5F5F5",100:"#EBEBEB",200:"#dfdfdf",300:"#bfbfbf",400:"#9f9f9f",500:"#808080",600:"#404040",700:"#383838",800:"#202020",900:"#000000"},PRIMARY:{0:"#FFFFFF",50:"#F1F2F9",100:"#E6E8F4",200:"#DDDFF0",300:"#BBBFE2",400:"#999FD3",500:"#777fc5",600:"#545fb6",700:"#414a98",800:"#333a76",900:"#242954"},SECONDARY:{0:"#FFFFFF",20:"#F7F5FF",50:"#EFEBFF",100:"#E6E0FF",200:"#d0c5ff",300:"#d0c5ff",400:"#b9a8ff",500:"#a18cff",600:"#8a6fff",700:"#7252ff",800:"#5b35ff",900:"#4318FF"},TERTIARY:{0:"#FFFFFF",50:"#FFFAFC",100:"#FFF5F9",200:"#ffeff5",300:"#ffe0eb",400:"#ffd0e1",500:"#ffc1d7",600:"#ffb1cd",700:"#FFA1C3",800:"#ff92b9",900:"#FF82AF"},QUATERNARY:{0:"#FFFFFF",50:"#FBFCFE",100:"#F2F6FD",200:"#ebf1fc",300:"#D8E4FA",400:"#c4d6f8",500:"#b0c8f5",600:"#9cbbf3",700:"#88adf0",800:"#75a0ed",900:"#6192EB"},STATE:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEF7EB",200:"#fef3e3",300:"#fde7c6",400:"#fcdba9",500:"#fbcf8d",600:"#fac270",700:"#f9b654",800:"#f8aa38",900:"#F79E1B"},ALERT:{0:"#FFFFFF",50:"#FFFBF5",100:"#FEEDEC",200:"#fde3e2",300:"#fbc8c5",400:"#f9ada8",500:"#f7918b",600:"#f4756d",700:"#F25A50",800:"#F03E33",900:"#EE2316"},SUCCESS:{0:"#FFFFFF",50:"#F7FDFA",100:"#EEFBF4",200:"#e4f9ed",300:"#c9f3db",400:"#aeedc9",500:"#93e7b7",600:"#78e1a4",700:"#5DDB92",800:"#42D580",900:"#2DC96F"},OTHER:{color1:"#151E5A"},STATUS:{DEFAULT:{0:"#F5F5F5",1:"#808080"},DRAFT:{0:"#F5F5F5",1:"#808080"},PENDING:{0:"#DFDFDF",1:"#404040"},REJECTED:{0:"#FDE3E2",1:"#EE2316"},ACCEPTED:{0:"#D0C5FF",1:"#4318FF"},CANCELED:{0:"#FDE3E2",1:"#EE2316"},PREPARING:{0:"#FEF3E3",1:"#F79E1B"},READYFORPICKUP:{0:"#FFEFF5",1:"#FF82AF"},DELIVERED:{0:"#E4F9ED",1:"#2DC96F"},FINISHED:{0:"#DDDFF0",1:"#414A98 "}}},effect:{darkShadow:{4:"0px 0px 4px 1px rgba(139, 139, 139, 0.32)",6:"0px 1px 6px rgba(60, 60, 60, 0.2)",8:"0px 1px 6px rgba(107, 107, 107, 0.2)",12:"0px 0px 12px 2px #F6F6F6",24:"0px 0px 24px 4px rgba(0, 14, 51, 0.2)",30:"0px 10px 30px rgba(0, 0, 0, 0.08)"},lightShadow:{2:"0px 0px 2px 1px rgba(149, 178, 254, 0.2)",16:"0px 4px 16px rgba(153, 181, 255, 0.2)"}}},Qt=({shape:e})=>{switch(e){case"rounded":return f.css`
      ...
      `;default:return f.css`
        border-radius: 0.625rem;
      `}},Ot=({design:e,color:o,fontColor:r})=>{switch(e){case"solid":return f.css`
        background-color: ${()=>z({color:o})};
        color: ${r?z({color:r}):"#fff"};
...
`,Xt=l.default(Gt)`
  ...
  ${({size:e})=>$({size:e})};
  ${({shape:e})=>Qt({shape:e})};
  ${({design:e,color:o,fontColor:r})=>Ot({design:e,color:o,fontColor:r})};
  ${({fullWidth:e})=>ue({fullWidth:e})};
  ${({isLoading:e})=>xe({isLoading:e})};
  ${({disabled:e})=>R({disabled:e})};
  ${({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:c,p:s,pb:A,pt:p,pr:h,pl:u,py:b,px:g})=>be({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:c,p:s,pb:A,pt:p,pr:h,pl:u,py:b,px:g})};
...
`,I=({children:e,...o})=>t.jsxs(Xt,{...o,children:[o.leftIcon,e,o.rightIcon]});function Jt(e,o,r){const n=()=>{const i=document.querySelectorAll("input");return Array.from(i).filter(c=>c.className===o)};v.useEffect(()=>{const i=a=>{a.key==="Backspace"&&setTimeout(()=>{const c=n(),s=document.activeElement;s.value="";const A=c.indexOf(s);A>0&&c[A-1].focus()},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),v.useEffect(()=>{const i=a=>{if(a.key!=="Backspace"){const c=a.key.toLowerCase();setTimeout(()=>{if(c.length===1){const s=n(),A=document.activeElement;A.value=c;const p=s.indexOf(A);p<s.length-1&&s[p+1].focus()}},0)}};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)},[]),v.useEffect(()=>{if(e){const i=a=>{const c=a.key.toLowerCase();(c.length===1||c==="backspace")&&setTimeout(()=>{const A=n().map(p=>p.value).join("");e(A)},0)};return document.addEventListener("keydown",i),()=>document.removeEventListener("keydown",i)}},[]),v.useEffect(()=>{if(r){const i=n(),a=i.map(A=>A.value),c=r.split(""),s=c.length===a.length?c:a;i.forEach((A,p)=>{const h=s[p];h&&(A.value=h)})}},[r])}const Kt=f.keyframes`
  0% {
    opacity: 0;
...
`,qt={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},Rt=f.css`
  ...
  ${({align:e})=>Vt({align:e})}
  ${({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:c,p:s,pb:A,pt:p,pr:h,pl:u,py:b,px:g})=>be({m:e,mb:o,mt:r,mr:n,ml:i,my:a,mx:c,p:s,pb:A,pt:p,pr:h,pl:u,py:b,px:g})};
`,$t=e=>{const o=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",r=o?"bold":"medium",n=o?ge[e]:ge.text,i="PRIMARY/900";return f.css`
    font-weight: ${({weight:a=r})=>Wt[a]||"500"};
  ...
  ${Rt}
  ${({as:e})=>$t(e)}
`,B=({as:e,...o})=>{const r=qt[e];return t.jsx(_t,{as:r,...o})},er={H1:e=>t.jsx(B,{as:"h1",...e}),H2:e=>t.jsx(B,{as:"h2",...e}),H3:e=>t.jsx(B,{as:"h3",...e}),H4:e=>t.jsx(B,{as:"h4",...e}),H5:e=>t.jsx(B,{as:"h5",...e}),H6:e=>t.jsx(B,{as:"h6",...e})},tr=l.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
...
`,ee=v.forwardRef(({type:e,leftAddon:o,rightAddon:r,placeholder:n,error:i,success:a,size:c,fullWidth:s,name:A,infoMessage:p,onFocus:h,onBlur:u,onChange:b,...g},w)=>{const[k,M]=v.useState(!1),C=!i&&!a&&p&&k;return t.jsxs(t.Fragment,{children:[t.jsxs(dr,{fullWidth:s,success:a,size:c,error:i,disabled:g.disabled,leftAddon:o,rightAddon:r,isFocused:k,children:[o&&t.jsx("span",{className:"leftAddon",children:o}),t.jsx("input",{ref:w,onFocus:m=>{h&&h(m),M(!0)},onBlur:m=>{u&&u(m),M(!1)},onChange:b,placeholder:n,type:e,name:A,...g}),r&&t.jsx("span",{className:"rightAddon",children:r}),i&&t.jsx("span",{className:"state",children:t.jsx(ar,{size:24,color:d.color.ALERT[900]})}),a&&t.jsx("span",{className:"state",children:t.jsx(lr,{size:20,color:d.color.SUCCESS[900]})})]}),C&&t.jsx(_,{shouldAppear:C,children:t.jsx(D,{size:"xs",color:"QUATERNARY/900",children:p})})]})});ee.displayName="TextInput";const cr=l.default.div`
  position: relative;
...
`,we=v.forwardRef(({label:e,searchable:o=!0,autoSize:r,value:n,options:i,placeholder:a="Seleccione una opci\xF3n",fullWidth:c,fullWidthOptions:s,onChange:A,formatOptionLabel:p,formatSelectedOption:h})=>{const u=v.useRef(null),[b,g]=v.useState(i),[w,k]=v.useState(""),[M,C]=v.useState(!1);Z(u,()=>{C(!1)});const m=v.useCallback(()=>{const L=i.filter(T=>T.label.toLowerCase().includes(w.toLowerCase()));g(L)},[i,n]),y=v.useCallback(L=>{A(i.find(T=>T.label===L)),C(!1),k(""),g(i)},[m]),E=v.useCallback(L=>{k(L.target.value);const T=i.filter(j=>j.label.toLowerCase().includes(L.target.value.toLowerCase()));g(T)},[]),N=()=>{const L=u.current;if(L){const T=L.getBoundingClientRect();return window.innerHeight-T.bottom-20}};return t.jsxs(cr,{fullWidth:c,ref:u,children:[e&&t.jsx(D,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),t.jsxs("div",{className:"select-btn",onClick:()=>C(!M),tabIndex:0,onKeyUpCapture:L=>{L.key==="Enter"&&C(!M)},children:[t.jsx(D,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:h?h(n):p?p(n):n.label}),t.jsx(ve,{size:20})]}),M&&t.jsxs(sr,{maxOptionsHeight:r?N():285,fullWidthOptions:s,children:[o&&t.jsx("div",{className:"search-box",children:t.jsx(ee,{leftAddon:t.jsx(ir,{}),type:"text",placeholder:a,value:w,onChange:E,fullWidth:!0})}),t.jsx("div",{className:"options",children:b.map(L=>t.jsx(D,{as:"li",color:"NEUTRAL/700",className:L.value===n.value?"selected":"",tabIndex:0,onClick:()=>y(L.label),onKeyUpCapture:T=>{T.key==="Enter"&&y(L.label)},children:p?p(L):L.label},`${L.label}-${L.value}`))})]})]})});we.displayName="CustomSelect";const pr=l.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
...
`,fr=({imageUrl:e,size:o=128,onChange:r})=>{const n=v.useRef(null),i=a=>{var s;const c=(s=a.target.files)==null?void 0:s[0];if(c){const A=URL.createObjectURL(c);r({file:c,url:A})}};return t.jsxs(pr,{size:o,children:[t.jsx(D,{color:"NEUTRAL/400",weight:"regular",size:"xs",children:"Agrega tu foto"}),t.jsxs("div",{className:"profile-input__container",children:[t.jsx("input",{type:"file",accept:"image/png, image/jpeg",onChange:i,ref:n}),t.jsx("img",{width:o,height:o,src:e||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"}),t.jsx(I,{type:"button",size:"lg",design:"flat",shape:"circular",onClick:()=>{var a;return(a=n.current)==null?void 0:a.click()},children:"+"})]})]})},hr=f.keyframes`
  0%,
  100% {
...
`,kr=({onBack:e,backLabel:o,profileImageUrl:r,rightContent:n})=>t.jsxs(Lr,{children:[t.jsxs("button",{type:"button",onClick:e,children:[t.jsx(X,{}),t.jsx(D,{color:"NEUTRAL/900",children:o})]}),n||t.jsx("img",{width:28,height:28,src:r||"/default-profile.svg",alt:"profile",referrerPolicy:"no-referrer"})]}),yr=f.keyframes`
  100% {
    transform: rotate(360deg);
  }
`,Er=l.default.div`
...
`,Dr=l.default.div`
  ...
  top: 0;
  right: calc(100% + 8px);
`,Nr=({text:e,options:o})=>{const[r,n]=v.useState(!1),i=v.useRef(null),a=c=>{if(i.current&&clearTimeout(i.current),c){n(!0);return}i.current=setTimeout(()=>{r!==c&&n(c)},50)};return t.jsxs(re,{onMouseEnter:()=>a(!0),onMouseLeave:()=>a(!1),active:r,onClick:c=>c.stopPropagation(),children:[e," ",t.jsx("div",{style:{transform:"rotateY(180deg)"},children:t.jsx(X,{})}),r&&t.jsx(Dr,{children:t.jsx(Ce,{children:o.map((c,s)=>t.jsxs(re,{alert:c.alert,onClick:A=>c.disabled||c.loading?A.stopPropagation():c.onClick(),disabled:c.disabled||c.loading,loading:c.loading,children:[c.text," ",c.loading?t.jsx("div",{style:{width:"24px"},children:t.jsx(te,{width:"20px",height:"20px"})}):c.icon]},`suboption-${s}`))})})]})},Ir=({options:e,header:o})=>t.jsxs(Ce,{children:[o&&t.jsx(Tr,{children:o}),e.map((r,n)=>"options"in r?t.jsx(Nr,{...r},`option-${n}`):t.jsxs(re,{disabled:r.disabled||r.loading,alert:r.alert,onClick:r.disabled||r.loading?i=>i.stopPropagation():r.onClick,loading:r.loading,children:[r.text," ",r.loading?t.jsx("div",{style:{width:"24px"},children:t.jsx(te,{width:"20px",height:"20px"})}):r.icon]},`option-${n}`))]}),Sr=l.default.div`
  display: flex;
  cursor: pointer;
  text-align: right;
  * {
...
`,zr=({options:e,activator:o,header:r})=>{const{x:n,y:i,reference:a,floating:c,strategy:s,update:A,refs:p}=U.useFloating({placement:"bottom-end"}),[h,u]=v.useState(!1);return v.useEffect(()=>{if(!(!p.reference.current||!p.floating.current))return U.autoUpdate(p.reference.current,p.floating.current,A)},[h,A]),Z(p.reference,()=>{u(!1)}),t.jsxs("div",{ref:a,children:[t.jsx(Sr,{onClick:()=>u(!h),children:o||t.jsx(ve,{size:25})}),h&&t.jsx("div",{ref:c,style:{position:s,top:i!=null?i:0,left:n!=null?n:0,zIndex:100},onClick:()=>u(!h),children:t.jsx(Ir,{options:e,header:r})})]})},Fr=l.default.div`
  text-align: center;
  font-weight: 300;
  font-size: 0.75rem;
...
`,J=({img:e,size:o=36,initials:r,containerProps:{style:n,...i}={}})=>{const a=r.slice(0,2).toUpperCase();return t.jsx(eo,{hasImg:!(e!=null&&e.src),style:{width:`${o}px`,minWidth:`${o}px`,height:`${o}px`,fontSize:`${o/(r.length===1?2:2.25)}px`,...n||{}},...i,children:e!=null&&e.src?t.jsx("img",{...e}):a})},W=f.css`
  ::-webkit-scrollbar {
    width: 4px;
    height: 4px;
  }
...
`,co=({option:e,onClose:o,subOptions:r=[]})=>{const[n,i]=v.useState(!1);return t.jsxs("li",{onClick:()=>{r.length>0?i(!n):(e.onClick(),o())},children:[t.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[e.text," ",r.length>0&&t.jsx(ie,{size:12,style:{display:"block",marginLeft:"auto",marginRight:"0",transform:n?"":"rotate(-90deg)"}})]}),n&&r.length>0&&t.jsx("ul",{children:r.map((a,c)=>t.jsx("li",{onClick:()=>{a.onClick(),o()},children:a.text},`${c}sub${e.key}`))})]})},so=({options:e=[],links:o=[],userIcon:r,searchOption:n,logoIcon:i,bellIcon:a,zIndex:c,isSticky:s})=>{const[A,p]=v.useState(!1),[h,u]=v.useState(!1),b=v.useRef(null);return Z(b,()=>{p(!1),u(!1)}),t.jsxs(to,{zIndex:c,isSticky:s,ref:b,children:[t.jsxs(ro,{children:[t.jsxs(Te,{children:[e.length>0&&t.jsx(Rr,{size:20,color:"#151E5A",onClick:()=>{u(!1),p(!A)},style:{cursor:"pointer"}}),i!=null&&i.onClick?t.jsx(Ee,{size:28,onClick:()=>{p(!1),u(!1),i==null||i.onClick()}}):t.jsx(Ee,{size:28})]}),t.jsxs(oo,{children:[t.jsx(no,{children:o.map((g,w)=>t.jsx("li",{onClick:()=>(g==null?void 0:g.onClick)&&(g==null?void 0:g.onClick()),children:g.text},`${w}navbarlinksfordesktop`))}),(n==null?void 0:n.show)&&t.jsx(Me,{...n,onSearch:g=>n.onSearch(g)}),(a==null?void 0:a.show)&&t.jsx($r,{size:16,onClick:()=>{a!=null&&a.onClick&&a.onClick(),p(!1),u(!h)}}),(r==null?void 0:r.show)&&t.jsxs(Te,{children:[((r==null?void 0:r.name)||(r==null?void 0:r.note))&&t.jsxs(io,{children:[(r==null?void 0:r.name)&&t.jsx(D,{children:r==null?void 0:r.name}),(r==null?void 0:r.note)&&t.jsx(D,{color:"NEUTRAL/500",size:"xs",as:"span",children:r==null?void 0:r.note})]}),t.jsx(J,{initials:(r==null?void 0:r.initials)||"ID",img:(r==null?void 0:r.img)||null,size:35,containerProps:{onClick:()=>{r!=null&&r.onClick&&(p(!1),u(!1),r.onClick())},style:r!=null&&r.onClick?{cursor:"pointer"}:{}}})]})]})]}),A&&t.jsx(ao,{children:t.jsx("ul",{children:e.map((g,w)=>t.jsx(co,{option:g.option,subOptions:g.subOptions,onClose:()=>p(!A)},`${w}navbaroption`))})}),h&&t.jsx(lo,{children:a==null?void 0:a.children})]})},po=e=>t.jsx(F,{viewBox:"0 0 8 8",...e,children:t.jsx("circle",{xmlns:"http://www.w3.org/2000/svg",cx:"4",cy:"4",r:"4",fill:"currentColor"})}),fo=l.default.span`
...
`,De=({children:e,spacing:o,color:r,bulletSize:n,size:i})=>t.jsxs(fo,{color:r,size:i,bulletSize:n,spacing:o,children:[t.jsx(po,{}),e]}),ho=l.default.div`
  display: flex;
  align-items: center;
  gap: 15px;
`,Ne=l.default.div`
  ...
  flex-grow: 1;
`,Ao=({children:e,thickness:o=1,hrMinWidth:r=15})=>t.jsxs(ho,{children:[t.jsx(Ne,{thickness:o,minWidth:r}),e,t.jsx(Ne,{thickness:o,minWidth:r})]}),go=l.default.button`
  color: currentColor;
  background-color: transparent;
  border: none;
  font-size: 14px;
  ...
  ${({isActive:e,rounded:o,activeColor:r,tabWidth:n,tabFullWidth:i,tabHeight:a})=>e&&f.css`
    ...
    `};
`,uo=({children:e,active:o,tabWidth:r=24,tabHeight:n=4,activeColor:i=d.color.SECONDARY[900],...a})=>t.jsx(go,{isActive:o,noWrap:!0,activeColor:i,tabWidth:r,tabHeight:n,...a,children:e});function Ie(e="(min-width: 768px)"){const[o,r]=v.useState({matches:window.innerWidth>(()=>{const i=e.match(/(\d+)/);return i?i[0]:768})()});return v.useEffect(()=>{let i=window.matchMedia(e);return i.addEventListener("change",r),()=>i.removeEventListener("change",r)},[]),{status:Boolean(o&&o.matches)}}const xo=l.default.div`
...
`,vo=({render:e,tooltipContent:o,tooltipStyles:r={},placement:n,offset:i,strategy:a,middlewares:c=[]})=>{const[s,A]=v.useState(!1),p=v.useRef(null),{x:h,y:u,reference:b,floating:g,strategy:w,update:k,refs:M,middlewareData:C,placement:m}=U.useFloating({placement:n||"top",strategy:a,middleware:[U.offset(i!=null?i:10),...c,U.arrow({element:p})]}),{x:y,y:E}=C.arrow||{},{status:N}=Ie("(hover: hover)"),L=(j=!0)=>{N&&A(j)};v.useEffect(()=>{if(!(!M.reference.current||!M.floating.current))return U.autoUpdate(M.reference.current,M.floating.current,k)},[s,k]);const T={top:"bottom",right:"left",bottom:"top",left:"right"}[m.split("-")[0]];return t.jsxs(t.Fragment,{children:[e({ref:b,onMouseEnter:()=>L(),onMouseLeave:()=>L(!1)}),s&&t.jsxs(xo,{ref:g,style:{position:w,top:u!=null?u:0,left:h!=null?h:0,...r},children:[o,t.jsx(bo,{ref:p,style:{left:y!=null?`${y}px`:"",top:E!=null?`${E}px`:"",[T]:"-3px"}})]})]})},wo=(...e)=>e.reduce((o,r)=>o+(r||"").charAt(0),"").toUpperCase(),Se=({name:e,lastname:o,img:r,size:n,tooltipProps:i={}})=>t.jsx(vo,{tooltipContent:`${e} ${o||""}`,render:a=>t.jsx(J,{initials:wo(e,o),img:r,size:n,containerProps:{...a}}),...i}),ze=e=>t.jsx(F,{viewBox:"0 0 12 12",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",fillRule:"evenodd",clipRule:"evenodd",d:"M5.99935 0.166992C6.31623 0.166992 6.57312 0.446814 6.57312 0.791992V5.37532L11.2589 5.37532C11.5758 5.37532 11.8327 5.65515 11.8327 6.00032C11.8327 6.3455 11.5758 6.62532 11.2589 6.62532L6.57312 6.62532V11.2087C6.57312 11.5538 6.31623 11.8337 5.99935 11.8337C5.68246 11.8337 5.42558 11.5538 5.42558 11.2087V6.62532L0.739786 6.62533C0.422901 6.62533 0.166016 6.3455 0.166016 6.00033C0.166016 5.65515 0.422901 5.37533 0.739786 5.37533L5.42558 5.37532V0.791992C5.42558 0.446814 5.68246 0.166992 5.99935 0.166992Z",fill:"currentColor"})}),Co=l.default.div`
  display: flex;
...
`,Mo=({users:e,onAdd:o,iconSize:r=34})=>t.jsxs(Co,{size:r,children:[o&&t.jsx(mo,{size:r,onClick:o,children:t.jsx(ze,{size:r/2.5})}),[...e].reverse().map((n,i)=>t.jsx("div",{style:{height:r},children:t.jsx(Se,{...n,size:r,tooltipProps:{strategy:"fixed"}})},`user-${n.name}-${i}`))]}),Lo=l.default.span`
  ...
  ${({statusName:e,removeBackground:o})=>{if(e==="draft")return f.css`
      ...
      `}};
`,Fe={default:"...",draft:"Borrador",pending:"Pendiente",rejected:"Rechazado",accepted:"Aceptado",canceled:"Anulado",preparing:"Preparando",readyforpickup:"Listo para recojo",delivered:"Entregado",finished:"Finalizado"},je=({statusName:e,text:o,removeBackground:r})=>{const n=i=>Fe[i]||Fe.default;return t.jsx(Lo,{statusName:e,removeBackground:r,children:o||n(e)})},ko=l.default.span`
  border-radius: 4px;
  padding: 4px 8px;
  line-height: 1em;
  font-size: 1em;
  display: inline-block;
  font-weight: bold;
`,Be=(e,o,r)=>e>=o&&e<=r?e:e<o?o:r,He=({intensity:e=.8,opacity:o=.5,children:r,style:n={},...i})=>{const a=Be(e,0,1),c=Be(o,0,1),s=256*a;return t.jsx(ko,{style:{backgroundColor:`rgba(${s}, ${s}, ${s}, ${c})`,...n},...i,children:r})},yo=l.default.span`
...
${({withBorder:e,color:o})=>e&&f.css`
    ...
    `}
`,Eo=({text:e,padding:o,color:r,background:n,applyFlex:i,maxWidth:a,weight:c,borderRadius:s,withBorder:A})=>t.jsx(yo,{padding:o,color:r,background:n,applyFlex:i,maxWidth:a,weigth:c,borderRadius:s,withBorder:A,children:e}),To=l.default.div`
  min-height: 50px;
  display: flex;
  justify-content: center;
...
`,Yo=({design:e="primary",header:o,options:r,optionsFormatter:n,content:i,withSeparator:a})=>t.jsxs(Uo,{design:e,withSeparator:a,children:[o&&t.jsx("header",{children:o}),r&&n&&t.jsx("ul",{children:r.map(c=>t.jsx("li",{children:n(c)},c.value))}),i&&i]}),Zo=l.default.div`
  padding: 20px;
  border-radius: 10px;
  background: #fff;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,We=l.default.span`
  color: #151E5A;
  font-weight: 500;
`,Qo=({items:e,creationDescription:o,creationDate:r,title:n,children:i})=>t.jsxs(Zo,{children:[n&&t.jsx(Wo,{children:n}),e.map(a=>t.jsxs("div",{children:[t.jsxs("p",{children:[a.description&&t.jsx("span",{children:a.description})," ",t.jsx(je,{statusName:a.statusName,removeBackground:!0})]}),t.jsx(We,{children:a.statusDate})]},crypto.randomUUID())),r&&t.jsxs("div",{children:[o&&t.jsx("span",{children:o}),t.jsx(We,{children:r})]}),i]}),Oo=l.default.div`
...
`,$o=l.default.img`
  ...
  font-size: 9px;
  object-fit: cover;
`,_o=({items:e,title:o="",onAction:r=()=>{},actionName:n="",hideQuantity:i=!1,children:a,gap:c=10,background:s,padding:A})=>t.jsxs(Oo,{background:s,padding:A,children:[(o||n)&&t.jsxs(Vo,{children:[t.jsx(Go,{children:o}),t.jsx(Xo,{onClick:()=>r(),children:n})]}),t.jsx(Jo,{style:{gap:c},children:e.map(p=>t.jsxs(Ko,{remark:Boolean(p.remark),children:[i?t.jsxs(Qe,{children:[t.jsxs("div",{children:[t.jsx("span",{children:p.description}),p.notes&&t.jsx(Oe,{children:p.notes.map(h=>t.jsx("li",{children:h},crypto.randomUUID()))})]}),p==null?void 0:p.decorators]}):t.jsxs(Qe,{children:[p.img&&t.jsx($o,{src:p.img,alt:p.description}),t.jsx(qo,{children:p.quantity}),t.jsxs("div",{children:[t.jsx("span",{children:p.description}),p.notes&&t.jsx(Oe,{children:p.notes.map(h=>t.jsx("li",{children:h},crypto.randomUUID()))})]}),p==null?void 0:p.decorators]}),t.jsxs(Ro,{remark:Boolean(p.remark),children:[p.currency," ",p.amount.toFixed(2)]})]},crypto.randomUUID()))}),a]}),en=l.default.div`
  background-color: white;
  box-shadow: 0px 10px 30px rgba(0, 0, 0, 0.08);
...
`,wn=l.default.span`
  ...
  text-decoration: underline;
  cursor: pointer;
`,Cn=({title:e="",description:o="",type:r,link:n,icon:i})=>{const a=()=>{if(i)return i;if(r==="success")return t.jsx(An,{});if(r==="warning")return t.jsx(Ve,{});if(r==="error")return t.jsx(hn,{});if(r==="quaternary")return t.jsx(gn,{});if(r==="tertiary")return t.jsx(Ve,{color:"#FF82AF"})};return t.jsxs(xn,{toastType:r||"primary",children:[a(),t.jsxs("div",{children:[e&&t.jsx(bn,{children:e}),o&&t.jsxs(vn,{children:[o," ",n&&n.onClick&&t.jsx(wn,{onClick:c=>{c.stopPropagation(),n.onClick&&n.onClick()},children:(n==null?void 0:n.text)||"Ver m\xE1s"})]})]})]})},Ge={xs:"(min-width: 360px)",sm:"(min-width: 591px)",md:"(min-width: 800px)",lg:"(min-width: 1400px)"},mn=l.default.div`
  font-family: 'Poppins';
  font-style: normal;
  display: flex;
  align-items: center;
...
`,Nn=({onClose:e=()=>{},backdropOpacity:o,zIndex:r})=>(v.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow="visible"}),[]),t.jsx(Dn,{onClick:n=>{n.stopPropagation(),e()},opacity:o,zIndex:r})),Xe=f.keyframes`
  from {
...
`,Sn=({children:e,onClose:o,backdropOpacity:r,zIndex:n,contentLocation:i="center",contentLocationInDesktop:a="center",boxShadow:c,boxShadowInDesktop:s,fullWidth:A,styleContainer:p})=>t.jsxs(t.Fragment,{children:[t.jsx(Nn,{onClose:o,backdropOpacity:r,zIndex:n||4}),t.jsx(In,{zIndex:n||4,contentLocation:i,contentLocationInDesktop:a,onClick:h=>h.stopPropagation(),boxShadow:c,boxShadowInDesktop:s,fullWidth:A,style:p,children:e})]}),zn=l.default.div`
...
`,Y=({show:e=!0,children:o,onClose:r,backdropOpacity:n,padding:i,borderRadius:a,borderRadiusInDesktop:c,maxHeight:s,height:A,maxWidth:p,width:h,zIndex:u,overflow:b,contentLocation:g="center",contentLocationInDesktop:w="center",closeIcon:k,closeIconInDesktop:M,background:C="#fff",boxShadow:m,boxShadowInDesktop:y,styleContainer:E})=>e?t.jsx(Sn,{onClose:r,backdropOpacity:n,zIndex:u,contentLocation:g,contentLocationInDesktop:w,boxShadow:m,boxShadowInDesktop:y,styleContainer:E,children:t.jsxs(zn,{padding:i,borderRadius:a,borderRadiusInDesktop:c,maxHeight:s,height:A,maxWidth:p,width:h,background:C,overflow:b,contentLocation:g,contentLocationInDesktop:w,children:[(k||M)&&t.jsx(Fn,{onClick:r,closeIconInDesktop:M,closeIcon:k,children:t.jsx(oe,{})}),o]})}):null,jn=l.default.h2`
  color: ${d.color.PRIMARY[900]};
  margin-bottom: 20px;
  font-size: 20px;
`,Bn=l.default.div`
...
`,ae=({value:e,onSetQuantity:o,onDelete:r,minimumQuantity:n=1,measureUnit:i,onlyIntegers:a,blockInputModal:c,disabled:s,hasError:A,variant:p,renderModal:h,zIndex:u,style:b,noDecrement:g,noIncrement:w})=>{const[k,M]=v.useState(!1),C=Number(e||0),m=e===null||C<=n,y=L=>{L.stopPropagation();const T=C%1!==0?Math.ceil(C):C+1;o(T)},E=L=>{if(L.stopPropagation(),m){r&&r();return}const T=C%1>0?Math.floor(C):C-1;o(T)},N=L=>{const T=a?Math.round(L):L;o(T<=n?n:T),M(!1)};return t.jsxs(t.Fragment,{children:[t.jsx(Hn,{children:t.jsxs(Yn,{isDisabled:s,onClick:L=>{L.stopPropagation(),!(c||s)&&M(!0)},minQuantity:m,canDelete:!!r,variant:p,error:A,style:b,children:[!g&&t.jsx("button",{disabled:s,onClick:E,children:m&&r?t.jsx(Un,{children:t.jsx($e,{color:d.color.ALERT[900]})}):"-"}),t.jsx(Pn,{children:`${e===null?"-":e} ${e!==null&&i||""}`}),!w&&t.jsx("button",{onClick:y,disabled:s,children:"+"})]})}),k&&!c&&(h?h(t.jsx(Re,{onClose:()=>M(!1),onConfirm:N,initialValue:e?e.toString():"",onlyIntegers:a,zIndex:u})):t.jsx(Re,{onClose:()=>M(!1),onConfirm:N,initialValue:e?e.toString():"",onlyIntegers:a,zIndex:u}))]})},Zn=l.default.div`
  background-color: white;
...
`,Rn=l.default.div`
  ...
  justify-content: space-between;
  align-items: center;
`,$n=({img:e,name:o,currencySymbol:r,total:n,unitPrice:i,quantity:a,comment:c,onClick:s,onChangeQuantity:A,onDeleteProduct:p,onChangeComment:h,discount:u,measureUnit:b,productDetails:g,renderModal:w,onlyIntegers:k})=>{const[M,C]=v.useState(!0),m=b||"u.";return t.jsxs(Zn,{children:[t.jsxs(Wn,{onClick:s||(()=>{}),canClick:!!s,children:[(e==null?void 0:e.src)&&t.jsx(Qn,{...e}),t.jsxs(On,{children:[t.jsxs(Vn,{detailsActive:M,children:[o,t.jsx(ie,{size:16,onClick:y=>{y.stopPropagation(),C(E=>!E)}})]}),u&&t.jsx(Gn,{children:u.label}),t.jsxs(Xn,{children:[u&&t.jsxs(Jn,{children:["-",r,u.discountedAmount.toFixed(2)]}),t.jsxs(_e,{children:[r,t.jsx("span",{children:n.toFixed(2)})]})]})]})]}),M&&t.jsxs("div",{children:[t.jsx(Kn,{value:c,onChange:y=>h(y.target.value),placeholder:"Agregar alg\xFAn comentario"}),g&&t.jsx(qn,{children:g})]}),t.jsxs(Rn,{children:[t.jsxs(_e,{children:[r,t.jsx("span",{children:i.toFixed(2)})," x ",m]}),t.jsx(ae,{value:a,onSetQuantity:A,measureUnit:m,onDelete:p,renderModal:w,onlyIntegers:k})]})]})},_n=l.default.div`
...
`,r0=l.default.button`
  ...
  ${({selected:e})=>e&&f.css`
    ...
    `}
`,et=({title:e,options:o,selected:r,onSelect:n})=>t.jsxs(_n,{children:[e&&t.jsx(e0,{children:e}),t.jsx(t0,{children:o.map(i=>t.jsx(r0,{selected:i.value===r,onClick:()=>n(i.value,i),disabled:!!i.disabled,children:i.content},`${i.value}-btn`))})]}),o0=Array.from(Array(5),(e,o)=>({content:`${o}`,value:`${o}`})),n0=l.default.div`
  position: absolute;
  top: calc(100% + 5px);
  left: 0;
`,i0=({selected:e,onSelect:o,onClose:r})=>{const n=v.useRef(null);return Z(n,r),t.jsx(n0,{ref:n,children:t.jsx(et,{title:"Order de salida",options:o0,selected:e.toString(),onSelect:i=>{o(Number(i)),r()}})})},a0=l.default.div`
...
`,u0=({img:e,name:o,currencySymbol:r,total:n,quantity:i,onClick:a,onChangeQuantity:c,onDeleteProduct:s,discount:A,productDetails:p,renderModal:h,onlyIntegers:u,dishNumber:b,onChangeDishNumber:g,measureUnit:w})=>{const[k,M]=v.useState(!1);return t.jsxs(a0,{children:[b&&t.jsxs(l0,{clickeable:!!g,children:["N\xB0",t.jsxs("div",{children:[t.jsx("button",{onClick:()=>{g&&M(!0)},children:b}),k&&g&&t.jsx(i0,{onClose:()=>M(!1),onSelect:C=>g(C),selected:b})]})]}),t.jsxs(d0,{children:[(e==null?void 0:e.src)&&t.jsxs(c0,{children:[t.jsx(s0,{...e}),A&&t.jsx(p0,{children:A.label})]}),t.jsxs(f0,{clickeable:!!a,onClick:a||(()=>{}),children:[t.jsxs(tt,{children:[t.jsx("span",{children:o}),p&&t.jsx(tt,{children:p})]}),t.jsxs(h0,{children:[t.jsxs("div",{children:[t.jsxs(A0,{children:[r,t.jsx("span",{children:n.toFixed(2)})]}),A&&t.jsxs(g0,{children:[r," ",A.prevTotal.toFixed(2)]})]}),t.jsx(ae,{value:i,onSetQuantity:c,onDelete:s,renderModal:h,onlyIntegers:u,measureUnit:w!=null?w:"u."})]})]})]})]})},x0=l.default.div`
  padding-right: 5px;
...
`,v0=l.default.span`
  ...
  font-size: 10px;
  font-weight: 700;
`,rt=({currencySymbol:e,unitPrice:o=null,total:r,measureUnit:n,discount:i,disabled:a,bottom:c})=>{const s=n||"u.";return t.jsxs(x0,{disabled:a,bottom:c,children:[t.jsx("span",{children:o!==null&&t.jsxs(t.Fragment,{children:[e,o.toFixed(2)," x ",s]})}),t.jsxs(b0,{disabled:a,children:[i&&t.jsxs(t.Fragment,{children:[t.jsx("span",{children:(!!i.prevTotal||i.prevTotal===0)&&t.jsxs(t.Fragment,{children:[e,i.prevTotal.toFixed(2)]})}),t.jsx(v0,{children:i.label})]}),t.jsxs("span",{children:[e,t.jsx("span",{children:r.toFixed(2)})]})]})]})},ot=e=>{switch(e){case"draft":return"Borrador";case"pending":return"Pendiente";case"accepted":return"Aceptado";case"preparing":return"Preparando";case"prepared":return"Listo";case"collected":return"Enviado";case"delivered":return"Entregado";case"canceled":return"Anulado";default:return""}},w0=l.default.div`
...
`,y0=l.default.div`
  ...
  margin-top: 8px;
  font-size: 12px;
`,E0=({name:e,img:o,quantity:r,currencySymbol:n,unitPrice:i,total:a,productDetails:c,discount:s,measureUnit:A,disabled:p,status:h,imgLabel:u,discountBottom:b=!0})=>{const g=b?!!(c||s):!!c;return t.jsxs(w0,{disabled:p,hasDetails:!!c,children:[t.jsxs(C0,{children:[(o==null?void 0:o.src)&&t.jsxs(m0,{children:[t.jsx("div",{children:t.jsx("img",{...o})}),u,h&&!u&&!!ot(h)&&t.jsx(M0,{status:h,children:ot(h)})]}),t.jsxs(L0,{hasDetails:!!g,children:[t.jsxs(k0,{disabled:p,children:[t.jsx(He,{opacity:.4,children:r}),e]}),c&&t.jsx(y0,{children:c}),!g&&t.jsx(rt,{currencySymbol:n,unitPrice:i,total:a,discount:s,disabled:p})]})]}),g&&t.jsx(rt,{currencySymbol:n,unitPrice:i,total:a,discount:s,disabled:p,bottom:!0})]})},T0=l.default.div`
  padding: 20px;
...
`,W0=({children:e,note:o="Esta acci\xF3n no se puede revertir.",btnLeft:r={onClick:()=>{},text:"Cancelar",disabled:!1},btnRight:n={onClick:()=>{},text:"Eliminar",disabled:!1}})=>{const{status:i}=Ie("(min-width: 1023px)");return t.jsxs(B0,{children:[t.jsxs(Z0,{children:[t.jsxs(H0,{children:[t.jsx(Y0,{children:e}),t.jsx(P0,{children:o})]}),t.jsxs(U0,{children:[i&&t.jsx(I,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{borderRadius:"32px",padding:"20px 0"},disabled:r.disabled,children:r.text}),t.jsx(I,{design:"solid",fullWidth:!0,onClick:()=>n.onClick(),style:{borderRadius:"32px",padding:"20px 60px"},disabled:n.disabled,children:n.text})]})]}),!i&&t.jsx(I,{design:"flat",fullWidth:!0,onClick:()=>r.onClick(),color:"PRIMARY/900",style:{margin:"0 15px 15px",width:"calc(100% - 30px)",padding:"20px",borderRadius:"15px"},children:r.text})]})},Q0=l.default.div`
  background: transparent;
  color: #383838;
  border-radius: 20px;
  font-weight: 500;
...
`,R0=({children:e,value:o="value",callbackOnChange:r=()=>{},disabled:n=!1,...i})=>{const[a,c]=v.useState((i==null?void 0:i.checked)||!1);return v.useEffect(()=>{c(Boolean(i==null?void 0:i.checked))},[i==null?void 0:i.checked]),t.jsxs(q0,{disabled:n,children:[t.jsx("input",{...i,type:"checkbox",value:o,disabled:n,onChange:s=>{c(!a),r(s.target.value,!a)},checked:a}),t.jsx("span",{children:a?t.jsx(J0,{color:n?"gray":"#4318FF"}):t.jsx(K0,{color:n?"gray":"#4318FF"})}),e]})},$0=l.default.div`
  position: relative;
  display: flex;
  align-items: flex-start;
  gap: 9px;
...
`,_0=({text:e,...o})=>t.jsxs($0,{disabled:Boolean(o.disabled),children:[t.jsx("input",{type:"radio",...o}),t.jsx("label",{htmlFor:o==null?void 0:o.id,children:e})]}),ei=e=>t.jsx(F,{viewBox:"0 0 15 2",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M1.88086 1H13.8809",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),ti=l.default.div`
  min-width: 134px;
  width: ${({fullWidth:e})=>e?"100%":"auto"};
  display: inline-flex;
  align-items: center;
...
`,ri=l.default.div`
  ...
  font-weight: 500;
  flex-grow: 0.5;
`,oi=({quantity:e,onChange:o,icon:r,increase:n,decrease:i,fullWidth:a})=>{var c,s;return t.jsxs(ti,{fullWidth:a,children:[((c=i==null?void 0:i.available)!=null?c:!0)&&t.jsx(at,{onClick:()=>o(e-1),disabled:e<=1||!!(i!=null&&i.disabled),children:t.jsx(ei,{size:17})}),t.jsxs(ri,{children:[e," ",r]}),((s=n==null?void 0:n.available)!=null?s:!0)&&t.jsx(at,{onClick:()=>o(e+1),disabled:!!(n!=null&&n.disabled),children:t.jsx(ze,{size:17})})]})},ni=l.default.div`
  background-color: white;
...
`;l.default.div`
  ...
  bottom: 0;
  left: 0;
`;const ai=({options:e,selected:o,disabled:r,onSelect:n,fullWidth:i,model:a,equalBtns:c})=>t.jsx(ni,{disabled:r,onClick:s=>{r&&s.stopPropagation()},model:a,fullWidth:i,children:e.map(s=>t.jsx(ii,{onClick:()=>n(s.value),active:s.value===o,disabled:r,model:a,equal:c,children:s.label},s.value))}),li=l.default.div`
...
`,ci=l.default.span`
  ...
  line-height: 1.25rem;
  color: ${d.color.PRIMARY[900]};
`,si=({description:e,defaultValue:o,value:r,onChange:n=()=>{},placeholder:i,suffix:a,disabled:c,readingMode:s})=>t.jsxs(li,{disabled:c,withDescription:Boolean(e),readingMode:s,children:[e&&t.jsx(di,{children:e}),s?t.jsxs(lt,{readingMode:s,children:[t.jsx(ci,{children:o}),a&&!c&&t.jsx(dt,{children:a})]}):t.jsxs(lt,{children:[t.jsx("input",{type:"text",placeholder:i,disabled:c,onChange:A=>n(A.target.value),value:r}),a&&!c&&t.jsx(dt,{children:a})]})]}),pi=l.default.div`
  background-color: white;
...
`,fi=({alert:e,fullWidth:o,minHeight:r,startEl:n,endEl:i,inputRef:a,...c})=>t.jsxs(pi,{alert:e,fullWidth:o,minHeight:r!=null?r:45,className:"base-input-container",children:[n,t.jsx("input",{ref:a,...c}),i]}),hi=l.default.div`
  display: flex;
  justify-content: flex-start;
  align-items: center;
  cursor: pointer;
...
`;l.default.p`
  ...
  margin: 15px 0;
  padding: 0 20px;
`;const xi=({initial:e=!1,onToggle:o=()=>{},disabled:r=!1,width:n,padding:i,styleOn:a,styleOff:c})=>{const[s,A]=v.useState(e),p=()=>{if(!r){const h=!s;A(h),o(h)}};return t.jsx(hi,{disabled:r,children:t.jsxs(Ai,{onClick:h=>{h.stopPropagation(),p()},toggled:s,width:n,padding:i,styleOn:a,styleOff:c,children:[t.jsx(gi,{toggled:s,width:n,padding:i}),t.jsx(ui,{visible:s,styleOn:a})]})})},bi=l.default.div`
  position: relative;
  width: 100%;
...
`,vi={control:(e,o)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${o.isFocused?d.color.QUATERNARY[900]:d.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:d.color.PRIMARY[900],fontWeight:400,fontSize:"0.875rem",fontFamily:"Poppins",fontStyle:"normal"}),placeholder:e=>({...e,color:d.color.NEUTRAL[500]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"10px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"15px"})},wi=({formatOptionLabel:e,options:o,loading:r=!1,style:n,firstOption:i={label:"Seleccione una opci\xF3n",value:""},initialValue:a,value:c,onChange:s,isMulti:A,placeholder:p,label:h})=>{const u=i,b=[...o];return t.jsxs(bi,{style:n,children:[h&&t.jsx(D,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:h}),r?t.jsx(S.default,{style:{borderRadius:10,display:"block"},height:"45px",width:"100%"}):t.jsx(Zt.default,{placeholder:p,value:c||void 0,defaultValue:a||u,options:b,onChange:s,styles:vi,isMulti:A,formatOptionLabel:e})]})},Ci=l.default.div`
  width: ${e=>e.size}px;
  height: ${e=>e.size}px;
  position: relative;
  &::before {
...
`,ua=({onGetFilters:e,initState:o,showIconCalendar:r=!0,showTimeInputs:n=!1,direction:i="horizontal",dateFormatDisplayed:a="detailed",initWithToday:c=!1,...s})=>{const A=v.useRef(null),[p,h]=v.useState({from:"00:00",to:"23:59"}),[u,b]=v.useState(!1),[g,w]=v.useState(o?[o]:[{startDate:c?new Date(Date.now()):void 0,endDate:c?new Date(Date.now()):void 0,key:"selection"}]),k=m=>{var y,E;if((g==null?void 0:g.length)>0&&((y=g[0])==null?void 0:y.startDate)&&((E=g[0])==null?void 0:E.endDate)){const{startDate:N,endDate:L}=g[0],T=m==="from"?N:L;let j="";return n?j=a==="simple"?"dd/MM/yyyy HH:mm":"dd 'de' MMMM 'del' YYY hh:mm aaaaa'm'":j=a==="simple"?"dd/MM/yyyy":"dd 'de' MMMM 'del' YYY",Pt.format(T,j,{locale:pt})}},M=(m,y)=>{h(E=>({...E,[y]:m}))},C=m=>{var y,E,N,L;if(m)e(null),w([{startDate:void 0,endDate:void 0,key:"selection"}]);else{const[T,j]=(y=p==null?void 0:p.from)==null?void 0:y.split(":"),[zt,bl]=(E=p==null?void 0:p.to)==null?void 0:E.split(":");let V,he;if((N=g[0])!=null&&N.startDate&&(V=new Date(g[0].startDate),V.setHours(Number(T||0),Number(j||0),0)),(L=g[0])!=null&&L.endDate&&(he=new Date(g[0].endDate),he.setHours(Number(zt||23),Number(bl||59),59)),V&&V){const Ft={...g[0],startDate:V,endDate:he};w([Ft]),e(Ft)}}b(!1)};return v.useEffect(()=>{const m=y=>{var E;u&&A.current&&!((E=A.current)!=null&&E.contains(y.target))&&b(!1)};return document.addEventListener("mousedown",m),()=>{document.removeEventListener("mousedown",m)}},[u]),t.jsxs(pa,{ref:A,children:[t.jsxs(Aa,{onClick:()=>b(!0),children:[r&&t.jsx(sa,{}),k("from")?t.jsx("p",{children:`${k("from")} - ${k("to")}`}):t.jsx("p",{style:{fontSize:"0.875rem"},children:"Seleccione una fecha"})]}),u&&t.jsxs(ha,{children:[t.jsx(Ut.DateRange,{onChange:m=>{var E,N;const y=Object.values(m);!Array.isArray(y)||(y==null?void 0:y.length)<1||w([{...g[0],startDate:(E=y[0])==null?void 0:E.startDate,endDate:(N=y[0])==null?void 0:N.endDate}])},showSelectionPreview:!0,moveRangeOnFirstSelection:!1,months:1,ranges:g,direction:i,locale:pt,...s}),t.jsxs(fa,{children:[n&&t.jsxs(ga,{children:[t.jsxs("div",{children:[t.jsx(D,{as:"label",htmlFor:"hour-from",children:"desde:"}),t.jsx("input",{type:"time",id:"hour-from",value:p.from,onChange:m=>M(m.target.value,"from")})]}),t.jsxs("div",{children:[t.jsx(D,{as:"label",htmlFor:"hour-to",children:"hasta:"}),t.jsx("input",{type:"time",id:"hour-to",defaultValue:p.to,onChange:m=>M(m.target.value,"to")})]})]}),t.jsx(I,{size:"xs",py:"5px",onClick:()=>C(!1),children:"Aplicar"})]})]})]})},xa=l.default.div`
  @media (max-width: 600px) {
    padding-bottom: 15px;
  }
`,ba=l.default.div`
...
`,ft=t.jsx("div",{style:{display:"inline-block"},children:t.jsx(te,{width:"20px",height:"20px"})}),Ca=({options:e,onClose:o,contentLocation:r,contentLocationInDesktop:n,defaultDescription:i="",defaultTitle:a="",optionsInCenter:c=!1,direction:s="row",iconOrientation:A="horizontal"})=>{const[p,h]=v.useState(null),u=v.useMemo(()=>{if(p===null)return null;const b=e[p];if(b&&"options"in b)return b},[p,e]);return t.jsx(Y,{maxWidth:"500px",padding:"20px 0",onClose:o,contentLocation:r||"bottom",contentLocationInDesktop:n||"center",closeIcon:!0,children:t.jsxs(xa,{children:[t.jsxs(va,{children:[t.jsxs(ba,{children:[u&&t.jsx(X,{onClick:()=>h(null)}),t.jsx(D,{as:"h2",size:"md",children:(u==null?void 0:u.text)||a})]}),i.length>0&&t.jsx(D,{color:"NEUTRAL/400",size:"sm",weight:"regular",children:(u==null?void 0:u.description)||i})]}),t.jsxs(wa,{direction:s,children:[!u&&e.map((b,g)=>"onClick"in b?t.jsxs(de,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&(b.onClick(),o())},optionsInCenter:c,iconOrientation:A,children:[t.jsx("span",{children:b.text}),b.loading?ft:b.icon]},`option-${g}`):t.jsxs(de,{onClick:()=>{h(g)},optionsInCenter:c,children:[b.text," ",t.jsx("div",{style:{transform:"rotateY(180deg)"},children:t.jsx(X,{})})]},`option-${g}`)),u==null?void 0:u.options.map((b,g)=>t.jsxs(de,{alert:b.alert,disabled:b.disabled||b.loading,onClick:()=>{!b.loading&&!b.disabled&&b.onClick()},optionsInCenter:c,children:[b.text," ",b.loading?ft:b.icon]},`suboption-${g}`))]})]})})},ma=({cardProps:e,...o})=>t.jsx(Y,{background:"transparent",boxShadowInDesktop:"none",padding:"0 10px",contentLocation:"bottom",maxWidth:"650px",...e,children:t.jsx(it,{...o})}),Ma=l.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
...
`,ht=({title:e,options:o,selected:r,onSelect:n,onClose:i,modalProps:a={},optionMinHeight:c=50})=>t.jsxs(Y,{onClose:i,closeIcon:!0,contentLocation:"bottom",padding:"0",maxWidth:"600px",...a,children:[t.jsx(Ma,{children:e}),t.jsx(La,{children:o.map(s=>t.jsxs(ka,{minHeight:c,selected:s.value===r,disabled:s.disabled,onClick:()=>{s.disabled||n(s.value,s)},children:[s.content," ",s.icon]},s.value))})]}),ya=e=>t.jsx(F,{viewBox:"0 0 10 8",fill:"none",...e,children:t.jsx("path",{xmlns:"http://www.w3.org/2000/svg",d:"M0.75 3.99992L3.58 6.82992L9.25 1.16992",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})}),Ea=l.default.div`
  color: ${({color:e})=>e};
  padding-left: 15px;
  display: flex;
  align-items: center;
  flex-grow: 1;
`,Ta=({options:e,selectedIcon:o,...r})=>t.jsx(ht,{options:e.map(({content:n,color:i=d.color.NEUTRAL[800],...a})=>({content:t.jsx(Ea,{color:i,children:t.jsx(De,{spacing:30,bulletSize:7,children:n})}),icon:a.value===r.selected?o||t.jsx(ya,{}):void 0,...a})),...r}),Da=l.default.div`
  color: ${({theme:e})=>e.color.PRIMARY[900]};
  font-size: 20px;
  font-weight: 700;
  padding-bottom: 18px;
...
`,Ya=({initialImgUrl:e,placeholder:o,onChange:r,onError:n})=>{const[i,a]=v.useState(null),[c,s]=v.useState(e||null),A=At();return v.useEffect(()=>{let p="";return i&&(p=window.URL.createObjectURL(i),s(p)),()=>{p&&window.URL.revokeObjectURL(p)}},[i]),v.useEffect(()=>{A||r(i,c||null)},[c]),t.jsx(ce,{onError:n||alert,onSelectFile:p=>a(p),acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:c?t.jsxs(Ha,{children:[t.jsxs(Pa,{children:[t.jsx("img",{src:c}),t.jsxs(Ua,{children:[t.jsx("span",{children:(i==null?void 0:i.name)||gt(c)[0]}),t.jsx("span",{children:(i==null?void 0:i.type)||gt(c)[1]})]})]}),t.jsx(ne,{variant:"secondary",onClick:p=>{p.stopPropagation(),a(null),s(null)},children:t.jsx(Fa,{size:12})})]}):t.jsx(ja,{children:o||t.jsxs(Ba,{children:[t.jsx(ut,{color:d.color.SECONDARY[900],size:18})," Sube un imagen ",t.jsx("span",{children:"aqu\xED"})]})})})},xt=l.default.div`
  width: 55px;
  height: 55px;
  border-radius: 7px;
`,Za=l.default.div`
...
`,Oa=l.default.div`
  ...
  right: 0;
  bottom: 0;
`,Va=({onChange:e,initialImages:o,limit:r})=>{const[n,i]=v.useState(o||[]),[a,c]=v.useState(null),s=At(),A=h=>{const u=window.URL.createObjectURL(h);i(b=>[...b,{file:h,url:u}])},p=h=>{const u=n[h];typeof u!="string"&&window.URL.revokeObjectURL(u.url),i(b=>b.filter((g,w)=>w!==h))};return v.useEffect(()=>{s||e(n)},[n]),t.jsxs(Za,{children:[n.map((h,u)=>t.jsxs(Wa,{onMouseEnter:()=>c(u),onMouseLeave:()=>c(null),onTouchCancel:()=>c(null),children:[t.jsx("img",{src:typeof h=="string"?h:h.url}),a===u&&t.jsx(Oa,{onClick:()=>p(u),children:t.jsx($e,{size:16})})]},`imgs-${u}`)),!(r&&n.length>=r)&&t.jsx(ce,{onError:alert,onSelectFile:A,acceptedFiles:"image/x-png,image/jpeg",validFileExtensions:["jpg","jpeg","png"],children:t.jsx(Qa,{children:t.jsx(ut,{})})})]})},Ga=l.default.div`
  display: grid;
...
`,mt=({currentPage:e=1,lastPage:o=1,onChangePage:r=()=>{}})=>{const[n,i]=v.useState(String(e)||"");v.useEffect(()=>{e!==0&&(!e||(Number(e)||1)>o?(i(String(o)),r(Number(o))):(r(Number(e)),i(String(e))))},[e]);const a=h=>{if(!((Number(h)||1)>o)){if(o>0&&(Number(n)<1||!Number(h))){i("1"),r(1);return}if(!h)return i("");i(h),r(Number(h)||1)}},c=()=>Number(n)<=1?"1px solid #BFBFBF":"1px solid #4318FF",s=()=>Number(n)<=1?"#BFBFBF":"#4318FF",A=()=>Number(n)===o?"#BFBFBF":"#4318FF",p=()=>Number(n)===Number(o)||Number(n)===1;return t.jsxs($a,{disabled:p(),children:[t.jsxs("button",{type:"button",disabled:n==="1",onClick:()=>a(String(1)),style:{padding:"0px",backgroundColor:"#fff",border:c()},children:[t.jsx(pe,{size:12,color:s()}),t.jsx(pe,{size:12,color:s(),styleContainer:{marginLeft:"-5px"}})]}),t.jsx("button",{type:"button",disabled:n==="1",onClick:()=>a(String((Number(n)||1)-1)),style:{padding:"0px",backgroundColor:"#fff",border:c()},children:t.jsx(pe,{size:12,color:s()})}),t.jsx("input",{type:"number",value:Number(n),max:o,onChange:h=>a(h.target.value||"")}),t.jsxs("p",{style:{whiteSpace:"nowrap"},children:["de ",o]}),t.jsx("button",{type:"button",disabled:Number(n)===o,onClick:()=>a(String((Number(n)||1)+1)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===o?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:t.jsx(fe,{size:12,color:A()})}),t.jsxs("button",{type:"button",disabled:Number(n)===o,onClick:()=>a(String(o)),style:{padding:"0px",backgroundColor:"#fff",border:`${Number(n)===o?"1px solid #BFBFBF":"1px solid #4318FF"}`},children:[t.jsx(fe,{size:12,color:A()}),t.jsx(fe,{size:12,color:A(),styleContainer:{marginLeft:"-5px"}})]})]})},_a=e=>{const o=v.useRef(0),r=v.useRef(0),n=v.useRef(!1);v.useEffect(()=>{if(!e.current||n.current)return;const i=e.current,a=s=>{s.preventDefault();const p=s.pageX-i.offsetLeft-o.current;i.scrollLeft=r.current-p},c=()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",c)};return i.addEventListener("mousedown",s=>{o.current=s.pageX-i.offsetLeft,r.current=i.scrollLeft,window.addEventListener("mousemove",a),window.addEventListener("mouseup",c)}),n.current=!0,()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",c)}},[e])},el=l.default.div`
  width: 100%;
  overflow-x: auto;
...
`,rl=({loading:e=!1,headers:o,body:r,noHover:n=!1,styleWrapper:i,styleTable:a,styleTHead:c,styleTBody:s,onScroll:A,showPagination:p=!0,pagination:h={onChangePage:()=>{},lastPage:1,currentPage:1}})=>{const[u,b]=v.useState([]),g=v.useRef(null),w=v.useRef(null);_a(w),v.useLayoutEffect(()=>{b(Array.from(Array(o.props.children.length).keys()))},[o.props.children.length]);const k=M=>{!A||(g.current&&clearTimeout(g.current),g.current=setTimeout(()=>{var C;A(((C=M.target)==null?void 0:C.scrollLeft)||0)},50))};return t.jsxs(t.Fragment,{children:[t.jsx(el,{style:i,onScroll:k,ref:w,children:t.jsxs(tl,{noHover:n,style:a,children:[t.jsx("thead",{style:c,children:t.jsx("tr",{children:o})}),t.jsx("tbody",{style:s,children:e?Array.from(Array(2).keys()).map(M=>t.jsx("tr",{children:u.map(C=>t.jsx("td",{children:t.jsx(S.default,{width:"100%",height:"100%"})},C))},M)):r})]})}),p&&!e&&t.jsx(mt,{currentPage:h.currentPage,lastPage:h.lastPage,onChangePage:h.onChangePage}),p&&e&&t.jsx(S.default,{width:"240px",height:"20px",style:{display:"block",margin:"15px auto 0"}})]})},ol=f.css`
  background: none;
  outline: none;
  border: none;
  padding: none;
...
`,al=l.default.button`
  ...
  ${({isLoading:e})=>xe({isLoading:e})};
  ${({disabled:e})=>R({disabled:e})};
`,ll=({container:e,options:o,closeIcon:r})=>{var n;return t.jsxs(nl,{marginBottom:e==null?void 0:e.marginBottom,padding:e==null?void 0:e.padding,isSticky:e==null?void 0:e.isSticky,zIndex:e==null?void 0:e.zIndex,children:[r!=null&&r.hide?t.jsx("div",{}):t.jsx(ne,{onClick:r.onClick,style:{marginLeft:(r==null?void 0:r.marginLeft)||"20px"},children:t.jsx(oe,{})}),t.jsx(il,{minWidthForOptions:o.minWidth,paddingForOptions:o.padding,children:(n=o==null?void 0:o.options)==null?void 0:n.map((i,a)=>t.jsx(al,{onClick:i.onClick,type:"button",mode:i.mode,disabled:i.disabled,children:i.text},`${a}${i.id}`))})]})},dl=l.default.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
  font-size: 14px;
...
`,sl=({title:e,subtitle:o,aside:r})=>t.jsxs(dl,{children:[t.jsxs(cl,{children:[e,o&&t.jsxs("span",{children:[t.jsx(ie,{size:10})," ",o]})]}),r]}),pl=l.default.div`
  display: flex;
  gap: ${({gap:e})=>e||"15px"};
  align-items: center;
  justify-content: center;
...
`,Al=({title:e,total_PEN:o,total_USD:r,tip_PEN:n,tip_USD:i,main:a,loading:c,autoWidth:s,noDecimals:A=!1,containerStyle:p})=>{const h=u=>Mt(u,A?0:2);return t.jsx(hl,{main:a,autoWidth:s,style:p,children:c?t.jsxs(t.Fragment,{children:[t.jsx(yt,{children:t.jsx(S.default,{width:"150px",height:"15px"})}),t.jsxs(Et,{children:[t.jsxs(K,{style:{marginRight:"30px"},children:[t.jsx(Lt,{})," ",t.jsx("span",{children:t.jsx(S.default,{width:"50px",height:"15px"})})]}),t.jsxs(K,{children:[t.jsx(kt,{})," ",t.jsx("span",{children:t.jsx(S.default,{width:"50px",height:"15px"})})]})]}),t.jsx(Tt,{children:t.jsx(S.default,{width:"150px",height:"15px"})})]}):t.jsxs(t.Fragment,{children:[t.jsx(yt,{children:e||""}),t.jsxs(Et,{children:[o&&o>0?t.jsxs(K,{style:{marginRight:"30px"},children:[t.jsx(Lt,{})," ",t.jsx("span",{children:h(o)})]}):null,r&&r>0?t.jsxs(K,{children:[t.jsx(kt,{})," ",t.jsx("span",{children:h(r)})]}):null]}),t.jsx(Tt,{children:n&&n>0||i&&i>0?t.jsxs(t.Fragment,{children:[t.jsx("span",{children:"Propina: "}),n&&n>0?t.jsxs("span",{children:[" ",` S/${h(n)}`]}):null,i&&i>0?t.jsxs("span",{children:[" ",` $/${h(i)}`]}):null]}):null})]})})},gl=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},stroke:o,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",viewBox:"0 0 24 24",xmlns:"http://www.w3.org/2000/svg",fill:"none",children:t.jsx("polyline",{points:"22 12 18 12 15 21 9 3 6 12 2 12"})})})}),ul=({size:e=20,color:o="#242954",onClick:r,styleContainer:n})=>t.jsx("div",{onClick:()=>r&&r(),style:{...n,display:"inline-flex",alignItems:"center",justifyContent:"center",width:`${e}px`,height:`${e}px`,minWidth:`${e}px`,minHeight:`${e}px`,cursor:r?"pointer":"default"},children:t.jsx("div",{style:{position:"relative",height:0,width:"100%",padding:0,paddingBottom:"100%"},children:t.jsx("svg",{style:{position:"absolute",height:"100%",width:"100%",left:0,top:0},stroke:o,viewBox:"0 0 24 24",strokeWidth:"0",xmlns:"http://www.w3.org/2000/svg",fill:o,children:t.jsx("path",{d:"M21 11H6.83l3.58-3.59L9 6l-6 6 6 6 1.41-1.41L6.83 13H21z"})})})}),Dt=l.default.div`
...
`,xl=({name:e,symbol:o,currentAmount:r,oldAmount:n,loading:i,autoWidth:a=!1,noDecimals:c,containerStyle:s})=>{var b;const A=g=>Mt(g,c?0:2),p=()=>{if(!r||!n)return 0;const g=Math.round(r*100/n);return Number.isNaN(g-100)?0:Number.isFinite(g-100)?g:100},h={isUp:!r||!n?!1:r>=n,value:`${(b=A(p()))!=null?b:"0"}%`},u=`${o!=null?o:""} ${A(r||0)}`;return i?t.jsxs(Dt,{autoWidth:Boolean(a),style:s,children:[e&&t.jsx(Nt,{children:t.jsx(S.default,{width:"70px",height:"17px"})}),t.jsxs(It,{children:[t.jsx(S.default,{width:"50px",height:"30px"}),h&&h.value&&t.jsx(St,{isUp:h.isUp,children:t.jsx(S.default,{width:"50px",height:"15px"})})]})]}):t.jsxs(Dt,{autoWidth:Boolean(a),style:s,children:[e&&t.jsxs(Nt,{children:[t.jsx(gl,{size:14}),e]}),t.jsxs(It,{children:[t.jsx("strong",{children:u}),h&&h.value&&t.jsx(St,{isUp:h.isUp,children:t.jsxs("strong",{children:[t.jsx(ul,{size:14,color:h.isUp?"#27ae60":"#ea345f",styleContainer:{transform:h.isUp?"rotate(90deg)":"rotate(-90deg)"}}),h.value]})})]})]})};x.ActionOptionsModal=Sa,x.Badge=Eo,x.BaseInput=fi,x.BulletOptionsModal=Ta,x.BulletPoint=De,x.Button=I,x.ButtonsSelect=et,x.ButtonsSwitch=ai,x.Card=Yo,x.CardModal=Y,x.CartProduct=$n,x.CartProductV2=u0,x.Checkbox=R0,x.ClientCard=fn,x.CodeInput=nr,x.Collapsible=Mr,x.ConfirmationCard=j0,x.ConfirmationCardV2=W0,x.ConfirmationCardV3=it,x.ConfirmationModalV3=ma,x.CurrentStatusCard=Qo,x.CustomSelect=we,x.DateRangePicker=ua,x.DropdownMenu=zr,x.EditQuantityInput=ae,x.GridTable=Ra,x.Heading=er,x.HorizontalDivision=Ao,x.IDCard=Tn,x.IconV2=F,x.KpiCard=Al,x.KpiCardV2=xl,x.Loader=ur,x.ModalHeader=ll,x.MultipleOptionsModal=Ca,x.Navbar=so,x.NoData=Hr,x.OptionsModal=ht,x.OrderStatusBadge=je,x.OrderTypeBanner=So,x.Pagination=mt,x.ProductDetailsCard=E0,x.ProfileImage=fr,x.QuantityInputV2=oi,x.Radio=_0,x.Search=Me,x.SectionCard=nn,x.SectionHeader=sl,x.SelectField=wi,x.SimpleFooter=fl,x.StatusBanner=Po,x.StickyHeader=kr,x.SupplyInput=si,x.Tab=uo,x.Table=rl,x.Text=D,x.TextField=st,x.ToastCard=Cn,x.ToggleSwitch=xi,x.TotalsCard=_o,x.TransparentBadge=He,x.UploadFileContainer=ce,x.UploadImage=Ya,x.UploadMultipleImages=Va,x.UserIconTooltip=Se,x.UserProfileIcon=J,x.UsersList=Mo,Object.defineProperties(x,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
