(function(f,s){typeof exports=="object"&&typeof module<"u"?s(exports,require("styled-components"),require("react/jsx-runtime"),require("react"),require("react-loading-skeleton"),require("react-select")):typeof define=="function"&&define.amd?define(["exports","styled-components","react/jsx-runtime","react","react-loading-skeleton","react-select"],s):(f=typeof globalThis<"u"?globalThis:f||self,s(f["ID-Components"]={},f.styled,f["react/jsx-runtime"].js,f.React,f.Skeleton,f.Select))})(this,function(f,s,r,g,H,P){"use strict";const D=e=>e&&typeof e=="object"&&"default"in e?e:{default:e},b=D(s),Z=D(H),G=D(P),V={bold:700,medium:500,regular:400,light:300},y={xs:"0.750rem",sm:"0.875rem	",md:"1.0rem",lg:"1.250rem",xl:"1.5rem","2xl":"1.875rem","3xl":"2.0rem","4xl":"2.5rem","5xl":"3.0rem"},F={h1:"xl",h2:"lg",h3:"md",h4:"sm",h5:"xs",h6:"xs",text:"sm"},J=({shape:e})=>{switch(e){case"rounded":return s.css`
      ...
      `;default:return s.css`
        background-color: ${({theme:t})=>N({theme:t,color:o})};
        color: #fff;
      `}},N=({color:e="SECONDARY/900",theme:o,design:t,hover:c})=>{const a=e.split("/"),i=a[0];let n=+a[1];if(c&&n>=300)switch(t){case"solid":n-=100;break;case"outline":n=100;break;case"flat":n=100;break;default:n>=400?n-=100:n+=100;break}if(c&&n<300)switch(t){case"solid":n+=100;break;case"outline":n=100;break;case"flat":n=100;break;default:n-=100;break}return i==="PRIMARY"||i==="SECONDARY"||i==="TERTIARY"||i==="QUATERNARY"||i==="STATE"||i==="ALERT"||i==="SUCCESS"?n===50||n===100||n===200||n===300||n===400||n===500||n===600||n===700||n===800||n===900?o.color[i][n]:o.color[i][900]:o.color.PRIMARY[900]},j=({fullWidth:e})=>e?s.css`
      width: 100%;
    `:s.css`
    width: auto;
...
`,ee=b.default(X)`
  ...
  ${({m:e,mb:o,mt:t,mr:c,ml:a,my:i,mx:n,p:l,pb:d,pt:h,pr:p,pl:m,py:M,px:x})=>B({m:e,mb:o,mt:t,mr:c,ml:a,my:i,mx:n,p:l,pb:d,pt:h,pr:p,pl:m,py:M,px:x})};
...
`,Q=({children:e,...o})=>r.jsxs(ee,{...o,children:[o.leftIcon,e,o.rightIcon]});function te(e,o,t){const c=()=>{const a=document.querySelectorAll("input");return Array.from(a).filter(n=>n.className===o)};g.useEffect(()=>{const a=i=>{i.key==="Backspace"&&setTimeout(()=>{const n=c(),l=document.activeElement;l.value="";const d=n.indexOf(l);d>0&&n[d-1].focus()},0)};return document.addEventListener("keydown",a),()=>document.removeEventListener("keydown",a)},[]),g.useEffect(()=>{const a=i=>{if(i.key!=="Backspace"){const n=i.key.toLowerCase();setTimeout(()=>{if(n.length===1){const l=c(),d=document.activeElement;d.value=n;const h=l.indexOf(d);h<l.length-1&&l[h+1].focus()}},0)}};return document.addEventListener("keydown",a),()=>document.removeEventListener("keydown",a)},[]),g.useEffect(()=>{if(e){const a=i=>{const n=i.key.toLowerCase();(n.length===1||n==="backspace")&&setTimeout(()=>{const d=c().map(h=>h.value).join("");e(d)},0)};return document.addEventListener("keydown",a),()=>document.removeEventListener("keydown",a)}},[]),g.useEffect(()=>{if(t){const a=c(),i=t.split("");a.forEach((n,l)=>{const d=i[l];d&&(n.value=d)})}},[t])}const oe=s.keyframes`
  0% {
    opacity: 0;
...
`,re=s.css`
  ...
  ${({align:e})=>K({align:e})}
  ${({m:e,mb:o,mt:t,mr:c,ml:a,my:i,mx:n,p:l,pb:d,pt:h,pr:p,pl:m,py:M,px:x})=>B({m:e,mb:o,mt:t,mr:c,ml:a,my:i,mx:n,p:l,pb:d,pt:h,pr:p,pl:m,py:M,px:x})};
`,ne=e=>{const o=e==="h1"||e==="h2"||e==="h3"||e==="h4"||e==="h5"||e==="h6",t=o?"bold":"medium",c=o?F[e]:F.text,a="PRIMARY/900";return s.css`
    font-weight: ${({weight:i=t})=>V[i]||"500"};
    font-size: ${({size:i=c})=>y[i]||i};
    color: ${({theme:i,color:n=a})=>{const l=n==null?void 0:n.split("/")[0],d=+(n==null?void 0:n.split("/")[1]);return i.color[l][d]}};
  `},ie={h1:"h1",h2:"h2",h3:"h3",h4:"h4",h5:"h5",h6:"h6",p:"p",li:"li",span:"span",strong:"strong",label:"label"},ae=b.default.div`
  ${re}
  ${({as:e})=>ne(e)}
`,w=({as:e,...o})=>{const t=ie[e];return r.jsx(ae,{as:t,...o})},ce={H1:e=>r.jsx(w,{as:"h1",...e}),H2:e=>r.jsx(w,{as:"h2",...e}),H3:e=>r.jsx(w,{as:"h3",...e}),H4:e=>r.jsx(w,{as:"h4",...e}),H5:e=>r.jsx(w,{as:"h5",...e}),H6:e=>r.jsx(w,{as:"h6",...e})},se=b.default.div`
  display: flex;
  align-items: center;
  gap: 8px;
  transition: 0.3s ease-out;
`,A=e=>e.rightIcon||e.leftIcon?r.jsxs(se,{children:[e.leftIcon,r.jsx(w,{as:e.as||"p",...e}),e.rightIcon]}):r.jsx(w,{as:e.as||"p",...e}),le=b.default.div`
  display: grid;
...
`,ge={control:(e,o)=>({...e,minHeight:"45px",borderRadius:10,backgroundColor:"#ffffff",border:`1px solid ${o.isFocused?I.color.QUATERNARY[900]:I.color.NEUTRAL[300]}`,boxShadow:"none",cursor:"pointer"}),singleValue:()=>({color:I.color.PRIMARY[900],fontWeight:500,fontSize:"14px"}),placeholder:e=>({...e,color:I.color.NEUTRAL[700]}),indicatorSeparator:e=>({...e,display:"none",padding:0}),indicatorsContainer:e=>({...e,"> div":{padding:"0",paddingRight:"3px"}}),valueContainer:e=>({...e,padding:0,paddingLeft:"6px"})},he=({formatOptionLabel:e,options:o,loading:t=!1,style:c,error:a,firstOption:i,initialValue:n,value:l,onChange:d,isMulti:h,placeholder:p,label:m})=>{const M=i||{label:"Seleccione una opci\xF3n",value:""},x=[...o];return r.jsxs(fe,{style:c,hasError:!!a,children:[m&&r.jsx(A,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",children:m}),t?r.jsx(Z.default,{style:{borderRadius:10},className:"loading-skeleton",height:46,width:"100%"}):r.jsx(G.default,{placeholder:p,value:l||void 0,defaultValue:n||M,options:x,onChange:d,styles:ge,isMulti:h,formatOptionLabel:e})]})},pe=b.default.div`
  ${({fullWidth:e})=>j({fullWidth:e})};
  position: relative;
  display: flex;
  align-items: center;
...
`,be=e=>r.jsx("svg",{stroke:"currentColor",fill:"currentColor",strokeWidth:0,color:e.color||"#EE2316",height:24,width:24,viewBox:"0 0 24 24",...e,children:r.jsxs("g",{stroke:"none",children:[r.jsx("path",{fill:"none",d:"M0 0h24v24H0z"}),r.jsx("path",{d:"M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm-1-5h2v2h-2v-2zm0-8h2v6h-2V7z"})]})}),me=e=>r.jsx("svg",{stroke:"currentColor",fill:"currentColor",strokeWidth:0,color:e.color||"#2DC96F",height:20,width:20,viewBox:"0 0 1024 1024",...e,children:r.jsx("path",{d:"M912 190h-69.9c-9.8 0-19.1 4.5-25.1 12.2L404.7 724.5 207 474a32 32 0 0 0-25.1-12.2H112c-6.7 0-10.4 7.7-6.3 12.9l273.9 347c12.8 16.2 37.4 16.2 50.3 0l488.4-618.9c4.1-5.1.4-12.8-6.3-12.8z",stroke:"none"})}),Y=g.forwardRef(({type:e,leftAddon:o,rightAddon:t,placeholder:c,error:a,success:i,size:n,fullWidth:l,name:d,infoMessage:h,onFocus:p,onBlur:m,onChange:M,...x},L)=>{const[E,v]=g.useState(!1),z=!a&&!i&&h&&E;return r.jsxs(r.Fragment,{children:[r.jsxs(pe,{fullWidth:l,success:i,size:n,error:a,disabled:x.disabled,leftAddon:o,rightAddon:t,isFocused:E,children:[o&&r.jsx("span",{className:"leftAddon",children:o}),r.jsx("input",{ref:L,onFocus:k=>{p&&p(k),v(!0)},onBlur:k=>{m&&m(k),v(!1)},onChange:M,placeholder:c,type:e,name:d,...x}),t&&r.jsx("span",{className:"rightAddon",children:t}),a&&r.jsx("span",{className:"state",children:r.jsx(be,{size:24,color:I.color.ALERT[900]})}),i&&r.jsx("span",{className:"state",children:r.jsx(me,{size:20,color:I.color.SUCCESS[900]})})]}),z&&r.jsx(C,{shouldAppear:z,children:r.jsx(A,{size:"xs",color:"QUATERNARY/900",children:h})})]})}),xe=b.default.div`
...
`,Te=g.forwardRef(({label:e,searchable:o=!0,isMobile:t,autoSize:c,value:a,options:i,placeholder:n="Seleccione una opci\xF3n",fullWidth:l,fullWidthOptions:d,onChange:h,formatOptionLabel:p,formatSelectedOption:m},M)=>{const x=g.useRef(null),[L,E]=g.useState(i),[v,z]=g.useState(""),[k,T]=g.useState(!1);ke(x,()=>{T(!1)});const Le=g.useCallback(()=>{const u=i.filter($=>$.label.toLowerCase().includes(v.toLowerCase()));E(u)},[i,a]),R=g.useCallback(u=>{h(i.find($=>$.label===u)),T(!1),z(""),E(i)},[Le]),ye=g.useCallback(u=>{z(u.target.value);const $=i.filter(W=>W.label.toLowerCase().includes(u.target.value.toLowerCase()));E($)},[]),Fe=()=>{const u=x.current;if(u){const $=u.getBoundingClientRect();return window.innerHeight-$.bottom-20}};return r.jsxs(ve,{fullWidth:l,ref:x,children:[e&&r.jsx(A,{as:"label",align:"left",size:"sm",color:"NEUTRAL/700",pl:"0.05rem",mb:"0.25rem",children:e}),r.jsxs("div",{className:"select-btn",onClick:()=>T(!k),tabIndex:0,onKeyUpCapture:u=>{u.key==="Enter"&&T(!k)},children:[r.jsx(A,{as:"span",color:"NEUTRAL/700",mr:"0.5rem",children:m?m(a):p?p(a):a.label}),r.jsx(Ie,{size:20})]}),k&&r.jsxs(ze,{maxOptionsHeight:c?Fe():285,fullWidthOptions:d,children:[o&&r.jsx("div",{className:"search-box",children:r.jsx(Y,{leftAddon:r.jsx(Ee,{}),type:"text",placeholder:n,value:v,onChange:ye,fullWidth:!0})}),r.jsx("div",{className:"options",children:L.map(u=>r.jsx(A,{as:"li",color:"NEUTRAL/700",className:u.value===a.value?"selected":"",tabIndex:0,onClick:()=>R(u.label),onKeyUpCapture:$=>{$.key==="Enter"&&R(u.label)},children:p?p(u):u.label},`${u.label}-${u.value}`))})]})]})}),De=b.default.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 30px;
